	...
	*/
	...
	if (value_type[e_value_type.LIGHT])
	{
		...
		if (value_type[e_value_type.SPOTLIGHT])
		{
			...
			tl_update_values_ease(e_value.SPOT_GOBO_REPEAT_X)
			tl_update_values_ease(e_value.SPOT_GOBO_REPEAT_Y)
			tl_update_values_ease(e_value.SPOT_GOBO_OFFSET_X)
			tl_update_values_ease(e_value.SPOT_GOBO_OFFSET_Y)
