...
namespace CppProject
{
	...
	void app_startup_keybinds()
	{
		...
		keybind_register(/*"projectnew"*/ STR(242), e_keybind_PROJECT_NEW, keybind_new(/*"N"*/ STR(243), true));
		keybind_register(/*"projectopen"*/ STR(244), e_keybind_PROJECT_OPEN, keybind_new(/*"O"*/ STR(245), true));
		keybind_register(/*"projectsave"*/ STR(246), e_keybind_PROJECT_SAVE, keybind_new(/*"S"*/ STR(247), true));
		keybind_register(/*"projectsaveas"*/ STR(248), e_keybind_PROJECT_SAVE_AS, keybind_new(/*"S"*/ STR(247), true, true));
		keybind_register(/*"importasset"*/ STR(249), e_keybind_IMPORT_ASSET, keybind_new(/*"I"*/ STR(250), true));
		keybind_register(/*"undo"*/ STR(251), e_keybind_UNDO, keybind_new(/*"Z"*/ STR(252), true));
		keybind_register(/*"redo"*/ STR(253), e_keybind_REDO, keybind_new(/*"Y"*/ STR(254), true));
		keybind_register(/*"timelinedelete"*/ STR(255), e_keybind_TIMELINE_DELETE, keybind_new(/*"R"*/ STR(256), true));
		keybind_register(/*"timelineduplicate"*/ STR(257), e_keybind_TIMELINE_DUPLICATE, keybind_new(/*"D"*/ STR(258), true));
		keybind_register(/*"timelineselect"*/ STR(259), e_keybind_TIMELINE_SELECT, keybind_new(/*"A"*/ STR(260), true));
		keybind_register(/*"timelinehide"*/ STR(261), e_keybind_TIMELINE_HIDE, keybind_new(/*"H"*/ STR(262), true));
		keybind_register(/*"timelineshowhidden"*/ STR(263), e_keybind_TIMELINE_SHOW_HIDDEN, keybind_new(/*"H"*/ STR(262), true, false, true));
		keybind_register(/*"createfolder"*/ STR(264), e_keybind_CREATE_FOLDER, keybind_new(/*"F"*/ STR(265), true));
		keybind_register(/*"keyframescreate"*/ STR(266), e_keybind_KEYFRAMES_CREATE, keybind_new(/*"Q"*/ STR(267), true));
		keybind_register(/*"keyframescopy"*/ STR(268), e_keybind_KEYFRAMES_COPY, keybind_new(/*"C"*/ STR(269), true));
		keybind_register(/*"keyframescut"*/ STR(270), e_keybind_KEYFRAMES_CUT, keybind_new(/*"X"*/ STR(271), true));
		keybind_register(/*"keyframespaste"*/ STR(272), e_keybind_KEYFRAMES_PASTE, keybind_new(/*"V"*/ STR(273), true));
		keybind_register(/*"keyframesdelete"*/ STR(274), e_keybind_KEYFRAMES_DELETE, keybind_new(vk_delete));
		keybind_register(/*"play"*/ STR(275), e_keybind_PLAY, keybind_new(vk_space));
		keybind_register(/*"playbeginning"*/ STR(276), e_keybind_PLAY_BEGINNING, keybind_new(vk_enter));
		keybind_register(/*"markerleft"*/ STR(277), e_keybind_MARKER_LEFT, keybind_new(vk_left), true);
		keybind_register(/*"markerright"*/ STR(278), e_keybind_MARKER_RIGHT, keybind_new(vk_right), true);
		keybind_register(/*"rendermode"*/ STR(279), e_keybind_RENDER_MODE, keybind_new(vk_f5));
		keybind_register(/*"particlesspawn"*/ STR(280), e_keybind_PARTICLES_SPAWN, keybind_new(/*"X"*/ STR(271)));
		keybind_register(/*"particlesclear"*/ STR(281), e_keybind_PARTICLES_CLEAR, keybind_new(/*"C"*/ STR(269)));
		keybind_register(/*"secondaryview"*/ STR(282), e_keybind_SECONDARY_VIEW, keybind_new(vk_f6));
		keybind_register(/*"toolselect"*/ STR(283), e_keybind_TOOL_SELECT, keybind_new(/*"W"*/ STR(284)));
		keybind_register(/*"toolmove"*/ STR(285), e_keybind_TOOL_MOVE, keybind_new(/*"G"*/ STR(286)));
		keybind_register(/*"toolrotate"*/ STR(287), e_keybind_TOOL_ROTATE, keybind_new(/*"R"*/ STR(256)));
		keybind_register(/*"toolscale"*/ STR(288), e_keybind_TOOL_SCALE, keybind_new(/*"S"*/ STR(247)));
		keybind_register(/*"toolbend"*/ STR(289), e_keybind_TOOL_BEND, keybind_new(/*"B"*/ STR(290)));
		keybind_register(/*"tooltransform"*/ STR(291), e_keybind_TOOL_TRANSFORM, keybind_new(/*"T"*/ STR(292)));
		keybind_register(/*"snap"*/ STR(293), e_keybind_SNAP, keybind_new(/*"F"*/ STR(265)));
		keybind_register(/*"camforward"*/ STR(294), e_keybind_CAM_FORWARD, keybind_new(/*"W"*/ STR(284)), true);
		keybind_register(/*"camleft"*/ STR(295), e_keybind_CAM_LEFT, keybind_new(/*"A"*/ STR(260)), true);
		keybind_register(/*"camback"*/ STR(296), e_keybind_CAM_BACK, keybind_new(/*"S"*/ STR(247)), true);
		keybind_register(/*"camright"*/ STR(297), e_keybind_CAM_RIGHT, keybind_new(/*"D"*/ STR(258)), true);
		keybind_register(/*"camascend"*/ STR(298), e_keybind_CAM_ASCEND, keybind_new(/*"E"*/ STR(299)), true);
		keybind_register(/*"camdescend"*/ STR(300), e_keybind_CAM_DESCEND, keybind_new(/*"Q"*/ STR(267)), true);
		keybind_register(/*"camrollforward"*/ STR(301), e_keybind_CAM_ROLL_FORWARD, keybind_new(/*"Z"*/ STR(252)), true);
		keybind_register(/*"camrollback"*/ STR(302), e_keybind_CAM_ROLL_BACK, keybind_new(/*"C"*/ STR(269)), true);
		keybind_register(/*"camrollreset"*/ STR(303), e_keybind_CAM_ROLL_RESET, keybind_new(/*"X"*/ STR(271)), true);
		keybind_register(/*"camreset"*/ STR(304), e_keybind_CAM_RESET, keybind_new(/*"R"*/ STR(256)), true);
		keybind_register(/*"camfast"*/ STR(305), e_keybind_CAM_FAST, keybind_new(vk_space), true);
		keybind_register(/*"camslow"*/ STR(306), e_keybind_CAM_SLOW, keybind_new(null_, false, true), true);
		keybind_register(/*"camviewtimeline"*/ STR(307), e_keybind_CAM_VIEW_TIMELINE, keybind_new(/*"V"*/ STR(273)), false);
	...
	void app_startup_lists(ScopeAny self)
	{
		...
		ds_list_add({ global::value_name_list, /*"POS_X"*/ STR(308), /*"POS_Y"*/ STR(309), /*"POS_Z"*/ STR(310), /*"ROT_X"*/ STR(311), /*"ROT_Y"*/ STR(312), /*"ROT_Z"*/ STR(313), /*"SCA_X"*/ STR(314), /*"SCA_Y"*/ STR(315), /*"SCA_Z"*/ STR(316), /*"BEND_ANGLE"*/ STR(317), /*"BEND_ANGLE_X"*/ STR(318), /*"BEND_ANGLE_Y"*/ STR(319), /*"BEND_ANGLE_Z"*/ STR(320), /*"ALPHA"*/ STR(321), /*"RGB_ADD"*/ STR(322), /*"RGB_SUB"*/ STR(323), /*"RGB_MUL"*/ STR(324), /*"HSB_ADD"*/ STR(325), /*"HSB_SUB"*/ STR(326), /*"HSB_MUL"*/ STR(327), /*"MIX_COLOR"*/ STR(328), /*"GLOW_COLOR"*/ STR(329), /*"MIX_PERCENT"*/ STR(330), /*"EMISSIVE"*/ STR(331), /*"METALLIC"*/ STR(332), /*"ROUGHNESS"*/ STR(333), /*"SUBSURFACE"*/ STR(334), /*"SUBSURFACE_RADIUS_RED"*/ STR(335), /*"SUBSURFACE_RADIUS_GREEN"*/ STR(336), /*"SUBSURFACE_RADIUS_BLUE"*/ STR(337), /*"SUBSURFACE_COLOR"*/ STR(338), /*"WIND_INFLUENCE"*/ STR(339), /*"SPAWN"*/ STR(340), /*"FREEZE"*/ STR(341), /*"CLEAR"*/ STR(342), /*"CUSTOM_SEED"*/ STR(343), /*"SEED"*/ STR(344), /*"ATTRACTOR"*/ STR(345), /*"FORCE"*/ STR(346), /*"FORCE_DIRECTIONAL"*/ STR(347), /*"FORCE_VORTEX"*/ STR(348), /*"LIGHT_COLOR"*/ STR(349), /*"LIGHT_STRENGTH"*/ STR(350), /*"LIGHT_SPECULAR_STRENGTH"*/ STR(351), /*"LIGHT_SIZE"*/ STR(352), /*"LIGHT_RANGE"*/ STR(353), /*"LIGHT_FADE_SIZE"*/ STR(354), /*"LIGHT_SPOT_RADIUS"*/ STR(355), /*"LIGHT_SPOT_SHARPNESS"*/ STR(356), /*"CAM_FOV"*/ STR(357), /*"CAM_CLIP_NEAR"*/ STR(358), /*"CAM_CLIP_FAR"*/ STR(359), /*"CAM_BLADE_AMOUNT"*/ STR(360), /*"CAM_BLADE_ANGLE"*/ STR(361), /*"CAM_LIGHT_MANAGEMENT"*/ STR(362), /*"CAM_TONEMAPPER"*/ STR(363), /*"CAM_EXPOSURE"*/ STR(364), /*"CAM_GAMMA"*/ STR(365), /*"CAM_ROTATE"*/ STR(366), /*"CAM_ROTATE_DISTANCE"*/ STR(367), /*"CAM_ROTATE_ANGLE_XY"*/ STR(368), /*"CAM_ROTATE_ANGLE_Z"*/ STR(369), /*"CAM_SHAKE"*/ STR(370), /*"CAM_SHAKE_MODE"*/ STR(371), /*"CAM_SHAKE_STRENGTH_X"*/ STR(372), /*"CAM_SHAKE_STRENGTH_Y"*/ STR(373), /*"CAM_SHAKE_STRENGTH_Z"*/ STR(374), /*"CAM_SHAKE_SPEED_X"*/ STR(375), /*"CAM_SHAKE_SPEED_Y"*/ STR(376), /*"CAM_SHAKE_SPEED_Z"*/ STR(377), /*"CAM_DOF"*/ STR(378), /*"CAM_DOF_DEPTH"*/ STR(379), /*"CAM_DOF_RANGE"*/ STR(380), /*"CAM_DOF_FADE_SIZE"*/ STR(381), /*"CAM_DOF_BLUR_SIZE"*/ STR(382), /*"CAM_DOF_BLUR_RATIO"*/ STR(383), /*"CAM_DOF_BIAS"*/ STR(384), /*"CAM_DOF_THRESHOLD"*/ STR(385), /*"CAM_DOF_GAIN"*/ STR(386), /*"CAM_DOF_FRINGE"*/ STR(387), /*"CAM_DOF_FRINGE_ANGLE_RED"*/ STR(388), /*"CAM_DOF_FRINGE_ANGLE_GREEN"*/ STR(389), /*"CAM_DOF_FRINGE_ANGLE_BLUE"*/ STR(390), /*"CAM_DOF_FRINGE_RED"*/ STR(391), /*"CAM_DOF_FRINGE_GREEN"*/ STR(392), /*"CAM_DOF_FRINGE_BLUE"*/ STR(393), /*"CAM_BLOOM"*/ STR(394), /*"CAM_BLOOM_THRESHOLD"*/ STR(395), /*"CAM_BLOOM_INTENSITY"*/ STR(396), /*"CAM_BLOOM_RADIUS"*/ STR(397), /*"CAM_BLOOM_RATIO"*/ STR(398), /*"CAM_BLOOM_BLEND"*/ STR(399), /*"CAM_LENS_DIRT"*/ STR(400), /*"CAM_LENS_DIRT_BLOOM"*/ STR(401), /*"CAM_LENS_DIRT_GLOW"*/ STR(402), /*"CAM_LENS_DIRT_RADIUS"*/ STR(403), /*"CAM_LENS_DIRT_INTENSITY"*/ STR(404), /*"CAM_LENS_DIRT_POWER"*/ STR(405), /*"CAM_COLOR_CORRECTION"*/ STR(406), /*"CAM_CONTRAST"*/ STR(407), /*"CAM_BRIGHTNESS"*/ STR(408), /*"CAM_SATURATION"*/ STR(409), /*"CAM_VIBRANCE"*/ STR(410), /*"CAM_COLOR_BURN"*/ STR(411), /*"CAM_GRAIN"*/ STR(412), /*"CAM_GRAIN_STRENGTH"*/ STR(413), /*"CAM_GRAIN_SATURATION"*/ STR(414), /*"CAM_GRAIN_SIZE"*/ STR(415), /*"CAM_VIGNETTE"*/ STR(416), /*"CAM_VIGNETTE_RADIUS"*/ STR(417), /*"CAM_VIGNETTE_SOFTNESS"*/ STR(418), /*"CAM_VIGNETTE_STRENGTH"*/ STR(419), /*"CAM_VIGNETTE_COLOR"*/ STR(420), /*"CAM_CA"*/ STR(421), /*"CAM_CA_BLUR_AMOUNT"*/ STR(422), /*"CAM_CA_DISTORT_CHANNELS"*/ STR(423), /*"CAM_CA_RED_OFFSET"*/ STR(424), /*"CAM_CA_GREEN_OFFSET"*/ STR(425), /*"CAM_CA_BLUE_OFFSET"*/ STR(426), /*"CAM_DISTORT"*/ STR(427), /*"CAM_DISTORT_REPEAT"*/ STR(428), /*"CAM_DISTORT_ZOOM_AMOUNT"*/ STR(429), /*"CAM_DISTORT_AMOUNT"*/ STR(430), /*"CAM_SIZE_USE_PROJECT"*/ STR(431), /*"CAM_SIZE_KEEP_ASPECT_RATIO"*/ STR(432), /*"CAM_WIDTH"*/ STR(433), /*"CAM_HEIGHT"*/ STR(434), /*"BG_IMAGE_SHOW"*/ STR(435), /*"BG_IMAGE_ROTATION"*/ STR(436), /*"BG_SKY_MOON_PHASE"*/ STR(437), /*"BG_SKY_TIME"*/ STR(438), /*"BG_SKY_ROTATION"*/ STR(439), /*"BG_SUNLIGHT_STRENGTH"*/ STR(440), /*"BG_SUNLIGHT_ANGLE"*/ STR(441), /*"BG_SKY_SUN_ANGLE"*/ STR(442), /*"BG_SKY_SUN_SCALE"*/ STR(443), /*"BG_SKY_MOON_ANGLE"*/ STR(444), /*"BG_SKY_MOON_SCALE"*/ STR(445), /*"BG_TWILIGHT"*/ STR(446), /*"BG_SKY_CLOUDS_SHOW"*/ STR(447), /*"BG_SKY_CLOUDS_SPEED"*/ STR(448), /*"BG_SKY_CLOUDS_HEIGHT"*/ STR(449), /*"BG_SKY_CLOUDS_OFFSET"*/ STR(450), /*"BG_GROUND_SHOW"*/ STR(451), /*"BG_GROUND_SLOT"*/ STR(452), /*"BG_BIOME"*/ STR(453), /*"BG_SKY_COLOR"*/ STR(454), /*"BG_SKY_CLOUDS_COLOR"*/ STR(455), /*"BG_SUNLIGHT_COLOR"*/ STR(456), /*"BG_AMBIENT_COLOR"*/ STR(457), /*"BG_NIGHT_COLOR"*/ STR(458), /*"BG_GRASS_COLOR"*/ STR(459), /*"BG_FOLIAGE_COLOR"*/ STR(460), /*"BG_WATER_COLOR"*/ STR(461), /*"BG_LEAVES_OAK_COLOR"*/ STR(462), /*"BG_LEAVES_SPRUCE_COLOR"*/ STR(463), /*"BG_LEAVES_BIRCH_COLOR"*/ STR(464), /*"BG_LEAVES_JUNGLE_COLOR"*/ STR(465), /*"BG_LEAVES_ACACIA_COLOR"*/ STR(466), /*"BG_LEAVES_DARK_OAK_COLOR"*/ STR(467), /*"BG_LEAVES_MANGROVE_COLOR"*/ STR(468), /*"BG_FOG_SHOW"*/ STR(469), /*"BG_FOG_SKY"*/ STR(470), /*"BG_FOG_CUSTOM_COLOR"*/ STR(471), /*"BG_FOG_COLOR"*/ STR(472), /*"BG_FOG_CUSTOM_OBJECT_COLOR"*/ STR(473), /*"BG_FOG_OBJECT_COLOR"*/ STR(474), /*"BG_FOG_DISTANCE"*/ STR(475), /*"BG_FOG_SIZE"*/ STR(476), /*"BG_FOG_HEIGHT"*/ STR(477), /*"BG_WIND"*/ STR(478), /*"BG_WIND_SPEED"*/ STR(479), /*"BG_WIND_STRENGTH"*/ STR(480), /*"BG_WIND_DIRECTION"*/ STR(481), /*"BG_WIND_DIRECTIONAL_SPEED"*/ STR(482), /*"BG_WIND_DIRECTIONAL_STRENGTH"*/ STR(483), /*"BG_TEXTURE_ANI_SPEED"*/ STR(484), /*"TEXTURE_OBJ"*/ STR(485), /*"TEXTURE_MATERIAL_OBJ"*/ STR(486), /*"TEXTURE_NORMAL_OBJ"*/ STR(487), /*"SOUND_OBJ"*/ STR(488), /*"SOUND_VOLUME"*/ STR(489), /*"SOUND_PITCH"*/ STR(490), /*"SOUND_START"*/ STR(491), /*"SOUND_END"*/ STR(492), /*"TEXT"*/ STR(493), /*"TEXT_FONT"*/ STR(494), /*"TEXT_HALIGN"*/ STR(495), /*"TEXT_VALIGN"*/ STR(496), /*"TEXT_AA"*/ STR(497), /*"CUSTOM_ITEM_SLOT"*/ STR(498), /*"ITEM_SLOT"*/ STR(499), /*"ITEM_NAME"*/ STR(500), /*"PATH_OBJ"*/ STR(501), /*"PATH_OFFSET"*/ STR(502), /*"PATH_POINT_ANGLE"*/ STR(503), /*"PATH_POINT_SCALE"*/ STR(504), /*"IK_TARGET"*/ STR(505), /*"IK_BLEND"*/ STR(506), /*"IK_TARGET_ANGLE"*/ STR(507), /*"IK_ANGLE_OFFSET"*/ STR(508), /*"ROT_TARGET"*/ STR(509), /*"POS_TARGET"*/ STR(510), /*"SCALE_TARGET"*/ STR(511), /*"FLW_ROT_X"*/ STR(512), /*"FLW_ROT_Y"*/ STR(513), /*"FLW_ROT_Z"*/ STR(514), /*"FLW_POS_X"*/ STR(515), /*"FLW_POS_Y"*/ STR(516), /*"FLW_POS_Z"*/ STR(517), /*"FLW_SCALE_X"*/ STR(518), /*"FLW_SCALE_Y"*/ STR(519), /*"FLW_SCALE_Z"*/ STR(520), /*"FLW_POS_OFFSET_X"*/ STR(521), /*"FLW_POS_OFFSET_Y"*/ STR(522), /*"FLW_POS_OFFSET_Z"*/ STR(523), /*"FLW_SCALE_MULT"*/ STR(524), /*"VISIBLE"*/ STR(525), /*"TRANSITION"*/ STR(526), /*"EASE_IN_X"*/ STR(527), /*"EASE_IN_Y"*/ STR(528), /*"EASE_OUT_X"*/ STR(529), /*"EASE_OUT_Y"*/ STR(530) });
		...
		ds_list_add({ global::temp_type_name_list, /*"char"*/ STR(531), /*"spblock"*/ STR(532), /*"scenery"*/ STR(533), /*"item"*/ STR(534), /*"block"*/ STR(535), /*"bodypart"*/ STR(536), /*"particles"*/ STR(537), /*"text"*/ STR(99), /*"cube"*/ STR(3), /*"cone"*/ STR(538), /*"cylinder"*/ STR(539), /*"sphere"*/ STR(540), /*"surface"*/ STR(541), /*"model"*/ STR(542) });
		global::tl_type_name_list = ds_list_create();
		ds_list_add({ global::tl_type_name_list, /*"char"*/ STR(531), /*"spblock"*/ STR(532), /*"scenery"*/ STR(533), /*"item"*/ STR(534), /*"block"*/ STR(535), /*"bodypart"*/ STR(536), /*"particles"*/ STR(537), /*"text"*/ STR(99), /*"cube"*/ STR(3), /*"cone"*/ STR(538), /*"cylinder"*/ STR(539), /*"sphere"*/ STR(540), /*"surface"*/ STR(541), /*"model"*/ STR(542), /*"camera"*/ STR(120), /*"spotlight"*/ STR(543), /*"pointlight"*/ STR(544), /*"folder"*/ STR(545), /*"background"*/ STR(213), /*"audio"*/ STR(546), /*"path"*/ STR(547), /*"pathpoint"*/ STR(548), /*"shape"*/ STR(549), /*"lightsource"*/ STR(550) });
		global::res_type_name_list = ds_list_create();
		ds_list_add({ global::res_type_name_list, /*"pack"*/ STR(551), /*"packunzipped"*/ STR(552), /*"skin"*/ STR(553), /*"downloadskin"*/ STR(199), /*"itemsheet"*/ STR(554), /*"legacyblocksheet"*/ STR(555), /*"blocksheet"*/ STR(556), /*"scenery"*/ STR(533), /*"fromworld"*/ STR(557), /*"particlesheet"*/ STR(558), /*"texture"*/ STR(559), /*"font"*/ STR(560), /*"sound"*/ STR(561), /*"model"*/ STR(542) });
		global::transition_list = ds_list_create();
		ds_list_add({ global::transition_list, /*"linear"*/ STR(562), /*"instant"*/ STR(563), /*"bezier"*/ STR(564), /*"easeinquad"*/ STR(565), /*"easeoutquad"*/ STR(566), /*"easeinoutquad"*/ STR(567), /*"easeincubic"*/ STR(568), /*"easeoutcubic"*/ STR(569), /*"easeinoutcubic"*/ STR(570), /*"easeinquart"*/ STR(571), /*"easeoutquart"*/ STR(572), /*"easeinoutquart"*/ STR(573), /*"easeinquint"*/ STR(574), /*"easeoutquint"*/ STR(575), /*"easeinoutquint"*/ STR(576), /*"easeinsine"*/ STR(577), /*"easeoutsine"*/ STR(578), /*"easeinoutsine"*/ STR(579), /*"easeinexpo"*/ STR(580), /*"easeoutexpo"*/ STR(581), /*"easeinoutexpo"*/ STR(582), /*"easeincirc"*/ STR(583), /*"easeoutcirc"*/ STR(584), /*"easeinoutcirc"*/ STR(585), /*"easeinelastic"*/ STR(586), /*"easeoutelastic"*/ STR(587), /*"easeinoutelastic"*/ STR(588), /*"easeinback"*/ STR(589), /*"easeoutback"*/ STR(590), /*"easeinoutback"*/ STR(591), /*"easeinbounce"*/ STR(592), /*"easeoutbounce"*/ STR(593), /*"easeinoutbounce"*/ STR(594) });
		log({ /*"Make transitions"*/ STR(595) });
		...
		log({ /*"Transitions OK"*/ STR(596) });
		global::videotemplate_list = ds_list_create();
		ds_list_add({ global::videotemplate_list, new_videotemplate(/*"avatar"*/ STR(597), IntType(512), IntType(512)), new_videotemplate(/*"hd_720p"*/ STR(598), IntType(1280), IntType(720)), new_videotemplate(/*"fhd_1080p"*/ STR(599), IntType(1920), IntType(1080)), new_videotemplate(/*"qhd_1440p"*/ STR(600), IntType(2560), IntType(1440)), new_videotemplate(/*"uhd_4k"*/ STR(601), IntType(3840), IntType(2160)), new_videotemplate(/*"hd_720p_cinematic"*/ STR(602), IntType(1680), IntType(720)), new_videotemplate(/*"fhd_1080p_cinematic"*/ STR(603), IntType(2560), IntType(1080)), new_videotemplate(/*"qhd_1440p_cinematic"*/ STR(604), IntType(3440), IntType(1440)), new_videotemplate(/*"uhd_4k_cinematic"*/ STR(605), IntType(5120), IntType(2160)) });
		global::videoquality_list = ds_list_create();
		ds_list_add({ global::videoquality_list, new_videoquality(/*"best"*/ STR(606), IntType(5000000)), new_videoquality(/*"high"*/ STR(607), IntType(2500000)), new_videoquality(/*"medium"*/ STR(608), IntType(1200000)), new_videoquality(/*"low"*/ STR(609), IntType(700000)), new_videoquality(/*"verylow"*/ STR(610), IntType(350000)) });
		...
		ds_list_add({ global::biome_list, new_biome(/*"custom"*/ STR(611), IntType(0), IntType(0), true, c_plains_biome_grass, c_plains_biome_foliage, c_plains_biome_water, null_) });
		...
		ds_list_add({ global::minecraft_color_name_list, /*"white"*/ STR(612), /*"orange"*/ STR(613), /*"magenta"*/ STR(614), /*"light_blue"*/ STR(615), /*"yellow"*/ STR(616), /*"lime"*/ STR(617), /*"pink"*/ STR(618), /*"gray"*/ STR(619), /*"light_gray"*/ STR(620), /*"cyan"*/ STR(621), /*"purple"*/ STR(622), /*"blue"*/ STR(623), /*"brown"*/ STR(624), /*"green"*/ STR(625), /*"red"*/ STR(626), /*"black"*/ STR(627) });
		...
		ds_list_add({ global::render_pass_list, /*"combined"*/ STR(633), /*"diffuse"*/ STR(634), /*"specular"*/ STR(635), /*"ao"*/ STR(636), /*"shadows"*/ STR(123), /*"indirect"*/ STR(125), /*"indirectshadows"*/ STR(637), /*"reflections"*/ STR(126), /*"depth"*/ STR(638), /*"normal"*/ STR(628), /*"material"*/ STR(639) });
	}
	...
	void app_startup_window(ScopeAny self)
	{
		...
		sStr(popup_block_ani_ease) = /*"easeoutcirc"*/ STR(584);
	...
	void app_update_animate(ScopeAny self)
	{
		...
		if (bgobject > 0)
		{
			...
			if (sVar(background_biome) == /*"custom"*/ STR(611) || sVar(background_biome_prev) != sVar(background_biome))
			{
		...
		sInt(background_sky_color_final) = merge_color((IntType)(sVar(background_sky_color)), hex_to_color(/*"020204"*/ STR(699)), background_sky_night_alpha());
