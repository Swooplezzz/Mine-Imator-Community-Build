...
namespace CppProject
{
	void app_startup_collapse()
	{
		...
		collapse_register(/*"openimagedenoise"*/ STR(139));
		...
		collapse_register(/*"copyrot"*/ STR(149));
		collapse_register(/*"copypos"*/ STR(150));
		collapse_register(/*"copyscale"*/ STR(151));
		collapse_register(/*"bendik"*/ STR(152));
		collapse_register(/*"path_shape"*/ STR(153));
		collapse_register(/*"path_shape_tube"*/ STR(154));
		collapse_register(/*"light_management_cam"*/ STR(155));
		collapse_register(/*"aperture"*/ STR(156));
		collapse_register(/*"camshake"*/ STR(157));
		collapse_register(/*"dof"*/ STR(158));
		collapse_register(/*"dof_fringe"*/ STR(159));
		collapse_register(/*"bloom"*/ STR(160));
		collapse_register(/*"lensdirt"*/ STR(161));
		collapse_register(/*"clrcor"*/ STR(162));
		collapse_register(/*"grain"*/ STR(163));
		collapse_register(/*"vignette"*/ STR(164));
		collapse_register(/*"ca"*/ STR(165));
		collapse_register(/*"distort"*/ STR(166));
		collapse_register(/*"itemslot"*/ STR(167));
		collapse_register(/*"material_color"*/ STR(168));
		collapse_register(/*"material_surface"*/ STR(169));
		collapse_register(/*"material_subsurface"*/ STR(170));
		collapse_register(/*"textoutline"*/ STR(171));
		collapse_register(/*"tl_glint"*/ STR(172));
	}
	
	void app_startup_fonts(ScopeAny self)
	{
		sInt(font_subheading) = font_add(fonts_directory + /*"rubik_medium.ttf"*/ STR(173), (IntType)(8.5), false, false, IntType(32), IntType(1024));
		sInt(font_label) = font_add(fonts_directory + /*"noto_bold.ttf"*/ STR(174), IntType(9), false, false, IntType(32), IntType(1024));
		sInt(font_value) = font_add(fonts_directory + /*"noto_regular.ttf"*/ STR(175), IntType(9), false, false, IntType(32), IntType(1024));
		sInt(font_digits) = font_add(fonts_directory + /*"notomono_regular.ttf"*/ STR(176), IntType(9), false, false, IntType(32), IntType(1024));
		sInt(font_caption) = font_add(fonts_directory + /*"noto_regular.ttf"*/ STR(175), IntType(8), false, false, IntType(32), IntType(1024));
		sInt(font_button) = font_add(fonts_directory + /*"rubik_medium.ttf"*/ STR(173), (IntType)(9.5), false, false, IntType(32), IntType(1024));
		sVar(font_upgrade) = font_add(fonts_directory + /*"noto_regular.ttf"*/ STR(175), IntType(18), false, false, IntType(32), IntType(1024));
		sInt(font_heading) = font_add(fonts_directory + /*"rubik_medium.ttf"*/ STR(173), IntType(10), false, false, IntType(32), IntType(1024));
		sVar(font_body_big) = font_add(fonts_directory + /*"noto_regular.ttf"*/ STR(175), IntType(12), false, false, IntType(32), IntType(1024));
		sInt(font_heading_big) = font_add(fonts_directory + /*"rubik_medium.ttf"*/ STR(173), IntType(13), false, false, IntType(32), IntType(1024));
		sInt(font_splash_bold_big) = font_add(fonts_directory + /*"rubik_semibold.ttf"*/ STR(177), IntType(11), false, false, IntType(32), IntType(1024));
		sInt(font_splash_bold) = font_add(fonts_directory + /*"rubik_semibold.ttf"*/ STR(177), IntType(10), false, false, IntType(32), IntType(1024));
		sInt(font_splash_bold_secondary) = font_add(fonts_directory + /*"rubik_semibold.ttf"*/ STR(177), (IntType)(8.5), false, false, IntType(32), IntType(1024));
	}
	...
	void app_startup_interface_panels()
	{
		...
		DsMap(global::_app->panel_map)[/*"left_secondary"*/ STR(199)] = (new obj_panel)->id;
		ObjType(obj_panel, DsMap(global::_app->panel_map)[/*"left_secondary"*/ STR(199)])->size = global::_app->setting_panel_left_bottom_size;
		ObjType(obj_panel, DsMap(global::_app->panel_map)[/*"left_secondary"*/ STR(199)])->location = /*"left_secondary"*/ STR(199);
		DsMap(global::_app->panel_map)[/*"right_secondary"*/ STR(200)] = (new obj_panel)->id;
		ObjType(obj_panel, DsMap(global::_app->panel_map)[/*"right_secondary"*/ STR(200)])->size = global::_app->setting_panel_right_bottom_size;
		ObjType(obj_panel, DsMap(global::_app->panel_map)[/*"right_secondary"*/ STR(200)])->location = /*"right_secondary"*/ STR(200);
		DsMap(global::_app->panel_map)[/*"bottom"*/ STR(201)] = (new obj_panel)->id;
		ObjType(obj_panel, DsMap(global::_app->panel_map)[/*"bottom"*/ STR(201)])->size = global::_app->setting_panel_bottom_size;
		ObjType(obj_panel, DsMap(global::_app->panel_map)[/*"bottom"*/ STR(201)])->location = /*"bottom"*/ STR(201);
		DsMap(global::_app->panel_map)[/*"top"*/ STR(202)] = (new obj_panel)->id;
		ObjType(obj_panel, DsMap(global::_app->panel_map)[/*"top"*/ STR(202)])->size = global::_app->setting_panel_top_size;
		ObjType(obj_panel, DsMap(global::_app->panel_map)[/*"top"*/ STR(202)])->location = /*"top"*/ STR(202);
		DsMap(global::_app->panel_map)[/*"left"*/ STR(203)] = (new obj_panel)->id;
		ObjType(obj_panel, DsMap(global::_app->panel_map)[/*"left"*/ STR(203)])->size = global::_app->setting_panel_left_top_size;
		ObjType(obj_panel, DsMap(global::_app->panel_map)[/*"left"*/ STR(203)])->location = /*"left"*/ STR(203);
		DsMap(global::_app->panel_map)[/*"right"*/ STR(204)] = (new obj_panel)->id;
		ObjType(obj_panel, DsMap(global::_app->panel_map)[/*"right"*/ STR(204)])->size = global::_app->setting_panel_right_top_size;
		ObjType(obj_panel, DsMap(global::_app->panel_map)[/*"right"*/ STR(204)])->location = /*"right"*/ STR(204);
	...
	{
		global::_app->popup_welcome = new_popup({ /*"welcome"*/ STR(205), ID_popup_welcome_draw, IntType(420), IntType(159), true, false, false, false });
		global::_app->popup_about = new_popup({ /*"about"*/ STR(206), ID_popup_about_draw, IntType(542), IntType(480), true, true, false, true });
		global::_app->popup_newproject = new_popup({ /*"newproject"*/ STR(207), ID_popup_newproject_draw, IntType(380), null_, true });
		...
		global::_app->popup_saveas = new_popup({ /*"saveas"*/ STR(208), ID_popup_saveas_draw, IntType(380), null_, true });
		...
		global::_app->popup_loading = new_popup({ /*"loading"*/ STR(209), ID_popup_loading_draw, IntType(400), null_, true, true });
		...
		global::_app->popup_downloadskin = new_popup({ /*"downloadskin"*/ STR(210), ID_popup_downloadskin_draw, IntType(300), null_, true });
		...
		global::_app->popup_importimage = new_popup({ /*"importimage"*/ STR(211), ID_popup_importimage_draw, IntType(512), null_, true });
		...
		global::_app->popup_importitemsheet = new_popup({ /*"importitemsheet"*/ STR(212), ID_popup_importitemsheet_draw, IntType(288), null_, true });
		...
		global::_app->popup_exportmovie = new_popup({ /*"exportmovie"*/ STR(213), ID_popup_exportmovie_draw, IntType(350), null_, true });
		...
		global::_app->popup_exportimage = new_popup({ /*"exportimage"*/ STR(214), ID_popup_exportimage_draw, IntType(350), null_, true });
		...
		withOne (obj_popup, global::_app->popup_upgrade, global::_app->id)
		{
			...
			self->page_ani_type = /*"right"*/ STR(204);
			self->open_advanced = false;
			self->custom_rendering = /*"default"*/ STR(102);
		}
		
		global::_app->popup_advanced = new_popup({ /*"advanced"*/ STR(215), ID_popup_advanced_draw, IntType(420), null_, true });
		global::_app->popup_modelbench = new_popup({ /*"modelbench"*/ STR(216), ID_popup_modelbench_draw, IntType(420), null_, true });
		...
		global::_app->popup_pattern_editor = new_popup({ /*"patterneditor"*/ STR(217), ID_popup_pattern_editor_draw, IntType(550), null_, true, false, false, false });
		...
		global::_app->popup_armor_editor = new_popup({ /*"armoreditor"*/ STR(218), ID_popup_armor_editor_draw, IntType(550), null_, true, false, false, true });
	...
	void app_startup_interface_tabs()
	{
		...
		{
			self->project = tab_add_category(self, /*"project"*/ STR(219), icons_CLAPPERBOARD_SMALL, ID_tab_properties_project, false);
			...
			withOne (obj_category, self->render, self->id)
			{
				...
				ObjType(obj_textbox, self->tbx_ssao_power)->suffix = /*"%"*/ STR(220);
				...
				ObjType(obj_textbox, self->tbx_subsurface_highlight)->suffix = /*"%"*/ STR(220);
				self->tbx_subsurface_highlight_strength = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_subsurface_highlight_strength)->suffix = /*"%"*/ STR(220);
				self->tbx_indirect_precision = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_indirect_precision)->suffix = /*"%"*/ STR(220);
				self->tbx_indirect_blur_radius = new_textbox_decimals();
				ObjType(obj_textbox, self->tbx_indirect_blur_radius)->suffix = /*"%"*/ STR(220);
				self->tbx_indirect_strength = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_indirect_strength)->suffix = /*"%"*/ STR(220);
				self->tbx_reflections_precision = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_reflections_precision)->suffix = /*"%"*/ STR(220);
				self->tbx_reflections_thickness = new_textbox_decimals();
				self->tbx_reflections_fade_amount = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_reflections_fade_amount)->suffix = /*"%"*/ STR(220);
				self->tbx_glow_radius = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_glow_radius)->suffix = /*"%"*/ STR(220);
				self->tbx_glow_intensity = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_glow_intensity)->suffix = /*"%"*/ STR(220);
				self->tbx_glow_falloff_radius = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_glow_falloff_radius)->suffix = /*"%"*/ STR(220);
				self->tbx_glow_falloff_intensity = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_glow_falloff_intensity)->suffix = /*"%"*/ STR(220);
				self->tbx_aa_power = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_aa_power)->suffix = /*"%"*/ STR(220);
				self->tbx_block_emissive = new_textbox_decimals();
				ObjType(obj_textbox, self->tbx_block_emissive)->suffix = /*"%"*/ STR(220);
				self->tbx_glint_speed = new_textbox_decimals();
				ObjType(obj_textbox, self->tbx_glint_speed)->suffix = /*"%"*/ STR(220);
				self->tbx_glint_strength = new_textbox_decimals();
				ObjType(obj_textbox, self->tbx_glint_strength)->suffix = /*"%"*/ STR(220);
			...
			self->library = tab_add_category(self, /*"library"*/ STR(221), icons_LIBRARY_SMALL, ID_tab_properties_library, false);
			withOne (obj_category, self->library, self->id)
			{
				...
				sortlist_column_add(self->list, /*"libname"*/ STR(222), IntType(0));
				sortlist_column_add(self->list, /*"libtype"*/ STR(223), 0.35);
				sortlist_column_add(self->list, /*"libinstances"*/ STR(224), 0.65);
			...
			self->background = tab_add_category(self, /*"background"*/ STR(225), icons_WORLD_SMALL, ID_tab_properties_background, false);
			withOne (obj_category, self->background, self->id)
			{
				self->tbx_background_rotation = new_textbox_decimals();
				ObjType(obj_textbox, self->tbx_background_rotation)->suffix = /*"°"*/ STR(226);
				self->tbx_sky_time = new_textbox(true, IntType(10), /*"-:0123456789"*/ STR(227));
				self->tbx_sky_rotation = new_textbox_ndecimals();
				ObjType(obj_textbox, self->tbx_sky_rotation)->suffix = /*"°"*/ STR(226);
				self->tbx_sky_sun_angle = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_sky_sun_angle)->suffix = /*"°"*/ STR(226);
				self->tbx_sky_sun_scale = new_textbox_decimals();
				ObjType(obj_textbox, self->tbx_sky_sun_scale)->suffix = /*"%"*/ STR(220);
				self->tbx_sky_moon_angle = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_sky_moon_angle)->suffix = /*"°"*/ STR(226);
				self->tbx_sky_moon_scale = new_textbox_decimals();
				ObjType(obj_textbox, self->tbx_sky_moon_scale)->suffix = /*"%"*/ STR(220);
				self->tbx_sunlight_strength = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_sunlight_strength)->suffix = /*"%"*/ STR(220);
				self->tbx_sunlight_angle = new_textbox_decimals();
				ObjType(obj_textbox, self->tbx_sunlight_angle)->suffix = /*"°"*/ STR(226);
				...
				ObjType(obj_textbox, self->tbx_sky_clouds_speed)->suffix = /*"%"*/ STR(220);
				self->tbx_sky_clouds_offset = new_textbox_ndecimals();
				self->tbx_ground_direction = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_ground_direction)->suffix = /*"°"*/ STR(226);
				...
				ObjType(obj_textbox, self->tbx_wind_speed)->suffix = /*"%"*/ STR(220);
				self->tbx_wind_strength = new_textbox_decimals();
				self->tbx_wind_direction = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_wind_direction)->suffix = /*"°"*/ STR(226);
				self->tbx_wind_directional_speed = new_textbox_decimals();
				ObjType(obj_textbox, self->tbx_wind_directional_speed)->suffix = /*"%"*/ STR(220);
				self->tbx_wind_directional_strength = new_textbox_decimals();
				self->tbx_texture_animation_speed = new_textbox_ndecimals();
			}
			
			self->resources = tab_add_category(self, /*"resources"*/ STR(228), icons_FILE_SMALL, ID_tab_properties_resources, false);
			withOne (obj_category, self->resources, self->id)
			{
				...
				sortlist_column_add(self->list, /*"resname"*/ STR(229), IntType(0));
				sortlist_column_add(self->list, /*"restype"*/ STR(230), 0.35);
				sortlist_column_add(self->list, /*"rescount"*/ STR(231), 0.65);
				...
				ObjType(obj_textbox, self->tbx_scenery_integrity)->suffix = /*"%"*/ STR(220);
			}
		...
		withOne (obj_tab, global::_app->template_editor, global::_app->id)
		{
			...
			sortlist_column_add(self->type_list, /*"particleeditortypename"*/ STR(232), IntType(0));
			sortlist_column_add(self->type_list, /*"particleeditortypekind"*/ STR(233), 0.4);
			sortlist_column_add(self->type_list, /*"particleeditortyperate"*/ STR(234), 0.75);
			...
			ObjType(obj_textbox, self->tbx_type_spawn_rate)->suffix = /*"%"*/ STR(220);
			...
			ObjType(obj_textbox, self->tbx_type_xangle)->suffix = /*"°"*/ STR(226);
			ObjType(obj_textbox, self->tbx_type_xangle_random)->suffix = /*"°"*/ STR(226);
			ObjType(obj_textbox, self->tbx_type_yangle)->suffix = /*"°"*/ STR(226);
			ObjType(obj_textbox, self->tbx_type_yangle_random)->suffix = /*"°"*/ STR(226);
			ObjType(obj_textbox, self->tbx_type_zangle)->suffix = /*"°"*/ STR(226);
			ObjType(obj_textbox, self->tbx_type_zangle_random)->suffix = /*"°"*/ STR(226);
			...
			ObjType(obj_textbox, self->tbx_type_xrot)->suffix = /*"°"*/ STR(226);
			self->tbx_type_xrot_random = new_textbox_ndecimals();
			ObjType(obj_textbox, self->tbx_type_xrot_random)->suffix = /*"°"*/ STR(226);
			self->tbx_type_yrot = new_textbox_ndecimals();
			ObjType(obj_textbox, self->tbx_type_yrot)->suffix = /*"°"*/ STR(226);
			self->tbx_type_yrot_random = new_textbox_ndecimals();
			ObjType(obj_textbox, self->tbx_type_yrot_random)->suffix = /*"°"*/ STR(226);
			self->tbx_type_zrot = new_textbox_ndecimals();
			ObjType(obj_textbox, self->tbx_type_zrot)->suffix = /*"°"*/ STR(226);
			self->tbx_type_zrot_random = new_textbox_ndecimals();
			ObjType(obj_textbox, self->tbx_type_zrot_random)->suffix = /*"°"*/ STR(226);
			...
			ObjType(obj_textbox, self->tbx_type_xrot_spd)->suffix = /*"°"*/ STR(226);
			ObjType(obj_textbox, self->tbx_type_xrot_spd_random)->suffix = /*"°"*/ STR(226);
			ObjType(obj_textbox, self->tbx_type_yrot_spd)->suffix = /*"°"*/ STR(226);
			ObjType(obj_textbox, self->tbx_type_yrot_spd_random)->suffix = /*"°"*/ STR(226);
			ObjType(obj_textbox, self->tbx_type_zrot_spd)->suffix = /*"°"*/ STR(226);
			ObjType(obj_textbox, self->tbx_type_zrot_spd_random)->suffix = /*"°"*/ STR(226);
			ObjType(obj_textbox, self->tbx_type_xrot_spd_add)->suffix = /*"°"*/ STR(226);
			ObjType(obj_textbox, self->tbx_type_xrot_spd_add_random)->suffix = /*"°"*/ STR(226);
			ObjType(obj_textbox, self->tbx_type_yrot_spd_add)->suffix = /*"°"*/ STR(226);
			ObjType(obj_textbox, self->tbx_type_yrot_spd_add_random)->suffix = /*"°"*/ STR(226);
			ObjType(obj_textbox, self->tbx_type_zrot_spd_add)->suffix = /*"°"*/ STR(226);
			ObjType(obj_textbox, self->tbx_type_zrot_spd_add_random)->suffix = /*"°"*/ STR(226);
			ObjType(obj_textbox, self->tbx_type_xrot_spd_mul)->suffix = /*"°"*/ STR(226);
			ObjType(obj_textbox, self->tbx_type_xrot_spd_mul_random)->suffix = /*"°"*/ STR(226);
			ObjType(obj_textbox, self->tbx_type_yrot_spd_mul)->suffix = /*"°"*/ STR(226);
			ObjType(obj_textbox, self->tbx_type_yrot_spd_mul_random)->suffix = /*"°"*/ STR(226);
			ObjType(obj_textbox, self->tbx_type_zrot_spd_mul)->suffix = /*"°"*/ STR(226);
			ObjType(obj_textbox, self->tbx_type_zrot_spd_mul_random)->suffix = /*"°"*/ STR(226);
			self->tbx_type_sprite_angle = new_textbox_ndecimals();
			ObjType(obj_textbox, self->tbx_type_sprite_angle)->suffix = /*"°"*/ STR(226);
			self->tbx_type_sprite_angle_random = new_textbox_ndecimals();
			ObjType(obj_textbox, self->tbx_type_sprite_angle_random)->suffix = /*"°"*/ STR(226);
			self->tbx_type_sprite_angle_add = new_textbox_ndecimals();
			ObjType(obj_textbox, self->tbx_type_sprite_angle_add)->suffix = /*"°"*/ STR(226);
			self->tbx_type_sprite_angle_add_random = new_textbox_ndecimals();
			ObjType(obj_textbox, self->tbx_type_sprite_angle_add_random)->suffix = /*"°"*/ STR(226);
			ObjType(obj_textbox, self->tbx_type_sprite_angle_add)->suffix = /*"°"*/ STR(226);
			ObjType(obj_textbox, self->tbx_type_sprite_angle_add_random)->suffix = /*"°"*/ STR(226);
			...
			ObjType(obj_textbox, self->tbx_type_alpha)->suffix = /*"%"*/ STR(220);
			self->tbx_type_alpha_random = new_textbox_integer();
			ObjType(obj_textbox, self->tbx_type_alpha_random)->suffix = /*"%"*/ STR(220);
			self->tbx_type_alpha_add = new_textbox_ninteger();
			ObjType(obj_textbox, self->tbx_type_alpha_add)->suffix = /*"%"*/ STR(220);
			self->tbx_type_alpha_add_random = new_textbox_ninteger();
			ObjType(obj_textbox, self->tbx_type_alpha_add_random)->suffix = /*"%"*/ STR(220);
		...
		global::_app->timeline = new_tab(/*"bottom"*/ STR(201), true, null_, e_window_TIMELINE);
		...
		{
			self->info = tab_add_category(self, /*"timelineeditorinfo"*/ STR(235), icons_LIST_BULLETED_SMALL, ID_tab_timeline_editor_info, true);
			...
			self->hierarchy = tab_add_category(self, /*"timelineeditorhierarchy"*/ STR(236), icons_HIERARCHY_SMALL, ID_tab_timeline_editor_hierarchy, true);
			self->appearance = tab_add_category(self, /*"timelineeditorappearance"*/ STR(237), ArrType::From({ icons_SPHERE_SHADING_SMALL, icons_SPHERE_SHADING_SMALL__DARK }), ID_tab_timeline_editor_appearance, false);
			withOne (obj_category, self->appearance, self->id)
			{
				self->tbx_glint_scale = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_glint_scale)->suffix = /*"%"*/ STR(220);
			...
			self->audio = tab_add_category(self, /*"timelineeditoraudio"*/ STR(238), icons_NOTE_SMALL, ID_tab_timeline_editor_audio, true);
			self->path = tab_add_category(self, /*"timelineeditorpath"*/ STR(239), icons_PATH_SMALL, ID_tab_timeline_editor_path, true);
		...
		{
			self->transform = tab_add_category(self, /*"frameeditortransform"*/ STR(240), icons_TRANSFORM_SMALL, ID_tab_frame_editor_transform, false);
			withOne (obj_category, self->transform, self->id)
			{
				...
				ObjType(obj_textbox, self->tbx_rot_x)->suffix = /*"°"*/ STR(226);
				self->tbx_rot_y = new_textbox_ndecimals();
				ObjType(obj_textbox, self->tbx_rot_y)->suffix = /*"°"*/ STR(226);
				self->tbx_rot_z = new_textbox_ndecimals();
				ObjType(obj_textbox, self->tbx_rot_z)->suffix = /*"°"*/ STR(226);
				...
				ObjType(obj_textbox, self->tbx_bend[IntType(0)])->suffix = /*"°"*/ STR(226);
				self->tbx_bend[IntType(1)] = new_textbox_ndecimals();
				ObjType(obj_textbox, self->tbx_bend[IntType(1)])->suffix = /*"°"*/ STR(226);
				self->tbx_bend[IntType(2)] = new_textbox_ndecimals();
				ObjType(obj_textbox, self->tbx_bend[IntType(2)])->suffix = /*"°"*/ STR(226);
				self->tbx_path_point_angle = new_textbox_ndecimals();
				ObjType(obj_textbox, self->tbx_path_point_angle)->suffix = /*"°"*/ STR(226);
				self->tbx_path_point_scale = new_textbox_decimals();
			}
			
			self->constraints_path = tab_add_category(self, /*"frameeditorconstraintspath"*/ STR(241), icons_JOINT_SMALL, ID_tab_frame_editor_constraints_path_point, false);
			self->constraints = tab_add_category(self, /*"frameeditorconstraints"*/ STR(242), icons_JOINT_SMALL, ID_tab_frame_editor_constraints, false);
			withOne (obj_category, self->constraints, self->id)
			{
				...
				ObjType(obj_textbox, self->tbx_ik_blend)->suffix = /*"%"*/ STR(220);
				self->tbx_ik_angle_offset = new_textbox_ndecimals();
				ObjType(obj_textbox, self->tbx_ik_angle_offset)->suffix = /*"°"*/ STR(226);
			}
			
			self->material = tab_add_category(self, /*"frameeditormaterial"*/ STR(243), ArrType::From({ icons_SPHERE_MATERIAL_SMALL, icons_SPHERE_MATERIAL_SMALL__DARK }), ID_tab_frame_editor_material, false);
			withOne (obj_category, self->material, self->id)
			{
				self->tbx_alpha = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_alpha)->suffix = /*"%"*/ STR(220);
				self->tbx_mix_percent = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_mix_percent)->suffix = /*"%"*/ STR(220);
				self->tbx_emissive = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_emissive)->suffix = /*"%"*/ STR(220);
				self->tbx_metallic = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_metallic)->suffix = /*"%"*/ STR(220);
				self->tbx_roughness = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_roughness)->suffix = /*"%"*/ STR(220);
				self->tbx_subsurface = new_textbox_decimals();
				self->tbx_subsurface_radius.Real(X_) = new_textbox_integer();
				idVar(self->tbx_subsurface_radius.Real(X_), suffix) = /*"%"*/ STR(220);
				self->tbx_subsurface_radius.Real(Y_) = new_textbox_integer();
				idVar(self->tbx_subsurface_radius.Real(Y_), suffix) = /*"%"*/ STR(220);
				self->tbx_subsurface_radius.Real(Z_) = new_textbox_integer();
				idVar(self->tbx_subsurface_radius.Real(Z_), suffix) = /*"%"*/ STR(220);
				self->tbx_wind_influence = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_wind_influence)->suffix = /*"%"*/ STR(220);
			}
			
			self->particles = tab_add_category(self, /*"frameeditorparticles"*/ STR(244), icons_PARTICLES_SMALL, ID_tab_frame_editor_particles, false);
			...
			self->light = tab_add_category(self, /*"frameeditorlight"*/ STR(245), icons_LIGHT_POINT_SMALL, ID_tab_frame_editor_light, false);
			withOne (obj_category, self->light, self->id)
			{
				...
				ObjType(obj_textbox, self->tbx_strength)->suffix = /*"%"*/ STR(220);
				self->tbx_specular_strength = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_specular_strength)->suffix = /*"%"*/ STR(220);
				self->tbx_fade_size = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_fade_size)->suffix = /*"%"*/ STR(220);
				self->tbx_spot_radius = new_textbox_decimals();
				self->tbx_spot_sharpness = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_spot_sharpness)->suffix = /*"%"*/ STR(220);
			}
			
			self->camera = tab_add_category(self, /*"frameeditorcamera"*/ STR(246), icons_CAMERA_SMALL, ID_tab_frame_editor_camera, false);
			withOne (Object, self->camera, self->id)
			{
				sVar(video_template) = null_;
				sBool(look_at_rotate) = true;
				sInt(tbx_aspect) = new_textbox_decimals();
				sInt(tbx_fov) = new_textbox_decimals();
				ObjType(obj_textbox, sInt(tbx_fov))->suffix = /*"°"*/ STR(226);
				...
				ObjType(obj_textbox, sInt(tbx_blade_angle))->suffix = /*"°"*/ STR(226);
				sInt(tbx_rotate_distance) = new_textbox_decimals();
				sInt(tbx_rotate_angle_xy) = new_textbox_ndecimals();
				ObjType(obj_textbox, sInt(tbx_rotate_angle_xy))->suffix = /*"°"*/ STR(226);
				sInt(tbx_rotate_angle_z) = new_textbox_ndecimals();
				ObjType(obj_textbox, sInt(tbx_rotate_angle_z))->suffix = /*"°"*/ STR(226);
				sInt(tbx_shake_strength_x) = new_textbox_decimals();
				ObjType(obj_textbox, sInt(tbx_shake_strength_x))->suffix = /*"%"*/ STR(220);
				sInt(tbx_shake_strength_y) = new_textbox_decimals();
				ObjType(obj_textbox, sInt(tbx_shake_strength_y))->suffix = /*"%"*/ STR(220);
				sInt(tbx_shake_strength_z) = new_textbox_decimals();
				ObjType(obj_textbox, sInt(tbx_shake_strength_z))->suffix = /*"%"*/ STR(220);
				sInt(tbx_shake_speed_x) = new_textbox_decimals();
				ObjType(obj_textbox, sInt(tbx_shake_speed_x))->suffix = /*"%"*/ STR(220);
				sInt(tbx_shake_speed_y) = new_textbox_decimals();
				ObjType(obj_textbox, sInt(tbx_shake_speed_y))->suffix = /*"%"*/ STR(220);
				sInt(tbx_shake_speed_z) = new_textbox_decimals();
				ObjType(obj_textbox, sInt(tbx_shake_speed_z))->suffix = /*"%"*/ STR(220);
				...
				ObjType(obj_textbox, sInt(tbx_dof_blur_size))->suffix = /*"%"*/ STR(220);
				sInt(tbx_dof_blur_ratio) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_dof_blur_ratio))->suffix = /*"%"*/ STR(220);
				sInt(tbx_dof_bias) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_dof_bias))->suffix = /*"%"*/ STR(220);
				sInt(tbx_dof_threshold) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_dof_threshold))->suffix = /*"%"*/ STR(220);
				sInt(tbx_dof_gain) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_dof_gain))->suffix = /*"%"*/ STR(220);
				sInt(tbx_dof_fringe_angle_red) = new_textbox_ndecimals();
				ObjType(obj_textbox, sInt(tbx_dof_fringe_angle_red))->suffix = /*"°"*/ STR(226);
				sInt(tbx_dof_fringe_angle_green) = new_textbox_ndecimals();
				ObjType(obj_textbox, sInt(tbx_dof_fringe_angle_green))->suffix = /*"°"*/ STR(226);
				sInt(tbx_dof_fringe_angle_blue) = new_textbox_ndecimals();
				ObjType(obj_textbox, sInt(tbx_dof_fringe_angle_blue))->suffix = /*"°"*/ STR(226);
				sInt(tbx_dof_fringe_red) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_dof_fringe_red))->suffix = /*"%"*/ STR(220);
				sInt(tbx_dof_fringe_green) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_dof_fringe_green))->suffix = /*"%"*/ STR(220);
				sInt(tbx_dof_fringe_blue) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_dof_fringe_blue))->suffix = /*"%"*/ STR(220);
				...
				ObjType(obj_textbox, sInt(tbx_bloom_threshold))->suffix = /*"%"*/ STR(220);
				sInt(tbx_bloom_intensity) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_bloom_intensity))->suffix = /*"%"*/ STR(220);
				sInt(tbx_bloom_radius) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_bloom_radius))->suffix = /*"%"*/ STR(220);
				sInt(tbx_bloom_ratio) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_bloom_ratio))->suffix = /*"%"*/ STR(220);
				sInt(tbx_lens_dirt_radius) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_lens_dirt_radius))->suffix = /*"%"*/ STR(220);
				sInt(tbx_lens_dirt_intensity) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_lens_dirt_intensity))->suffix = /*"%"*/ STR(220);
				sInt(tbx_lens_dirt_power) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_lens_dirt_power))->suffix = /*"%"*/ STR(220);
				sInt(tbx_contrast) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_contrast))->suffix = /*"%"*/ STR(220);
				sInt(tbx_brightness) = new_textbox_ninteger();
				ObjType(obj_textbox, sInt(tbx_brightness))->suffix = /*"%"*/ STR(220);
				sInt(tbx_saturation) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_saturation))->suffix = /*"%"*/ STR(220);
				sInt(tbx_vibrance) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_vibrance))->suffix = /*"%"*/ STR(220);
				sInt(tbx_grain_strength) = new_textbox_ninteger();
				ObjType(obj_textbox, sInt(tbx_grain_strength))->suffix = /*"%"*/ STR(220);
				sInt(tbx_grain_saturation) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_grain_saturation))->suffix = /*"%"*/ STR(220);
				sInt(tbx_grain_size) = new_textbox_integer();
				sInt(tbx_vignette_radius) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_vignette_radius))->suffix = /*"%"*/ STR(220);
				sInt(tbx_vignette_softness) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_vignette_softness))->suffix = /*"%"*/ STR(220);
				sInt(tbx_vignette_strength) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_vignette_strength))->suffix = /*"%"*/ STR(220);
				sInt(tbx_ca_blur_amount) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_ca_blur_amount))->suffix = /*"%"*/ STR(220);
				sInt(tbx_ca_red_offset) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_ca_red_offset))->suffix = /*"%"*/ STR(220);
				sInt(tbx_ca_green_offset) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_ca_green_offset))->suffix = /*"%"*/ STR(220);
				sInt(tbx_ca_blue_offset) = new_textbox_integer();
				ObjType(obj_textbox, sInt(tbx_ca_blue_offset))->suffix = /*"%"*/ STR(220);
				sInt(tbx_distort_zoom_amount) = new_textbox_decimals();
				ObjType(obj_textbox, sInt(tbx_distort_zoom_amount))->suffix = /*"%"*/ STR(220);
				sInt(tbx_distort_amount) = new_textbox_ninteger();
				ObjType(obj_textbox, sInt(tbx_distort_amount))->suffix = /*"%"*/ STR(220);
			}
			
			self->sound = tab_add_category(self, /*"frameeditorsound"*/ STR(247), icons_VOLUME_SMALL, ID_tab_frame_editor_sound, true);
			withOne (obj_category, self->sound, self->id)
			{
				self->tbx_volume = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_volume)->suffix = /*"%"*/ STR(220);
				self->tbx_pitch = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_pitch)->suffix = /*"%"*/ STR(220);
				self->tbx_start = new_textbox_decimals();
				self->tbx_end = new_textbox_ndecimals();
			}
			
			self->text = tab_add_category(self, /*"frameeditortext"*/ STR(248), icons_TEXT_SMALL, ID_tab_frame_editor_text, false);
			withOne (Object, self->text, self->id)
				sInt(tbx_text) = new_textbox(false, IntType(0), /*""*/ STR(0));
			
			self->item = tab_add_category(self, /*"frameeditoritem"*/ STR(249), icons_ITEM_SMALL, ID_tab_frame_editor_item, false);
			...
			self->keyframe = tab_add_category(self, /*"frameeditorkeyframe"*/ STR(250), icons_KEYFRAME_SMALL, ID_tab_frame_editor_keyframe, false);
			withOne (obj_category, self->keyframe, self->id)
			{
				self->tbx_ease_in_x = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_ease_in_x)->suffix = /*"%"*/ STR(220);
				self->tbx_ease_in_y = new_textbox_ninteger();
				ObjType(obj_textbox, self->tbx_ease_in_y)->suffix = /*"%"*/ STR(220);
				self->tbx_ease_out_x = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_ease_out_x)->suffix = /*"%"*/ STR(220);
				self->tbx_ease_out_y = new_textbox_ninteger();
				ObjType(obj_textbox, self->tbx_ease_out_y)->suffix = /*"%"*/ STR(220);
		...
		{
			self->program = tab_add_category(self, /*"settingsprogram"*/ STR(251), icons_SETTINGS_SMALL, ID_tab_settings_program, false);
			withOne (obj_category, self->program, self->id)
			{
				...
				ObjType(obj_textbox, self->tbx_watermark_padding)->suffix = /*"%"*/ STR(220);
				self->tbx_watermark_scale = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_watermark_scale)->suffix = /*"%"*/ STR(220);
				self->tbx_watermark_opacity = new_textbox_integer();
				ObjType(obj_textbox, self->tbx_watermark_opacity)->suffix = /*"%"*/ STR(220);
			}
			
			self->interface_ = tab_add_category(self, /*"settingsinterface"*/ STR(252), icons_BRUSH_SMALL, ID_tab_settings_interface, false);
			self->controls = tab_add_category(self, /*"settingscontrols"*/ STR(253), icons_KEYBOARD_SMALL, ID_tab_settings_controls, false);
