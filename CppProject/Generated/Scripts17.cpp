...
namespace CppProject
{
	...
	void app_startup_lists(ScopeAny self)
	{
		...
		ds_list_add({ global::temp_type_name_list, /*"char"*/ STR(525), /*"spblock"*/ STR(526), /*"scenery"*/ STR(527), /*"item"*/ STR(528), /*"block"*/ STR(529), /*"bodypart"*/ STR(530), /*"particles"*/ STR(531), /*"text"*/ STR(99), /*"cube"*/ STR(3), /*"cone"*/ STR(532), /*"cylinder"*/ STR(533), /*"sphere"*/ STR(534), /*"surface"*/ STR(535), /*"model"*/ STR(536) });
		global::tl_type_name_list = ds_list_create();
		ds_list_add({ global::tl_type_name_list, /*"char"*/ STR(525), /*"spblock"*/ STR(526), /*"scenery"*/ STR(527), /*"item"*/ STR(528), /*"block"*/ STR(529), /*"bodypart"*/ STR(530), /*"particles"*/ STR(531), /*"text"*/ STR(99), /*"cube"*/ STR(3), /*"cone"*/ STR(532), /*"cylinder"*/ STR(533), /*"sphere"*/ STR(534), /*"surface"*/ STR(535), /*"model"*/ STR(536), /*"camera"*/ STR(120), /*"spotlight"*/ STR(537), /*"pointlight"*/ STR(538), /*"folder"*/ STR(539), /*"background"*/ STR(212), /*"audio"*/ STR(540), /*"path"*/ STR(541), /*"pathpoint"*/ STR(542), /*"shape"*/ STR(543), /*"lightsource"*/ STR(544) });
		global::res_type_name_list = ds_list_create();
		ds_list_add({ global::res_type_name_list, /*"pack"*/ STR(545), /*"packunzipped"*/ STR(546), /*"skin"*/ STR(547), /*"downloadskin"*/ STR(198), /*"itemsheet"*/ STR(548), /*"legacyblocksheet"*/ STR(549), /*"blocksheet"*/ STR(550), /*"scenery"*/ STR(527), /*"fromworld"*/ STR(551), /*"particlesheet"*/ STR(552), /*"texture"*/ STR(553), /*"font"*/ STR(554), /*"sound"*/ STR(555), /*"model"*/ STR(536) });
		global::transition_list = ds_list_create();
		ds_list_add({ global::transition_list, /*"linear"*/ STR(556), /*"instant"*/ STR(557), /*"bezier"*/ STR(558), /*"easeinquad"*/ STR(559), /*"easeoutquad"*/ STR(560), /*"easeinoutquad"*/ STR(561), /*"easeincubic"*/ STR(562), /*"easeoutcubic"*/ STR(563), /*"easeinoutcubic"*/ STR(564), /*"easeinquart"*/ STR(565), /*"easeoutquart"*/ STR(566), /*"easeinoutquart"*/ STR(567), /*"easeinquint"*/ STR(568), /*"easeoutquint"*/ STR(569), /*"easeinoutquint"*/ STR(570), /*"easeinsine"*/ STR(571), /*"easeoutsine"*/ STR(572), /*"easeinoutsine"*/ STR(573), /*"easeinexpo"*/ STR(574), /*"easeoutexpo"*/ STR(575), /*"easeinoutexpo"*/ STR(576), /*"easeincirc"*/ STR(577), /*"easeoutcirc"*/ STR(578), /*"easeinoutcirc"*/ STR(579), /*"easeinelastic"*/ STR(580), /*"easeoutelastic"*/ STR(581), /*"easeinoutelastic"*/ STR(582), /*"easeinback"*/ STR(583), /*"easeoutback"*/ STR(584), /*"easeinoutback"*/ STR(585), /*"easeinbounce"*/ STR(586), /*"easeoutbounce"*/ STR(587), /*"easeinoutbounce"*/ STR(588) });
		...
		ds_list_add({ global::minecraft_color_name_list, /*"white"*/ STR(606), /*"orange"*/ STR(607), /*"magenta"*/ STR(608), /*"light_blue"*/ STR(609), /*"yellow"*/ STR(610), /*"lime"*/ STR(611), /*"pink"*/ STR(612), /*"gray"*/ STR(613), /*"light_gray"*/ STR(614), /*"cyan"*/ STR(615), /*"purple"*/ STR(616), /*"blue"*/ STR(617), /*"brown"*/ STR(618), /*"green"*/ STR(619), /*"red"*/ STR(620), /*"black"*/ STR(621) });
		...
		ds_list_add({ global::blend_mode_list, /*"normal"*/ STR(622), /*"add"*/ STR(623), /*"subtract"*/ STR(624), /*"multiply"*/ STR(625), /*"screen"*/ STR(626) });
		global::blend_mode_map = ds_map_create();
		ds_map_add(global::blend_mode_map, /*"normal"*/ STR(622), bm_normal);
		ds_map_add(global::blend_mode_map, /*"add"*/ STR(623), bm_add);
		ds_map_add(global::blend_mode_map, /*"subtract"*/ STR(624), bm_subtract);
		ds_map_add(global::blend_mode_map, /*"multiply"*/ STR(625), ArrType::From({ bm_zero, bm_src_color }));
		ds_map_add(global::blend_mode_map, /*"screen"*/ STR(626), ArrType::From({ bm_one, bm_inv_src_color }));
		...
		ds_list_add({ global::render_pass_list, /*"combined"*/ STR(627), /*"diffuse"*/ STR(628), /*"specular"*/ STR(629), /*"ao"*/ STR(630), /*"shadows"*/ STR(123), /*"indirect"*/ STR(125), /*"indirectshadows"*/ STR(631), /*"reflections"*/ STR(126), /*"depth"*/ STR(632), /*"normal"*/ STR(622), /*"material"*/ STR(633) });
	}
	...
	{
		sStr(recent_display_mode) = /*"grid"*/ STR(634);
	...
	void app_startup_themes(ScopeAny self)
	{
		...
		{
			self->name = /*"light"*/ STR(635);
			self->dark = false;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DB3030"*/ STR(636)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D85B00"*/ STR(637)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D68E02"*/ STR(638)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"34A100"*/ STR(639)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"0D8E41"*/ STR(640)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"048E8E"*/ STR(641)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"2144F1"*/ STR(642)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"982BCB"*/ STR(643)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"E93983"*/ STR(644)));
			self->level_top = hex_to_color(/*"F7FAFC"*/ STR(645));
			self->level_middle = hex_to_color(/*"ECEFF1"*/ STR(646));
			self->level_bottom = hex_to_color(/*"D7DFE2"*/ STR(647));
			self->viewport_top = hex_to_color(/*"F0FFFF"*/ STR(648));
			self->viewport_bottom = hex_to_color(/*"B5E8F2"*/ STR(649));
			self->text_main = hex_to_color(/*"0D1214"*/ STR(650));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"FFFFFF"*/ STR(651));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .15;
			self->red_error = hex_to_color(/*"FF1D0F"*/ STR(652));
			self->yellow_warning = hex_to_color(/*"FFC01E"*/ STR(653));
			self->green_success = hex_to_color(/*"61C159"*/ STR(654));
			self->red = hex_to_color(/*"FF5656"*/ STR(655));
			self->green = hex_to_color(/*"4AB758"*/ STR(656));
			self->blue = hex_to_color(/*"1370FB"*/ STR(657));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(658));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(659));
			self->yellow = hex_to_color(/*"F4CC5D"*/ STR(660));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(661));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"158AF5"*/ STR(662));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64A56B"*/ STR(663));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"D09522"*/ STR(664));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF1D0F"*/ STR(652));
		}
		
		global::theme_dark = (new obj_theme)->id;
		withOne (obj_theme, global::theme_dark, self->id)
		{
			self->name = /*"dark"*/ STR(665);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(666)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFA360"*/ STR(667)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFF065"*/ STR(668)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"8BFF6D"*/ STR(669)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"4EF390"*/ STR(670)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"49EED9"*/ STR(671)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"98BBFF"*/ STR(672)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(673)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(674)));
			self->level_top = hex_to_color(/*"37444A"*/ STR(675));
			self->level_middle = hex_to_color(/*"2B373D"*/ STR(676));
			self->level_bottom = hex_to_color(/*"18242A"*/ STR(677));
			self->viewport_top = hex_to_color(/*"2B373D"*/ STR(676));
			self->viewport_bottom = hex_to_color(/*"839096"*/ STR(678));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(651));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"000000"*/ STR(679));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .25;
			self->red_error = hex_to_color(/*"FF7A72"*/ STR(680));
			self->yellow_warning = hex_to_color(/*"FFEB36"*/ STR(681));
			self->green_success = hex_to_color(/*"64E879"*/ STR(682));
			self->red = hex_to_color(/*"FF5656"*/ STR(655));
			self->green = hex_to_color(/*"23FF88"*/ STR(683));
			self->blue = hex_to_color(/*"1370FB"*/ STR(657));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(658));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(659));
			self->yellow = hex_to_color(/*"FFD969"*/ STR(684));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(661));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"7EC1FF"*/ STR(685));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64E879"*/ STR(682));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"FFEB36"*/ STR(681));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF7A72"*/ STR(680));
		}
		
		global::theme_darker = (new obj_theme)->id;
		withOne (obj_theme, global::theme_darker, self->id)
		{
			self->name = /*"darker"*/ STR(686);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(666)));
			...
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(673)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(674)));
			self->level_top = hex_to_color(/*"1C1C1C"*/ STR(687));
			self->level_middle = hex_to_color(/*"101010"*/ STR(688));
			self->level_bottom = hex_to_color(/*"050505"*/ STR(689));
			self->viewport_top = hex_to_color(/*"484848"*/ STR(690));
			self->viewport_bottom = hex_to_color(/*"2B2B2B"*/ STR(691));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(651));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
	...
	void app_update_animate(ScopeAny self)
	{
		...
		sInt(background_sky_color_final) = merge_color((IntType)(sVar(background_sky_color)), hex_to_color(/*"020204"*/ STR(693)), background_sky_night_alpha());
	...
	void app_update_caption()
	{
		if (global::_app->project_name != /*""*/ STR(0))
			window_set_caption(global::_app->project_name + string_repeat(/*" * "*/ STR(694), global::_app->project_changed) + /*" - Mine-imator"*/ STR(695));
		else
			window_set_caption(/*"Mine-imator"*/ STR(19));
	...
	void app_update_keybinds()
	{
		...
		for (IntType i = IntType(0); i < e_keybind_amount; i++)
		{
			...
			check = keybind_check(obj, /*"keyboard_check"*/ STR(696));
			idBool(obj, released) = false;
			if (idVar(obj, active) > 0)
				idBool(obj, released) = keybind_check(obj, /*"keyboard_check_released"*/ STR(697));
			idBool(obj, pressed) = keybind_check(obj, /*"keyboard_check_pressed"*/ STR(698));
	...
	void app_update_keyboard(ScopeAny self)
	{
		...
		if (sStr(window_state) == /*""*/ STR(0) && (sVar(window_busy) == /*""*/ STR(0) || sStr(settings_menu_name) == /*"colorpicker"*/ STR(699)) && !sBool(textbox_isediting))
		{
