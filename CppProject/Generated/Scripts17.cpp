...
namespace CppProject
{
	...
	void app_startup_lists(ScopeAny self)
	{
		...
		ds_list_add({ global::temp_type_name_list, /*"char"*/ STR(518), /*"spblock"*/ STR(519), /*"scenery"*/ STR(520), /*"item"*/ STR(521), /*"block"*/ STR(522), /*"bodypart"*/ STR(523), /*"particles"*/ STR(524), /*"text"*/ STR(99), /*"cube"*/ STR(3), /*"cone"*/ STR(525), /*"cylinder"*/ STR(526), /*"sphere"*/ STR(527), /*"surface"*/ STR(528), /*"model"*/ STR(529) });
		global::tl_type_name_list = ds_list_create();
		ds_list_add({ global::tl_type_name_list, /*"char"*/ STR(518), /*"spblock"*/ STR(519), /*"scenery"*/ STR(520), /*"item"*/ STR(521), /*"block"*/ STR(522), /*"bodypart"*/ STR(523), /*"particles"*/ STR(524), /*"text"*/ STR(99), /*"cube"*/ STR(3), /*"cone"*/ STR(525), /*"cylinder"*/ STR(526), /*"sphere"*/ STR(527), /*"surface"*/ STR(528), /*"model"*/ STR(529), /*"camera"*/ STR(120), /*"spotlight"*/ STR(530), /*"pointlight"*/ STR(531), /*"folder"*/ STR(532), /*"background"*/ STR(212), /*"audio"*/ STR(533), /*"path"*/ STR(534), /*"pathpoint"*/ STR(535), /*"shape"*/ STR(536), /*"lightsource"*/ STR(537) });
		global::res_type_name_list = ds_list_create();
		ds_list_add({ global::res_type_name_list, /*"pack"*/ STR(538), /*"packunzipped"*/ STR(539), /*"skin"*/ STR(540), /*"downloadskin"*/ STR(198), /*"itemsheet"*/ STR(541), /*"legacyblocksheet"*/ STR(542), /*"blocksheet"*/ STR(543), /*"scenery"*/ STR(520), /*"fromworld"*/ STR(544), /*"particlesheet"*/ STR(545), /*"texture"*/ STR(546), /*"font"*/ STR(547), /*"sound"*/ STR(548), /*"model"*/ STR(529) });
		...
		log({ /*"Transitions OK"*/ STR(583) });
		global::videotemplate_list = ds_list_create();
		ds_list_add({ global::videotemplate_list, new_videotemplate(/*"avatar"*/ STR(584), IntType(512), IntType(512)), new_videotemplate(/*"hd_720p"*/ STR(585), IntType(1280), IntType(720)), new_videotemplate(/*"fhd_1080p"*/ STR(586), IntType(1920), IntType(1080)), new_videotemplate(/*"qhd_1440p"*/ STR(587), IntType(2560), IntType(1440)), new_videotemplate(/*"uhd_4k"*/ STR(588), IntType(3840), IntType(2160)), new_videotemplate(/*"hd_720p_cinematic"*/ STR(589), IntType(1680), IntType(720)), new_videotemplate(/*"fhd_1080p_cinematic"*/ STR(590), IntType(2560), IntType(1080)), new_videotemplate(/*"qhd_1440p_cinematic"*/ STR(591), IntType(3440), IntType(1440)), new_videotemplate(/*"uhd_4k_cinematic"*/ STR(592), IntType(5120), IntType(2160)) });
		global::videoquality_list = ds_list_create();
		ds_list_add({ global::videoquality_list, new_videoquality(/*"best"*/ STR(593), IntType(5000000)), new_videoquality(/*"high"*/ STR(594), IntType(2500000)), new_videoquality(/*"medium"*/ STR(595), IntType(1200000)), new_videoquality(/*"low"*/ STR(596), IntType(700000)), new_videoquality(/*"verylow"*/ STR(597), IntType(350000)) });
		...
		ds_list_add({ global::biome_list, new_biome(/*"custom"*/ STR(598), IntType(0), IntType(0), true, c_plains_biome_grass, c_plains_biome_foliage, c_plains_biome_water, null_) });
		...
		ds_list_add({ global::minecraft_color_name_list, /*"white"*/ STR(599), /*"orange"*/ STR(600), /*"magenta"*/ STR(601), /*"light_blue"*/ STR(602), /*"yellow"*/ STR(603), /*"lime"*/ STR(604), /*"pink"*/ STR(605), /*"gray"*/ STR(606), /*"light_gray"*/ STR(607), /*"cyan"*/ STR(608), /*"purple"*/ STR(609), /*"blue"*/ STR(610), /*"brown"*/ STR(611), /*"green"*/ STR(612), /*"red"*/ STR(613), /*"black"*/ STR(614) });
		...
		ds_list_add({ global::blend_mode_list, /*"normal"*/ STR(615), /*"add"*/ STR(616), /*"subtract"*/ STR(617), /*"multiply"*/ STR(618), /*"screen"*/ STR(619) });
		global::blend_mode_map = ds_map_create();
		ds_map_add(global::blend_mode_map, /*"normal"*/ STR(615), bm_normal);
		ds_map_add(global::blend_mode_map, /*"add"*/ STR(616), bm_add);
		ds_map_add(global::blend_mode_map, /*"subtract"*/ STR(617), bm_subtract);
		ds_map_add(global::blend_mode_map, /*"multiply"*/ STR(618), ArrType::From({ bm_zero, bm_src_color }));
		ds_map_add(global::blend_mode_map, /*"screen"*/ STR(619), ArrType::From({ bm_one, bm_inv_src_color }));
		...
		ds_list_add({ global::render_pass_list, /*"combined"*/ STR(620), /*"diffuse"*/ STR(621), /*"specular"*/ STR(622), /*"ao"*/ STR(623), /*"shadows"*/ STR(123), /*"indirect"*/ STR(125), /*"indirectshadows"*/ STR(624), /*"reflections"*/ STR(126), /*"depth"*/ STR(625), /*"normal"*/ STR(615), /*"material"*/ STR(626) });
	}
	...
	void app_startup_themes(ScopeAny self)
	{
		...
		{
			self->name = /*"light"*/ STR(628);
			self->dark = false;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DB3030"*/ STR(629)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D85B00"*/ STR(630)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D68E02"*/ STR(631)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"34A100"*/ STR(632)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"0D8E41"*/ STR(633)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"048E8E"*/ STR(634)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"2144F1"*/ STR(635)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"982BCB"*/ STR(636)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"E93983"*/ STR(637)));
			self->level_top = hex_to_color(/*"F7FAFC"*/ STR(638));
			self->level_middle = hex_to_color(/*"ECEFF1"*/ STR(639));
			self->level_bottom = hex_to_color(/*"D7DFE2"*/ STR(640));
			self->viewport_top = hex_to_color(/*"F0FFFF"*/ STR(641));
			self->viewport_bottom = hex_to_color(/*"B5E8F2"*/ STR(642));
			self->text_main = hex_to_color(/*"0D1214"*/ STR(643));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"FFFFFF"*/ STR(644));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .15;
			self->red_error = hex_to_color(/*"FF1D0F"*/ STR(645));
			self->yellow_warning = hex_to_color(/*"FFC01E"*/ STR(646));
			self->green_success = hex_to_color(/*"61C159"*/ STR(647));
			self->red = hex_to_color(/*"FF5656"*/ STR(648));
			self->green = hex_to_color(/*"4AB758"*/ STR(649));
			self->blue = hex_to_color(/*"1370FB"*/ STR(650));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(651));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(652));
			self->yellow = hex_to_color(/*"F4CC5D"*/ STR(653));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(654));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"158AF5"*/ STR(655));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64A56B"*/ STR(656));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"D09522"*/ STR(657));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF1D0F"*/ STR(645));
		}
		
		global::theme_dark = (new obj_theme)->id;
		withOne (obj_theme, global::theme_dark, self->id)
		{
			self->name = /*"dark"*/ STR(658);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(659)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFA360"*/ STR(660)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFF065"*/ STR(661)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"8BFF6D"*/ STR(662)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"4EF390"*/ STR(663)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"49EED9"*/ STR(664)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"98BBFF"*/ STR(665)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(666)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(667)));
			self->level_top = hex_to_color(/*"37444A"*/ STR(668));
			self->level_middle = hex_to_color(/*"2B373D"*/ STR(669));
			self->level_bottom = hex_to_color(/*"18242A"*/ STR(670));
			self->viewport_top = hex_to_color(/*"2B373D"*/ STR(669));
			self->viewport_bottom = hex_to_color(/*"839096"*/ STR(671));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(644));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"000000"*/ STR(672));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .25;
			self->red_error = hex_to_color(/*"FF7A72"*/ STR(673));
			self->yellow_warning = hex_to_color(/*"FFEB36"*/ STR(674));
			self->green_success = hex_to_color(/*"64E879"*/ STR(675));
			self->red = hex_to_color(/*"FF5656"*/ STR(648));
			self->green = hex_to_color(/*"23FF88"*/ STR(676));
			self->blue = hex_to_color(/*"1370FB"*/ STR(650));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(651));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(652));
			self->yellow = hex_to_color(/*"FFD969"*/ STR(677));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(654));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"7EC1FF"*/ STR(678));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64E879"*/ STR(675));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"FFEB36"*/ STR(674));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF7A72"*/ STR(673));
		}
		
		global::theme_darker = (new obj_theme)->id;
		withOne (obj_theme, global::theme_darker, self->id)
		{
			self->name = /*"darker"*/ STR(679);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(659)));
			...
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(666)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(667)));
			self->level_top = hex_to_color(/*"1C1C1C"*/ STR(680));
			self->level_middle = hex_to_color(/*"101010"*/ STR(681));
			self->level_bottom = hex_to_color(/*"050505"*/ STR(682));
			self->viewport_top = hex_to_color(/*"484848"*/ STR(683));
			self->viewport_bottom = hex_to_color(/*"2B2B2B"*/ STR(684));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(644));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
	...
	void app_update_animate(ScopeAny self)
	{
		...
		if (bgobject > 0)
		{
			...
			if (sVar(background_biome) == /*"custom"*/ STR(598) || sVar(background_biome_prev) != sVar(background_biome))
			{
		...
		sInt(background_sky_color_final) = merge_color((IntType)(sVar(background_sky_color)), hex_to_color(/*"020204"*/ STR(686)), background_sky_night_alpha());
	...
	void app_update_caption()
	{
		if (global::_app->project_name != /*""*/ STR(0))
			window_set_caption(global::_app->project_name + string_repeat(/*" * "*/ STR(687), global::_app->project_changed) + /*" - Mine-imator"*/ STR(688));
		else
			window_set_caption(/*"Mine-imator"*/ STR(19));
	...
	void app_update_keybinds()
	{
		...
		for (IntType i = IntType(0); i < e_keybind_amount; i++)
		{
			...
			check = keybind_check(obj, /*"keyboard_check"*/ STR(689));
			idBool(obj, released) = false;
			if (idVar(obj, active) > 0)
				idBool(obj, released) = keybind_check(obj, /*"keyboard_check_released"*/ STR(690));
			idBool(obj, pressed) = keybind_check(obj, /*"keyboard_check_pressed"*/ STR(691));
	...
	void app_update_keyboard(ScopeAny self)
	{
		...
		if (sStr(window_state) == /*""*/ STR(0) && (sVar(window_busy) == /*""*/ STR(0) || sStr(settings_menu_name) == /*"colorpicker"*/ STR(692)) && !sBool(textbox_isediting))
		{
