...
namespace CppProject
{
	...
	void app_startup_lists(ScopeAny self)
	{
		...
		ds_list_add({ global::temp_type_name_list, /*"char"*/ STR(527), /*"spblock"*/ STR(528), /*"scenery"*/ STR(529), /*"item"*/ STR(530), /*"block"*/ STR(531), /*"bodypart"*/ STR(532), /*"particles"*/ STR(533), /*"text"*/ STR(99), /*"cube"*/ STR(3), /*"cone"*/ STR(534), /*"cylinder"*/ STR(535), /*"sphere"*/ STR(536), /*"surface"*/ STR(537), /*"model"*/ STR(538) });
		global::tl_type_name_list = ds_list_create();
		ds_list_add({ global::tl_type_name_list, /*"char"*/ STR(527), /*"spblock"*/ STR(528), /*"scenery"*/ STR(529), /*"item"*/ STR(530), /*"block"*/ STR(531), /*"bodypart"*/ STR(532), /*"particles"*/ STR(533), /*"text"*/ STR(99), /*"cube"*/ STR(3), /*"cone"*/ STR(534), /*"cylinder"*/ STR(535), /*"sphere"*/ STR(536), /*"surface"*/ STR(537), /*"model"*/ STR(538), /*"camera"*/ STR(120), /*"spotlight"*/ STR(539), /*"pointlight"*/ STR(540), /*"folder"*/ STR(541), /*"background"*/ STR(213), /*"audio"*/ STR(542), /*"path"*/ STR(543), /*"pathpoint"*/ STR(544), /*"shape"*/ STR(545), /*"lightsource"*/ STR(546) });
		global::res_type_name_list = ds_list_create();
		ds_list_add({ global::res_type_name_list, /*"pack"*/ STR(547), /*"packunzipped"*/ STR(548), /*"skin"*/ STR(549), /*"downloadskin"*/ STR(199), /*"itemsheet"*/ STR(550), /*"legacyblocksheet"*/ STR(551), /*"blocksheet"*/ STR(552), /*"scenery"*/ STR(529), /*"fromworld"*/ STR(553), /*"particlesheet"*/ STR(554), /*"texture"*/ STR(555), /*"font"*/ STR(556), /*"sound"*/ STR(557), /*"model"*/ STR(538) });
		global::transition_list = ds_list_create();
		ds_list_add({ global::transition_list, /*"linear"*/ STR(558), /*"instant"*/ STR(559), /*"bezier"*/ STR(560), /*"easeinquad"*/ STR(561), /*"easeoutquad"*/ STR(562), /*"easeinoutquad"*/ STR(563), /*"easeincubic"*/ STR(564), /*"easeoutcubic"*/ STR(565), /*"easeinoutcubic"*/ STR(566), /*"easeinquart"*/ STR(567), /*"easeoutquart"*/ STR(568), /*"easeinoutquart"*/ STR(569), /*"easeinquint"*/ STR(570), /*"easeoutquint"*/ STR(571), /*"easeinoutquint"*/ STR(572), /*"easeinsine"*/ STR(573), /*"easeoutsine"*/ STR(574), /*"easeinoutsine"*/ STR(575), /*"easeinexpo"*/ STR(576), /*"easeoutexpo"*/ STR(577), /*"easeinoutexpo"*/ STR(578), /*"easeincirc"*/ STR(579), /*"easeoutcirc"*/ STR(580), /*"easeinoutcirc"*/ STR(581), /*"easeinelastic"*/ STR(582), /*"easeoutelastic"*/ STR(583), /*"easeinoutelastic"*/ STR(584), /*"easeinback"*/ STR(585), /*"easeoutback"*/ STR(586), /*"easeinoutback"*/ STR(587), /*"easeinbounce"*/ STR(588), /*"easeoutbounce"*/ STR(589), /*"easeinoutbounce"*/ STR(590) });
		log({ /*"Make transitions"*/ STR(591) });
		...
		log({ /*"Transitions OK"*/ STR(592) });
		global::videotemplate_list = ds_list_create();
		ds_list_add({ global::videotemplate_list, new_videotemplate(/*"avatar"*/ STR(593), IntType(512), IntType(512)), new_videotemplate(/*"hd_720p"*/ STR(594), IntType(1280), IntType(720)), new_videotemplate(/*"fhd_1080p"*/ STR(595), IntType(1920), IntType(1080)), new_videotemplate(/*"qhd_1440p"*/ STR(596), IntType(2560), IntType(1440)), new_videotemplate(/*"uhd_4k"*/ STR(597), IntType(3840), IntType(2160)), new_videotemplate(/*"hd_720p_cinematic"*/ STR(598), IntType(1680), IntType(720)), new_videotemplate(/*"fhd_1080p_cinematic"*/ STR(599), IntType(2560), IntType(1080)), new_videotemplate(/*"qhd_1440p_cinematic"*/ STR(600), IntType(3440), IntType(1440)), new_videotemplate(/*"uhd_4k_cinematic"*/ STR(601), IntType(5120), IntType(2160)) });
		global::videoquality_list = ds_list_create();
		ds_list_add({ global::videoquality_list, new_videoquality(/*"best"*/ STR(602), IntType(5000000)), new_videoquality(/*"high"*/ STR(603), IntType(2500000)), new_videoquality(/*"medium"*/ STR(604), IntType(1200000)), new_videoquality(/*"low"*/ STR(605), IntType(700000)), new_videoquality(/*"verylow"*/ STR(606), IntType(350000)) });
		...
		ds_list_add({ global::biome_list, new_biome(/*"custom"*/ STR(607), IntType(0), IntType(0), true, c_plains_biome_grass, c_plains_biome_foliage, c_plains_biome_water, null_) });
		...
		ds_list_add({ global::minecraft_color_name_list, /*"white"*/ STR(608), /*"orange"*/ STR(609), /*"magenta"*/ STR(610), /*"light_blue"*/ STR(611), /*"yellow"*/ STR(612), /*"lime"*/ STR(613), /*"pink"*/ STR(614), /*"gray"*/ STR(615), /*"light_gray"*/ STR(616), /*"cyan"*/ STR(617), /*"purple"*/ STR(618), /*"blue"*/ STR(619), /*"brown"*/ STR(620), /*"green"*/ STR(621), /*"red"*/ STR(622), /*"black"*/ STR(623) });
		...
		ds_list_add({ global::blend_mode_list, /*"normal"*/ STR(624), /*"add"*/ STR(625), /*"subtract"*/ STR(626), /*"multiply"*/ STR(627), /*"screen"*/ STR(628) });
		global::blend_mode_map = ds_map_create();
		ds_map_add(global::blend_mode_map, /*"normal"*/ STR(624), bm_normal);
		ds_map_add(global::blend_mode_map, /*"add"*/ STR(625), bm_add);
		ds_map_add(global::blend_mode_map, /*"subtract"*/ STR(626), bm_subtract);
		ds_map_add(global::blend_mode_map, /*"multiply"*/ STR(627), ArrType::From({ bm_zero, bm_src_color }));
		ds_map_add(global::blend_mode_map, /*"screen"*/ STR(628), ArrType::From({ bm_one, bm_inv_src_color }));
		...
		ds_list_add({ global::render_pass_list, /*"combined"*/ STR(629), /*"diffuse"*/ STR(630), /*"specular"*/ STR(631), /*"ao"*/ STR(632), /*"shadows"*/ STR(123), /*"indirect"*/ STR(125), /*"indirectshadows"*/ STR(633), /*"reflections"*/ STR(126), /*"depth"*/ STR(634), /*"normal"*/ STR(624), /*"material"*/ STR(635) });
	}
	...
	{
		sStr(recent_display_mode) = /*"grid"*/ STR(636);
	...
	void app_startup_themes(ScopeAny self)
	{
		...
		{
			self->name = /*"light"*/ STR(637);
			self->dark = false;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DB3030"*/ STR(638)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D85B00"*/ STR(639)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D68E02"*/ STR(640)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"34A100"*/ STR(641)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"0D8E41"*/ STR(642)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"048E8E"*/ STR(643)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"2144F1"*/ STR(644)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"982BCB"*/ STR(645)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"E93983"*/ STR(646)));
			self->level_top = hex_to_color(/*"F7FAFC"*/ STR(647));
			self->level_middle = hex_to_color(/*"ECEFF1"*/ STR(648));
			self->level_bottom = hex_to_color(/*"D7DFE2"*/ STR(649));
			self->viewport_top = hex_to_color(/*"F0FFFF"*/ STR(650));
			self->viewport_bottom = hex_to_color(/*"B5E8F2"*/ STR(651));
			self->text_main = hex_to_color(/*"0D1214"*/ STR(652));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"FFFFFF"*/ STR(653));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .15;
			self->red_error = hex_to_color(/*"FF1D0F"*/ STR(654));
			self->yellow_warning = hex_to_color(/*"FFC01E"*/ STR(655));
			self->green_success = hex_to_color(/*"61C159"*/ STR(656));
			self->red = hex_to_color(/*"FF5656"*/ STR(657));
			self->green = hex_to_color(/*"4AB758"*/ STR(658));
			self->blue = hex_to_color(/*"1370FB"*/ STR(659));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(660));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(661));
			self->yellow = hex_to_color(/*"F4CC5D"*/ STR(662));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(663));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"158AF5"*/ STR(664));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64A56B"*/ STR(665));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"D09522"*/ STR(666));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF1D0F"*/ STR(654));
		}
		
		global::theme_dark = (new obj_theme)->id;
		withOne (obj_theme, global::theme_dark, self->id)
		{
			self->name = /*"dark"*/ STR(667);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(668)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFA360"*/ STR(669)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFF065"*/ STR(670)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"8BFF6D"*/ STR(671)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"4EF390"*/ STR(672)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"49EED9"*/ STR(673)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"98BBFF"*/ STR(674)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(675)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(676)));
			self->level_top = hex_to_color(/*"37444A"*/ STR(677));
			self->level_middle = hex_to_color(/*"2B373D"*/ STR(678));
			self->level_bottom = hex_to_color(/*"18242A"*/ STR(679));
			self->viewport_top = hex_to_color(/*"2B373D"*/ STR(678));
			self->viewport_bottom = hex_to_color(/*"839096"*/ STR(680));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(653));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"000000"*/ STR(681));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .25;
			self->red_error = hex_to_color(/*"FF7A72"*/ STR(682));
			self->yellow_warning = hex_to_color(/*"FFEB36"*/ STR(683));
			self->green_success = hex_to_color(/*"64E879"*/ STR(684));
			self->red = hex_to_color(/*"FF5656"*/ STR(657));
			self->green = hex_to_color(/*"23FF88"*/ STR(685));
			self->blue = hex_to_color(/*"1370FB"*/ STR(659));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(660));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(661));
			self->yellow = hex_to_color(/*"FFD969"*/ STR(686));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(663));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"7EC1FF"*/ STR(687));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64E879"*/ STR(684));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"FFEB36"*/ STR(683));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF7A72"*/ STR(682));
		}
		
		global::theme_darker = (new obj_theme)->id;
		withOne (obj_theme, global::theme_darker, self->id)
		{
			self->name = /*"darker"*/ STR(688);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(668)));
			...
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(675)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(676)));
			self->level_top = hex_to_color(/*"1C1C1C"*/ STR(689));
			self->level_middle = hex_to_color(/*"101010"*/ STR(690));
			self->level_bottom = hex_to_color(/*"050505"*/ STR(691));
			self->viewport_top = hex_to_color(/*"484848"*/ STR(692));
			self->viewport_bottom = hex_to_color(/*"2B2B2B"*/ STR(693));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(653));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
	...
	void app_startup_window(ScopeAny self)
	{
		...
		sStr(popup_block_ani_ease) = /*"easeoutcirc"*/ STR(580);
	...
	void app_update_animate(ScopeAny self)
	{
		...
		if (bgobject > 0)
		{
			...
			if (sVar(background_biome) == /*"custom"*/ STR(607) || sVar(background_biome_prev) != sVar(background_biome))
			{
		...
		sInt(background_sky_color_final) = merge_color((IntType)(sVar(background_sky_color)), hex_to_color(/*"020204"*/ STR(695)), background_sky_night_alpha());
	...
	void app_update_caption()
	{
		if (global::_app->project_name != /*""*/ STR(0))
			window_set_caption(global::_app->project_name + string_repeat(/*" * "*/ STR(696), global::_app->project_changed) + /*" - Mine-imator"*/ STR(697));
		else
			window_set_caption(/*"Mine-imator"*/ STR(19));
	...
	void app_update_keybinds()
	{
		...
		for (IntType i = IntType(0); i < e_keybind_amount; i++)
		{
			...
			check = keybind_check(obj, /*"keyboard_check"*/ STR(698));
			idBool(obj, released) = false;
			if (idVar(obj, active) > 0)
				idBool(obj, released) = keybind_check(obj, /*"keyboard_check_released"*/ STR(699));
			idBool(obj, pressed) = keybind_check(obj, /*"keyboard_check_pressed"*/ STR(700));
	...
	void app_update_keyboard(ScopeAny self)
	{
		...
		if (sStr(window_state) == /*""*/ STR(0) && (sVar(window_busy) == /*""*/ STR(0) || sStr(settings_menu_name) == /*"colorpicker"*/ STR(701)) && !sBool(textbox_isediting))
		{
