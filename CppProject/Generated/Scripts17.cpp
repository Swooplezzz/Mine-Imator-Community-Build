...
namespace CppProject
{
	...
	void app_startup_keybinds()
	{
		...
		keybind_register(/*"projectnew"*/ STR(240), e_keybind_PROJECT_NEW, keybind_new(/*"N"*/ STR(241), true));
		keybind_register(/*"projectopen"*/ STR(242), e_keybind_PROJECT_OPEN, keybind_new(/*"O"*/ STR(243), true));
		keybind_register(/*"projectsave"*/ STR(244), e_keybind_PROJECT_SAVE, keybind_new(/*"S"*/ STR(245), true));
		keybind_register(/*"projectsaveas"*/ STR(246), e_keybind_PROJECT_SAVE_AS, keybind_new(/*"S"*/ STR(245), true, true));
		keybind_register(/*"importasset"*/ STR(247), e_keybind_IMPORT_ASSET, keybind_new(/*"I"*/ STR(248), true));
		keybind_register(/*"undo"*/ STR(249), e_keybind_UNDO, keybind_new(/*"Z"*/ STR(250), true));
		keybind_register(/*"redo"*/ STR(251), e_keybind_REDO, keybind_new(/*"Y"*/ STR(252), true));
		keybind_register(/*"timelinedelete"*/ STR(253), e_keybind_TIMELINE_DELETE, keybind_new(/*"R"*/ STR(254), true));
		keybind_register(/*"timelineduplicate"*/ STR(255), e_keybind_TIMELINE_DUPLICATE, keybind_new(/*"D"*/ STR(256), true));
		keybind_register(/*"timelineselect"*/ STR(257), e_keybind_TIMELINE_SELECT, keybind_new(/*"A"*/ STR(258), true));
		keybind_register(/*"timelinehide"*/ STR(259), e_keybind_TIMELINE_HIDE, keybind_new(/*"H"*/ STR(260), true));
		keybind_register(/*"timelineshowhidden"*/ STR(261), e_keybind_TIMELINE_SHOW_HIDDEN, keybind_new(/*"H"*/ STR(260), true, false, true));
		keybind_register(/*"createfolder"*/ STR(262), e_keybind_CREATE_FOLDER, keybind_new(/*"F"*/ STR(263), true));
		keybind_register(/*"keyframescreate"*/ STR(264), e_keybind_KEYFRAMES_CREATE, keybind_new(/*"Q"*/ STR(265), true));
		keybind_register(/*"keyframescopy"*/ STR(266), e_keybind_KEYFRAMES_COPY, keybind_new(/*"C"*/ STR(267), true));
		keybind_register(/*"keyframescut"*/ STR(268), e_keybind_KEYFRAMES_CUT, keybind_new(/*"X"*/ STR(269), true));
		keybind_register(/*"keyframespaste"*/ STR(270), e_keybind_KEYFRAMES_PASTE, keybind_new(/*"V"*/ STR(271), true));
		keybind_register(/*"keyframesdelete"*/ STR(272), e_keybind_KEYFRAMES_DELETE, keybind_new(vk_delete));
		keybind_register(/*"play"*/ STR(273), e_keybind_PLAY, keybind_new(vk_space));
		keybind_register(/*"playbeginning"*/ STR(274), e_keybind_PLAY_BEGINNING, keybind_new(vk_enter));
		keybind_register(/*"markerleft"*/ STR(275), e_keybind_MARKER_LEFT, keybind_new(vk_left), true);
		keybind_register(/*"markerright"*/ STR(276), e_keybind_MARKER_RIGHT, keybind_new(vk_right), true);
		keybind_register(/*"rendermode"*/ STR(277), e_keybind_RENDER_MODE, keybind_new(vk_f5));
		keybind_register(/*"particlesspawn"*/ STR(278), e_keybind_PARTICLES_SPAWN, keybind_new(/*"X"*/ STR(269)));
		keybind_register(/*"particlesclear"*/ STR(279), e_keybind_PARTICLES_CLEAR, keybind_new(/*"C"*/ STR(267)));
		keybind_register(/*"secondaryview"*/ STR(280), e_keybind_SECONDARY_VIEW, keybind_new(vk_f6));
		keybind_register(/*"toolselect"*/ STR(281), e_keybind_TOOL_SELECT, keybind_new(/*"W"*/ STR(282)));
		keybind_register(/*"toolmove"*/ STR(283), e_keybind_TOOL_MOVE, keybind_new(/*"G"*/ STR(284)));
		keybind_register(/*"toolrotate"*/ STR(285), e_keybind_TOOL_ROTATE, keybind_new(/*"R"*/ STR(254)));
		keybind_register(/*"toolscale"*/ STR(286), e_keybind_TOOL_SCALE, keybind_new(/*"S"*/ STR(245)));
		keybind_register(/*"toolbend"*/ STR(287), e_keybind_TOOL_BEND, keybind_new(/*"B"*/ STR(288)));
		keybind_register(/*"tooltransform"*/ STR(289), e_keybind_TOOL_TRANSFORM, keybind_new(/*"T"*/ STR(290)));
		keybind_register(/*"snap"*/ STR(291), e_keybind_SNAP, keybind_new(/*"F"*/ STR(263)));
		keybind_register(/*"camforward"*/ STR(292), e_keybind_CAM_FORWARD, keybind_new(/*"W"*/ STR(282)), true);
		keybind_register(/*"camleft"*/ STR(293), e_keybind_CAM_LEFT, keybind_new(/*"A"*/ STR(258)), true);
		keybind_register(/*"camback"*/ STR(294), e_keybind_CAM_BACK, keybind_new(/*"S"*/ STR(245)), true);
		keybind_register(/*"camright"*/ STR(295), e_keybind_CAM_RIGHT, keybind_new(/*"D"*/ STR(256)), true);
		keybind_register(/*"camascend"*/ STR(296), e_keybind_CAM_ASCEND, keybind_new(/*"E"*/ STR(297)), true);
		keybind_register(/*"camdescend"*/ STR(298), e_keybind_CAM_DESCEND, keybind_new(/*"Q"*/ STR(265)), true);
		keybind_register(/*"camrollforward"*/ STR(299), e_keybind_CAM_ROLL_FORWARD, keybind_new(/*"Z"*/ STR(250)), true);
		keybind_register(/*"camrollback"*/ STR(300), e_keybind_CAM_ROLL_BACK, keybind_new(/*"C"*/ STR(267)), true);
		keybind_register(/*"camrollreset"*/ STR(301), e_keybind_CAM_ROLL_RESET, keybind_new(/*"X"*/ STR(269)), true);
		keybind_register(/*"camreset"*/ STR(302), e_keybind_CAM_RESET, keybind_new(/*"R"*/ STR(254)), true);
		keybind_register(/*"camfast"*/ STR(303), e_keybind_CAM_FAST, keybind_new(vk_space), true);
		keybind_register(/*"camslow"*/ STR(304), e_keybind_CAM_SLOW, keybind_new(null_, false, true), true);
		keybind_register(/*"camviewtimeline"*/ STR(305), e_keybind_CAM_VIEW_TIMELINE, keybind_new(/*"V"*/ STR(271)), false);
	...
	void app_startup_lists(ScopeAny self)
	{
		...
		ds_list_add({ global::value_name_list, /*"POS_X"*/ STR(306), /*"POS_Y"*/ STR(307), /*"POS_Z"*/ STR(308), /*"ROT_X"*/ STR(309), /*"ROT_Y"*/ STR(310), /*"ROT_Z"*/ STR(311), /*"SCA_X"*/ STR(312), /*"SCA_Y"*/ STR(313), /*"SCA_Z"*/ STR(314), /*"BEND_ANGLE"*/ STR(315), /*"BEND_ANGLE_X"*/ STR(316), /*"BEND_ANGLE_Y"*/ STR(317), /*"BEND_ANGLE_Z"*/ STR(318), /*"ALPHA"*/ STR(319), /*"RGB_ADD"*/ STR(320), /*"RGB_SUB"*/ STR(321), /*"RGB_MUL"*/ STR(322), /*"HSB_ADD"*/ STR(323), /*"HSB_SUB"*/ STR(324), /*"HSB_MUL"*/ STR(325), /*"MIX_COLOR"*/ STR(326), /*"GLOW_COLOR"*/ STR(327), /*"MIX_PERCENT"*/ STR(328), /*"EMISSIVE"*/ STR(329), /*"METALLIC"*/ STR(330), /*"ROUGHNESS"*/ STR(331), /*"SUBSURFACE"*/ STR(332), /*"SUBSURFACE_RADIUS_RED"*/ STR(333), /*"SUBSURFACE_RADIUS_GREEN"*/ STR(334), /*"SUBSURFACE_RADIUS_BLUE"*/ STR(335), /*"SUBSURFACE_COLOR"*/ STR(336), /*"WIND_INFLUENCE"*/ STR(337), /*"SPAWN"*/ STR(338), /*"FREEZE"*/ STR(339), /*"CLEAR"*/ STR(340), /*"CUSTOM_SEED"*/ STR(341), /*"SEED"*/ STR(342), /*"ATTRACTOR"*/ STR(343), /*"FORCE"*/ STR(344), /*"FORCE_DIRECTIONAL"*/ STR(345), /*"FORCE_VORTEX"*/ STR(346), /*"LIGHT_COLOR"*/ STR(347), /*"LIGHT_STRENGTH"*/ STR(348), /*"LIGHT_SPECULAR_STRENGTH"*/ STR(349), /*"LIGHT_SIZE"*/ STR(350), /*"LIGHT_RANGE"*/ STR(351), /*"LIGHT_FADE_SIZE"*/ STR(352), /*"LIGHT_SPOT_RADIUS"*/ STR(353), /*"LIGHT_SPOT_SHARPNESS"*/ STR(354), /*"CAM_FOV"*/ STR(355), /*"CAM_BLADE_AMOUNT"*/ STR(356), /*"CAM_BLADE_ANGLE"*/ STR(357), /*"CAM_LIGHT_MANAGEMENT"*/ STR(358), /*"CAM_TONEMAPPER"*/ STR(359), /*"CAM_EXPOSURE"*/ STR(360), /*"CAM_GAMMA"*/ STR(361), /*"CAM_ROTATE"*/ STR(362), /*"CAM_ROTATE_DISTANCE"*/ STR(363), /*"CAM_ROTATE_ANGLE_XY"*/ STR(364), /*"CAM_ROTATE_ANGLE_Z"*/ STR(365), /*"CAM_SHAKE"*/ STR(366), /*"CAM_SHAKE_MODE"*/ STR(367), /*"CAM_SHAKE_STRENGTH_X"*/ STR(368), /*"CAM_SHAKE_STRENGTH_Y"*/ STR(369), /*"CAM_SHAKE_STRENGTH_Z"*/ STR(370), /*"CAM_SHAKE_SPEED_X"*/ STR(371), /*"CAM_SHAKE_SPEED_Y"*/ STR(372), /*"CAM_SHAKE_SPEED_Z"*/ STR(373), /*"CAM_DOF"*/ STR(374), /*"CAM_DOF_DEPTH"*/ STR(375), /*"CAM_DOF_RANGE"*/ STR(376), /*"CAM_DOF_FADE_SIZE"*/ STR(377), /*"CAM_DOF_BLUR_SIZE"*/ STR(378), /*"CAM_DOF_BLUR_RATIO"*/ STR(379), /*"CAM_DOF_BIAS"*/ STR(380), /*"CAM_DOF_THRESHOLD"*/ STR(381), /*"CAM_DOF_GAIN"*/ STR(382), /*"CAM_DOF_FRINGE"*/ STR(383), /*"CAM_DOF_FRINGE_ANGLE_RED"*/ STR(384), /*"CAM_DOF_FRINGE_ANGLE_GREEN"*/ STR(385), /*"CAM_DOF_FRINGE_ANGLE_BLUE"*/ STR(386), /*"CAM_DOF_FRINGE_RED"*/ STR(387), /*"CAM_DOF_FRINGE_GREEN"*/ STR(388), /*"CAM_DOF_FRINGE_BLUE"*/ STR(389), /*"CAM_BLOOM"*/ STR(390), /*"CAM_BLOOM_THRESHOLD"*/ STR(391), /*"CAM_BLOOM_INTENSITY"*/ STR(392), /*"CAM_BLOOM_RADIUS"*/ STR(393), /*"CAM_BLOOM_RATIO"*/ STR(394), /*"CAM_BLOOM_BLEND"*/ STR(395), /*"CAM_LENS_DIRT"*/ STR(396), /*"CAM_LENS_DIRT_BLOOM"*/ STR(397), /*"CAM_LENS_DIRT_GLOW"*/ STR(398), /*"CAM_LENS_DIRT_RADIUS"*/ STR(399), /*"CAM_LENS_DIRT_INTENSITY"*/ STR(400), /*"CAM_LENS_DIRT_POWER"*/ STR(401), /*"CAM_COLOR_CORRECTION"*/ STR(402), /*"CAM_CONTRAST"*/ STR(403), /*"CAM_BRIGHTNESS"*/ STR(404), /*"CAM_SATURATION"*/ STR(405), /*"CAM_VIBRANCE"*/ STR(406), /*"CAM_COLOR_BURN"*/ STR(407), /*"CAM_GRAIN"*/ STR(408), /*"CAM_GRAIN_STRENGTH"*/ STR(409), /*"CAM_GRAIN_SATURATION"*/ STR(410), /*"CAM_GRAIN_SIZE"*/ STR(411), /*"CAM_VIGNETTE"*/ STR(412), /*"CAM_VIGNETTE_RADIUS"*/ STR(413), /*"CAM_VIGNETTE_SOFTNESS"*/ STR(414), /*"CAM_VIGNETTE_STRENGTH"*/ STR(415), /*"CAM_VIGNETTE_COLOR"*/ STR(416), /*"CAM_CA"*/ STR(417), /*"CAM_CA_BLUR_AMOUNT"*/ STR(418), /*"CAM_CA_DISTORT_CHANNELS"*/ STR(419), /*"CAM_CA_RED_OFFSET"*/ STR(420), /*"CAM_CA_GREEN_OFFSET"*/ STR(421), /*"CAM_CA_BLUE_OFFSET"*/ STR(422), /*"CAM_DISTORT"*/ STR(423), /*"CAM_DISTORT_REPEAT"*/ STR(424), /*"CAM_DISTORT_ZOOM_AMOUNT"*/ STR(425), /*"CAM_DISTORT_AMOUNT"*/ STR(426), /*"CAM_SIZE_USE_PROJECT"*/ STR(427), /*"CAM_SIZE_KEEP_ASPECT_RATIO"*/ STR(428), /*"CAM_WIDTH"*/ STR(429), /*"CAM_HEIGHT"*/ STR(430), /*"BG_IMAGE_SHOW"*/ STR(431), /*"BG_IMAGE_ROTATION"*/ STR(432), /*"BG_SKY_MOON_PHASE"*/ STR(433), /*"BG_SKY_TIME"*/ STR(434), /*"BG_SKY_ROTATION"*/ STR(435), /*"BG_SUNLIGHT_STRENGTH"*/ STR(436), /*"BG_SUNLIGHT_ANGLE"*/ STR(437), /*"BG_TWILIGHT"*/ STR(438), /*"BG_SKY_CLOUDS_SHOW"*/ STR(439), /*"BG_SKY_CLOUDS_SPEED"*/ STR(440), /*"BG_SKY_CLOUDS_HEIGHT"*/ STR(441), /*"BG_SKY_CLOUDS_OFFSET"*/ STR(442), /*"BG_GROUND_SHOW"*/ STR(443), /*"BG_GROUND_SLOT"*/ STR(444), /*"BG_BIOME"*/ STR(445), /*"BG_SKY_COLOR"*/ STR(446), /*"BG_SKY_CLOUDS_COLOR"*/ STR(447), /*"BG_SUNLIGHT_COLOR"*/ STR(448), /*"BG_AMBIENT_COLOR"*/ STR(449), /*"BG_NIGHT_COLOR"*/ STR(450), /*"BG_GRASS_COLOR"*/ STR(451), /*"BG_FOLIAGE_COLOR"*/ STR(452), /*"BG_WATER_COLOR"*/ STR(453), /*"BG_LEAVES_OAK_COLOR"*/ STR(454), /*"BG_LEAVES_SPRUCE_COLOR"*/ STR(455), /*"BG_LEAVES_BIRCH_COLOR"*/ STR(456), /*"BG_LEAVES_JUNGLE_COLOR"*/ STR(457), /*"BG_LEAVES_ACACIA_COLOR"*/ STR(458), /*"BG_LEAVES_DARK_OAK_COLOR"*/ STR(459), /*"BG_LEAVES_MANGROVE_COLOR"*/ STR(460), /*"BG_FOG_SHOW"*/ STR(461), /*"BG_FOG_SKY"*/ STR(462), /*"BG_FOG_CUSTOM_COLOR"*/ STR(463), /*"BG_FOG_COLOR"*/ STR(464), /*"BG_FOG_CUSTOM_OBJECT_COLOR"*/ STR(465), /*"BG_FOG_OBJECT_COLOR"*/ STR(466), /*"BG_FOG_DISTANCE"*/ STR(467), /*"BG_FOG_SIZE"*/ STR(468), /*"BG_FOG_HEIGHT"*/ STR(469), /*"BG_WIND"*/ STR(470), /*"BG_WIND_SPEED"*/ STR(471), /*"BG_WIND_STRENGTH"*/ STR(472), /*"BG_WIND_DIRECTION"*/ STR(473), /*"BG_WIND_DIRECTIONAL_SPEED"*/ STR(474), /*"BG_WIND_DIRECTIONAL_STRENGTH"*/ STR(475), /*"BG_TEXTURE_ANI_SPEED"*/ STR(476), /*"TEXTURE_OBJ"*/ STR(477), /*"TEXTURE_MATERIAL_OBJ"*/ STR(478), /*"TEXTURE_NORMAL_OBJ"*/ STR(479), /*"SOUND_OBJ"*/ STR(480), /*"SOUND_VOLUME"*/ STR(481), /*"SOUND_PITCH"*/ STR(482), /*"SOUND_START"*/ STR(483), /*"SOUND_END"*/ STR(484), /*"TEXT"*/ STR(485), /*"TEXT_FONT"*/ STR(486), /*"TEXT_HALIGN"*/ STR(487), /*"TEXT_VALIGN"*/ STR(488), /*"TEXT_AA"*/ STR(489), /*"CUSTOM_ITEM_SLOT"*/ STR(490), /*"ITEM_SLOT"*/ STR(491), /*"ITEM_NAME"*/ STR(492), /*"PATH_OBJ"*/ STR(493), /*"PATH_OFFSET"*/ STR(494), /*"PATH_POINT_ANGLE"*/ STR(495), /*"PATH_POINT_SCALE"*/ STR(496), /*"IK_TARGET"*/ STR(497), /*"IK_BLEND"*/ STR(498), /*"IK_TARGET_ANGLE"*/ STR(499), /*"IK_ANGLE_OFFSET"*/ STR(500), /*"ROT_TARGET"*/ STR(501), /*"POS_TARGET"*/ STR(502), /*"SCALE_TARGET"*/ STR(503), /*"FLW_ROT_X"*/ STR(504), /*"FLW_ROT_Y"*/ STR(505), /*"FLW_ROT_Z"*/ STR(506), /*"FLW_POS_X"*/ STR(507), /*"FLW_POS_Y"*/ STR(508), /*"FLW_POS_Z"*/ STR(509), /*"FLW_SCALE_X"*/ STR(510), /*"FLW_SCALE_Y"*/ STR(511), /*"FLW_SCALE_Z"*/ STR(512), /*"VISIBLE"*/ STR(513), /*"TRANSITION"*/ STR(514), /*"EASE_IN_X"*/ STR(515), /*"EASE_IN_Y"*/ STR(516), /*"EASE_OUT_X"*/ STR(517), /*"EASE_OUT_Y"*/ STR(518) });
		...
		ds_list_add({ global::temp_type_name_list, /*"char"*/ STR(519), /*"spblock"*/ STR(520), /*"scenery"*/ STR(521), /*"item"*/ STR(522), /*"block"*/ STR(523), /*"bodypart"*/ STR(524), /*"particles"*/ STR(525), /*"text"*/ STR(99), /*"cube"*/ STR(3), /*"cone"*/ STR(526), /*"cylinder"*/ STR(527), /*"sphere"*/ STR(528), /*"surface"*/ STR(529), /*"model"*/ STR(530) });
		global::tl_type_name_list = ds_list_create();
		ds_list_add({ global::tl_type_name_list, /*"char"*/ STR(519), /*"spblock"*/ STR(520), /*"scenery"*/ STR(521), /*"item"*/ STR(522), /*"block"*/ STR(523), /*"bodypart"*/ STR(524), /*"particles"*/ STR(525), /*"text"*/ STR(99), /*"cube"*/ STR(3), /*"cone"*/ STR(526), /*"cylinder"*/ STR(527), /*"sphere"*/ STR(528), /*"surface"*/ STR(529), /*"model"*/ STR(530), /*"camera"*/ STR(120), /*"spotlight"*/ STR(531), /*"pointlight"*/ STR(532), /*"folder"*/ STR(533), /*"background"*/ STR(212), /*"audio"*/ STR(534), /*"path"*/ STR(535), /*"pathpoint"*/ STR(536), /*"shape"*/ STR(537), /*"lightsource"*/ STR(538) });
		global::res_type_name_list = ds_list_create();
		ds_list_add({ global::res_type_name_list, /*"pack"*/ STR(539), /*"packunzipped"*/ STR(540), /*"skin"*/ STR(541), /*"downloadskin"*/ STR(198), /*"itemsheet"*/ STR(542), /*"legacyblocksheet"*/ STR(543), /*"blocksheet"*/ STR(544), /*"scenery"*/ STR(521), /*"fromworld"*/ STR(545), /*"particlesheet"*/ STR(546), /*"texture"*/ STR(547), /*"font"*/ STR(548), /*"sound"*/ STR(549), /*"model"*/ STR(530) });
		global::transition_list = ds_list_create();
		ds_list_add({ global::transition_list, /*"linear"*/ STR(550), /*"instant"*/ STR(551), /*"bezier"*/ STR(552), /*"easeinquad"*/ STR(553), /*"easeoutquad"*/ STR(554), /*"easeinoutquad"*/ STR(555), /*"easeincubic"*/ STR(556), /*"easeoutcubic"*/ STR(557), /*"easeinoutcubic"*/ STR(558), /*"easeinquart"*/ STR(559), /*"easeoutquart"*/ STR(560), /*"easeinoutquart"*/ STR(561), /*"easeinquint"*/ STR(562), /*"easeoutquint"*/ STR(563), /*"easeinoutquint"*/ STR(564), /*"easeinsine"*/ STR(565), /*"easeoutsine"*/ STR(566), /*"easeinoutsine"*/ STR(567), /*"easeinexpo"*/ STR(568), /*"easeoutexpo"*/ STR(569), /*"easeinoutexpo"*/ STR(570), /*"easeincirc"*/ STR(571), /*"easeoutcirc"*/ STR(572), /*"easeinoutcirc"*/ STR(573), /*"easeinelastic"*/ STR(574), /*"easeoutelastic"*/ STR(575), /*"easeinoutelastic"*/ STR(576), /*"easeinback"*/ STR(577), /*"easeoutback"*/ STR(578), /*"easeinoutback"*/ STR(579), /*"easeinbounce"*/ STR(580), /*"easeoutbounce"*/ STR(581), /*"easeinoutbounce"*/ STR(582) });
		log({ /*"Make transitions"*/ STR(583) });
		...
		log({ /*"Transitions OK"*/ STR(584) });
		global::videotemplate_list = ds_list_create();
		ds_list_add({ global::videotemplate_list, new_videotemplate(/*"avatar"*/ STR(585), IntType(512), IntType(512)), new_videotemplate(/*"hd_720p"*/ STR(586), IntType(1280), IntType(720)), new_videotemplate(/*"fhd_1080p"*/ STR(587), IntType(1920), IntType(1080)), new_videotemplate(/*"qhd_1440p"*/ STR(588), IntType(2560), IntType(1440)), new_videotemplate(/*"uhd_4k"*/ STR(589), IntType(3840), IntType(2160)), new_videotemplate(/*"hd_720p_cinematic"*/ STR(590), IntType(1680), IntType(720)), new_videotemplate(/*"fhd_1080p_cinematic"*/ STR(591), IntType(2560), IntType(1080)), new_videotemplate(/*"qhd_1440p_cinematic"*/ STR(592), IntType(3440), IntType(1440)), new_videotemplate(/*"uhd_4k_cinematic"*/ STR(593), IntType(5120), IntType(2160)) });
		global::videoquality_list = ds_list_create();
		ds_list_add({ global::videoquality_list, new_videoquality(/*"best"*/ STR(594), IntType(5000000)), new_videoquality(/*"high"*/ STR(595), IntType(2500000)), new_videoquality(/*"medium"*/ STR(596), IntType(1200000)), new_videoquality(/*"low"*/ STR(597), IntType(700000)), new_videoquality(/*"verylow"*/ STR(598), IntType(350000)) });
		...
		ds_list_add({ global::biome_list, new_biome(/*"custom"*/ STR(599), IntType(0), IntType(0), true, c_plains_biome_grass, c_plains_biome_foliage, c_plains_biome_water, null_) });
		...
		ds_list_add({ global::minecraft_color_name_list, /*"white"*/ STR(600), /*"orange"*/ STR(601), /*"magenta"*/ STR(602), /*"light_blue"*/ STR(603), /*"yellow"*/ STR(604), /*"lime"*/ STR(605), /*"pink"*/ STR(606), /*"gray"*/ STR(607), /*"light_gray"*/ STR(608), /*"cyan"*/ STR(609), /*"purple"*/ STR(610), /*"blue"*/ STR(611), /*"brown"*/ STR(612), /*"green"*/ STR(613), /*"red"*/ STR(614), /*"black"*/ STR(615) });
		...
		ds_list_add({ global::blend_mode_list, /*"normal"*/ STR(616), /*"add"*/ STR(617), /*"subtract"*/ STR(618), /*"multiply"*/ STR(619), /*"screen"*/ STR(620) });
		global::blend_mode_map = ds_map_create();
		ds_map_add(global::blend_mode_map, /*"normal"*/ STR(616), bm_normal);
		ds_map_add(global::blend_mode_map, /*"add"*/ STR(617), bm_add);
		ds_map_add(global::blend_mode_map, /*"subtract"*/ STR(618), bm_subtract);
		ds_map_add(global::blend_mode_map, /*"multiply"*/ STR(619), ArrType::From({ bm_zero, bm_src_color }));
		ds_map_add(global::blend_mode_map, /*"screen"*/ STR(620), ArrType::From({ bm_one, bm_inv_src_color }));
		...
		ds_list_add({ global::render_pass_list, /*"combined"*/ STR(621), /*"diffuse"*/ STR(622), /*"specular"*/ STR(623), /*"ao"*/ STR(624), /*"shadows"*/ STR(123), /*"indirect"*/ STR(125), /*"indirectshadows"*/ STR(625), /*"reflections"*/ STR(126), /*"depth"*/ STR(626), /*"normal"*/ STR(616), /*"material"*/ STR(627) });
	}
	...
	{
		sStr(recent_display_mode) = /*"grid"*/ STR(628);
	...
	void app_startup_themes(ScopeAny self)
	{
		...
		{
			self->name = /*"light"*/ STR(629);
			self->dark = false;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DB3030"*/ STR(630)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D85B00"*/ STR(631)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D68E02"*/ STR(632)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"34A100"*/ STR(633)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"0D8E41"*/ STR(634)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"048E8E"*/ STR(635)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"2144F1"*/ STR(636)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"982BCB"*/ STR(637)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"E93983"*/ STR(638)));
			self->level_top = hex_to_color(/*"F7FAFC"*/ STR(639));
			self->level_middle = hex_to_color(/*"ECEFF1"*/ STR(640));
			self->level_bottom = hex_to_color(/*"D7DFE2"*/ STR(641));
			self->viewport_top = hex_to_color(/*"F0FFFF"*/ STR(642));
			self->viewport_bottom = hex_to_color(/*"B5E8F2"*/ STR(643));
			self->text_main = hex_to_color(/*"0D1214"*/ STR(644));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"FFFFFF"*/ STR(645));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .15;
			self->red_error = hex_to_color(/*"FF1D0F"*/ STR(646));
			self->yellow_warning = hex_to_color(/*"FFC01E"*/ STR(647));
			self->green_success = hex_to_color(/*"61C159"*/ STR(648));
			self->red = hex_to_color(/*"FF5656"*/ STR(649));
			self->green = hex_to_color(/*"4AB758"*/ STR(650));
			self->blue = hex_to_color(/*"1370FB"*/ STR(651));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(652));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(653));
			self->yellow = hex_to_color(/*"F4CC5D"*/ STR(654));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(655));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"158AF5"*/ STR(656));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64A56B"*/ STR(657));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"D09522"*/ STR(658));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF1D0F"*/ STR(646));
		}
		
		global::theme_dark = (new obj_theme)->id;
		withOne (obj_theme, global::theme_dark, self->id)
		{
			self->name = /*"dark"*/ STR(659);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(660)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFA360"*/ STR(661)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFF065"*/ STR(662)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"8BFF6D"*/ STR(663)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"4EF390"*/ STR(664)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"49EED9"*/ STR(665)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"98BBFF"*/ STR(666)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(667)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(668)));
			self->level_top = hex_to_color(/*"37444A"*/ STR(669));
			self->level_middle = hex_to_color(/*"2B373D"*/ STR(670));
			self->level_bottom = hex_to_color(/*"18242A"*/ STR(671));
			self->viewport_top = hex_to_color(/*"2B373D"*/ STR(670));
			self->viewport_bottom = hex_to_color(/*"839096"*/ STR(672));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(645));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"000000"*/ STR(673));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .25;
			self->red_error = hex_to_color(/*"FF7A72"*/ STR(674));
			self->yellow_warning = hex_to_color(/*"FFEB36"*/ STR(675));
			self->green_success = hex_to_color(/*"64E879"*/ STR(676));
			self->red = hex_to_color(/*"FF5656"*/ STR(649));
			self->green = hex_to_color(/*"23FF88"*/ STR(677));
			self->blue = hex_to_color(/*"1370FB"*/ STR(651));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(652));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(653));
			self->yellow = hex_to_color(/*"FFD969"*/ STR(678));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(655));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"7EC1FF"*/ STR(679));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64E879"*/ STR(676));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"FFEB36"*/ STR(675));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF7A72"*/ STR(674));
		}
		
		global::theme_darker = (new obj_theme)->id;
		withOne (obj_theme, global::theme_darker, self->id)
		{
			self->name = /*"darker"*/ STR(680);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(660)));
			...
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(667)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(668)));
			self->level_top = hex_to_color(/*"1C1C1C"*/ STR(681));
			self->level_middle = hex_to_color(/*"101010"*/ STR(682));
			self->level_bottom = hex_to_color(/*"050505"*/ STR(683));
			self->viewport_top = hex_to_color(/*"484848"*/ STR(684));
			self->viewport_bottom = hex_to_color(/*"2B2B2B"*/ STR(685));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(645));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
	...
	void app_startup_window(ScopeAny self)
	{
		...
		sStr(popup_block_ani_ease) = /*"easeoutcirc"*/ STR(572);
	...
	void app_update_animate(ScopeAny self)
	{
		...
		if (bgobject > 0)
		{
			...
			if (sVar(background_biome) == /*"custom"*/ STR(599) || sVar(background_biome_prev) != sVar(background_biome))
			{
		...
		sInt(background_sky_color_final) = merge_color((IntType)(sVar(background_sky_color)), hex_to_color(/*"020204"*/ STR(687)), background_sky_night_alpha());
	...
	void app_update_caption()
	{
		if (global::_app->project_name != /*""*/ STR(0))
			window_set_caption(global::_app->project_name + string_repeat(/*" * "*/ STR(688), global::_app->project_changed) + /*" - Mine-imator"*/ STR(689));
		else
			window_set_caption(/*"Mine-imator"*/ STR(19));
	...
	void app_update_keybinds()
	{
		...
		for (IntType i = IntType(0); i < e_keybind_amount; i++)
		{
			...
			check = keybind_check(obj, /*"keyboard_check"*/ STR(690));
			idBool(obj, released) = false;
			if (idVar(obj, active) > 0)
				idBool(obj, released) = keybind_check(obj, /*"keyboard_check_released"*/ STR(691));
			idBool(obj, pressed) = keybind_check(obj, /*"keyboard_check_pressed"*/ STR(692));
	...
	void app_update_keyboard(ScopeAny self)
	{
		...
		if (sStr(window_state) == /*""*/ STR(0) && (sVar(window_busy) == /*""*/ STR(0) || sStr(settings_menu_name) == /*"colorpicker"*/ STR(693)) && !sBool(textbox_isediting))
		{
