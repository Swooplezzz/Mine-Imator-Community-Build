...
namespace CppProject
{
	...
	void app_startup_keybinds()
	{
		...
		keybind_register(/*"projectnew"*/ STR(243), e_keybind_PROJECT_NEW, keybind_new(/*"N"*/ STR(244), true));
		keybind_register(/*"projectopen"*/ STR(245), e_keybind_PROJECT_OPEN, keybind_new(/*"O"*/ STR(246), true));
		keybind_register(/*"projectsave"*/ STR(247), e_keybind_PROJECT_SAVE, keybind_new(/*"S"*/ STR(248), true));
		keybind_register(/*"projectsaveas"*/ STR(249), e_keybind_PROJECT_SAVE_AS, keybind_new(/*"S"*/ STR(248), true, true));
		keybind_register(/*"importasset"*/ STR(250), e_keybind_IMPORT_ASSET, keybind_new(/*"I"*/ STR(251), true));
		keybind_register(/*"undo"*/ STR(252), e_keybind_UNDO, keybind_new(/*"Z"*/ STR(253), true));
		keybind_register(/*"redo"*/ STR(254), e_keybind_REDO, keybind_new(/*"Y"*/ STR(255), true));
		keybind_register(/*"timelinedelete"*/ STR(256), e_keybind_TIMELINE_DELETE, keybind_new(/*"R"*/ STR(257), true));
		keybind_register(/*"timelineduplicate"*/ STR(258), e_keybind_TIMELINE_DUPLICATE, keybind_new(/*"D"*/ STR(259), true));
		keybind_register(/*"timelineselect"*/ STR(260), e_keybind_TIMELINE_SELECT, keybind_new(/*"A"*/ STR(261), true));
		keybind_register(/*"timelinehide"*/ STR(262), e_keybind_TIMELINE_HIDE, keybind_new(/*"H"*/ STR(263), true));
		keybind_register(/*"timelineshowhidden"*/ STR(264), e_keybind_TIMELINE_SHOW_HIDDEN, keybind_new(/*"H"*/ STR(263), true, false, true));
		keybind_register(/*"createfolder"*/ STR(265), e_keybind_CREATE_FOLDER, keybind_new(/*"F"*/ STR(266), true));
		keybind_register(/*"keyframescreate"*/ STR(267), e_keybind_KEYFRAMES_CREATE, keybind_new(/*"Q"*/ STR(268), true));
		keybind_register(/*"keyframescopy"*/ STR(269), e_keybind_KEYFRAMES_COPY, keybind_new(/*"C"*/ STR(270), true));
		keybind_register(/*"keyframescut"*/ STR(271), e_keybind_KEYFRAMES_CUT, keybind_new(/*"X"*/ STR(272), true));
		keybind_register(/*"keyframespaste"*/ STR(273), e_keybind_KEYFRAMES_PASTE, keybind_new(/*"V"*/ STR(274), true));
		keybind_register(/*"keyframesdelete"*/ STR(275), e_keybind_KEYFRAMES_DELETE, keybind_new(vk_delete));
		keybind_register(/*"play"*/ STR(276), e_keybind_PLAY, keybind_new(vk_space));
		keybind_register(/*"playbeginning"*/ STR(277), e_keybind_PLAY_BEGINNING, keybind_new(vk_enter));
		keybind_register(/*"markerleft"*/ STR(278), e_keybind_MARKER_LEFT, keybind_new(vk_left), true);
		keybind_register(/*"markerright"*/ STR(279), e_keybind_MARKER_RIGHT, keybind_new(vk_right), true);
		keybind_register(/*"rendermode"*/ STR(280), e_keybind_RENDER_MODE, keybind_new(vk_f5));
		keybind_register(/*"particlesspawn"*/ STR(281), e_keybind_PARTICLES_SPAWN, keybind_new(/*"X"*/ STR(272)));
		keybind_register(/*"particlesclear"*/ STR(282), e_keybind_PARTICLES_CLEAR, keybind_new(/*"C"*/ STR(270)));
		keybind_register(/*"secondaryview"*/ STR(283), e_keybind_SECONDARY_VIEW, keybind_new(vk_f6));
		keybind_register(/*"toolselect"*/ STR(284), e_keybind_TOOL_SELECT, keybind_new(/*"W"*/ STR(285)));
		keybind_register(/*"toolmove"*/ STR(286), e_keybind_TOOL_MOVE, keybind_new(/*"G"*/ STR(287)));
		keybind_register(/*"toolrotate"*/ STR(288), e_keybind_TOOL_ROTATE, keybind_new(/*"R"*/ STR(257)));
		keybind_register(/*"toolscale"*/ STR(289), e_keybind_TOOL_SCALE, keybind_new(/*"S"*/ STR(248)));
		keybind_register(/*"toolbend"*/ STR(290), e_keybind_TOOL_BEND, keybind_new(/*"B"*/ STR(291)));
		keybind_register(/*"tooltransform"*/ STR(292), e_keybind_TOOL_TRANSFORM, keybind_new(/*"T"*/ STR(293)));
		keybind_register(/*"snap"*/ STR(294), e_keybind_SNAP, keybind_new(/*"F"*/ STR(266)));
		keybind_register(/*"camforward"*/ STR(295), e_keybind_CAM_FORWARD, keybind_new(/*"W"*/ STR(285)), true);
		keybind_register(/*"camleft"*/ STR(296), e_keybind_CAM_LEFT, keybind_new(/*"A"*/ STR(261)), true);
		keybind_register(/*"camback"*/ STR(297), e_keybind_CAM_BACK, keybind_new(/*"S"*/ STR(248)), true);
		keybind_register(/*"camright"*/ STR(298), e_keybind_CAM_RIGHT, keybind_new(/*"D"*/ STR(259)), true);
		keybind_register(/*"camascend"*/ STR(299), e_keybind_CAM_ASCEND, keybind_new(/*"E"*/ STR(300)), true);
		keybind_register(/*"camdescend"*/ STR(301), e_keybind_CAM_DESCEND, keybind_new(/*"Q"*/ STR(268)), true);
		keybind_register(/*"camrollforward"*/ STR(302), e_keybind_CAM_ROLL_FORWARD, keybind_new(/*"Z"*/ STR(253)), true);
		keybind_register(/*"camrollback"*/ STR(303), e_keybind_CAM_ROLL_BACK, keybind_new(/*"C"*/ STR(270)), true);
		keybind_register(/*"camrollreset"*/ STR(304), e_keybind_CAM_ROLL_RESET, keybind_new(/*"X"*/ STR(272)), true);
		keybind_register(/*"camreset"*/ STR(305), e_keybind_CAM_RESET, keybind_new(/*"R"*/ STR(257)), true);
		keybind_register(/*"camfast"*/ STR(306), e_keybind_CAM_FAST, keybind_new(vk_space), true);
		keybind_register(/*"camslow"*/ STR(307), e_keybind_CAM_SLOW, keybind_new(null_, false, true), true);
		keybind_register(/*"camviewtimeline"*/ STR(308), e_keybind_CAM_VIEW_TIMELINE, keybind_new(/*"V"*/ STR(274)), false);
	...
	void app_startup_lists(ScopeAny self)
	{
		...
		ds_list_add({ global::temp_type_name_list, /*"char"*/ STR(532), /*"spblock"*/ STR(533), /*"scenery"*/ STR(534), /*"item"*/ STR(535), /*"block"*/ STR(536), /*"bodypart"*/ STR(537), /*"particles"*/ STR(538), /*"text"*/ STR(100), /*"cube"*/ STR(3), /*"cone"*/ STR(539), /*"cylinder"*/ STR(540), /*"sphere"*/ STR(541), /*"surface"*/ STR(542), /*"model"*/ STR(543) });
		global::tl_type_name_list = ds_list_create();
		ds_list_add({ global::tl_type_name_list, /*"char"*/ STR(532), /*"spblock"*/ STR(533), /*"scenery"*/ STR(534), /*"item"*/ STR(535), /*"block"*/ STR(536), /*"bodypart"*/ STR(537), /*"particles"*/ STR(538), /*"text"*/ STR(100), /*"cube"*/ STR(3), /*"cone"*/ STR(539), /*"cylinder"*/ STR(540), /*"sphere"*/ STR(541), /*"surface"*/ STR(542), /*"model"*/ STR(543), /*"camera"*/ STR(121), /*"spotlight"*/ STR(544), /*"pointlight"*/ STR(545), /*"folder"*/ STR(546), /*"background"*/ STR(214), /*"audio"*/ STR(547), /*"path"*/ STR(548), /*"pathpoint"*/ STR(549), /*"shape"*/ STR(550), /*"lightsource"*/ STR(551) });
		global::res_type_name_list = ds_list_create();
		ds_list_add({ global::res_type_name_list, /*"pack"*/ STR(552), /*"packunzipped"*/ STR(553), /*"skin"*/ STR(554), /*"downloadskin"*/ STR(200), /*"itemsheet"*/ STR(555), /*"legacyblocksheet"*/ STR(556), /*"blocksheet"*/ STR(557), /*"scenery"*/ STR(534), /*"fromworld"*/ STR(558), /*"particlesheet"*/ STR(559), /*"texture"*/ STR(560), /*"font"*/ STR(561), /*"sound"*/ STR(562), /*"model"*/ STR(543) });
		global::transition_list = ds_list_create();
		ds_list_add({ global::transition_list, /*"linear"*/ STR(563), /*"instant"*/ STR(564), /*"bezier"*/ STR(565), /*"easeinquad"*/ STR(566), /*"easeoutquad"*/ STR(567), /*"easeinoutquad"*/ STR(568), /*"easeincubic"*/ STR(569), /*"easeoutcubic"*/ STR(570), /*"easeinoutcubic"*/ STR(571), /*"easeinquart"*/ STR(572), /*"easeoutquart"*/ STR(573), /*"easeinoutquart"*/ STR(574), /*"easeinquint"*/ STR(575), /*"easeoutquint"*/ STR(576), /*"easeinoutquint"*/ STR(577), /*"easeinsine"*/ STR(578), /*"easeoutsine"*/ STR(579), /*"easeinoutsine"*/ STR(580), /*"easeinexpo"*/ STR(581), /*"easeoutexpo"*/ STR(582), /*"easeinoutexpo"*/ STR(583), /*"easeincirc"*/ STR(584), /*"easeoutcirc"*/ STR(585), /*"easeinoutcirc"*/ STR(586), /*"easeinelastic"*/ STR(587), /*"easeoutelastic"*/ STR(588), /*"easeinoutelastic"*/ STR(589), /*"easeinback"*/ STR(590), /*"easeoutback"*/ STR(591), /*"easeinoutback"*/ STR(592), /*"easeinbounce"*/ STR(593), /*"easeoutbounce"*/ STR(594), /*"easeinoutbounce"*/ STR(595) });
		log({ /*"Make transitions"*/ STR(596) });
		...
		log({ /*"Transitions OK"*/ STR(597) });
		global::videotemplate_list = ds_list_create();
		ds_list_add({ global::videotemplate_list, new_videotemplate(/*"avatar"*/ STR(598), IntType(512), IntType(512)), new_videotemplate(/*"hd_720p"*/ STR(599), IntType(1280), IntType(720)), new_videotemplate(/*"fhd_1080p"*/ STR(600), IntType(1920), IntType(1080)), new_videotemplate(/*"qhd_1440p"*/ STR(601), IntType(2560), IntType(1440)), new_videotemplate(/*"uhd_4k"*/ STR(602), IntType(3840), IntType(2160)), new_videotemplate(/*"hd_720p_cinematic"*/ STR(603), IntType(1680), IntType(720)), new_videotemplate(/*"fhd_1080p_cinematic"*/ STR(604), IntType(2560), IntType(1080)), new_videotemplate(/*"qhd_1440p_cinematic"*/ STR(605), IntType(3440), IntType(1440)), new_videotemplate(/*"uhd_4k_cinematic"*/ STR(606), IntType(5120), IntType(2160)) });
		global::videoquality_list = ds_list_create();
		ds_list_add({ global::videoquality_list, new_videoquality(/*"best"*/ STR(607), IntType(5000000)), new_videoquality(/*"high"*/ STR(608), IntType(2500000)), new_videoquality(/*"medium"*/ STR(609), IntType(1200000)), new_videoquality(/*"low"*/ STR(610), IntType(700000)), new_videoquality(/*"verylow"*/ STR(611), IntType(350000)) });
		...
		ds_list_add({ global::biome_list, new_biome(/*"custom"*/ STR(612), IntType(0), IntType(0), true, c_plains_biome_grass, c_plains_biome_foliage, c_plains_biome_water, null_) });
		...
		ds_list_add({ global::minecraft_color_name_list, /*"white"*/ STR(613), /*"orange"*/ STR(614), /*"magenta"*/ STR(615), /*"light_blue"*/ STR(616), /*"yellow"*/ STR(617), /*"lime"*/ STR(618), /*"pink"*/ STR(619), /*"gray"*/ STR(620), /*"light_gray"*/ STR(621), /*"cyan"*/ STR(622), /*"purple"*/ STR(623), /*"blue"*/ STR(624), /*"brown"*/ STR(625), /*"green"*/ STR(626), /*"red"*/ STR(627), /*"black"*/ STR(628) });
		...
		ds_list_add({ global::render_pass_list, /*"combined"*/ STR(634), /*"diffuse"*/ STR(635), /*"specular"*/ STR(636), /*"ao"*/ STR(637), /*"shadows"*/ STR(124), /*"indirect"*/ STR(126), /*"indirectshadows"*/ STR(638), /*"reflections"*/ STR(127), /*"depth"*/ STR(639), /*"normal"*/ STR(629), /*"material"*/ STR(640) });
	}
	...
	void app_update_animate(ScopeAny self)
	{
		...
		if (bgobject > 0)
		{
			...
			if (sVar(background_biome) == /*"custom"*/ STR(612) || sVar(background_biome_prev) != sVar(background_biome))
			{
		...
		sInt(background_sky_color_final) = merge_color((IntType)(sVar(background_sky_color)), hex_to_color(/*"020204"*/ STR(700)), background_sky_night_alpha());
	...
	void app_update_keybinds()
	{
		...
		for (IntType i = IntType(0); i < e_keybind_amount; i++)
		{
			...
			if (idBool(obj, pressed) && idBool(obj, navigation) && string_contains(global::_app->window_busy, /*"camera"*/ STR(121)))
				navclear = true;
		}
		if (navclear)
		{
