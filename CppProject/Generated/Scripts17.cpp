...
namespace CppProject
{
	...
	void app_startup_lists(ScopeAny self)
	{
		...
		ds_list_add({ global::value_name_list, /*"POS_X"*/ STR(306), /*"POS_Y"*/ STR(307), /*"POS_Z"*/ STR(308), /*"ROT_X"*/ STR(309), /*"ROT_Y"*/ STR(310), /*"ROT_Z"*/ STR(311), /*"SCA_X"*/ STR(312), /*"SCA_Y"*/ STR(313), /*"SCA_Z"*/ STR(314), /*"BEND_ANGLE"*/ STR(315), /*"BEND_ANGLE_X"*/ STR(316), /*"BEND_ANGLE_Y"*/ STR(317), /*"BEND_ANGLE_Z"*/ STR(318), /*"ALPHA"*/ STR(319), /*"RGB_ADD"*/ STR(320), /*"RGB_SUB"*/ STR(321), /*"RGB_MUL"*/ STR(322), /*"HSB_ADD"*/ STR(323), /*"HSB_SUB"*/ STR(324), /*"HSB_MUL"*/ STR(325), /*"MIX_COLOR"*/ STR(326), /*"GLOW_COLOR"*/ STR(327), /*"MIX_PERCENT"*/ STR(328), /*"EMISSIVE"*/ STR(329), /*"METALLIC"*/ STR(330), /*"ROUGHNESS"*/ STR(331), /*"SUBSURFACE"*/ STR(332), /*"SUBSURFACE_RADIUS_RED"*/ STR(333), /*"SUBSURFACE_RADIUS_GREEN"*/ STR(334), /*"SUBSURFACE_RADIUS_BLUE"*/ STR(335), /*"SUBSURFACE_COLOR"*/ STR(336), /*"WIND_INFLUENCE"*/ STR(337), /*"SPAWN"*/ STR(338), /*"FREEZE"*/ STR(339), /*"CLEAR"*/ STR(340), /*"CUSTOM_SEED"*/ STR(341), /*"SEED"*/ STR(342), /*"ATTRACTOR"*/ STR(343), /*"FORCE"*/ STR(344), /*"FORCE_DIRECTIONAL"*/ STR(345), /*"FORCE_VORTEX"*/ STR(346), /*"LIGHT_COLOR"*/ STR(347), /*"LIGHT_STRENGTH"*/ STR(348), /*"LIGHT_SPECULAR_STRENGTH"*/ STR(349), /*"LIGHT_SIZE"*/ STR(350), /*"LIGHT_RANGE"*/ STR(351), /*"LIGHT_FADE_SIZE"*/ STR(352), /*"LIGHT_SPOT_RADIUS"*/ STR(353), /*"LIGHT_SPOT_SHARPNESS"*/ STR(354), /*"CAM_FOV"*/ STR(355), /*"CAM_CLIP_NEAR"*/ STR(356), /*"CAM_CLIP_FAR"*/ STR(357), /*"CAM_BLADE_AMOUNT"*/ STR(358), /*"CAM_BLADE_ANGLE"*/ STR(359), /*"CAM_LIGHT_MANAGEMENT"*/ STR(360), /*"CAM_TONEMAPPER"*/ STR(361), /*"CAM_EXPOSURE"*/ STR(362), /*"CAM_GAMMA"*/ STR(363), /*"CAM_ROTATE"*/ STR(364), /*"CAM_ROTATE_DISTANCE"*/ STR(365), /*"CAM_ROTATE_ANGLE_XY"*/ STR(366), /*"CAM_ROTATE_ANGLE_Z"*/ STR(367), /*"CAM_SHAKE"*/ STR(368), /*"CAM_SHAKE_MODE"*/ STR(369), /*"CAM_SHAKE_STRENGTH_X"*/ STR(370), /*"CAM_SHAKE_STRENGTH_Y"*/ STR(371), /*"CAM_SHAKE_STRENGTH_Z"*/ STR(372), /*"CAM_SHAKE_SPEED_X"*/ STR(373), /*"CAM_SHAKE_SPEED_Y"*/ STR(374), /*"CAM_SHAKE_SPEED_Z"*/ STR(375), /*"CAM_DOF"*/ STR(376), /*"CAM_DOF_DEPTH"*/ STR(377), /*"CAM_DOF_RANGE"*/ STR(378), /*"CAM_DOF_FADE_SIZE"*/ STR(379), /*"CAM_DOF_BLUR_SIZE"*/ STR(380), /*"CAM_DOF_BLUR_RATIO"*/ STR(381), /*"CAM_DOF_BIAS"*/ STR(382), /*"CAM_DOF_THRESHOLD"*/ STR(383), /*"CAM_DOF_GAIN"*/ STR(384), /*"CAM_DOF_FRINGE"*/ STR(385), /*"CAM_DOF_FRINGE_ANGLE_RED"*/ STR(386), /*"CAM_DOF_FRINGE_ANGLE_GREEN"*/ STR(387), /*"CAM_DOF_FRINGE_ANGLE_BLUE"*/ STR(388), /*"CAM_DOF_FRINGE_RED"*/ STR(389), /*"CAM_DOF_FRINGE_GREEN"*/ STR(390), /*"CAM_DOF_FRINGE_BLUE"*/ STR(391), /*"CAM_BLOOM"*/ STR(392), /*"CAM_BLOOM_THRESHOLD"*/ STR(393), /*"CAM_BLOOM_INTENSITY"*/ STR(394), /*"CAM_BLOOM_RADIUS"*/ STR(395), /*"CAM_BLOOM_RATIO"*/ STR(396), /*"CAM_BLOOM_BLEND"*/ STR(397), /*"CAM_LENS_DIRT"*/ STR(398), /*"CAM_LENS_DIRT_BLOOM"*/ STR(399), /*"CAM_LENS_DIRT_GLOW"*/ STR(400), /*"CAM_LENS_DIRT_RADIUS"*/ STR(401), /*"CAM_LENS_DIRT_INTENSITY"*/ STR(402), /*"CAM_LENS_DIRT_POWER"*/ STR(403), /*"CAM_COLOR_CORRECTION"*/ STR(404), /*"CAM_CONTRAST"*/ STR(405), /*"CAM_BRIGHTNESS"*/ STR(406), /*"CAM_SATURATION"*/ STR(407), /*"CAM_VIBRANCE"*/ STR(408), /*"CAM_COLOR_BURN"*/ STR(409), /*"CAM_GRAIN"*/ STR(410), /*"CAM_GRAIN_STRENGTH"*/ STR(411), /*"CAM_GRAIN_SATURATION"*/ STR(412), /*"CAM_GRAIN_SIZE"*/ STR(413), /*"CAM_VIGNETTE"*/ STR(414), /*"CAM_VIGNETTE_RADIUS"*/ STR(415), /*"CAM_VIGNETTE_SOFTNESS"*/ STR(416), /*"CAM_VIGNETTE_STRENGTH"*/ STR(417), /*"CAM_VIGNETTE_COLOR"*/ STR(418), /*"CAM_CA"*/ STR(419), /*"CAM_CA_BLUR_AMOUNT"*/ STR(420), /*"CAM_CA_DISTORT_CHANNELS"*/ STR(421), /*"CAM_CA_RED_OFFSET"*/ STR(422), /*"CAM_CA_GREEN_OFFSET"*/ STR(423), /*"CAM_CA_BLUE_OFFSET"*/ STR(424), /*"CAM_DISTORT"*/ STR(425), /*"CAM_DISTORT_REPEAT"*/ STR(426), /*"CAM_DISTORT_ZOOM_AMOUNT"*/ STR(427), /*"CAM_DISTORT_AMOUNT"*/ STR(428), /*"CAM_SIZE_USE_PROJECT"*/ STR(429), /*"CAM_SIZE_KEEP_ASPECT_RATIO"*/ STR(430), /*"CAM_WIDTH"*/ STR(431), /*"CAM_HEIGHT"*/ STR(432), /*"BG_IMAGE_SHOW"*/ STR(433), /*"BG_IMAGE_ROTATION"*/ STR(434), /*"BG_SKY_MOON_PHASE"*/ STR(435), /*"BG_SKY_TIME"*/ STR(436), /*"BG_SKY_ROTATION"*/ STR(437), /*"BG_SUNLIGHT_STRENGTH"*/ STR(438), /*"BG_SUNLIGHT_ANGLE"*/ STR(439), /*"BG_TWILIGHT"*/ STR(440), /*"BG_SKY_CLOUDS_SHOW"*/ STR(441), /*"BG_SKY_CLOUDS_SPEED"*/ STR(442), /*"BG_SKY_CLOUDS_HEIGHT"*/ STR(443), /*"BG_SKY_CLOUDS_OFFSET"*/ STR(444), /*"BG_GROUND_SHOW"*/ STR(445), /*"BG_GROUND_SLOT"*/ STR(446), /*"BG_BIOME"*/ STR(447), /*"BG_SKY_COLOR"*/ STR(448), /*"BG_SKY_CLOUDS_COLOR"*/ STR(449), /*"BG_SUNLIGHT_COLOR"*/ STR(450), /*"BG_AMBIENT_COLOR"*/ STR(451), /*"BG_NIGHT_COLOR"*/ STR(452), /*"BG_GRASS_COLOR"*/ STR(453), /*"BG_FOLIAGE_COLOR"*/ STR(454), /*"BG_WATER_COLOR"*/ STR(455), /*"BG_LEAVES_OAK_COLOR"*/ STR(456), /*"BG_LEAVES_SPRUCE_COLOR"*/ STR(457), /*"BG_LEAVES_BIRCH_COLOR"*/ STR(458), /*"BG_LEAVES_JUNGLE_COLOR"*/ STR(459), /*"BG_LEAVES_ACACIA_COLOR"*/ STR(460), /*"BG_LEAVES_DARK_OAK_COLOR"*/ STR(461), /*"BG_LEAVES_MANGROVE_COLOR"*/ STR(462), /*"BG_FOG_SHOW"*/ STR(463), /*"BG_FOG_SKY"*/ STR(464), /*"BG_FOG_CUSTOM_COLOR"*/ STR(465), /*"BG_FOG_COLOR"*/ STR(466), /*"BG_FOG_CUSTOM_OBJECT_COLOR"*/ STR(467), /*"BG_FOG_OBJECT_COLOR"*/ STR(468), /*"BG_FOG_DISTANCE"*/ STR(469), /*"BG_FOG_SIZE"*/ STR(470), /*"BG_FOG_HEIGHT"*/ STR(471), /*"BG_WIND"*/ STR(472), /*"BG_WIND_SPEED"*/ STR(473), /*"BG_WIND_STRENGTH"*/ STR(474), /*"BG_WIND_DIRECTION"*/ STR(475), /*"BG_WIND_DIRECTIONAL_SPEED"*/ STR(476), /*"BG_WIND_DIRECTIONAL_STRENGTH"*/ STR(477), /*"BG_TEXTURE_ANI_SPEED"*/ STR(478), /*"TEXTURE_OBJ"*/ STR(479), /*"TEXTURE_MATERIAL_OBJ"*/ STR(480), /*"TEXTURE_NORMAL_OBJ"*/ STR(481), /*"SOUND_OBJ"*/ STR(482), /*"SOUND_VOLUME"*/ STR(483), /*"SOUND_PITCH"*/ STR(484), /*"SOUND_START"*/ STR(485), /*"SOUND_END"*/ STR(486), /*"TEXT"*/ STR(487), /*"TEXT_FONT"*/ STR(488), /*"TEXT_HALIGN"*/ STR(489), /*"TEXT_VALIGN"*/ STR(490), /*"TEXT_AA"*/ STR(491), /*"CUSTOM_ITEM_SLOT"*/ STR(492), /*"ITEM_SLOT"*/ STR(493), /*"ITEM_NAME"*/ STR(494), /*"PATH_OBJ"*/ STR(495), /*"PATH_OFFSET"*/ STR(496), /*"PATH_POINT_ANGLE"*/ STR(497), /*"PATH_POINT_SCALE"*/ STR(498), /*"IK_TARGET"*/ STR(499), /*"IK_BLEND"*/ STR(500), /*"IK_TARGET_ANGLE"*/ STR(501), /*"IK_ANGLE_OFFSET"*/ STR(502), /*"ROT_TARGET"*/ STR(503), /*"POS_TARGET"*/ STR(504), /*"SCALE_TARGET"*/ STR(505), /*"FLW_ROT_X"*/ STR(506), /*"FLW_ROT_Y"*/ STR(507), /*"FLW_ROT_Z"*/ STR(508), /*"FLW_POS_X"*/ STR(509), /*"FLW_POS_Y"*/ STR(510), /*"FLW_POS_Z"*/ STR(511), /*"FLW_SCALE_X"*/ STR(512), /*"FLW_SCALE_Y"*/ STR(513), /*"FLW_SCALE_Z"*/ STR(514), /*"VISIBLE"*/ STR(515), /*"TRANSITION"*/ STR(516), /*"EASE_IN_X"*/ STR(517), /*"EASE_IN_Y"*/ STR(518), /*"EASE_OUT_X"*/ STR(519), /*"EASE_OUT_Y"*/ STR(520) });
		...
		ds_list_add({ global::temp_type_name_list, /*"char"*/ STR(521), /*"spblock"*/ STR(522), /*"scenery"*/ STR(523), /*"item"*/ STR(524), /*"block"*/ STR(525), /*"bodypart"*/ STR(526), /*"particles"*/ STR(527), /*"text"*/ STR(99), /*"cube"*/ STR(3), /*"cone"*/ STR(528), /*"cylinder"*/ STR(529), /*"sphere"*/ STR(530), /*"surface"*/ STR(531), /*"model"*/ STR(532) });
		global::tl_type_name_list = ds_list_create();
		ds_list_add({ global::tl_type_name_list, /*"char"*/ STR(521), /*"spblock"*/ STR(522), /*"scenery"*/ STR(523), /*"item"*/ STR(524), /*"block"*/ STR(525), /*"bodypart"*/ STR(526), /*"particles"*/ STR(527), /*"text"*/ STR(99), /*"cube"*/ STR(3), /*"cone"*/ STR(528), /*"cylinder"*/ STR(529), /*"sphere"*/ STR(530), /*"surface"*/ STR(531), /*"model"*/ STR(532), /*"camera"*/ STR(120), /*"spotlight"*/ STR(533), /*"pointlight"*/ STR(534), /*"folder"*/ STR(535), /*"background"*/ STR(212), /*"audio"*/ STR(536), /*"path"*/ STR(537), /*"pathpoint"*/ STR(538), /*"shape"*/ STR(539), /*"lightsource"*/ STR(540) });
		global::res_type_name_list = ds_list_create();
		ds_list_add({ global::res_type_name_list, /*"pack"*/ STR(541), /*"packunzipped"*/ STR(542), /*"skin"*/ STR(543), /*"downloadskin"*/ STR(198), /*"itemsheet"*/ STR(544), /*"legacyblocksheet"*/ STR(545), /*"blocksheet"*/ STR(546), /*"scenery"*/ STR(523), /*"fromworld"*/ STR(547), /*"particlesheet"*/ STR(548), /*"texture"*/ STR(549), /*"font"*/ STR(550), /*"sound"*/ STR(551), /*"model"*/ STR(532) });
		...
		log({ /*"Transitions OK"*/ STR(586) });
		global::videotemplate_list = ds_list_create();
		ds_list_add({ global::videotemplate_list, new_videotemplate(/*"avatar"*/ STR(587), IntType(512), IntType(512)), new_videotemplate(/*"hd_720p"*/ STR(588), IntType(1280), IntType(720)), new_videotemplate(/*"fhd_1080p"*/ STR(589), IntType(1920), IntType(1080)), new_videotemplate(/*"qhd_1440p"*/ STR(590), IntType(2560), IntType(1440)), new_videotemplate(/*"uhd_4k"*/ STR(591), IntType(3840), IntType(2160)), new_videotemplate(/*"hd_720p_cinematic"*/ STR(592), IntType(1680), IntType(720)), new_videotemplate(/*"fhd_1080p_cinematic"*/ STR(593), IntType(2560), IntType(1080)), new_videotemplate(/*"qhd_1440p_cinematic"*/ STR(594), IntType(3440), IntType(1440)), new_videotemplate(/*"uhd_4k_cinematic"*/ STR(595), IntType(5120), IntType(2160)) });
		global::videoquality_list = ds_list_create();
		ds_list_add({ global::videoquality_list, new_videoquality(/*"best"*/ STR(596), IntType(5000000)), new_videoquality(/*"high"*/ STR(597), IntType(2500000)), new_videoquality(/*"medium"*/ STR(598), IntType(1200000)), new_videoquality(/*"low"*/ STR(599), IntType(700000)), new_videoquality(/*"verylow"*/ STR(600), IntType(350000)) });
		...
		ds_list_add({ global::biome_list, new_biome(/*"custom"*/ STR(601), IntType(0), IntType(0), true, c_plains_biome_grass, c_plains_biome_foliage, c_plains_biome_water, null_) });
		...
		ds_list_add({ global::minecraft_color_name_list, /*"white"*/ STR(602), /*"orange"*/ STR(603), /*"magenta"*/ STR(604), /*"light_blue"*/ STR(605), /*"yellow"*/ STR(606), /*"lime"*/ STR(607), /*"pink"*/ STR(608), /*"gray"*/ STR(609), /*"light_gray"*/ STR(610), /*"cyan"*/ STR(611), /*"purple"*/ STR(612), /*"blue"*/ STR(613), /*"brown"*/ STR(614), /*"green"*/ STR(615), /*"red"*/ STR(616), /*"black"*/ STR(617) });
		...
		ds_list_add({ global::blend_mode_list, /*"normal"*/ STR(618), /*"add"*/ STR(619), /*"subtract"*/ STR(620), /*"multiply"*/ STR(621), /*"screen"*/ STR(622) });
		global::blend_mode_map = ds_map_create();
		ds_map_add(global::blend_mode_map, /*"normal"*/ STR(618), bm_normal);
		ds_map_add(global::blend_mode_map, /*"add"*/ STR(619), bm_add);
		ds_map_add(global::blend_mode_map, /*"subtract"*/ STR(620), bm_subtract);
		ds_map_add(global::blend_mode_map, /*"multiply"*/ STR(621), ArrType::From({ bm_zero, bm_src_color }));
		ds_map_add(global::blend_mode_map, /*"screen"*/ STR(622), ArrType::From({ bm_one, bm_inv_src_color }));
		...
		ds_list_add({ global::render_pass_list, /*"combined"*/ STR(623), /*"diffuse"*/ STR(624), /*"specular"*/ STR(625), /*"ao"*/ STR(626), /*"shadows"*/ STR(123), /*"indirect"*/ STR(125), /*"indirectshadows"*/ STR(627), /*"reflections"*/ STR(126), /*"depth"*/ STR(628), /*"normal"*/ STR(618), /*"material"*/ STR(629) });
	}
	...
	{
		sStr(recent_display_mode) = /*"grid"*/ STR(630);
	...
	void app_startup_themes(ScopeAny self)
	{
		...
		{
			self->name = /*"light"*/ STR(631);
			self->dark = false;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DB3030"*/ STR(632)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D85B00"*/ STR(633)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D68E02"*/ STR(634)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"34A100"*/ STR(635)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"0D8E41"*/ STR(636)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"048E8E"*/ STR(637)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"2144F1"*/ STR(638)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"982BCB"*/ STR(639)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"E93983"*/ STR(640)));
			self->level_top = hex_to_color(/*"F7FAFC"*/ STR(641));
			self->level_middle = hex_to_color(/*"ECEFF1"*/ STR(642));
			self->level_bottom = hex_to_color(/*"D7DFE2"*/ STR(643));
			self->viewport_top = hex_to_color(/*"F0FFFF"*/ STR(644));
			self->viewport_bottom = hex_to_color(/*"B5E8F2"*/ STR(645));
			self->text_main = hex_to_color(/*"0D1214"*/ STR(646));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"FFFFFF"*/ STR(647));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .15;
			self->red_error = hex_to_color(/*"FF1D0F"*/ STR(648));
			self->yellow_warning = hex_to_color(/*"FFC01E"*/ STR(649));
			self->green_success = hex_to_color(/*"61C159"*/ STR(650));
			self->red = hex_to_color(/*"FF5656"*/ STR(651));
			self->green = hex_to_color(/*"4AB758"*/ STR(652));
			self->blue = hex_to_color(/*"1370FB"*/ STR(653));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(654));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(655));
			self->yellow = hex_to_color(/*"F4CC5D"*/ STR(656));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(657));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"158AF5"*/ STR(658));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64A56B"*/ STR(659));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"D09522"*/ STR(660));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF1D0F"*/ STR(648));
		}
		
		global::theme_dark = (new obj_theme)->id;
		withOne (obj_theme, global::theme_dark, self->id)
		{
			self->name = /*"dark"*/ STR(661);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(662)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFA360"*/ STR(663)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFF065"*/ STR(664)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"8BFF6D"*/ STR(665)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"4EF390"*/ STR(666)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"49EED9"*/ STR(667)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"98BBFF"*/ STR(668)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(669)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(670)));
			self->level_top = hex_to_color(/*"37444A"*/ STR(671));
			self->level_middle = hex_to_color(/*"2B373D"*/ STR(672));
			self->level_bottom = hex_to_color(/*"18242A"*/ STR(673));
			self->viewport_top = hex_to_color(/*"2B373D"*/ STR(672));
			self->viewport_bottom = hex_to_color(/*"839096"*/ STR(674));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(647));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"000000"*/ STR(675));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .25;
			self->red_error = hex_to_color(/*"FF7A72"*/ STR(676));
			self->yellow_warning = hex_to_color(/*"FFEB36"*/ STR(677));
			self->green_success = hex_to_color(/*"64E879"*/ STR(678));
			self->red = hex_to_color(/*"FF5656"*/ STR(651));
			self->green = hex_to_color(/*"23FF88"*/ STR(679));
			self->blue = hex_to_color(/*"1370FB"*/ STR(653));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(654));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(655));
			self->yellow = hex_to_color(/*"FFD969"*/ STR(680));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(657));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"7EC1FF"*/ STR(681));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64E879"*/ STR(678));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"FFEB36"*/ STR(677));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF7A72"*/ STR(676));
		}
		
		global::theme_darker = (new obj_theme)->id;
		withOne (obj_theme, global::theme_darker, self->id)
		{
			self->name = /*"darker"*/ STR(682);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(662)));
			...
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(669)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(670)));
			self->level_top = hex_to_color(/*"1C1C1C"*/ STR(683));
			self->level_middle = hex_to_color(/*"101010"*/ STR(684));
			self->level_bottom = hex_to_color(/*"050505"*/ STR(685));
			self->viewport_top = hex_to_color(/*"484848"*/ STR(686));
			self->viewport_bottom = hex_to_color(/*"2B2B2B"*/ STR(687));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(647));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
	...
	void app_update_animate(ScopeAny self)
	{
		...
		if (bgobject > 0)
		{
			...
			if (sVar(background_biome) == /*"custom"*/ STR(601) || sVar(background_biome_prev) != sVar(background_biome))
			{
		...
		sInt(background_sky_color_final) = merge_color((IntType)(sVar(background_sky_color)), hex_to_color(/*"020204"*/ STR(689)), background_sky_night_alpha());
	...
	void app_update_caption()
	{
		if (global::_app->project_name != /*""*/ STR(0))
			window_set_caption(global::_app->project_name + string_repeat(/*" * "*/ STR(690), global::_app->project_changed) + /*" - Mine-imator"*/ STR(691));
		else
			window_set_caption(/*"Mine-imator"*/ STR(19));
	...
	void app_update_keybinds()
	{
		...
		for (IntType i = IntType(0); i < e_keybind_amount; i++)
		{
			...
			check = keybind_check(obj, /*"keyboard_check"*/ STR(692));
			idBool(obj, released) = false;
			if (idVar(obj, active) > 0)
				idBool(obj, released) = keybind_check(obj, /*"keyboard_check_released"*/ STR(693));
			idBool(obj, pressed) = keybind_check(obj, /*"keyboard_check_pressed"*/ STR(694));
	...
	void app_update_keyboard(ScopeAny self)
	{
		...
		if (sStr(window_state) == /*""*/ STR(0) && (sVar(window_busy) == /*""*/ STR(0) || sStr(settings_menu_name) == /*"colorpicker"*/ STR(695)) && !sBool(textbox_isediting))
		{
