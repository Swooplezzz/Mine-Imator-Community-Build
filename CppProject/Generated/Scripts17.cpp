...
namespace CppProject
{
	...
	void app_startup_interface_tabs()
	{
		...
		withOne (obj_tab, global::_app->frame_editor, global::_app->id)
		{
			...
			self->constraints = tab_add_category(self, /*"frameeditorconstraints"*/ STR(241), icons_JOINT_SMALL, ID_tab_frame_editor_constraints, false);
			...
			self->material = tab_add_category(self, /*"frameeditormaterial"*/ STR(242), ArrType::From({ icons_SPHERE_MATERIAL_SMALL, icons_SPHERE_MATERIAL_SMALL__DARK }), ID_tab_frame_editor_material, false);
			...
			self->particles = tab_add_category(self, /*"frameeditorparticles"*/ STR(243), icons_PARTICLES_SMALL, ID_tab_frame_editor_particles, false);
			...
			self->light = tab_add_category(self, /*"frameeditorlight"*/ STR(244), icons_LIGHT_POINT_SMALL, ID_tab_frame_editor_light, false);
			...
			self->camera = tab_add_category(self, /*"frameeditorcamera"*/ STR(245), icons_CAMERA_SMALL, ID_tab_frame_editor_camera, false);
			...
			self->sound = tab_add_category(self, /*"frameeditorsound"*/ STR(246), icons_VOLUME_SMALL, ID_tab_frame_editor_sound, true);
			...
			self->text = tab_add_category(self, /*"frameeditortext"*/ STR(247), icons_TEXT_SMALL, ID_tab_frame_editor_text, false);
			withOne (Object, self->text, self->id)
				sInt(tbx_text) = new_textbox(false, IntType(0), /*""*/ STR(0));
			
			self->item = tab_add_category(self, /*"frameeditoritem"*/ STR(248), icons_ITEM_SMALL, ID_tab_frame_editor_item, false);
			...
			self->keyframe = tab_add_category(self, /*"frameeditorkeyframe"*/ STR(249), icons_KEYFRAME_SMALL, ID_tab_frame_editor_keyframe, false);
		...
		{
			self->program = tab_add_category(self, /*"settingsprogram"*/ STR(250), icons_SETTINGS_SMALL, ID_tab_settings_program, false);
			...
			self->interface_ = tab_add_category(self, /*"settingsinterface"*/ STR(251), icons_BRUSH_SMALL, ID_tab_settings_interface, false);
			self->controls = tab_add_category(self, /*"settingscontrols"*/ STR(252), icons_KEYBOARD_SMALL, ID_tab_settings_controls, false);
