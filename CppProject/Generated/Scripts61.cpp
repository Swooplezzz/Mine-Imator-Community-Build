...
namespace CppProject
{
	...
	void tab_properties_project(ScopeAny self)
	{
		...
		draw_meter(self, /*"projecttempo"*/ STR(3410), sVar(dx), sVar(dy), sVar(dw), sVar(project_tempo), IntType(1), IntType(128), IntType(24), IntType(1), ObjType(obj_category, idInt(sVar(tab), project))->tbx_tempo, ID_action_project_tempo, /*"projecttempotip"*/ STR(3411));
		tab_next(self);
	}
