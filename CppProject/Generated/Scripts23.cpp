...
namespace CppProject
{
	...
	{
		if (block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"snowy"*/ STR(928)) == /*"true"*/ STR(759))
			return IntType(0);
		StringType snowy = /*"false"*/ STR(760);
		if (!sBool(build_edge_zp))
		{
			...
			if (otherblock != null_ && idVar(otherblock, type) == /*"snow"*/ STR(929))
				snowy = /*"true"*/ STR(759);
		}
		sReal(block_state_id_current) = block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"snowy"*/ STR(928), snowy);
		return IntType(0);
	}
	...
	RealType block_set_stairs(ScopeAny self)
	{
		...
		StringType shape;
		VarType half, facing;
		shape = /*"straight"*/ STR(930);
		half = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"half"*/ STR(901));
		facing = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"facing"*/ STR(886));
		if (!sBool(build_edge_xp) && (facing == /*"east"*/ STR(879) || facing == /*"west"*/ STR(880)))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x) + IntType(1), sInt(build_pos_y), sInt(build_pos_z));
			if (block != null_ && idVar(block, type) == /*"stairs"*/ STR(931))
			{
				IntType stateid = builder_get_state_id(self, sInt(build_pos_x) + IntType(1), sInt(build_pos_y), sInt(build_pos_z));
				if (block_get_state_id_value(block, stateid, /*"half"*/ STR(901)) == half)
				{
					VarType otherfacing = block_get_state_id_value(block, stateid, /*"facing"*/ STR(886));
					if (facing == /*"east"*/ STR(879))
					{
						if (otherfacing == /*"south"*/ STR(881))
							shape = /*"outer_right"*/ STR(932);
						else
							if (otherfacing == /*"north"*/ STR(882))
								shape = /*"outer_left"*/ STR(933);
						
					}
					else
					{
						if (otherfacing == /*"south"*/ STR(881))
							shape = /*"inner_left"*/ STR(934);
						else
							if (otherfacing == /*"north"*/ STR(882))
								shape = /*"inner_right"*/ STR(935);
		...
		if (!sBool(build_edge_xn) && (facing == /*"east"*/ STR(879) || facing == /*"west"*/ STR(880)))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x) - IntType(1), sInt(build_pos_y), sInt(build_pos_z));
			if (block != null_ && idVar(block, type) == /*"stairs"*/ STR(931))
			{
		...
		if (!sBool(build_edge_yp) && (facing == /*"south"*/ STR(881) || facing == /*"north"*/ STR(882)))
		{
			...
			if (block != null_ && idVar(block, type) == /*"stairs"*/ STR(931))
			{
				...
				if (block_get_state_id_value(block, stateid, /*"half"*/ STR(901)) == half)
				{
					...
					{
						if (otherfacing == /*"east"*/ STR(879))
							shape = /*"outer_left"*/ STR(933);
						else
							if (otherfacing == /*"west"*/ STR(880))
								shape = /*"outer_right"*/ STR(932);
		...
		if (!sBool(build_edge_yn) && (facing == /*"south"*/ STR(881) || facing == /*"north"*/ STR(882)))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) - IntType(1), sInt(build_pos_z));
			if (block != null_ && idVar(block, type) == /*"stairs"*/ STR(931))
			{
	...
	RealType block_set_tripwire(ScopeAny self)
	{
		...
		{
			IntType block = builder_get_block(self, sInt(build_pos_x) + IntType(1), sInt(build_pos_y), sInt(build_pos_z));
			if (block != null_ && (idVar(block, name) == /*"tripwire"*/ STR(936) || idVar(block, name) == /*"tripwire_hook"*/ STR(937)))
				east = /*"true"*/ STR(759);
		}
	...
	RealType block_set_twisting_vines(ScopeAny self)
	{
		if (!sBool(build_edge_zn))
		{
			...
			if (block == null_ || idVar(block, type) != /*"twisting_vines"*/ STR(938))
				global::vertex_wave_zmin = sInt(block_pos_z);
		}
		else
			global::vertex_wave_zmin = sInt(block_pos_z);
		
		if ((sBool(builder_scenery) && !sBool(builder_scenery_legacy)) || block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"variant"*/ STR(797)) == /*"twisting_vines_plant"*/ STR(939))
			return IntType(0);
		if (sInt(build_pos_z) != (sInt(build_size_z) - IntType(1)))
			sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"variant"*/ STR(797), /*"twisting_vines_plant"*/ STR(939) }));
		return IntType(0);
	}
	
	RealType block_set_vine(ScopeAny self)
	{
		StringType up = /*"false"*/ STR(760);
		if (!sBool(build_edge_zp))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y), sInt(build_pos_z) + IntType(1));
		...
		sReal(block_state_id_current) = block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"up"*/ STR(898), up);
		return IntType(0);
	}
	...
	RealType block_set_wall(ScopeAny self)
	{
		...
		states = ArrType::From({ /*"none"*/ STR(888), /*"low"*/ STR(596), /*"tall"*/ STR(940) });
		tall = false;
		i = IntType(0);
		if (!sBool(build_edge_zp))
		{
			...
			if (!sBool(build_edge_xp) && (i == IntType(0) || (i == IntType(1) && east > 0)))
			{
				...
				if (block != null_)
				{
					if (idVar(block, type) == idVar(sInt(block_current), type) || (sInt(block_face_min_depth_xp) == e_block_depth_DEPTH0 && sBool(block_face_full_xp)))
						...
						{
							VarType facing = block_get_state_id_value(block, builder_get_state_id(self, sInt(build_pos_x) + IntType(1), sInt(build_pos_y), sInt(build_pos_z) + i), /*"facing"*/ STR(886));
			...
			if (!sBool(build_edge_yp) && (i == IntType(0) || (i == IntType(1) && south > 0)))
			{
				...
				if (block != null_)
				{
					if (idVar(block, type) == idVar(sInt(block_current), type) || (sInt(block_face_min_depth_yp) == e_block_depth_DEPTH0 && sBool(block_face_full_yp)))
						...
						if (idVar(block, type) == /*"fence_gate"*/ STR(916))
						{
							VarType facing = block_get_state_id_value(block, builder_get_state_id(self, sInt(build_pos_x), sInt(build_pos_y) + IntType(1), sInt(build_pos_z) + i), /*"facing"*/ STR(886));
		...
		sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"variant"*/ STR(797), variant, /*"east"*/ STR(879), states.Value(east), /*"west"*/ STR(880), states.Value(west), /*"south"*/ STR(881), states.Value(south), /*"north"*/ STR(882), states.Value(north), /*"up"*/ STR(898), up }));
		return IntType(0);
	}
	...
	RealType block_set_weeping_vines(ScopeAny self)
	{
		...
		{
			IntType block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y), sInt(build_pos_z) + IntType(1));
			if (block == null_ || idVar(block, type) != /*"weeping_vines"*/ STR(941))
				global::vertex_wave_zmax = sInt(block_pos_z) + block_size_;
		}
		else
			global::vertex_wave_zmax = sInt(block_pos_z) + block_size_;
		
		if ((sBool(builder_scenery) && !sBool(builder_scenery_legacy)) || block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"variant"*/ STR(797)) == /*"weeping_vines_plant"*/ STR(942))
			return IntType(0);
		if (sInt(build_pos_z) == IntType(0))
			sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"variant"*/ STR(797), /*"weeping_vines"*/ STR(941) }));
		else
			sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"variant"*/ STR(797), /*"weeping_vines_plant"*/ STR(942) }));
	...
	VarType block_texture_get_blend(VarType texname, VarType res)
	{
		...
		if (!is_undefined(col))
		{
			...
			switch (StringType(col).id)
			{
				...
				case 848: // spruce_leaves
				{
					return idVar(res, color_leaves_spruce);
				}
				case 849: // birch_leaves
				{
	...
	void block_tile_entity_banner(Scope<obj_builder_thread> self, IntType map)
	{
		...
		patterns = DsMap(map).Value(/*"Patterns"*/ STR(947));
		if (ds_map_exists(map, /*"Base"*/ STR(948)))
		{
			base = DsMap(map).Value(/*"Base"*/ STR(948));
			legacy = true;
		}
		else
		{
		...
		if (ds_list_valid(patterns))
		{
			for (IntType i = IntType(0); i < ds_list_size((IntType)(patterns)); i++)
			{
				...
				pattern = value_get_string({ DsMap(patternmap).Value(/*"Pattern"*/ STR(949)), DsList(global::minecraft_pattern_short_list).Value(IntType(1)) });
				color = value_get_real({ DsMap(patternmap).Value(/*"Color"*/ STR(950)), IntType(0) });
		...
		{
			VarType color = block_get_state_id_value(self->block_current, self->block_state_id_current, /*"color"*/ STR(900));
	...
	{
		VarType colorid = DsMap(map).Value(/*"color"*/ STR(900));
		if (!is_real(colorid))
			return IntType(0);
		if (is_undefined(colorid) || colorid >= ds_list_size(global::minecraft_color_list))
			return IntType(0);
		RealType newstate = block_set_state_id_value(self->block_current, self->block_state_id_current, /*"color"*/ STR(900), DsList(global::minecraft_color_name_list).Value(colorid));
	...
	RealType block_tile_entity_sign(Scope<obj_builder_thread> self, IntType map)
	{
		...
		IntType color;
		text = /*""*/ STR(0);
		colorname = value_get_string({ DsMap(map).Value(/*"Color"*/ STR(950)), /*"black"*/ STR(614) });
		...
		{
			VarType line = DsMap(map).Value(/*"Text"*/ STR(951) + string(i + IntType(1)));
			if (!is_string(line))
				return IntType(0);
			...
			if (ds_map_valid(textmap))
			{
				...
				if (ds_list_valid(DsMap(textmap).Value(/*"extra"*/ STR(952))) && ds_list_size((IntType)(DsMap(textmap).Value(/*"extra"*/ STR(952)))) > IntType(0))
				{
					IntType extramap = ds_list_find_value(DsMap(textmap).Value(/*"extra"*/ STR(952)), IntType(0));
	...
	RealType block_tile_entity_skull(Scope<obj_builder_thread> self, VarType map)
	{
		...
		VarType texlist;
		mapname = /*"Owner"*/ STR(954);
		if (!ds_map_valid(DsMap(map).Value(mapname)))
		{
			mapname = /*"SkullOwner"*/ STR(955);
			if (!ds_map_valid(DsMap(map).Value(mapname)))
				return IntType(0);
		}
		map = DsMap(map).Value(mapname);
		ownerid = string(DsMap(map).Value(/*"Id"*/ STR(956)));
		map = DsMap(map).Value(/*"Properties"*/ STR(957));
		if (!ds_map_valid(map))
			return IntType(0);
		texlist = DsMap(map).Value(/*"textures"*/ STR(824));
		if (!ds_list_valid(texlist))
			return IntType(0);
		map = DsList(texlist).Value(IntType(0));
		texvalue = base64_decode(DsMap(map).Value(/*"Value"*/ STR(958)));
		map = json_decode(texvalue);
		if (!ds_map_valid(map))
			return IntType(0);
		if (!ds_map_valid(DsMap(map).Value(/*"textures"*/ STR(824))))
			return IntType(0);
		map = DsMap(map).Value(/*"textures"*/ STR(824));
		map = DsMap(map).Value(/*"SKIN"*/ STR(959));
		texurl = DsMap(map).Value(/*"url"*/ STR(960)).Str();
	...
	RealType builder_generate(ScopeAny self)
	{
		...
		if (builder_get_waterlogged(Scope<obj_builder_thread>(self), sInt(build_pos_x), sInt(build_pos_y), sInt(build_pos_z)))
		{
			...
			sInt(block_pos_y) = sInt(build_pos_y) * block_size_;
			sInt(block_pos_z) = sInt(build_pos_z) * block_size_;
			sInt(block_current) = DsMap(ObjType(obj_minecraft_assets, global::mc_assets)->block_name_map).Value(/*"water"*/ STR(799));
