...
namespace CppProject
{
	...
	{
		log({ /*"Create vertex format"*/ STR(3808) });
		vertex_format_begin();
	...
	void view_area_draw(ScopeAny self)
	{
		...
		if (sVar(window_busy) == /*"viewresizehor"*/ STR(3809) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3810))
		{
		...
		if (sVar(window_busy) == /*"viewresizever"*/ STR(3811) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3810))
		{
		...
		if (sVar(window_busy) == /*"viewresizeboth"*/ STR(3810))
		{
		...
		if (sVar(window_busy) == /*"viewresizesplithor"*/ STR(3812))
		{
			sInt(mouse_cursor) = cr_size_we;
		...
		if (sVar(window_busy) == /*"viewresizesplitver"*/ STR(3813))
		{
			sInt(mouse_cursor) = cr_size_ns;
