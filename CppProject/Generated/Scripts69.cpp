...
namespace CppProject
{
	...
	{
		log({ /*"Create vertex format"*/ STR(3819) });
		vertex_format_begin();
	...
	void view_area_draw(ScopeAny self)
	{
		...
		if (sVar(window_busy) == /*"viewresizehor"*/ STR(3820) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3821))
		{
		...
		if (sVar(window_busy) == /*"viewresizever"*/ STR(3822) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3821))
		{
		...
		if (sVar(window_busy) == /*"viewresizeboth"*/ STR(3821))
		{
		...
		if (sVar(window_busy) == /*"viewresizesplithor"*/ STR(3823))
		{
			sInt(mouse_cursor) = cr_size_we;
		...
		if (sVar(window_busy) == /*"viewresizesplitver"*/ STR(3824))
		{
			sInt(mouse_cursor) = cr_size_ns;
