...
namespace CppProject
{
	...
	{
		log({ /*"Create vertex format"*/ STR(3837) });
		vertex_format_begin();
	...
	void view_area_draw(ScopeAny self)
	{
		...
		if (sVar(window_busy) == /*"viewresizehor"*/ STR(3838) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3839))
		{
		...
		if (sVar(window_busy) == /*"viewresizever"*/ STR(3840) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3839))
		{
		...
		if (sVar(window_busy) == /*"viewresizeboth"*/ STR(3839))
		{
		...
		if (sVar(window_busy) == /*"viewresizesplithor"*/ STR(3841))
		{
			sInt(mouse_cursor) = cr_size_we;
		...
		if (sVar(window_busy) == /*"viewresizesplitver"*/ STR(3842))
		{
			sInt(mouse_cursor) = cr_size_ns;
