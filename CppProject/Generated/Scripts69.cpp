...
namespace CppProject
{
	...
	{
		log({ /*"Create vertex format"*/ STR(3795) });
		vertex_format_begin();
	...
	void view_area_draw(ScopeAny self)
	{
		...
		if (sVar(window_busy) == /*"viewresizehor"*/ STR(3796) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3797))
		{
		...
		if (sVar(window_busy) == /*"viewresizever"*/ STR(3798) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3797))
		{
		...
		if (sVar(window_busy) == /*"viewresizeboth"*/ STR(3797))
		{
		...
		if (sVar(window_busy) == /*"viewresizesplithor"*/ STR(3799))
		{
			sInt(mouse_cursor) = cr_size_we;
		...
		if (sVar(window_busy) == /*"viewresizesplitver"*/ STR(3800))
		{
			sInt(mouse_cursor) = cr_size_ns;
