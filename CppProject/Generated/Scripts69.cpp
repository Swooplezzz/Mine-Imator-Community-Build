...
namespace CppProject
{
	...
	{
		log({ /*"Create vertex format"*/ STR(3823) });
		vertex_format_begin();
	...
	void view_area_draw(ScopeAny self)
	{
		...
		if (sVar(window_busy) == /*"viewresizehor"*/ STR(3824) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3825))
		{
		...
		if (sVar(window_busy) == /*"viewresizever"*/ STR(3826) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3825))
		{
		...
		if (sVar(window_busy) == /*"viewresizeboth"*/ STR(3825))
		{
		...
		if (sVar(window_busy) == /*"viewresizesplithor"*/ STR(3827))
		{
			sInt(mouse_cursor) = cr_size_we;
		...
		if (sVar(window_busy) == /*"viewresizesplitver"*/ STR(3828))
		{
			sInt(mouse_cursor) = cr_size_ns;
