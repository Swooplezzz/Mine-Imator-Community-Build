...
namespace CppProject
{
	...
	RealType debug_info_draw(ScopeAny self)
	{
		...
		StringType nodox_project_file = string_replace(sVar(project_file), string(environment_get_variable(/*"USERPROFILE"*/ STR(1074))), nodox_userprofile);
		StringType nodox_project_folder = string_replace(sStr(project_folder), string(environment_get_variable(/*"USERPROFILE"*/ STR(1074))), nodox_userprofile);
		StringType nodox_working_directory = string_replace(gmlGlobal::working_directory, string(environment_get_variable(/*"USERPROFILE"*/ STR(1074))), nodox_userprofile);
		StringType nodox_file_directory = string_replace(file_directory, string(environment_get_variable(/*"USERPROFILE"*/ STR(1074))), nodox_userprofile);
		str += /*"Project: \n"*/ STR(1077);
		str += /*"======================================= \n"*/ STR(1062);
		str += /*"project_file: "*/ STR(1078) + nodox_project_file + /*" \n"*/ STR(1064);
		str += /*"project_folder: "*/ STR(1079) + nodox_project_folder + /*" \n"*/ STR(1064);
		str += /*"working_directory: "*/ STR(1080) + nodox_working_directory + /*" \n"*/ STR(1064);
		str += /*"file_directory: "*/ STR(1081) + nodox_file_directory + /*" \n"*/ STR(1064);
		str += /*"\n"*/ STR(710);
