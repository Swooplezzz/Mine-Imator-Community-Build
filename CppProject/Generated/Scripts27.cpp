...
namespace CppProject
{
	...
	RealType debug_info_draw(ScopeAny self)
	{
		...
		str += /*"\n"*/ STR(711);
		StringType userprofile = string_replace_all(string(environment_get_variable(/*"USERPROFILE"*/ STR(1075))), /*"/"*/ STR(20), /*"\\"*/ STR(1076));
		StringType nodox_userprofile = string_replace_all(userprofile, string(environment_get_variable(/*"USERNAME"*/ STR(1077))), /*"?????"*/ STR(1078));
		StringType nodox_project_file = string_replace_all(sVar(project_file), /*"/"*/ STR(20), /*"\\"*/ STR(1076));
		StringType nodox_project_folder = string_replace_all(sStr(project_folder), /*"/"*/ STR(20), /*"\\"*/ STR(1076));
		StringType nodox_working_directory = string_replace_all(gmlGlobal::working_directory, /*"/"*/ STR(20), /*"\\"*/ STR(1076));
		StringType nodox_file_directory = string_replace_all(file_directory, /*"/"*/ STR(20), /*"\\"*/ STR(1076));
		str += /*"Project: \n"*/ STR(1079);
		str += /*"======================================= \n"*/ STR(1063);
		str += /*"project_file: "*/ STR(1080) + string_replace_all(nodox_project_file, userprofile, nodox_userprofile) + /*" \n"*/ STR(1065);
		str += /*"project_folder: "*/ STR(1081) + string_replace_all(nodox_project_folder, userprofile, nodox_userprofile) + /*" \n"*/ STR(1065);
		str += /*"working_directory: "*/ STR(1082) + string_replace_all(nodox_working_directory, userprofile, nodox_userprofile) + /*" \n"*/ STR(1065);
		str += /*"file_directory: "*/ STR(1083) + string_replace_all(nodox_file_directory, userprofile, nodox_userprofile) + /*" \n"*/ STR(1065);
		str += /*"\n"*/ STR(711);
