/*
	...
	[ Generated on 2023.07.16 06:35:43 ]
*/
...
namespace CppProject
{
	...
	void render_high_volume_fog(VarType prevsurf, BoolType glowfalloff)
	{
	}
	...
	RealType render_set_texture(VarType tex, StringType type)
	{
		...
		sampler = DsMap(idInt(global::render_shader_obj, sampler_map)).Value(/*"uTexture"*/ STR(1903) + type);
		scalex = IntType(1);
		scaley = IntType(1);
