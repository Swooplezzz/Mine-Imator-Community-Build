...
namespace CppProject
{
	...
	void app_startup_lists(ScopeAny self)
	{
		...
		ds_list_add({ global::temp_type_name_list, /*"char"*/ STR(548), /*"spblock"*/ STR(549), /*"scenery"*/ STR(550), /*"item"*/ STR(551), /*"block"*/ STR(4), /*"bodypart"*/ STR(552), /*"particles"*/ STR(553), /*"text"*/ STR(104), /*"cube"*/ STR(3), /*"cone"*/ STR(554), /*"cylinder"*/ STR(555), /*"sphere"*/ STR(556), /*"surface"*/ STR(557), /*"model"*/ STR(8) });
		global::tl_type_name_list = ds_list_create();
		ds_list_add({ global::tl_type_name_list, /*"char"*/ STR(548), /*"spblock"*/ STR(549), /*"scenery"*/ STR(550), /*"item"*/ STR(551), /*"block"*/ STR(4), /*"bodypart"*/ STR(552), /*"particles"*/ STR(553), /*"text"*/ STR(104), /*"cube"*/ STR(3), /*"cone"*/ STR(554), /*"cylinder"*/ STR(555), /*"sphere"*/ STR(556), /*"surface"*/ STR(557), /*"model"*/ STR(8), /*"camera"*/ STR(126), /*"spotlight"*/ STR(558), /*"pointlight"*/ STR(559), /*"folder"*/ STR(560), /*"background"*/ STR(225), /*"audio"*/ STR(561), /*"path"*/ STR(562), /*"pathpoint"*/ STR(563), /*"shape"*/ STR(564), /*"lightsource"*/ STR(565) });
		global::res_type_name_list = ds_list_create();
		ds_list_add({ global::res_type_name_list, /*"pack"*/ STR(566), /*"packunzipped"*/ STR(567), /*"skin"*/ STR(568), /*"downloadskin"*/ STR(210), /*"itemsheet"*/ STR(569), /*"legacyblocksheet"*/ STR(570), /*"blocksheet"*/ STR(571), /*"scenery"*/ STR(550), /*"fromworld"*/ STR(572), /*"particlesheet"*/ STR(573), /*"texture"*/ STR(574), /*"font"*/ STR(575), /*"sound"*/ STR(576), /*"model"*/ STR(8) });
		global::transition_list = ds_list_create();
		ds_list_add({ global::transition_list, /*"linear"*/ STR(577), /*"instant"*/ STR(578), /*"bezier"*/ STR(579), /*"easeinquad"*/ STR(580), /*"easeoutquad"*/ STR(581), /*"easeinoutquad"*/ STR(582), /*"easeincubic"*/ STR(583), /*"easeoutcubic"*/ STR(584), /*"easeinoutcubic"*/ STR(585), /*"easeinquart"*/ STR(586), /*"easeoutquart"*/ STR(587), /*"easeinoutquart"*/ STR(588), /*"easeinquint"*/ STR(589), /*"easeoutquint"*/ STR(590), /*"easeinoutquint"*/ STR(591), /*"easeinsine"*/ STR(592), /*"easeoutsine"*/ STR(593), /*"easeinoutsine"*/ STR(594), /*"easeinexpo"*/ STR(595), /*"easeoutexpo"*/ STR(596), /*"easeinoutexpo"*/ STR(597), /*"easeincirc"*/ STR(598), /*"easeoutcirc"*/ STR(599), /*"easeinoutcirc"*/ STR(600), /*"easeinelastic"*/ STR(601), /*"easeoutelastic"*/ STR(602), /*"easeinoutelastic"*/ STR(603), /*"easeinback"*/ STR(604), /*"easeoutback"*/ STR(605), /*"easeinoutback"*/ STR(606), /*"easeinbounce"*/ STR(607), /*"easeoutbounce"*/ STR(608), /*"easeinoutbounce"*/ STR(609) });
		global::transition_list_order = ds_list_create();
		for (IntType i = IntType(0); i < ds_list_size(global::transition_list); i++)
			if (!string_contains(DsList(global::transition_list).Value(i), /*"ease"*/ STR(610)))
				ds_list_add({ global::transition_list_order, DsList(global::transition_list).Value(i) });
		for (IntType i = IntType(0); i < ds_list_size(global::transition_list); i++)
			if (string_contains(DsList(global::transition_list).Value(i), /*"easein"*/ STR(611)) && !string_contains(DsList(global::transition_list).Value(i), /*"easeinout"*/ STR(612)))
				ds_list_add({ global::transition_list_order, DsList(global::transition_list).Value(i) });
		for (IntType i = IntType(0); i < ds_list_size(global::transition_list); i++)
			if (string_contains(DsList(global::transition_list).Value(i), /*"easeout"*/ STR(613)))
				ds_list_add({ global::transition_list_order, DsList(global::transition_list).Value(i) });
		for (IntType i = IntType(0); i < ds_list_size(global::transition_list); i++)
			if (string_contains(DsList(global::transition_list).Value(i), /*"easeinout"*/ STR(612)))
				ds_list_add({ global::transition_list_order, DsList(global::transition_list).Value(i) });
		log({ /*"Make transitions"*/ STR(614) });
		...
		log({ /*"Transitions OK"*/ STR(615) });
		global::videotemplate_list = ds_list_create();
		ds_list_add({ global::videotemplate_list, new_videotemplate(/*"avatar"*/ STR(616), IntType(512), IntType(512)), new_videotemplate(/*"hd_720p"*/ STR(617), IntType(1280), IntType(720)), new_videotemplate(/*"fhd_1080p"*/ STR(618), IntType(1920), IntType(1080)), new_videotemplate(/*"qhd_1440p"*/ STR(619), IntType(2560), IntType(1440)), new_videotemplate(/*"uhd_4k"*/ STR(620), IntType(3840), IntType(2160)), new_videotemplate(/*"hd_720p_cinematic"*/ STR(621), IntType(1680), IntType(720)), new_videotemplate(/*"fhd_1080p_cinematic"*/ STR(622), IntType(2560), IntType(1080)), new_videotemplate(/*"qhd_1440p_cinematic"*/ STR(623), IntType(3440), IntType(1440)), new_videotemplate(/*"uhd_4k_cinematic"*/ STR(624), IntType(5120), IntType(2160)) });
		global::videoquality_list = ds_list_create();
		ds_list_add({ global::videoquality_list, new_videoquality(/*"best"*/ STR(625), IntType(5000000)), new_videoquality(/*"high"*/ STR(626), IntType(2500000)), new_videoquality(/*"medium"*/ STR(627), IntType(1200000)), new_videoquality(/*"low"*/ STR(628), IntType(700000)), new_videoquality(/*"verylow"*/ STR(629), IntType(350000)) });
		...
		ds_list_add({ global::biome_list, new_biome(/*"custom"*/ STR(630), IntType(0), IntType(0), true, c_plains_biome_grass, c_plains_biome_foliage, c_plains_biome_water, null_) });
		...
		ds_list_add({ global::blend_mode_list, /*"normal"*/ STR(631), /*"add"*/ STR(632), /*"subtract"*/ STR(633), /*"multiply"*/ STR(634), /*"screen"*/ STR(635) });
		global::blend_mode_map = ds_map_create();
		ds_map_add(global::blend_mode_map, /*"normal"*/ STR(631), bm_normal);
		ds_map_add(global::blend_mode_map, /*"add"*/ STR(632), bm_add);
		ds_map_add(global::blend_mode_map, /*"subtract"*/ STR(633), bm_subtract);
		ds_map_add(global::blend_mode_map, /*"multiply"*/ STR(634), ArrType::From({ bm_zero, bm_src_color }));
		ds_map_add(global::blend_mode_map, /*"screen"*/ STR(635), ArrType::From({ bm_one, bm_inv_src_color }));
		...
		ds_list_add({ global::render_pass_list, /*"combined"*/ STR(636), /*"diffuse"*/ STR(637), /*"specular"*/ STR(638), /*"ao"*/ STR(639), /*"shadows"*/ STR(129), /*"indirect"*/ STR(131), /*"indirectshadows"*/ STR(640), /*"reflections"*/ STR(132), /*"depth"*/ STR(641), /*"normal"*/ STR(631), /*"material"*/ STR(642) });
	}
	...
	{
		sStr(recent_display_mode) = /*"grid"*/ STR(643);
	...
	void app_startup_themes(ScopeAny self)
	{
		...
		{
			self->name = /*"light"*/ STR(644);
			self->dark = false;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DB3030"*/ STR(645)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D85B00"*/ STR(646)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D68E02"*/ STR(647)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"34A100"*/ STR(648)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"0D8E41"*/ STR(649)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"048E8E"*/ STR(650)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"2144F1"*/ STR(651)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"982BCB"*/ STR(652)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"E93983"*/ STR(653)));
			self->level_top = hex_to_color(/*"F7FAFC"*/ STR(654));
			self->level_middle = hex_to_color(/*"ECEFF1"*/ STR(655));
			self->level_bottom = hex_to_color(/*"D7DFE2"*/ STR(656));
			self->viewport_top = hex_to_color(/*"F0FFFF"*/ STR(657));
			self->viewport_bottom = hex_to_color(/*"B5E8F2"*/ STR(658));
			self->text_main = hex_to_color(/*"0D1214"*/ STR(659));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"FFFFFF"*/ STR(660));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .15;
			self->red_error = hex_to_color(/*"FF1D0F"*/ STR(661));
			self->yellow_warning = hex_to_color(/*"FFC01E"*/ STR(662));
			self->green_success = hex_to_color(/*"61C159"*/ STR(663));
			self->red = hex_to_color(/*"FF5656"*/ STR(664));
			self->green = hex_to_color(/*"4AB758"*/ STR(665));
			self->blue = hex_to_color(/*"1370FB"*/ STR(666));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(667));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(668));
			self->yellow = hex_to_color(/*"F4CC5D"*/ STR(669));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(670));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"158AF5"*/ STR(671));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64A56B"*/ STR(672));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"D09522"*/ STR(673));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF1D0F"*/ STR(661));
		}
		
		global::theme_dark = (new obj_theme)->id;
		withOne (obj_theme, global::theme_dark, self->id)
		{
			self->name = /*"dark"*/ STR(674);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(675)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFA360"*/ STR(676)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFF065"*/ STR(677)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"8BFF6D"*/ STR(678)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"4EF390"*/ STR(679)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"49EED9"*/ STR(680)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"98BBFF"*/ STR(681)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(682)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(683)));
			self->level_top = hex_to_color(/*"37444A"*/ STR(684));
			self->level_middle = hex_to_color(/*"2B373D"*/ STR(685));
			self->level_bottom = hex_to_color(/*"18242A"*/ STR(686));
			self->viewport_top = hex_to_color(/*"2B373D"*/ STR(685));
			self->viewport_bottom = hex_to_color(/*"839096"*/ STR(687));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(660));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"000000"*/ STR(688));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .25;
			self->red_error = hex_to_color(/*"FF7A72"*/ STR(689));
			self->yellow_warning = hex_to_color(/*"FFEB36"*/ STR(690));
			self->green_success = hex_to_color(/*"64E879"*/ STR(691));
			self->red = hex_to_color(/*"FF5656"*/ STR(664));
			self->green = hex_to_color(/*"23FF88"*/ STR(692));
			self->blue = hex_to_color(/*"1370FB"*/ STR(666));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(667));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(668));
			self->yellow = hex_to_color(/*"FFD969"*/ STR(693));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(670));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"7EC1FF"*/ STR(694));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64E879"*/ STR(691));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"FFEB36"*/ STR(690));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF7A72"*/ STR(689));
		}
		
		global::theme_darker = (new obj_theme)->id;
		withOne (obj_theme, global::theme_darker, self->id)
		{
			self->name = /*"darker"*/ STR(695);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(675)));
			...
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(682)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(683)));
			self->level_top = hex_to_color(/*"1C1C1C"*/ STR(696));
			self->level_middle = hex_to_color(/*"101010"*/ STR(697));
			self->level_bottom = hex_to_color(/*"050505"*/ STR(698));
			self->viewport_top = hex_to_color(/*"484848"*/ STR(699));
			self->viewport_bottom = hex_to_color(/*"2B2B2B"*/ STR(700));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(660));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
	...
	void app_update_animate(ScopeAny self)
	{
		...
		if (bgobject > 0)
		{
			...
			if (sVar(background_biome) == /*"custom"*/ STR(630) || sVar(background_biome_prev) != sVar(background_biome))
			{
		...
		sInt(background_sky_color_final) = merge_color((IntType)(sVar(background_sky_color)), (IntType)(hex_to_color(/*"020204"*/ STR(702))), background_sky_night_alpha());
	...
	void app_update_caption()
	{
		if (global::_app->project_name != /*""*/ STR(0))
			window_set_caption(global::_app->project_name + string_repeat(/*" * "*/ STR(703), global::_app->project_changed) + /*" - Mine-imator"*/ STR(704));
		else
			window_set_caption(/*"Mine-imator"*/ STR(23));
	...
	void app_update_keybinds()
	{
		...
		for (IntType i = IntType(0); i < e_keybind_amount; i++)
		{
			...
			check = keybind_check(obj, /*"keyboard_check"*/ STR(705));
			idBool(obj, released) = false;
			if (idVar(obj, active) > 0)
				idBool(obj, released) = keybind_check(obj, /*"keyboard_check_released"*/ STR(706));
			idBool(obj, pressed) = keybind_check(obj, /*"keyboard_check_pressed"*/ STR(707));
	...
	void app_update_keyboard(ScopeAny self)
	{
		...
		if (sStr(window_state) == /*""*/ STR(0) && (sVar(window_busy) == /*""*/ STR(0) || sStr(settings_menu_name) == /*"colorpicker"*/ STR(708)) && !sBool(textbox_isediting))
		{
