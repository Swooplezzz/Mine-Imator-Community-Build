...
namespace CppProject
{
	...
	BoolType asset_load(ScopeAny self, VarArgs argument)
	{
		...
		{
			log({ /*"Opening legacy asset"*/ STR(739), fn });
		...
		switch (StringType(ext).id)
		{
			...
			case 712: // .miparticles
			{
				...
				withOne (obj_template, temp, self->id)
				{
					...
					project_load_particles(ScopeAny(self), DsMap(rootmap).Value(/*"particles"*/ STR(537)));
	...
	void background_ground_startup()
	{
		...
		log({ /*"Ground vbuffer init"*/ STR(743) });
