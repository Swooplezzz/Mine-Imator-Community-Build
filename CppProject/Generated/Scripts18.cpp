/*
	...
	[ Generated on 2023.12.15 14:41:42 ]
*/
...
namespace CppProject
{
	...
	void app_startup_keybinds()
	{
		...
		keybind_register(/*"projectnew"*/ STR(252), e_keybind_PROJECT_NEW, keybind_new(/*"N"*/ STR(253), true));
		keybind_register(/*"projectopen"*/ STR(254), e_keybind_PROJECT_OPEN, keybind_new(/*"O"*/ STR(255), true));
		keybind_register(/*"projectsave"*/ STR(256), e_keybind_PROJECT_SAVE, keybind_new(/*"S"*/ STR(257), true));
		keybind_register(/*"projectsaveas"*/ STR(258), e_keybind_PROJECT_SAVE_AS, keybind_new(/*"S"*/ STR(257), true, true));
		keybind_register(/*"importasset"*/ STR(259), e_keybind_IMPORT_ASSET, keybind_new(/*"I"*/ STR(260), true));
		keybind_register(/*"undo"*/ STR(261), e_keybind_UNDO, keybind_new(/*"Z"*/ STR(262), true));
		keybind_register(/*"redo"*/ STR(263), e_keybind_REDO, keybind_new(/*"Y"*/ STR(264), true));
		keybind_register(/*"timelinedelete"*/ STR(265), e_keybind_TIMELINE_DELETE, keybind_new(/*"R"*/ STR(266), true));
		keybind_register(/*"timelineduplicate"*/ STR(267), e_keybind_TIMELINE_DUPLICATE, keybind_new(/*"D"*/ STR(268), true));
		keybind_register(/*"timelineselect"*/ STR(269), e_keybind_TIMELINE_SELECT, keybind_new(/*"A"*/ STR(270), true));
		keybind_register(/*"timelinehide"*/ STR(271), e_keybind_TIMELINE_HIDE, keybind_new(/*"H"*/ STR(272), true));
		keybind_register(/*"timelineshowhidden"*/ STR(273), e_keybind_TIMELINE_SHOW_HIDDEN, keybind_new(/*"H"*/ STR(272), true, false, true));
		keybind_register(/*"createfolder"*/ STR(274), e_keybind_CREATE_FOLDER, keybind_new(/*"F"*/ STR(275), true));
		keybind_register(/*"keyframescreate"*/ STR(276), e_keybind_KEYFRAMES_CREATE, keybind_new(/*"Q"*/ STR(277), true));
		keybind_register(/*"keyframescopy"*/ STR(278), e_keybind_KEYFRAMES_COPY, keybind_new(/*"C"*/ STR(279), true));
		keybind_register(/*"keyframescut"*/ STR(280), e_keybind_KEYFRAMES_CUT, keybind_new(/*"X"*/ STR(281), true));
		keybind_register(/*"keyframespaste"*/ STR(282), e_keybind_KEYFRAMES_PASTE, keybind_new(/*"V"*/ STR(283), true));
		keybind_register(/*"keyframesdelete"*/ STR(284), e_keybind_KEYFRAMES_DELETE, keybind_new(vk_delete));
		keybind_register(/*"play"*/ STR(285), e_keybind_PLAY, keybind_new(vk_space));
		keybind_register(/*"playbeginning"*/ STR(286), e_keybind_PLAY_BEGINNING, keybind_new(vk_enter));
		keybind_register(/*"markerleft"*/ STR(287), e_keybind_MARKER_LEFT, keybind_new(vk_left), true);
		keybind_register(/*"markerright"*/ STR(288), e_keybind_MARKER_RIGHT, keybind_new(vk_right), true);
		keybind_register(/*"rendermode"*/ STR(289), e_keybind_RENDER_MODE, keybind_new(vk_f5));
		keybind_register(/*"particlesspawn"*/ STR(290), e_keybind_PARTICLES_SPAWN, keybind_new(/*"X"*/ STR(281)));
		keybind_register(/*"particlesclear"*/ STR(291), e_keybind_PARTICLES_CLEAR, keybind_new(/*"C"*/ STR(279)));
		keybind_register(/*"secondaryview"*/ STR(292), e_keybind_SECONDARY_VIEW, keybind_new(vk_f6));
		keybind_register(/*"toolselect"*/ STR(293), e_keybind_TOOL_SELECT, keybind_new(/*"W"*/ STR(294)));
		keybind_register(/*"toolmove"*/ STR(295), e_keybind_TOOL_MOVE, keybind_new(/*"G"*/ STR(296)));
		keybind_register(/*"toolrotate"*/ STR(297), e_keybind_TOOL_ROTATE, keybind_new(/*"R"*/ STR(266)));
		keybind_register(/*"toolscale"*/ STR(298), e_keybind_TOOL_SCALE, keybind_new(/*"S"*/ STR(257)));
		keybind_register(/*"toolbend"*/ STR(299), e_keybind_TOOL_BEND, keybind_new(/*"B"*/ STR(300)));
		keybind_register(/*"tooltransform"*/ STR(301), e_keybind_TOOL_TRANSFORM, keybind_new(/*"T"*/ STR(302)));
		keybind_register(/*"snap"*/ STR(303), e_keybind_SNAP, keybind_new(/*"F"*/ STR(275)));
		keybind_register(/*"camforward"*/ STR(304), e_keybind_CAM_FORWARD, keybind_new(/*"W"*/ STR(294)), true);
		keybind_register(/*"camleft"*/ STR(305), e_keybind_CAM_LEFT, keybind_new(/*"A"*/ STR(270)), true);
		keybind_register(/*"camback"*/ STR(306), e_keybind_CAM_BACK, keybind_new(/*"S"*/ STR(257)), true);
		keybind_register(/*"camright"*/ STR(307), e_keybind_CAM_RIGHT, keybind_new(/*"D"*/ STR(268)), true);
		keybind_register(/*"camascend"*/ STR(308), e_keybind_CAM_ASCEND, keybind_new(/*"E"*/ STR(309)), true);
		keybind_register(/*"camdescend"*/ STR(310), e_keybind_CAM_DESCEND, keybind_new(/*"Q"*/ STR(277)), true);
		keybind_register(/*"camrollforward"*/ STR(311), e_keybind_CAM_ROLL_FORWARD, keybind_new(/*"Z"*/ STR(262)), true);
		keybind_register(/*"camrollback"*/ STR(312), e_keybind_CAM_ROLL_BACK, keybind_new(/*"C"*/ STR(279)), true);
		keybind_register(/*"camrollreset"*/ STR(313), e_keybind_CAM_ROLL_RESET, keybind_new(/*"X"*/ STR(281)), true);
		keybind_register(/*"camreset"*/ STR(314), e_keybind_CAM_RESET, keybind_new(/*"R"*/ STR(266)), true);
		keybind_register(/*"camfast"*/ STR(315), e_keybind_CAM_FAST, keybind_new(vk_space), true);
		keybind_register(/*"camslow"*/ STR(316), e_keybind_CAM_SLOW, keybind_new(null_, false, true), true);
		keybind_register(/*"camviewtimeline"*/ STR(317), e_keybind_CAM_VIEW_TIMELINE, keybind_new(/*"V"*/ STR(283)), false);
	...
	void app_startup_lists(ScopeAny self)
	{
		...
		ds_list_add({ global::value_name_list, /*"POS_X"*/ STR(318), /*"POS_Y"*/ STR(319), /*"POS_Z"*/ STR(320), /*"ROT_X"*/ STR(321), /*"ROT_Y"*/ STR(322), /*"ROT_Z"*/ STR(323), /*"SCA_X"*/ STR(324), /*"SCA_Y"*/ STR(325), /*"SCA_Z"*/ STR(326), /*"BEND_ANGLE"*/ STR(327), /*"BEND_ANGLE_X"*/ STR(328), /*"BEND_ANGLE_Y"*/ STR(329), /*"BEND_ANGLE_Z"*/ STR(330), /*"ALPHA"*/ STR(331), /*"RGB_ADD"*/ STR(332), /*"RGB_SUB"*/ STR(333), /*"RGB_MUL"*/ STR(334), /*"HSB_ADD"*/ STR(335), /*"HSB_SUB"*/ STR(336), /*"HSB_MUL"*/ STR(337), /*"MIX_COLOR"*/ STR(338), /*"GLOW_COLOR"*/ STR(339), /*"MIX_PERCENT"*/ STR(340), /*"EMISSIVE"*/ STR(341), /*"METALLIC"*/ STR(342), /*"ROUGHNESS"*/ STR(343), /*"SUBSURFACE"*/ STR(344), /*"SUBSURFACE_RADIUS_RED"*/ STR(345), /*"SUBSURFACE_RADIUS_GREEN"*/ STR(346), /*"SUBSURFACE_RADIUS_BLUE"*/ STR(347), /*"SUBSURFACE_COLOR"*/ STR(348), /*"WIND_INFLUENCE"*/ STR(349), /*"SPAWN"*/ STR(350), /*"FREEZE"*/ STR(351), /*"CLEAR"*/ STR(352), /*"CUSTOM_SEED"*/ STR(353), /*"SEED"*/ STR(354), /*"ATTRACTOR"*/ STR(355), /*"FORCE"*/ STR(356), /*"FORCE_DIRECTIONAL"*/ STR(357), /*"FORCE_VORTEX"*/ STR(358), /*"LIGHT_COLOR"*/ STR(359), /*"LIGHT_STRENGTH"*/ STR(360), /*"LIGHT_SPECULAR_STRENGTH"*/ STR(361), /*"LIGHT_SIZE"*/ STR(362), /*"LIGHT_RANGE"*/ STR(363), /*"LIGHT_FADE_SIZE"*/ STR(364), /*"LIGHT_SPOT_RADIUS"*/ STR(365), /*"LIGHT_SPOT_SHARPNESS"*/ STR(366), /*"CAM_FOV"*/ STR(367), /*"CAM_ASPECT"*/ STR(368), /*"CAM_CLIP_NEAR"*/ STR(369), /*"CAM_CLIP_FAR"*/ STR(370), /*"CAM_BLADE_AMOUNT"*/ STR(371), /*"CAM_BLADE_ANGLE"*/ STR(372), /*"CAM_LIGHT_MANAGEMENT"*/ STR(373), /*"CAM_TONEMAPPER"*/ STR(374), /*"CAM_EXPOSURE"*/ STR(375), /*"CAM_GAMMA"*/ STR(376), /*"CAM_ROTATE"*/ STR(377), /*"CAM_ROTATE_DISTANCE"*/ STR(378), /*"CAM_ROTATE_ANGLE_XY"*/ STR(379), /*"CAM_ROTATE_ANGLE_Z"*/ STR(380), /*"CAM_SHAKE"*/ STR(381), /*"CAM_SHAKE_MODE"*/ STR(382), /*"CAM_SHAKE_STRENGTH_X"*/ STR(383), /*"CAM_SHAKE_STRENGTH_Y"*/ STR(384), /*"CAM_SHAKE_STRENGTH_Z"*/ STR(385), /*"CAM_SHAKE_SPEED_X"*/ STR(386), /*"CAM_SHAKE_SPEED_Y"*/ STR(387), /*"CAM_SHAKE_SPEED_Z"*/ STR(388), /*"CAM_DOF"*/ STR(389), /*"CAM_DOF_DEPTH"*/ STR(390), /*"CAM_DOF_RANGE"*/ STR(391), /*"CAM_DOF_FADE_SIZE"*/ STR(392), /*"CAM_DOF_BLUR_SIZE"*/ STR(393), /*"CAM_DOF_BLUR_RATIO"*/ STR(394), /*"CAM_DOF_BIAS"*/ STR(395), /*"CAM_DOF_THRESHOLD"*/ STR(396), /*"CAM_DOF_GAIN"*/ STR(397), /*"CAM_DOF_FRINGE"*/ STR(398), /*"CAM_DOF_FRINGE_ANGLE_RED"*/ STR(399), /*"CAM_DOF_FRINGE_ANGLE_GREEN"*/ STR(400), /*"CAM_DOF_FRINGE_ANGLE_BLUE"*/ STR(401), /*"CAM_DOF_FRINGE_RED"*/ STR(402), /*"CAM_DOF_FRINGE_GREEN"*/ STR(403), /*"CAM_DOF_FRINGE_BLUE"*/ STR(404), /*"CAM_BLOOM"*/ STR(405), /*"CAM_BLOOM_THRESHOLD"*/ STR(406), /*"CAM_BLOOM_INTENSITY"*/ STR(407), /*"CAM_BLOOM_RADIUS"*/ STR(408), /*"CAM_BLOOM_RATIO"*/ STR(409), /*"CAM_BLOOM_BLEND"*/ STR(410), /*"CAM_LENS_DIRT"*/ STR(411), /*"CAM_LENS_DIRT_BLOOM"*/ STR(412), /*"CAM_LENS_DIRT_GLOW"*/ STR(413), /*"CAM_LENS_DIRT_RADIUS"*/ STR(414), /*"CAM_LENS_DIRT_INTENSITY"*/ STR(415), /*"CAM_LENS_DIRT_POWER"*/ STR(416), /*"CAM_COLOR_CORRECTION"*/ STR(417), /*"CAM_CONTRAST"*/ STR(418), /*"CAM_BRIGHTNESS"*/ STR(419), /*"CAM_SATURATION"*/ STR(420), /*"CAM_VIBRANCE"*/ STR(421), /*"CAM_COLOR_BURN"*/ STR(422), /*"CAM_GRAIN"*/ STR(423), /*"CAM_GRAIN_STRENGTH"*/ STR(424), /*"CAM_GRAIN_SATURATION"*/ STR(425), /*"CAM_GRAIN_SIZE"*/ STR(426), /*"CAM_VIGNETTE"*/ STR(427), /*"CAM_VIGNETTE_RADIUS"*/ STR(428), /*"CAM_VIGNETTE_SOFTNESS"*/ STR(429), /*"CAM_VIGNETTE_STRENGTH"*/ STR(430), /*"CAM_VIGNETTE_COLOR"*/ STR(431), /*"CAM_CA"*/ STR(432), /*"CAM_CA_BLUR_AMOUNT"*/ STR(433), /*"CAM_CA_DISTORT_CHANNELS"*/ STR(434), /*"CAM_CA_RED_OFFSET"*/ STR(435), /*"CAM_CA_GREEN_OFFSET"*/ STR(436), /*"CAM_CA_BLUE_OFFSET"*/ STR(437), /*"CAM_DISTORT"*/ STR(438), /*"CAM_DISTORT_REPEAT"*/ STR(439), /*"CAM_DISTORT_ZOOM_AMOUNT"*/ STR(440), /*"CAM_DISTORT_AMOUNT"*/ STR(441), /*"CAM_SIZE_USE_PROJECT"*/ STR(442), /*"CAM_SIZE_KEEP_ASPECT_RATIO"*/ STR(443), /*"CAM_WIDTH"*/ STR(444), /*"CAM_HEIGHT"*/ STR(445), /*"BG_IMAGE_SHOW"*/ STR(446), /*"BG_IMAGE_ROTATION"*/ STR(447), /*"BG_SKY_MOON_PHASE"*/ STR(448), /*"BG_SKY_TIME"*/ STR(449), /*"BG_SKY_ROTATION"*/ STR(450), /*"BG_SUNLIGHT_STRENGTH"*/ STR(451), /*"BG_SUNLIGHT_ANGLE"*/ STR(452), /*"BG_SKY_SUN_ANGLE"*/ STR(453), /*"BG_SKY_SUN_SCALE"*/ STR(454), /*"BG_SKY_MOON_ANGLE"*/ STR(455), /*"BG_SKY_MOON_SCALE"*/ STR(456), /*"BG_TWILIGHT"*/ STR(457), /*"BG_SKY_CLOUDS_SHOW"*/ STR(458), /*"BG_SKY_CLOUDS_SPEED"*/ STR(459), /*"BG_SKY_CLOUDS_HEIGHT"*/ STR(460), /*"BG_SKY_CLOUDS_OFFSET"*/ STR(461), /*"BG_GROUND_SHOW"*/ STR(462), /*"BG_GROUND_SLOT"*/ STR(463), /*"BG_BIOME"*/ STR(464), /*"BG_SKY_COLOR"*/ STR(465), /*"BG_SKY_CLOUDS_COLOR"*/ STR(466), /*"BG_SUNLIGHT_COLOR"*/ STR(467), /*"BG_AMBIENT_COLOR"*/ STR(468), /*"BG_NIGHT_COLOR"*/ STR(469), /*"BG_GRASS_COLOR"*/ STR(470), /*"BG_FOLIAGE_COLOR"*/ STR(471), /*"BG_WATER_COLOR"*/ STR(472), /*"BG_LEAVES_OAK_COLOR"*/ STR(473), /*"BG_LEAVES_SPRUCE_COLOR"*/ STR(474), /*"BG_LEAVES_BIRCH_COLOR"*/ STR(475), /*"BG_LEAVES_JUNGLE_COLOR"*/ STR(476), /*"BG_LEAVES_ACACIA_COLOR"*/ STR(477), /*"BG_LEAVES_DARK_OAK_COLOR"*/ STR(478), /*"BG_LEAVES_MANGROVE_COLOR"*/ STR(479), /*"BG_FOG_SHOW"*/ STR(480), /*"BG_FOG_SKY"*/ STR(481), /*"BG_FOG_CUSTOM_COLOR"*/ STR(482), /*"BG_FOG_COLOR"*/ STR(483), /*"BG_FOG_CUSTOM_OBJECT_COLOR"*/ STR(484), /*"BG_FOG_OBJECT_COLOR"*/ STR(485), /*"BG_FOG_DISTANCE"*/ STR(486), /*"BG_FOG_SIZE"*/ STR(487), /*"BG_FOG_HEIGHT"*/ STR(488), /*"BG_WIND"*/ STR(489), /*"BG_WIND_SPEED"*/ STR(490), /*"BG_WIND_STRENGTH"*/ STR(491), /*"BG_WIND_DIRECTION"*/ STR(492), /*"BG_WIND_DIRECTIONAL_SPEED"*/ STR(493), /*"BG_WIND_DIRECTIONAL_STRENGTH"*/ STR(494), /*"BG_TEXTURE_ANI_SPEED"*/ STR(495), /*"TEXTURE_OBJ"*/ STR(496), /*"TEXTURE_MATERIAL_OBJ"*/ STR(497), /*"TEXTURE_NORMAL_OBJ"*/ STR(498), /*"SOUND_OBJ"*/ STR(499), /*"SOUND_VOLUME"*/ STR(500), /*"SOUND_PITCH"*/ STR(501), /*"SOUND_START"*/ STR(502), /*"SOUND_END"*/ STR(503), /*"TEXT"*/ STR(504), /*"TEXT_FONT"*/ STR(505), /*"TEXT_HALIGN"*/ STR(506), /*"TEXT_VALIGN"*/ STR(507), /*"TEXT_AA"*/ STR(508), /*"TEXT_OUTLINE"*/ STR(509), /*"TEXT_OUTLINE_COLOR"*/ STR(510), /*"CUSTOM_ITEM_SLOT"*/ STR(511), /*"ITEM_SLOT"*/ STR(512), /*"ITEM_NAME"*/ STR(513), /*"PATH_OBJ"*/ STR(514), /*"PATH_OFFSET"*/ STR(515), /*"PATH_POINT_ANGLE"*/ STR(516), /*"PATH_POINT_SCALE"*/ STR(517), /*"IK_TARGET"*/ STR(518), /*"IK_BLEND"*/ STR(519), /*"IK_TARGET_ANGLE"*/ STR(520), /*"IK_ANGLE_OFFSET"*/ STR(521), /*"ROT_TARGET"*/ STR(522), /*"POS_TARGET"*/ STR(523), /*"SCALE_TARGET"*/ STR(524), /*"FLW_ROT_X"*/ STR(525), /*"FLW_ROT_Y"*/ STR(526), /*"FLW_ROT_Z"*/ STR(527), /*"FLW_POS_X"*/ STR(528), /*"FLW_POS_Y"*/ STR(529), /*"FLW_POS_Z"*/ STR(530), /*"FLW_SCALE_X"*/ STR(531), /*"FLW_SCALE_Y"*/ STR(532), /*"FLW_SCALE_Z"*/ STR(533), /*"FLW_POS_OFFSET_X"*/ STR(534), /*"FLW_POS_OFFSET_Y"*/ STR(535), /*"FLW_POS_OFFSET_Z"*/ STR(536), /*"FLW_SCALE_MULT"*/ STR(537), /*"VISIBLE"*/ STR(538), /*"TRANSITION"*/ STR(539), /*"EASE_IN_X"*/ STR(540), /*"EASE_IN_Y"*/ STR(541), /*"EASE_OUT_X"*/ STR(542), /*"EASE_OUT_Y"*/ STR(543) });
		...
		ds_list_add({ global::temp_type_name_list, /*"char"*/ STR(544), /*"spblock"*/ STR(545), /*"scenery"*/ STR(546), /*"item"*/ STR(547), /*"block"*/ STR(4), /*"bodypart"*/ STR(548), /*"particles"*/ STR(549), /*"text"*/ STR(104), /*"cube"*/ STR(3), /*"cone"*/ STR(550), /*"cylinder"*/ STR(551), /*"sphere"*/ STR(552), /*"surface"*/ STR(553), /*"model"*/ STR(8) });
		global::tl_type_name_list = ds_list_create();
		ds_list_add({ global::tl_type_name_list, /*"char"*/ STR(544), /*"spblock"*/ STR(545), /*"scenery"*/ STR(546), /*"item"*/ STR(547), /*"block"*/ STR(4), /*"bodypart"*/ STR(548), /*"particles"*/ STR(549), /*"text"*/ STR(104), /*"cube"*/ STR(3), /*"cone"*/ STR(550), /*"cylinder"*/ STR(551), /*"sphere"*/ STR(552), /*"surface"*/ STR(553), /*"model"*/ STR(8), /*"camera"*/ STR(126), /*"spotlight"*/ STR(554), /*"pointlight"*/ STR(555), /*"folder"*/ STR(556), /*"background"*/ STR(223), /*"audio"*/ STR(557), /*"path"*/ STR(558), /*"pathpoint"*/ STR(559), /*"shape"*/ STR(560), /*"lightsource"*/ STR(561) });
		global::res_type_name_list = ds_list_create();
		ds_list_add({ global::res_type_name_list, /*"pack"*/ STR(562), /*"packunzipped"*/ STR(563), /*"skin"*/ STR(564), /*"downloadskin"*/ STR(208), /*"itemsheet"*/ STR(565), /*"legacyblocksheet"*/ STR(566), /*"blocksheet"*/ STR(567), /*"scenery"*/ STR(546), /*"fromworld"*/ STR(568), /*"particlesheet"*/ STR(569), /*"texture"*/ STR(570), /*"font"*/ STR(571), /*"sound"*/ STR(572), /*"model"*/ STR(8) });
		global::transition_list = ds_list_create();
		ds_list_add({ global::transition_list, /*"linear"*/ STR(573), /*"instant"*/ STR(574), /*"bezier"*/ STR(575), /*"easeinquad"*/ STR(576), /*"easeoutquad"*/ STR(577), /*"easeinoutquad"*/ STR(578), /*"easeincubic"*/ STR(579), /*"easeoutcubic"*/ STR(580), /*"easeinoutcubic"*/ STR(581), /*"easeinquart"*/ STR(582), /*"easeoutquart"*/ STR(583), /*"easeinoutquart"*/ STR(584), /*"easeinquint"*/ STR(585), /*"easeoutquint"*/ STR(586), /*"easeinoutquint"*/ STR(587), /*"easeinsine"*/ STR(588), /*"easeoutsine"*/ STR(589), /*"easeinoutsine"*/ STR(590), /*"easeinexpo"*/ STR(591), /*"easeoutexpo"*/ STR(592), /*"easeinoutexpo"*/ STR(593), /*"easeincirc"*/ STR(594), /*"easeoutcirc"*/ STR(595), /*"easeinoutcirc"*/ STR(596), /*"easeinelastic"*/ STR(597), /*"easeoutelastic"*/ STR(598), /*"easeinoutelastic"*/ STR(599), /*"easeinback"*/ STR(600), /*"easeoutback"*/ STR(601), /*"easeinoutback"*/ STR(602), /*"easeinbounce"*/ STR(603), /*"easeoutbounce"*/ STR(604), /*"easeinoutbounce"*/ STR(605) });
		global::transition_list_order = ds_list_create();
		for (IntType i = IntType(0); i < ds_list_size(global::transition_list); i++)
			if (!string_contains(DsList(global::transition_list).Value(i), /*"ease"*/ STR(606)))
				ds_list_add({ global::transition_list_order, DsList(global::transition_list).Value(i) });
		for (IntType i = IntType(0); i < ds_list_size(global::transition_list); i++)
			if (string_contains(DsList(global::transition_list).Value(i), /*"easein"*/ STR(607)) && !string_contains(DsList(global::transition_list).Value(i), /*"easeinout"*/ STR(608)))
				ds_list_add({ global::transition_list_order, DsList(global::transition_list).Value(i) });
		for (IntType i = IntType(0); i < ds_list_size(global::transition_list); i++)
			if (string_contains(DsList(global::transition_list).Value(i), /*"easeout"*/ STR(609)))
				ds_list_add({ global::transition_list_order, DsList(global::transition_list).Value(i) });
		for (IntType i = IntType(0); i < ds_list_size(global::transition_list); i++)
			if (string_contains(DsList(global::transition_list).Value(i), /*"easeinout"*/ STR(608)))
				ds_list_add({ global::transition_list_order, DsList(global::transition_list).Value(i) });
		log({ /*"Make transitions"*/ STR(610) });
		...
		log({ /*"Transitions OK"*/ STR(611) });
		global::videotemplate_list = ds_list_create();
		ds_list_add({ global::videotemplate_list, new_videotemplate(/*"avatar"*/ STR(612), IntType(512), IntType(512)), new_videotemplate(/*"hd_720p"*/ STR(613), IntType(1280), IntType(720)), new_videotemplate(/*"fhd_1080p"*/ STR(614), IntType(1920), IntType(1080)), new_videotemplate(/*"qhd_1440p"*/ STR(615), IntType(2560), IntType(1440)), new_videotemplate(/*"uhd_4k"*/ STR(616), IntType(3840), IntType(2160)), new_videotemplate(/*"hd_720p_cinematic"*/ STR(617), IntType(1680), IntType(720)), new_videotemplate(/*"fhd_1080p_cinematic"*/ STR(618), IntType(2560), IntType(1080)), new_videotemplate(/*"qhd_1440p_cinematic"*/ STR(619), IntType(3440), IntType(1440)), new_videotemplate(/*"uhd_4k_cinematic"*/ STR(620), IntType(5120), IntType(2160)) });
		global::videoquality_list = ds_list_create();
		ds_list_add({ global::videoquality_list, new_videoquality(/*"best"*/ STR(621), IntType(5000000)), new_videoquality(/*"high"*/ STR(622), IntType(2500000)), new_videoquality(/*"medium"*/ STR(623), IntType(1200000)), new_videoquality(/*"low"*/ STR(624), IntType(700000)), new_videoquality(/*"verylow"*/ STR(625), IntType(350000)) });
		...
		ds_list_add({ global::biome_list, new_biome(/*"custom"*/ STR(626), IntType(0), IntType(0), true, c_plains_biome_grass, c_plains_biome_foliage, c_plains_biome_water, null_) });
		...
		ds_list_add({ global::blend_mode_list, /*"normal"*/ STR(627), /*"add"*/ STR(628), /*"subtract"*/ STR(629), /*"multiply"*/ STR(630), /*"screen"*/ STR(631) });
		global::blend_mode_map = ds_map_create();
		ds_map_add(global::blend_mode_map, /*"normal"*/ STR(627), bm_normal);
		ds_map_add(global::blend_mode_map, /*"add"*/ STR(628), bm_add);
		ds_map_add(global::blend_mode_map, /*"subtract"*/ STR(629), bm_subtract);
		ds_map_add(global::blend_mode_map, /*"multiply"*/ STR(630), ArrType::From({ bm_zero, bm_src_color }));
		ds_map_add(global::blend_mode_map, /*"screen"*/ STR(631), ArrType::From({ bm_one, bm_inv_src_color }));
		...
		ds_list_add({ global::render_pass_list, /*"combined"*/ STR(632), /*"diffuse"*/ STR(633), /*"specular"*/ STR(634), /*"ao"*/ STR(635), /*"shadows"*/ STR(129), /*"indirect"*/ STR(131), /*"indirectshadows"*/ STR(636), /*"reflections"*/ STR(132), /*"depth"*/ STR(637), /*"normal"*/ STR(627), /*"material"*/ STR(638) });
	}
	...
	{
		sStr(recent_display_mode) = /*"grid"*/ STR(639);
	...
	void app_startup_themes(ScopeAny self)
	{
		...
		{
			self->name = /*"light"*/ STR(640);
			self->dark = false;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DB3030"*/ STR(641)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D85B00"*/ STR(642)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D68E02"*/ STR(643)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"34A100"*/ STR(644)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"0D8E41"*/ STR(645)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"048E8E"*/ STR(646)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"2144F1"*/ STR(647)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"982BCB"*/ STR(648)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"E93983"*/ STR(649)));
			self->level_top = hex_to_color(/*"F7FAFC"*/ STR(650));
			self->level_middle = hex_to_color(/*"ECEFF1"*/ STR(651));
			self->level_bottom = hex_to_color(/*"D7DFE2"*/ STR(652));
			self->viewport_top = hex_to_color(/*"F0FFFF"*/ STR(653));
			self->viewport_bottom = hex_to_color(/*"B5E8F2"*/ STR(654));
			self->text_main = hex_to_color(/*"0D1214"*/ STR(655));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"FFFFFF"*/ STR(656));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .15;
			self->red_error = hex_to_color(/*"FF1D0F"*/ STR(657));
			self->yellow_warning = hex_to_color(/*"FFC01E"*/ STR(658));
			self->green_success = hex_to_color(/*"61C159"*/ STR(659));
			self->red = hex_to_color(/*"FF5656"*/ STR(660));
			self->green = hex_to_color(/*"4AB758"*/ STR(661));
			self->blue = hex_to_color(/*"1370FB"*/ STR(662));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(663));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(664));
			self->yellow = hex_to_color(/*"F4CC5D"*/ STR(665));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(666));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"158AF5"*/ STR(667));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64A56B"*/ STR(668));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"D09522"*/ STR(669));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF1D0F"*/ STR(657));
		}
		
		global::theme_dark = (new obj_theme)->id;
		withOne (obj_theme, global::theme_dark, self->id)
		{
			self->name = /*"dark"*/ STR(670);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(671)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFA360"*/ STR(672)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFF065"*/ STR(673)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"8BFF6D"*/ STR(674)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"4EF390"*/ STR(675)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"49EED9"*/ STR(676)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"98BBFF"*/ STR(677)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(678)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(679)));
			self->level_top = hex_to_color(/*"37444A"*/ STR(680));
			self->level_middle = hex_to_color(/*"2B373D"*/ STR(681));
			self->level_bottom = hex_to_color(/*"18242A"*/ STR(682));
			self->viewport_top = hex_to_color(/*"2B373D"*/ STR(681));
			self->viewport_bottom = hex_to_color(/*"839096"*/ STR(683));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(656));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"000000"*/ STR(684));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .25;
			self->red_error = hex_to_color(/*"FF7A72"*/ STR(685));
			self->yellow_warning = hex_to_color(/*"FFEB36"*/ STR(686));
			self->green_success = hex_to_color(/*"64E879"*/ STR(687));
			self->red = hex_to_color(/*"FF5656"*/ STR(660));
			self->green = hex_to_color(/*"23FF88"*/ STR(688));
			self->blue = hex_to_color(/*"1370FB"*/ STR(662));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(663));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(664));
			self->yellow = hex_to_color(/*"FFD969"*/ STR(689));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(666));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"7EC1FF"*/ STR(690));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64E879"*/ STR(687));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"FFEB36"*/ STR(686));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF7A72"*/ STR(685));
		}
		
		global::theme_darker = (new obj_theme)->id;
		withOne (obj_theme, global::theme_darker, self->id)
		{
			self->name = /*"darker"*/ STR(691);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(671)));
			...
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(678)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(679)));
			self->level_top = hex_to_color(/*"1C1C1C"*/ STR(692));
			self->level_middle = hex_to_color(/*"101010"*/ STR(693));
			self->level_bottom = hex_to_color(/*"050505"*/ STR(694));
			self->viewport_top = hex_to_color(/*"484848"*/ STR(695));
			self->viewport_bottom = hex_to_color(/*"2B2B2B"*/ STR(696));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(656));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
	...
	void app_update_animate(ScopeAny self)
	{
		...
		withAll (obj_timeline, global::_app->id)
		{
			...
			if (self->value.Value(e_value_ROT_TARGET) != null_ || self->value.Value(e_value_POS_TARGET) != null_ || self->value.Value(e_value_SCALE_TARGET) != null_)
				array_add(VarType::CreateRef(global::_app->project_flw_obj_array), self->id);
		...
		for (IntType i = IntType(0); i < array_length(VarType::CreateRef(sVar(project_flw_obj_array))); i++)
			ObjType(obj_timeline, sVar(project_flw_obj_array)[i])->update_matrix = true;
		...
		if (array_length(VarType::CreateRef(sVar(project_flw_obj_array))) > IntType(0))
		{
			withOne (app, global::_app->id, global::_app->id)
		...
		if (bgobject > 0)
		{
			...
			if (sVar(background_biome) == /*"custom"*/ STR(626) || sVar(background_biome_prev) != sVar(background_biome))
			{
		...
		sInt(background_sky_color_final) = merge_color((IntType)(sVar(background_sky_color)), (IntType)(hex_to_color(/*"020204"*/ STR(698))), background_sky_night_alpha());
	...
	void app_update_caption()
	{
		if (global::_app->project_name != /*""*/ STR(0))
			window_set_caption(global::_app->project_name + string_repeat(/*" * "*/ STR(699), global::_app->project_changed) + /*" - Mine-imator"*/ STR(700));
		else
			window_set_caption(/*"Mine-imator"*/ STR(23));
	...
	void app_update_keybinds()
	{
		...
		for (IntType i = IntType(0); i < e_keybind_amount; i++)
		{
			...
			check = keybind_check(obj, /*"keyboard_check"*/ STR(701));
			idBool(obj, released) = false;
			if (idVar(obj, active) > 0)
				idBool(obj, released) = keybind_check(obj, /*"keyboard_check_released"*/ STR(702));
			idBool(obj, pressed) = keybind_check(obj, /*"keyboard_check_pressed"*/ STR(703));
	...
	void app_update_keyboard(ScopeAny self)
	{
		...
		if (sStr(window_state) == /*""*/ STR(0) && (sVar(window_busy) == /*""*/ STR(0) || sStr(settings_menu_name) == /*"colorpicker"*/ STR(704)) && !sBool(textbox_isediting))
		{
