...
namespace CppProject
{
	...
	void app_startup_lists(ScopeAny self)
	{
		...
		ds_list_add({ global::value_name_list, /*"POS_X"*/ STR(320), /*"POS_Y"*/ STR(321), /*"POS_Z"*/ STR(322), /*"ROT_X"*/ STR(323), /*"ROT_Y"*/ STR(324), /*"ROT_Z"*/ STR(325), /*"SCA_X"*/ STR(326), /*"SCA_Y"*/ STR(327), /*"SCA_Z"*/ STR(328), /*"BEND_ANGLE"*/ STR(329), /*"BEND_ANGLE_X"*/ STR(330), /*"BEND_ANGLE_Y"*/ STR(331), /*"BEND_ANGLE_Z"*/ STR(332), /*"ALPHA"*/ STR(333), /*"RGB_ADD"*/ STR(334), /*"RGB_SUB"*/ STR(335), /*"RGB_MUL"*/ STR(336), /*"HSB_ADD"*/ STR(337), /*"HSB_SUB"*/ STR(338), /*"HSB_MUL"*/ STR(339), /*"MIX_COLOR"*/ STR(340), /*"GLOW_COLOR"*/ STR(341), /*"MIX_PERCENT"*/ STR(342), /*"EMISSIVE"*/ STR(343), /*"METALLIC"*/ STR(344), /*"ROUGHNESS"*/ STR(345), /*"SUBSURFACE"*/ STR(346), /*"SUBSURFACE_RADIUS_RED"*/ STR(347), /*"SUBSURFACE_RADIUS_GREEN"*/ STR(348), /*"SUBSURFACE_RADIUS_BLUE"*/ STR(349), /*"SUBSURFACE_COLOR"*/ STR(350), /*"WIND_INFLUENCE"*/ STR(351), /*"SPAWN"*/ STR(352), /*"FREEZE"*/ STR(353), /*"CLEAR"*/ STR(354), /*"CUSTOM_SEED"*/ STR(355), /*"SEED"*/ STR(356), /*"ATTRACTOR"*/ STR(357), /*"FORCE"*/ STR(358), /*"FORCE_DIRECTIONAL"*/ STR(359), /*"FORCE_VORTEX"*/ STR(360), /*"LIGHT_COLOR"*/ STR(361), /*"LIGHT_STRENGTH"*/ STR(362), /*"LIGHT_SPECULAR_STRENGTH"*/ STR(363), /*"LIGHT_SIZE"*/ STR(364), /*"LIGHT_RANGE"*/ STR(365), /*"LIGHT_FADE_SIZE"*/ STR(366), /*"LIGHT_SPOT_RADIUS"*/ STR(367), /*"LIGHT_SPOT_SHARPNESS"*/ STR(368), /*"CAM_FOV"*/ STR(369), /*"CAM_CLIP_NEAR"*/ STR(370), /*"CAM_CLIP_FAR"*/ STR(371), /*"CAM_BLADE_AMOUNT"*/ STR(372), /*"CAM_BLADE_ANGLE"*/ STR(373), /*"CAM_LIGHT_MANAGEMENT"*/ STR(374), /*"CAM_TONEMAPPER"*/ STR(375), /*"CAM_EXPOSURE"*/ STR(376), /*"CAM_GAMMA"*/ STR(377), /*"CAM_ROTATE"*/ STR(378), /*"CAM_ROTATE_DISTANCE"*/ STR(379), /*"CAM_ROTATE_ANGLE_XY"*/ STR(380), /*"CAM_ROTATE_ANGLE_Z"*/ STR(381), /*"CAM_SHAKE"*/ STR(382), /*"CAM_SHAKE_MODE"*/ STR(383), /*"CAM_SHAKE_STRENGTH_X"*/ STR(384), /*"CAM_SHAKE_STRENGTH_Y"*/ STR(385), /*"CAM_SHAKE_STRENGTH_Z"*/ STR(386), /*"CAM_SHAKE_SPEED_X"*/ STR(387), /*"CAM_SHAKE_SPEED_Y"*/ STR(388), /*"CAM_SHAKE_SPEED_Z"*/ STR(389), /*"CAM_DOF"*/ STR(390), /*"CAM_DOF_DEPTH"*/ STR(391), /*"CAM_DOF_RANGE"*/ STR(392), /*"CAM_DOF_FADE_SIZE"*/ STR(393), /*"CAM_DOF_BLUR_SIZE"*/ STR(394), /*"CAM_DOF_BLUR_RATIO"*/ STR(395), /*"CAM_DOF_BIAS"*/ STR(396), /*"CAM_DOF_THRESHOLD"*/ STR(397), /*"CAM_DOF_GAIN"*/ STR(398), /*"CAM_DOF_FRINGE"*/ STR(399), /*"CAM_DOF_FRINGE_ANGLE_RED"*/ STR(400), /*"CAM_DOF_FRINGE_ANGLE_GREEN"*/ STR(401), /*"CAM_DOF_FRINGE_ANGLE_BLUE"*/ STR(402), /*"CAM_DOF_FRINGE_RED"*/ STR(403), /*"CAM_DOF_FRINGE_GREEN"*/ STR(404), /*"CAM_DOF_FRINGE_BLUE"*/ STR(405), /*"CAM_BLOOM"*/ STR(406), /*"CAM_BLOOM_THRESHOLD"*/ STR(407), /*"CAM_BLOOM_INTENSITY"*/ STR(408), /*"CAM_BLOOM_RADIUS"*/ STR(409), /*"CAM_BLOOM_RATIO"*/ STR(410), /*"CAM_BLOOM_BLEND"*/ STR(411), /*"CAM_LENS_DIRT"*/ STR(412), /*"CAM_LENS_DIRT_BLOOM"*/ STR(413), /*"CAM_LENS_DIRT_GLOW"*/ STR(414), /*"CAM_LENS_DIRT_RADIUS"*/ STR(415), /*"CAM_LENS_DIRT_INTENSITY"*/ STR(416), /*"CAM_LENS_DIRT_POWER"*/ STR(417), /*"CAM_COLOR_CORRECTION"*/ STR(418), /*"CAM_CONTRAST"*/ STR(419), /*"CAM_BRIGHTNESS"*/ STR(420), /*"CAM_SATURATION"*/ STR(421), /*"CAM_VIBRANCE"*/ STR(422), /*"CAM_COLOR_BURN"*/ STR(423), /*"CAM_GRAIN"*/ STR(424), /*"CAM_GRAIN_STRENGTH"*/ STR(425), /*"CAM_GRAIN_SATURATION"*/ STR(426), /*"CAM_GRAIN_SIZE"*/ STR(427), /*"CAM_VIGNETTE"*/ STR(428), /*"CAM_VIGNETTE_RADIUS"*/ STR(429), /*"CAM_VIGNETTE_SOFTNESS"*/ STR(430), /*"CAM_VIGNETTE_STRENGTH"*/ STR(431), /*"CAM_VIGNETTE_COLOR"*/ STR(432), /*"CAM_CA"*/ STR(433), /*"CAM_CA_BLUR_AMOUNT"*/ STR(434), /*"CAM_CA_DISTORT_CHANNELS"*/ STR(435), /*"CAM_CA_RED_OFFSET"*/ STR(436), /*"CAM_CA_GREEN_OFFSET"*/ STR(437), /*"CAM_CA_BLUE_OFFSET"*/ STR(438), /*"CAM_DISTORT"*/ STR(439), /*"CAM_DISTORT_REPEAT"*/ STR(440), /*"CAM_DISTORT_ZOOM_AMOUNT"*/ STR(441), /*"CAM_DISTORT_AMOUNT"*/ STR(442), /*"CAM_SIZE_USE_PROJECT"*/ STR(443), /*"CAM_SIZE_KEEP_ASPECT_RATIO"*/ STR(444), /*"CAM_WIDTH"*/ STR(445), /*"CAM_HEIGHT"*/ STR(446), /*"BG_IMAGE_SHOW"*/ STR(447), /*"BG_IMAGE_ROTATION"*/ STR(448), /*"BG_SKY_MOON_PHASE"*/ STR(449), /*"BG_SKY_TIME"*/ STR(450), /*"BG_SKY_ROTATION"*/ STR(451), /*"BG_SUNLIGHT_STRENGTH"*/ STR(452), /*"BG_SUNLIGHT_ANGLE"*/ STR(453), /*"BG_SKY_SUN_ANGLE"*/ STR(454), /*"BG_SKY_SUN_SCALE"*/ STR(455), /*"BG_SKY_MOON_ANGLE"*/ STR(456), /*"BG_SKY_MOON_SCALE"*/ STR(457), /*"BG_TWILIGHT"*/ STR(458), /*"BG_SKY_CLOUDS_SHOW"*/ STR(459), /*"BG_SKY_CLOUDS_SPEED"*/ STR(460), /*"BG_SKY_CLOUDS_HEIGHT"*/ STR(461), /*"BG_SKY_CLOUDS_OFFSET"*/ STR(462), /*"BG_GROUND_SHOW"*/ STR(463), /*"BG_GROUND_SLOT"*/ STR(464), /*"BG_BIOME"*/ STR(465), /*"BG_SKY_COLOR"*/ STR(466), /*"BG_SKY_CLOUDS_COLOR"*/ STR(467), /*"BG_SUNLIGHT_COLOR"*/ STR(468), /*"BG_AMBIENT_COLOR"*/ STR(469), /*"BG_NIGHT_COLOR"*/ STR(470), /*"BG_GRASS_COLOR"*/ STR(471), /*"BG_FOLIAGE_COLOR"*/ STR(472), /*"BG_WATER_COLOR"*/ STR(473), /*"BG_LEAVES_OAK_COLOR"*/ STR(474), /*"BG_LEAVES_SPRUCE_COLOR"*/ STR(475), /*"BG_LEAVES_BIRCH_COLOR"*/ STR(476), /*"BG_LEAVES_JUNGLE_COLOR"*/ STR(477), /*"BG_LEAVES_ACACIA_COLOR"*/ STR(478), /*"BG_LEAVES_DARK_OAK_COLOR"*/ STR(479), /*"BG_LEAVES_MANGROVE_COLOR"*/ STR(480), /*"BG_FOG_SHOW"*/ STR(481), /*"BG_FOG_SKY"*/ STR(482), /*"BG_FOG_CUSTOM_COLOR"*/ STR(483), /*"BG_FOG_COLOR"*/ STR(484), /*"BG_FOG_CUSTOM_OBJECT_COLOR"*/ STR(485), /*"BG_FOG_OBJECT_COLOR"*/ STR(486), /*"BG_FOG_DISTANCE"*/ STR(487), /*"BG_FOG_SIZE"*/ STR(488), /*"BG_FOG_HEIGHT"*/ STR(489), /*"BG_WIND"*/ STR(490), /*"BG_WIND_SPEED"*/ STR(491), /*"BG_WIND_STRENGTH"*/ STR(492), /*"BG_WIND_DIRECTION"*/ STR(493), /*"BG_WIND_DIRECTIONAL_SPEED"*/ STR(494), /*"BG_WIND_DIRECTIONAL_STRENGTH"*/ STR(495), /*"BG_TEXTURE_ANI_SPEED"*/ STR(496), /*"TEXTURE_OBJ"*/ STR(497), /*"TEXTURE_MATERIAL_OBJ"*/ STR(498), /*"TEXTURE_NORMAL_OBJ"*/ STR(499), /*"SOUND_OBJ"*/ STR(500), /*"SOUND_VOLUME"*/ STR(501), /*"SOUND_PITCH"*/ STR(502), /*"SOUND_START"*/ STR(503), /*"SOUND_END"*/ STR(504), /*"TEXT"*/ STR(505), /*"TEXT_FONT"*/ STR(506), /*"TEXT_HALIGN"*/ STR(507), /*"TEXT_VALIGN"*/ STR(508), /*"TEXT_AA"*/ STR(509), /*"TEXT_OUTLINE"*/ STR(510), /*"TEXT_OUTLINE_COLOR"*/ STR(511), /*"CUSTOM_ITEM_SLOT"*/ STR(512), /*"ITEM_SLOT"*/ STR(513), /*"ITEM_NAME"*/ STR(514), /*"PATH_OBJ"*/ STR(515), /*"PATH_OFFSET"*/ STR(516), /*"PATH_POINT_ANGLE"*/ STR(517), /*"PATH_POINT_SCALE"*/ STR(518), /*"IK_TARGET"*/ STR(519), /*"IK_BLEND"*/ STR(520), /*"IK_TARGET_ANGLE"*/ STR(521), /*"IK_ANGLE_OFFSET"*/ STR(522), /*"ROT_TARGET"*/ STR(523), /*"POS_TARGET"*/ STR(524), /*"SCALE_TARGET"*/ STR(525), /*"FLW_ROT_X"*/ STR(526), /*"FLW_ROT_Y"*/ STR(527), /*"FLW_ROT_Z"*/ STR(528), /*"FLW_POS_X"*/ STR(529), /*"FLW_POS_Y"*/ STR(530), /*"FLW_POS_Z"*/ STR(531), /*"FLW_SCALE_X"*/ STR(532), /*"FLW_SCALE_Y"*/ STR(533), /*"FLW_SCALE_Z"*/ STR(534), /*"FLW_POS_OFFSET_X"*/ STR(535), /*"FLW_POS_OFFSET_Y"*/ STR(536), /*"FLW_POS_OFFSET_Z"*/ STR(537), /*"FLW_SCALE_MULT"*/ STR(538), /*"VISIBLE"*/ STR(539), /*"TRANSITION"*/ STR(540), /*"EASE_IN_X"*/ STR(541), /*"EASE_IN_Y"*/ STR(542), /*"EASE_OUT_X"*/ STR(543), /*"EASE_OUT_Y"*/ STR(544) });
		...
		ds_list_add({ global::temp_type_name_list, /*"char"*/ STR(545), /*"spblock"*/ STR(546), /*"scenery"*/ STR(547), /*"item"*/ STR(548), /*"block"*/ STR(4), /*"bodypart"*/ STR(549), /*"particles"*/ STR(550), /*"text"*/ STR(105), /*"cube"*/ STR(3), /*"cone"*/ STR(551), /*"cylinder"*/ STR(552), /*"sphere"*/ STR(553), /*"surface"*/ STR(554), /*"model"*/ STR(8) });
		global::tl_type_name_list = ds_list_create();
		ds_list_add({ global::tl_type_name_list, /*"char"*/ STR(545), /*"spblock"*/ STR(546), /*"scenery"*/ STR(547), /*"item"*/ STR(548), /*"block"*/ STR(4), /*"bodypart"*/ STR(549), /*"particles"*/ STR(550), /*"text"*/ STR(105), /*"cube"*/ STR(3), /*"cone"*/ STR(551), /*"cylinder"*/ STR(552), /*"sphere"*/ STR(553), /*"surface"*/ STR(554), /*"model"*/ STR(8), /*"camera"*/ STR(127), /*"spotlight"*/ STR(555), /*"pointlight"*/ STR(556), /*"folder"*/ STR(557), /*"background"*/ STR(225), /*"audio"*/ STR(558), /*"path"*/ STR(559), /*"pathpoint"*/ STR(560), /*"shape"*/ STR(561), /*"lightsource"*/ STR(562) });
		global::res_type_name_list = ds_list_create();
		ds_list_add({ global::res_type_name_list, /*"pack"*/ STR(563), /*"packunzipped"*/ STR(564), /*"skin"*/ STR(565), /*"downloadskin"*/ STR(210), /*"itemsheet"*/ STR(566), /*"legacyblocksheet"*/ STR(567), /*"blocksheet"*/ STR(568), /*"scenery"*/ STR(547), /*"fromworld"*/ STR(569), /*"particlesheet"*/ STR(570), /*"texture"*/ STR(571), /*"font"*/ STR(572), /*"sound"*/ STR(573), /*"model"*/ STR(8) });
		global::transition_list = ds_list_create();
		ds_list_add({ global::transition_list, /*"linear"*/ STR(574), /*"instant"*/ STR(575), /*"bezier"*/ STR(576), /*"easeinquad"*/ STR(577), /*"easeoutquad"*/ STR(578), /*"easeinoutquad"*/ STR(579), /*"easeincubic"*/ STR(580), /*"easeoutcubic"*/ STR(581), /*"easeinoutcubic"*/ STR(582), /*"easeinquart"*/ STR(583), /*"easeoutquart"*/ STR(584), /*"easeinoutquart"*/ STR(585), /*"easeinquint"*/ STR(586), /*"easeoutquint"*/ STR(587), /*"easeinoutquint"*/ STR(588), /*"easeinsine"*/ STR(589), /*"easeoutsine"*/ STR(590), /*"easeinoutsine"*/ STR(591), /*"easeinexpo"*/ STR(592), /*"easeoutexpo"*/ STR(593), /*"easeinoutexpo"*/ STR(594), /*"easeincirc"*/ STR(595), /*"easeoutcirc"*/ STR(596), /*"easeinoutcirc"*/ STR(597), /*"easeinelastic"*/ STR(598), /*"easeoutelastic"*/ STR(599), /*"easeinoutelastic"*/ STR(600), /*"easeinback"*/ STR(601), /*"easeoutback"*/ STR(602), /*"easeinoutback"*/ STR(603), /*"easeinbounce"*/ STR(604), /*"easeoutbounce"*/ STR(605), /*"easeinoutbounce"*/ STR(606) });
		global::transition_list_order = ds_list_create();
		for (IntType i = IntType(0); i < ds_list_size(global::transition_list); i++)
			if (!string_contains(DsList(global::transition_list).Value(i), /*"ease"*/ STR(607)))
				ds_list_add({ global::transition_list_order, DsList(global::transition_list).Value(i) });
		for (IntType i = IntType(0); i < ds_list_size(global::transition_list); i++)
			if (string_contains(DsList(global::transition_list).Value(i), /*"easein"*/ STR(608)) && !string_contains(DsList(global::transition_list).Value(i), /*"easeinout"*/ STR(609)))
				ds_list_add({ global::transition_list_order, DsList(global::transition_list).Value(i) });
		for (IntType i = IntType(0); i < ds_list_size(global::transition_list); i++)
			if (string_contains(DsList(global::transition_list).Value(i), /*"easeout"*/ STR(610)))
				ds_list_add({ global::transition_list_order, DsList(global::transition_list).Value(i) });
		for (IntType i = IntType(0); i < ds_list_size(global::transition_list); i++)
			if (string_contains(DsList(global::transition_list).Value(i), /*"easeinout"*/ STR(609)))
				ds_list_add({ global::transition_list_order, DsList(global::transition_list).Value(i) });
		log({ /*"Make transitions"*/ STR(611) });
		...
		log({ /*"Transitions OK"*/ STR(612) });
		global::videotemplate_list = ds_list_create();
		ds_list_add({ global::videotemplate_list, new_videotemplate(/*"avatar"*/ STR(613), IntType(512), IntType(512)), new_videotemplate(/*"hd_720p"*/ STR(614), IntType(1280), IntType(720)), new_videotemplate(/*"fhd_1080p"*/ STR(615), IntType(1920), IntType(1080)), new_videotemplate(/*"qhd_1440p"*/ STR(616), IntType(2560), IntType(1440)), new_videotemplate(/*"uhd_4k"*/ STR(617), IntType(3840), IntType(2160)), new_videotemplate(/*"hd_720p_cinematic"*/ STR(618), IntType(1680), IntType(720)), new_videotemplate(/*"fhd_1080p_cinematic"*/ STR(619), IntType(2560), IntType(1080)), new_videotemplate(/*"qhd_1440p_cinematic"*/ STR(620), IntType(3440), IntType(1440)), new_videotemplate(/*"uhd_4k_cinematic"*/ STR(621), IntType(5120), IntType(2160)) });
		global::videoquality_list = ds_list_create();
		ds_list_add({ global::videoquality_list, new_videoquality(/*"best"*/ STR(622), IntType(5000000)), new_videoquality(/*"high"*/ STR(623), IntType(2500000)), new_videoquality(/*"medium"*/ STR(624), IntType(1200000)), new_videoquality(/*"low"*/ STR(625), IntType(700000)), new_videoquality(/*"verylow"*/ STR(626), IntType(350000)) });
		...
		ds_list_add({ global::biome_list, new_biome(/*"custom"*/ STR(627), IntType(0), IntType(0), true, c_plains_biome_grass, c_plains_biome_foliage, c_plains_biome_water, null_) });
		...
		ds_list_add({ global::blend_mode_list, /*"normal"*/ STR(628), /*"add"*/ STR(629), /*"subtract"*/ STR(630), /*"multiply"*/ STR(631), /*"screen"*/ STR(632) });
		global::blend_mode_map = ds_map_create();
		ds_map_add(global::blend_mode_map, /*"normal"*/ STR(628), bm_normal);
		ds_map_add(global::blend_mode_map, /*"add"*/ STR(629), bm_add);
		ds_map_add(global::blend_mode_map, /*"subtract"*/ STR(630), bm_subtract);
		ds_map_add(global::blend_mode_map, /*"multiply"*/ STR(631), ArrType::From({ bm_zero, bm_src_color }));
		ds_map_add(global::blend_mode_map, /*"screen"*/ STR(632), ArrType::From({ bm_one, bm_inv_src_color }));
		...
		ds_list_add({ global::render_pass_list, /*"combined"*/ STR(633), /*"diffuse"*/ STR(634), /*"specular"*/ STR(635), /*"ao"*/ STR(636), /*"shadows"*/ STR(130), /*"indirect"*/ STR(132), /*"indirectshadows"*/ STR(637), /*"reflections"*/ STR(133), /*"depth"*/ STR(638), /*"normal"*/ STR(628), /*"material"*/ STR(639) });
	}
	...
	{
		sStr(recent_display_mode) = /*"grid"*/ STR(640);
	...
	void app_startup_themes(ScopeAny self)
	{
		...
		{
			self->name = /*"light"*/ STR(641);
			self->dark = false;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DB3030"*/ STR(642)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D85B00"*/ STR(643)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D68E02"*/ STR(644)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"34A100"*/ STR(645)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"0D8E41"*/ STR(646)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"048E8E"*/ STR(647)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"2144F1"*/ STR(648)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"982BCB"*/ STR(649)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"E93983"*/ STR(650)));
			self->level_top = hex_to_color(/*"F7FAFC"*/ STR(651));
			self->level_middle = hex_to_color(/*"ECEFF1"*/ STR(652));
			self->level_bottom = hex_to_color(/*"D7DFE2"*/ STR(653));
			self->viewport_top = hex_to_color(/*"F0FFFF"*/ STR(654));
			self->viewport_bottom = hex_to_color(/*"B5E8F2"*/ STR(655));
			self->text_main = hex_to_color(/*"0D1214"*/ STR(656));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"FFFFFF"*/ STR(657));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .15;
			self->red_error = hex_to_color(/*"FF1D0F"*/ STR(658));
			self->yellow_warning = hex_to_color(/*"FFC01E"*/ STR(659));
			self->green_success = hex_to_color(/*"61C159"*/ STR(660));
			self->red = hex_to_color(/*"FF5656"*/ STR(661));
			self->green = hex_to_color(/*"4AB758"*/ STR(662));
			self->blue = hex_to_color(/*"1370FB"*/ STR(663));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(664));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(665));
			self->yellow = hex_to_color(/*"F4CC5D"*/ STR(666));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(667));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"158AF5"*/ STR(668));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64A56B"*/ STR(669));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"D09522"*/ STR(670));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF1D0F"*/ STR(658));
		}
		
		global::theme_dark = (new obj_theme)->id;
		withOne (obj_theme, global::theme_dark, self->id)
		{
			self->name = /*"dark"*/ STR(671);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(672)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFA360"*/ STR(673)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFF065"*/ STR(674)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"8BFF6D"*/ STR(675)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"4EF390"*/ STR(676)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"49EED9"*/ STR(677)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"98BBFF"*/ STR(678)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(679)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(680)));
			self->level_top = hex_to_color(/*"37444A"*/ STR(681));
			self->level_middle = hex_to_color(/*"2B373D"*/ STR(682));
			self->level_bottom = hex_to_color(/*"18242A"*/ STR(683));
			self->viewport_top = hex_to_color(/*"2B373D"*/ STR(682));
			self->viewport_bottom = hex_to_color(/*"839096"*/ STR(684));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(657));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"000000"*/ STR(685));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .25;
			self->red_error = hex_to_color(/*"FF7A72"*/ STR(686));
			self->yellow_warning = hex_to_color(/*"FFEB36"*/ STR(687));
			self->green_success = hex_to_color(/*"64E879"*/ STR(688));
			self->red = hex_to_color(/*"FF5656"*/ STR(661));
			self->green = hex_to_color(/*"23FF88"*/ STR(689));
			self->blue = hex_to_color(/*"1370FB"*/ STR(663));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(664));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(665));
			self->yellow = hex_to_color(/*"FFD969"*/ STR(690));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(667));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"7EC1FF"*/ STR(691));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64E879"*/ STR(688));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"FFEB36"*/ STR(687));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF7A72"*/ STR(686));
		}
		
		global::theme_darker = (new obj_theme)->id;
		withOne (obj_theme, global::theme_darker, self->id)
		{
			self->name = /*"darker"*/ STR(692);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(672)));
			...
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(679)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(680)));
			self->level_top = hex_to_color(/*"1C1C1C"*/ STR(693));
			self->level_middle = hex_to_color(/*"101010"*/ STR(694));
			self->level_bottom = hex_to_color(/*"050505"*/ STR(695));
			self->viewport_top = hex_to_color(/*"484848"*/ STR(696));
			self->viewport_bottom = hex_to_color(/*"2B2B2B"*/ STR(697));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(657));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
	...
	void app_update_animate(ScopeAny self)
	{
		...
		if (bgobject > 0)
		{
			...
			if (sVar(background_biome) == /*"custom"*/ STR(627) || sVar(background_biome_prev) != sVar(background_biome))
			{
		...
		sInt(background_sky_color_final) = merge_color((IntType)(sVar(background_sky_color)), (IntType)(hex_to_color(/*"020204"*/ STR(699))), background_sky_night_alpha());
	...
	void app_update_caption()
	{
		if (global::_app->project_name != /*""*/ STR(0))
			window_set_caption(global::_app->project_name + string_repeat(/*" * "*/ STR(700), global::_app->project_changed) + /*" - Mine-imator"*/ STR(701));
		else
			window_set_caption(/*"Mine-imator"*/ STR(23));
	...
	void app_update_keybinds()
	{
		...
		for (IntType i = IntType(0); i < e_keybind_amount; i++)
		{
			...
			check = keybind_check(obj, /*"keyboard_check"*/ STR(702));
			idBool(obj, released) = false;
			if (idVar(obj, active) > 0)
				idBool(obj, released) = keybind_check(obj, /*"keyboard_check_released"*/ STR(703));
			idBool(obj, pressed) = keybind_check(obj, /*"keyboard_check_pressed"*/ STR(704));
	...
	void app_update_keyboard(ScopeAny self)
	{
		...
		if (sStr(window_state) == /*""*/ STR(0) && (sVar(window_busy) == /*""*/ STR(0) || sStr(settings_menu_name) == /*"colorpicker"*/ STR(705)) && !sBool(textbox_isediting))
		{
