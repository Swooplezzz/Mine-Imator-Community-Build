...
namespace CppProject
{
	...
	void app_startup_lists(ScopeAny self)
	{
		...
		ds_list_add({ global::temp_type_name_list, /*"char"*/ STR(546), /*"spblock"*/ STR(547), /*"scenery"*/ STR(548), /*"item"*/ STR(549), /*"block"*/ STR(4), /*"bodypart"*/ STR(550), /*"particles"*/ STR(551), /*"text"*/ STR(104), /*"cube"*/ STR(3), /*"cone"*/ STR(552), /*"cylinder"*/ STR(553), /*"sphere"*/ STR(554), /*"surface"*/ STR(555), /*"model"*/ STR(8) });
		global::tl_type_name_list = ds_list_create();
		ds_list_add({ global::tl_type_name_list, /*"char"*/ STR(546), /*"spblock"*/ STR(547), /*"scenery"*/ STR(548), /*"item"*/ STR(549), /*"block"*/ STR(4), /*"bodypart"*/ STR(550), /*"particles"*/ STR(551), /*"text"*/ STR(104), /*"cube"*/ STR(3), /*"cone"*/ STR(552), /*"cylinder"*/ STR(553), /*"sphere"*/ STR(554), /*"surface"*/ STR(555), /*"model"*/ STR(8), /*"camera"*/ STR(126), /*"spotlight"*/ STR(556), /*"pointlight"*/ STR(557), /*"folder"*/ STR(558), /*"background"*/ STR(225), /*"audio"*/ STR(559), /*"path"*/ STR(560), /*"pathpoint"*/ STR(561), /*"shape"*/ STR(562), /*"lightsource"*/ STR(563) });
		global::res_type_name_list = ds_list_create();
		ds_list_add({ global::res_type_name_list, /*"pack"*/ STR(564), /*"packunzipped"*/ STR(565), /*"skin"*/ STR(566), /*"downloadskin"*/ STR(210), /*"itemsheet"*/ STR(567), /*"legacyblocksheet"*/ STR(568), /*"blocksheet"*/ STR(569), /*"scenery"*/ STR(548), /*"fromworld"*/ STR(570), /*"particlesheet"*/ STR(571), /*"texture"*/ STR(572), /*"font"*/ STR(573), /*"sound"*/ STR(574), /*"model"*/ STR(8) });
		global::transition_list = ds_list_create();
		ds_list_add({ global::transition_list, /*"linear"*/ STR(575), /*"instant"*/ STR(576), /*"bezier"*/ STR(577), /*"easeinquad"*/ STR(578), /*"easeoutquad"*/ STR(579), /*"easeinoutquad"*/ STR(580), /*"easeincubic"*/ STR(581), /*"easeoutcubic"*/ STR(582), /*"easeinoutcubic"*/ STR(583), /*"easeinquart"*/ STR(584), /*"easeoutquart"*/ STR(585), /*"easeinoutquart"*/ STR(586), /*"easeinquint"*/ STR(587), /*"easeoutquint"*/ STR(588), /*"easeinoutquint"*/ STR(589), /*"easeinsine"*/ STR(590), /*"easeoutsine"*/ STR(591), /*"easeinoutsine"*/ STR(592), /*"easeinexpo"*/ STR(593), /*"easeoutexpo"*/ STR(594), /*"easeinoutexpo"*/ STR(595), /*"easeincirc"*/ STR(596), /*"easeoutcirc"*/ STR(597), /*"easeinoutcirc"*/ STR(598), /*"easeinelastic"*/ STR(599), /*"easeoutelastic"*/ STR(600), /*"easeinoutelastic"*/ STR(601), /*"easeinback"*/ STR(602), /*"easeoutback"*/ STR(603), /*"easeinoutback"*/ STR(604), /*"easeinbounce"*/ STR(605), /*"easeoutbounce"*/ STR(606), /*"easeinoutbounce"*/ STR(607) });
		...
		log({ /*"Transitions OK"*/ STR(613) });
		global::videotemplate_list = ds_list_create();
		ds_list_add({ global::videotemplate_list, new_videotemplate(/*"avatar"*/ STR(614), IntType(512), IntType(512)), new_videotemplate(/*"hd_720p"*/ STR(615), IntType(1280), IntType(720)), new_videotemplate(/*"fhd_1080p"*/ STR(616), IntType(1920), IntType(1080)), new_videotemplate(/*"qhd_1440p"*/ STR(617), IntType(2560), IntType(1440)), new_videotemplate(/*"uhd_4k"*/ STR(618), IntType(3840), IntType(2160)), new_videotemplate(/*"hd_720p_cinematic"*/ STR(619), IntType(1680), IntType(720)), new_videotemplate(/*"fhd_1080p_cinematic"*/ STR(620), IntType(2560), IntType(1080)), new_videotemplate(/*"qhd_1440p_cinematic"*/ STR(621), IntType(3440), IntType(1440)), new_videotemplate(/*"uhd_4k_cinematic"*/ STR(622), IntType(5120), IntType(2160)) });
		global::videoquality_list = ds_list_create();
		ds_list_add({ global::videoquality_list, new_videoquality(/*"best"*/ STR(623), IntType(5000000)), new_videoquality(/*"high"*/ STR(624), IntType(2500000)), new_videoquality(/*"medium"*/ STR(625), IntType(1200000)), new_videoquality(/*"low"*/ STR(626), IntType(700000)), new_videoquality(/*"verylow"*/ STR(627), IntType(350000)) });
		...
		ds_list_add({ global::biome_list, new_biome(/*"custom"*/ STR(628), IntType(0), IntType(0), true, c_plains_biome_grass, c_plains_biome_foliage, c_plains_biome_water, null_) });
		...
		ds_list_add({ global::blend_mode_list, /*"normal"*/ STR(629), /*"add"*/ STR(630), /*"subtract"*/ STR(631), /*"multiply"*/ STR(632), /*"screen"*/ STR(633) });
		global::blend_mode_map = ds_map_create();
		ds_map_add(global::blend_mode_map, /*"normal"*/ STR(629), bm_normal);
		ds_map_add(global::blend_mode_map, /*"add"*/ STR(630), bm_add);
		ds_map_add(global::blend_mode_map, /*"subtract"*/ STR(631), bm_subtract);
		ds_map_add(global::blend_mode_map, /*"multiply"*/ STR(632), ArrType::From({ bm_zero, bm_src_color }));
		ds_map_add(global::blend_mode_map, /*"screen"*/ STR(633), ArrType::From({ bm_one, bm_inv_src_color }));
		...
		ds_list_add({ global::render_pass_list, /*"combined"*/ STR(634), /*"diffuse"*/ STR(635), /*"specular"*/ STR(636), /*"ao"*/ STR(637), /*"shadows"*/ STR(129), /*"indirect"*/ STR(131), /*"indirectshadows"*/ STR(638), /*"reflections"*/ STR(132), /*"depth"*/ STR(639), /*"normal"*/ STR(629), /*"material"*/ STR(640) });
	}
	...
	{
		sStr(recent_display_mode) = /*"grid"*/ STR(641);
	...
	void app_startup_themes(ScopeAny self)
	{
		...
		{
			self->name = /*"light"*/ STR(642);
			self->dark = false;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DB3030"*/ STR(643)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D85B00"*/ STR(644)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"D68E02"*/ STR(645)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"34A100"*/ STR(646)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"0D8E41"*/ STR(647)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"048E8E"*/ STR(648)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"2144F1"*/ STR(649)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"982BCB"*/ STR(650)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"E93983"*/ STR(651)));
			self->level_top = hex_to_color(/*"F7FAFC"*/ STR(652));
			self->level_middle = hex_to_color(/*"ECEFF1"*/ STR(653));
			self->level_bottom = hex_to_color(/*"D7DFE2"*/ STR(654));
			self->viewport_top = hex_to_color(/*"F0FFFF"*/ STR(655));
			self->viewport_bottom = hex_to_color(/*"B5E8F2"*/ STR(656));
			self->text_main = hex_to_color(/*"0D1214"*/ STR(657));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"FFFFFF"*/ STR(658));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .15;
			self->red_error = hex_to_color(/*"FF1D0F"*/ STR(659));
			self->yellow_warning = hex_to_color(/*"FFC01E"*/ STR(660));
			self->green_success = hex_to_color(/*"61C159"*/ STR(661));
			self->red = hex_to_color(/*"FF5656"*/ STR(662));
			self->green = hex_to_color(/*"4AB758"*/ STR(663));
			self->blue = hex_to_color(/*"1370FB"*/ STR(664));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(665));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(666));
			self->yellow = hex_to_color(/*"F4CC5D"*/ STR(667));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(668));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"158AF5"*/ STR(669));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64A56B"*/ STR(670));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"D09522"*/ STR(671));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF1D0F"*/ STR(659));
		}
		
		global::theme_dark = (new obj_theme)->id;
		withOne (obj_theme, global::theme_dark, self->id)
		{
			self->name = /*"dark"*/ STR(672);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(673)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFA360"*/ STR(674)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FFF065"*/ STR(675)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"8BFF6D"*/ STR(676)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"4EF390"*/ STR(677)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"49EED9"*/ STR(678)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"98BBFF"*/ STR(679)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(680)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(681)));
			self->level_top = hex_to_color(/*"37444A"*/ STR(682));
			self->level_middle = hex_to_color(/*"2B373D"*/ STR(683));
			self->level_bottom = hex_to_color(/*"18242A"*/ STR(684));
			self->viewport_top = hex_to_color(/*"2B373D"*/ STR(683));
			self->viewport_bottom = hex_to_color(/*"839096"*/ STR(685));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(658));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
			self->overlay = self->text_main;
			self->button_text = hex_to_color(/*"000000"*/ STR(686));
			self->button_text_alpha = .91;
			self->dark_overlay_alpha = .25;
			self->red_error = hex_to_color(/*"FF7A72"*/ STR(687));
			self->yellow_warning = hex_to_color(/*"FFEB36"*/ STR(688));
			self->green_success = hex_to_color(/*"64E879"*/ STR(689));
			self->red = hex_to_color(/*"FF5656"*/ STR(662));
			self->green = hex_to_color(/*"23FF88"*/ STR(690));
			self->blue = hex_to_color(/*"1370FB"*/ STR(664));
			self->pink = hex_to_color(/*"FF5FFF"*/ STR(665));
			self->cyan = hex_to_color(/*"51C2FF"*/ STR(666));
			self->yellow = hex_to_color(/*"FFD969"*/ STR(691));
			self->magenta = hex_to_color(/*"FF37E8"*/ STR(668));
			self->toast_color[e_toast_INFO] = hex_to_color(/*"7EC1FF"*/ STR(692));
			self->toast_color[e_toast_POSITIVE] = hex_to_color(/*"64E879"*/ STR(689));
			self->toast_color[e_toast_WARNING] = hex_to_color(/*"FFEB36"*/ STR(688));
			self->toast_color[e_toast_NEGATIVE] = hex_to_color(/*"FF7A72"*/ STR(687));
		}
		
		global::theme_darker = (new obj_theme)->id;
		withOne (obj_theme, global::theme_darker, self->id)
		{
			self->name = /*"darker"*/ STR(693);
			self->dark = true;
			self->pattern = IntType(0);
			self->accent_list = ArrType();
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF7E76"*/ STR(673)));
			...
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"DF9CFF"*/ STR(680)));
			array_add(VarType::CreateRef(self->accent_list), hex_to_color(/*"FF9BC5"*/ STR(681)));
			self->level_top = hex_to_color(/*"1C1C1C"*/ STR(694));
			self->level_middle = hex_to_color(/*"101010"*/ STR(695));
			self->level_bottom = hex_to_color(/*"050505"*/ STR(696));
			self->viewport_top = hex_to_color(/*"484848"*/ STR(697));
			self->viewport_bottom = hex_to_color(/*"2B2B2B"*/ STR(698));
			self->text_main = hex_to_color(/*"FFFFFF"*/ STR(658));
			self->text_secondary = self->text_main;
			self->text_tertiary = self->text_main;
			self->border = self->text_main;
	...
	void app_startup_window(ScopeAny self)
	{
		...
		sStr(popup_block_ani_ease) = /*"easeoutcirc"*/ STR(597);
	...
	void app_update_animate(ScopeAny self)
	{
		...
		if (bgobject > 0)
		{
			...
			if (sVar(background_biome) == /*"custom"*/ STR(628) || sVar(background_biome_prev) != sVar(background_biome))
			{
		...
		sInt(background_sky_color_final) = merge_color((IntType)(sVar(background_sky_color)), (IntType)(hex_to_color(/*"020204"*/ STR(700))), background_sky_night_alpha());
	...
	void app_update_caption()
	{
		if (global::_app->project_name != /*""*/ STR(0))
			window_set_caption(global::_app->project_name + string_repeat(/*" * "*/ STR(701), global::_app->project_changed) + /*" - Mine-imator"*/ STR(702));
		else
			window_set_caption(/*"Mine-imator"*/ STR(23));
	...
	void app_update_keybinds()
	{
		...
		for (IntType i = IntType(0); i < e_keybind_amount; i++)
		{
			...
			check = keybind_check(obj, /*"keyboard_check"*/ STR(703));
			idBool(obj, released) = false;
			if (idVar(obj, active) > 0)
				idBool(obj, released) = keybind_check(obj, /*"keyboard_check_released"*/ STR(704));
			idBool(obj, pressed) = keybind_check(obj, /*"keyboard_check_pressed"*/ STR(705));
	...
	void app_update_keyboard(ScopeAny self)
	{
		...
		if (sStr(window_state) == /*""*/ STR(0) && (sVar(window_busy) == /*""*/ STR(0) || sStr(settings_menu_name) == /*"colorpicker"*/ STR(706)) && !sBool(textbox_isediting))
		{
