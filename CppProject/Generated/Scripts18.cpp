...
namespace CppProject
{
	...
	void app_startup_keybinds()
	{
		...
		keybind_register(/*"projectnew"*/ STR(253), e_keybind_PROJECT_NEW, keybind_new(/*"N"*/ STR(254), true));
		keybind_register(/*"projectopen"*/ STR(255), e_keybind_PROJECT_OPEN, keybind_new(/*"O"*/ STR(256), true));
		keybind_register(/*"projectsave"*/ STR(257), e_keybind_PROJECT_SAVE, keybind_new(/*"S"*/ STR(258), true));
		keybind_register(/*"projectsaveas"*/ STR(259), e_keybind_PROJECT_SAVE_AS, keybind_new(/*"S"*/ STR(258), true, true));
		keybind_register(/*"importasset"*/ STR(260), e_keybind_IMPORT_ASSET, keybind_new(/*"I"*/ STR(261), true));
		keybind_register(/*"undo"*/ STR(262), e_keybind_UNDO, keybind_new(/*"Z"*/ STR(263), true));
		keybind_register(/*"redo"*/ STR(264), e_keybind_REDO, keybind_new(/*"Y"*/ STR(265), true));
		keybind_register(/*"timelinedelete"*/ STR(266), e_keybind_TIMELINE_DELETE, keybind_new(/*"R"*/ STR(267), true));
		keybind_register(/*"timelineduplicate"*/ STR(268), e_keybind_TIMELINE_DUPLICATE, keybind_new(/*"D"*/ STR(269), true));
		keybind_register(/*"timelineselect"*/ STR(270), e_keybind_TIMELINE_SELECT, keybind_new(/*"A"*/ STR(271), true));
		keybind_register(/*"timelinehide"*/ STR(272), e_keybind_TIMELINE_HIDE, keybind_new(/*"H"*/ STR(273), true));
		keybind_register(/*"timelineshowhidden"*/ STR(274), e_keybind_TIMELINE_SHOW_HIDDEN, keybind_new(/*"H"*/ STR(273), true, false, true));
		keybind_register(/*"createfolder"*/ STR(275), e_keybind_CREATE_FOLDER, keybind_new(/*"F"*/ STR(276), true));
		keybind_register(/*"keyframescreate"*/ STR(277), e_keybind_KEYFRAMES_CREATE, keybind_new(/*"Q"*/ STR(278), true));
		keybind_register(/*"keyframescopy"*/ STR(279), e_keybind_KEYFRAMES_COPY, keybind_new(/*"C"*/ STR(280), true));
		keybind_register(/*"keyframescut"*/ STR(281), e_keybind_KEYFRAMES_CUT, keybind_new(/*"X"*/ STR(282), true));
		keybind_register(/*"keyframespaste"*/ STR(283), e_keybind_KEYFRAMES_PASTE, keybind_new(/*"V"*/ STR(284), true));
		keybind_register(/*"keyframesdelete"*/ STR(285), e_keybind_KEYFRAMES_DELETE, keybind_new(vk_delete));
		keybind_register(/*"play"*/ STR(286), e_keybind_PLAY, keybind_new(vk_space));
		keybind_register(/*"playbeginning"*/ STR(287), e_keybind_PLAY_BEGINNING, keybind_new(vk_enter));
		keybind_register(/*"markerleft"*/ STR(288), e_keybind_MARKER_LEFT, keybind_new(vk_left), true);
		keybind_register(/*"markerright"*/ STR(289), e_keybind_MARKER_RIGHT, keybind_new(vk_right), true);
		keybind_register(/*"rendermode"*/ STR(290), e_keybind_RENDER_MODE, keybind_new(vk_f5));
		keybind_register(/*"particlesspawn"*/ STR(291), e_keybind_PARTICLES_SPAWN, keybind_new(/*"X"*/ STR(282)));
		keybind_register(/*"particlesclear"*/ STR(292), e_keybind_PARTICLES_CLEAR, keybind_new(/*"C"*/ STR(280)));
		keybind_register(/*"secondaryview"*/ STR(293), e_keybind_SECONDARY_VIEW, keybind_new(vk_f6));
		keybind_register(/*"toolselect"*/ STR(294), e_keybind_TOOL_SELECT, keybind_new(/*"W"*/ STR(295)));
		keybind_register(/*"toolmove"*/ STR(296), e_keybind_TOOL_MOVE, keybind_new(/*"G"*/ STR(297)));
		keybind_register(/*"toolrotate"*/ STR(298), e_keybind_TOOL_ROTATE, keybind_new(/*"R"*/ STR(267)));
		keybind_register(/*"toolscale"*/ STR(299), e_keybind_TOOL_SCALE, keybind_new(/*"S"*/ STR(258)));
		keybind_register(/*"toolbend"*/ STR(300), e_keybind_TOOL_BEND, keybind_new(/*"B"*/ STR(301)));
		keybind_register(/*"tooltransform"*/ STR(302), e_keybind_TOOL_TRANSFORM, keybind_new(/*"T"*/ STR(303)));
		keybind_register(/*"snap"*/ STR(304), e_keybind_SNAP, keybind_new(/*"F"*/ STR(276)));
		keybind_register(/*"camforward"*/ STR(305), e_keybind_CAM_FORWARD, keybind_new(/*"W"*/ STR(295)), true);
		keybind_register(/*"camleft"*/ STR(306), e_keybind_CAM_LEFT, keybind_new(/*"A"*/ STR(271)), true);
		keybind_register(/*"camback"*/ STR(307), e_keybind_CAM_BACK, keybind_new(/*"S"*/ STR(258)), true);
		keybind_register(/*"camright"*/ STR(308), e_keybind_CAM_RIGHT, keybind_new(/*"D"*/ STR(269)), true);
		keybind_register(/*"camascend"*/ STR(309), e_keybind_CAM_ASCEND, keybind_new(/*"E"*/ STR(310)), true);
		keybind_register(/*"camdescend"*/ STR(311), e_keybind_CAM_DESCEND, keybind_new(/*"Q"*/ STR(278)), true);
		keybind_register(/*"camrollforward"*/ STR(312), e_keybind_CAM_ROLL_FORWARD, keybind_new(/*"Z"*/ STR(263)), true);
		keybind_register(/*"camrollback"*/ STR(313), e_keybind_CAM_ROLL_BACK, keybind_new(/*"C"*/ STR(280)), true);
		keybind_register(/*"camrollreset"*/ STR(314), e_keybind_CAM_ROLL_RESET, keybind_new(/*"X"*/ STR(282)), true);
		keybind_register(/*"camreset"*/ STR(315), e_keybind_CAM_RESET, keybind_new(/*"R"*/ STR(267)), true);
		keybind_register(/*"camfast"*/ STR(316), e_keybind_CAM_FAST, keybind_new(vk_space), true);
		keybind_register(/*"camslow"*/ STR(317), e_keybind_CAM_SLOW, keybind_new(null_, false, true), true);
		keybind_register(/*"camviewtimeline"*/ STR(318), e_keybind_CAM_VIEW_TIMELINE, keybind_new(/*"V"*/ STR(284)), false);
	...
	void app_startup_lists(ScopeAny self)
	{
		...
		ds_list_add({ global::temp_type_name_list, /*"char"*/ STR(544), /*"spblock"*/ STR(545), /*"scenery"*/ STR(546), /*"item"*/ STR(547), /*"block"*/ STR(4), /*"bodypart"*/ STR(548), /*"particles"*/ STR(549), /*"text"*/ STR(105), /*"cube"*/ STR(3), /*"cone"*/ STR(550), /*"cylinder"*/ STR(551), /*"sphere"*/ STR(552), /*"surface"*/ STR(553), /*"model"*/ STR(8) });
		global::tl_type_name_list = ds_list_create();
		ds_list_add({ global::tl_type_name_list, /*"char"*/ STR(544), /*"spblock"*/ STR(545), /*"scenery"*/ STR(546), /*"item"*/ STR(547), /*"block"*/ STR(4), /*"bodypart"*/ STR(548), /*"particles"*/ STR(549), /*"text"*/ STR(105), /*"cube"*/ STR(3), /*"cone"*/ STR(550), /*"cylinder"*/ STR(551), /*"sphere"*/ STR(552), /*"surface"*/ STR(553), /*"model"*/ STR(8), /*"camera"*/ STR(127), /*"spotlight"*/ STR(554), /*"pointlight"*/ STR(555), /*"folder"*/ STR(556), /*"background"*/ STR(224), /*"audio"*/ STR(557), /*"path"*/ STR(558), /*"pathpoint"*/ STR(559), /*"shape"*/ STR(560), /*"lightsource"*/ STR(561) });
		global::res_type_name_list = ds_list_create();
		ds_list_add({ global::res_type_name_list, /*"pack"*/ STR(562), /*"packunzipped"*/ STR(563), /*"skin"*/ STR(564), /*"downloadskin"*/ STR(209), /*"itemsheet"*/ STR(565), /*"legacyblocksheet"*/ STR(566), /*"blocksheet"*/ STR(567), /*"scenery"*/ STR(546), /*"fromworld"*/ STR(568), /*"particlesheet"*/ STR(569), /*"texture"*/ STR(570), /*"font"*/ STR(571), /*"sound"*/ STR(572), /*"model"*/ STR(8) });
		...
		ds_list_add({ global::render_pass_list, /*"combined"*/ STR(632), /*"diffuse"*/ STR(633), /*"specular"*/ STR(634), /*"ao"*/ STR(635), /*"shadows"*/ STR(130), /*"indirect"*/ STR(132), /*"indirectshadows"*/ STR(636), /*"reflections"*/ STR(133), /*"depth"*/ STR(637), /*"normal"*/ STR(627), /*"material"*/ STR(638) });
	}
	...
	void app_update_keybinds()
	{
		...
		for (IntType i = IntType(0); i < e_keybind_amount; i++)
		{
			...
			if (idBool(obj, pressed) && idBool(obj, navigation) && string_contains(global::_app->window_busy, /*"camera"*/ STR(127)))
				navclear = true;
		}
		if (navclear)
		{
