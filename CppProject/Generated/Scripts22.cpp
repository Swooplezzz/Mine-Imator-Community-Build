...
namespace CppProject
{
	...
	{
		self->timeline = true;
		if (is_string(DsMap(map).Value(/*"model"*/ STR(538))))
		{
			self->tl_model_name = DsMap(map).Value(/*"model"*/ STR(538));
			self->tl_model_state = ArrType();
			self->tl_model_state_amount = IntType(0);
			self->tl_has_model_state = false;
			if (DsMap(typemap).Value(/*"model_state"*/ STR(877)) == e_json_type_STRING)
			{
				self->tl_model_state = string_get_state_vars(DsMap(map).Value(/*"model_state"*/ STR(877)));
				self->tl_has_model_state = true;
			}
			else
				if (DsMap(typemap).Value(/*"model_state"*/ STR(877)) == e_json_type_OBJECT)
				{
					VarType key = ds_map_find_first((IntType)(DsMap(map).Value(/*"model_state"*/ STR(877))));
					while (!is_undefined(key))
					{
						withOne (obj_block_tl_state, (new obj_block_tl_state)->id, self->id)
						{
							self->vars = string_get_state_vars(key);
							self->value = string_get_state_vars(ds_map_find_value((IntType)(DsMap(map).Value(/*"model_state"*/ STR(877))), key));
						...
						key = ds_map_find_next((IntType)(DsMap(map).Value(/*"model_state"*/ STR(877))), key);
					}
		...
		if (is_bool(DsMap(map).Value(/*"model_double"*/ STR(878))))
			self->model_double = DsMap(map).Value(/*"model_double"*/ STR(878));
		self->tl_has_text = false;
		if (is_bool(DsMap(map).Value(/*"has_text"*/ STR(879))))
			self->tl_has_text = DsMap(map).Value(/*"has_text"*/ STR(879));
		if (self->tl_has_text > 0)
			self->tl_text_position = value_get_point3D(DsMap(map).Value(/*"text_position"*/ STR(880)), point3D(IntType(0), IntType(0), IntType(0)));
		self->tl_text_scale = DsMap(map).Value(/*"text_scale"*/ STR(881));
		self->tl_pattern_type = /*""*/ STR(0);
		if (is_string(DsMap(map).Value(/*"pattern_type"*/ STR(882))))
			self->tl_pattern_type = DsMap(map).Value(/*"pattern_type"*/ STR(882));
		self->tl_rot_point = point3D(IntType(0), IntType(0), IntType(0));
		self->tl_rot_point_state_amount = IntType(0);
		if (DsMap(typemap).Value(/*"rotation_point"*/ STR(883)) == e_json_type_ARRAY)
			self->tl_rot_point = value_get_point3D(DsMap(map).Value(/*"rotation_point"*/ STR(883)), point3D(IntType(0), IntType(0), IntType(0)));
		else
			if (DsMap(typemap).Value(/*"rotation_point"*/ STR(883)) == e_json_type_OBJECT)
			{
				VarType key = ds_map_find_first((IntType)(DsMap(map).Value(/*"rotation_point"*/ STR(883))));
				while (!is_undefined(key))
				{
					withOne (obj_block_tl_state, (new obj_block_tl_state)->id, self->id)
					{
						self->vars = string_get_state_vars(key);
						self->value = value_get_point3D(ds_map_find_value((IntType)(DsMap(map).Value(/*"rotation_point"*/ STR(883))), key), point3D(IntType(0), IntType(0), IntType(0)));
						self->state_id = ArrType();
						for (IntType i = IntType(0); i < ObjType(obj_block, self.otherId)->state_id_amount; i++)
							if (state_vars_match_state_id(self->vars, self.otherId, i))
								self->state_id = array_add(VarType::CreateRef(self->state_id), i);
					...
					key = ds_map_find_next((IntType)(DsMap(map).Value(/*"rotation_point"*/ STR(883))), key);
				}
		...
		if (DsMap(typemap).Value(/*"rotation"*/ STR(837)) == e_json_type_ARRAY)
			self->tl_rotation = value_get_point3D(DsMap(map).Value(/*"rotation"*/ STR(837)), point3D(IntType(0), IntType(0), IntType(0)));
		else
			if (DsMap(typemap).Value(/*"rotation"*/ STR(837)) == e_json_type_OBJECT)
			{
				VarType key = ds_map_find_first((IntType)(DsMap(map).Value(/*"rotation"*/ STR(837))));
				while (!is_undefined(key))
				{
					withOne (obj_block_tl_state, (new obj_block_tl_state)->id, self->id)
					{
						self->vars = string_get_state_vars(key);
						self->value = value_get_point3D(ds_map_find_value((IntType)(DsMap(map).Value(/*"rotation"*/ STR(837))), key), point3D(IntType(0), IntType(0), IntType(0)));
						self->state_id = ArrType();
						for (IntType i = IntType(0); i < ObjType(obj_block, self.otherId)->state_id_amount; i++)
							if (state_vars_match_state_id(self->vars, self.otherId, i))
								self->state_id = array_add(VarType::CreateRef(self->state_id), i);
					...
					key = ds_map_find_next((IntType)(DsMap(map).Value(/*"rotation"*/ STR(837))), key);
				}
	...
	{
		if (is_undefined(DsMap(map).Value(/*"model"*/ STR(538))))
		{
			log({ /*"Missing parameter \"model\""*/ STR(884) });
			return false;
		}
		StringType blockname;
		VarType blockmodel;
		blockname = string_replace(DsMap(map).Value(/*"model"*/ STR(538)), /*"minecraft:"*/ STR(829), /*""*/ STR(0));
		blockmodel = block_load_model_file(global::load_assets_dir + mc_models_directory + blockname + /*".json"*/ STR(720));
		if (!(blockmodel > 0))
			return false;
		VecType rot = vec3(IntType(0), IntType(0), IntType(0));
		if (!is_undefined(DsMap(map).Value(/*"x"*/ STR(841))))
			rot.Real(X_) = clamp(snap(DsMap(map).Value(/*"x"*/ STR(841)), IntType(90)), IntType(0), IntType(270));
		if (!is_undefined(DsMap(map).Value(/*"y"*/ STR(824))))
			rot.Real(Z_) = clamp(snap(DsMap(map).Value(/*"y"*/ STR(824)), IntType(90)), IntType(0), IntType(270));
		VarType uvlock = false;
		if (is_bool(DsMap(map).Value(/*"uvlock"*/ STR(885))))
			uvlock = DsMap(map).Value(/*"uvlock"*/ STR(885));
		else
			if (is_string(DsMap(map).Value(/*"uvlock"*/ STR(885))))
				uvlock = (DsMap(map).Value(/*"uvlock"*/ STR(885)) == /*"true"*/ STR(768));
		
		VarType weight = IntType(1);
		if (!is_undefined(DsMap(map).Value(/*"weight"*/ STR(886))))
			weight = DsMap(map).Value(/*"weight"*/ STR(886));
		...
		switch ((IntType)culldir)
		{
			case e_dir_EAST:
			{
				if (!idBool(el, face_edge_xp) || self->block_face_min_depth_xp == null_ || self->block_face_min_depth_xp > ObjType(obj_block_render_model, model)->face_min_depth_xp)
					return false;
				if (self->block_current != null_ && ObjType(obj_block, self->block_current)->type == /*"leaves"*/ STR(887) && self->block_face_min_depth_xp > e_block_depth_DEPTH0)
					return false;
			...
			case e_dir_WEST:
			{
				if (!idBool(el, face_edge_xn) || self->block_face_min_depth_xn == null_ || self->block_face_min_depth_xn > ObjType(obj_block_render_model, model)->face_min_depth_xn)
					return false;
				if (self->block_current != null_ && ObjType(obj_block, self->block_current)->type == /*"leaves"*/ STR(887) && self->block_face_min_depth_xn > e_block_depth_DEPTH0)
					return false;
			...
			case e_dir_SOUTH:
			{
				if (!idBool(el, face_edge_yp) || self->block_face_min_depth_yp == null_ || self->block_face_min_depth_yp > ObjType(obj_block_render_model, model)->face_min_depth_yp)
					return false;
				if (self->block_current != null_ && ObjType(obj_block, self->block_current)->type == /*"leaves"*/ STR(887) && self->block_face_min_depth_yp > e_block_depth_DEPTH0)
					return false;
			...
			case e_dir_NORTH:
			{
				if (!idBool(el, face_edge_yn) || self->block_face_min_depth_yn == null_ || self->block_face_min_depth_yn > ObjType(obj_block_render_model, model)->face_min_depth_yn)
					return false;
				if (self->block_current != null_ && ObjType(obj_block, self->block_current)->type == /*"leaves"*/ STR(887) && self->block_face_min_depth_yn > e_block_depth_DEPTH0)
					return false;
			...
			case e_dir_UP:
			{
				if (!idBool(el, face_edge_zp) || self->block_face_min_depth_zp == null_ || self->block_face_min_depth_zp > ObjType(obj_block_render_model, model)->face_min_depth_zp)
					return false;
				if (self->block_current != null_ && ObjType(obj_block, self->block_current)->type == /*"leaves"*/ STR(887) && self->block_face_min_depth_zp > e_block_depth_DEPTH0)
					return false;
			...
			case e_dir_DOWN:
			{
				if (!idBool(el, face_edge_zn) || self->block_face_min_depth_zn == null_ || self->block_face_min_depth_zn > ObjType(obj_block_render_model, model)->face_min_depth_zn)
					return false;
				if (self->block_current != null_ && ObjType(obj_block, self->block_current)->type == /*"leaves"*/ STR(887) && self->block_face_min_depth_zn > e_block_depth_DEPTH0)
					return false;
	...
	RealType block_set_bars(ScopeAny self)
	{
		...
		if (!sBool(build_edge_xp))
		{
			...
			if ((block != null_ && (idVar(block, type) == /*"bars"*/ STR(888) || idVar(block, type) == /*"colored_bars"*/ STR(889))) || (sInt(block_face_min_depth_xp) != e_block_depth_DEPTH1 && sBool(block_face_full_xp)))
				east = /*"true"*/ STR(768);
		}
		if (!sBool(build_edge_xn))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x) - IntType(1), sInt(build_pos_y), sInt(build_pos_z));
			if ((block != null_ && (idVar(block, type) == /*"bars"*/ STR(888) || idVar(block, type) == /*"colored_bars"*/ STR(889))) || (sInt(block_face_min_depth_xn) != e_block_depth_DEPTH1 && sBool(block_face_full_xn)))
				west = /*"true"*/ STR(768);
		}
		if (!sBool(build_edge_yp))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) + IntType(1), sInt(build_pos_z));
			if ((block != null_ && (idVar(block, type) == /*"bars"*/ STR(888) || idVar(block, type) == /*"colored_bars"*/ STR(889))) || (sInt(block_face_min_depth_yp) != e_block_depth_DEPTH1 && sBool(block_face_full_yp)))
				south = /*"true"*/ STR(768);
		}
		if (!sBool(build_edge_yn))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) - IntType(1), sInt(build_pos_z));
			if ((block != null_ && (idVar(block, type) == /*"bars"*/ STR(888) || idVar(block, type) == /*"colored_bars"*/ STR(889))) || (sInt(block_face_min_depth_yn) != e_block_depth_DEPTH1 && sBool(block_face_full_yn)))
				north = /*"true"*/ STR(768);
		}
	...
	{
		if (block_get_state_id_value(self->block_current, self->block_state_id_current, /*"part"*/ STR(894)) == /*"head"*/ STR(895))
			return null_;
		return IntType(0);
	}
	...
	{
		if ((self->builder_scenery && !self->builder_scenery_legacy) || block_get_state_id_value(self->block_current, self->block_state_id_current, /*"type"*/ STR(796)) == /*"big_dripleaf_stem"*/ STR(896))
			return IntType(0);
		if (self->build_pos_z != (self->build_size_z - IntType(1)))
		{
			VarType facing = block_get_state_id_value(self->block_current, self->block_state_id_current, /*"facing"*/ STR(897));
			self->block_state_id_current = block_get_state_id(self->block_current, ArrType::From({ /*"type"*/ STR(796), /*"big_dripleaf_stem"*/ STR(896), /*"facing"*/ STR(897), facing, /*"tilt"*/ STR(898), /*"none"*/ STR(899) }));
		}
		return IntType(0);
	}
	...
	RealType block_set_cave_vines(ScopeAny self)
	{
		if (!sBool(build_edge_zp))
		{
			...
			if (block == null_ || idVar(block, type) != /*"cave_vines"*/ STR(900))
				global::vertex_wave_zmax = sInt(block_pos_z) + block_size_;
		}
		else
			global::vertex_wave_zmax = sInt(block_pos_z) + block_size_;
		
		if ((sBool(builder_scenery) && !sBool(builder_scenery_legacy)) || block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"type"*/ STR(796)) == /*"cave_vines_plant"*/ STR(901))
			return IntType(0);
		VarType berries = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"berries"*/ STR(902));
		if (sInt(build_pos_z) == IntType(0))
			sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"type"*/ STR(796), /*"cave_vines"*/ STR(900), /*"berries"*/ STR(902), berries }));
		else
			sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"type"*/ STR(796), /*"cave_vines_plant"*/ STR(901), /*"berries"*/ STR(902), berries }));
	...
	VarType block_set_chest(ScopeAny self)
	{
		VarType type;
		StringType double_;
		type = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"type"*/ STR(796));
		double_ = /*"false"*/ STR(769);
		switch (StringType(type).id)
		{
			...
			case 904: // legacy
			{
				if (idVar(sInt(block_current), name) == /*"ender_chest"*/ STR(905))
					break;
				IntType connectblock, discardblock;
				connectblock = null_;
				discardblock = null_;
				VarType facing = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"facing"*/ STR(897));
		...
		sReal(block_state_id_current) = block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"double"*/ STR(906), double_);
		return IntType(0);
	}
	...
	RealType block_set_chorus_plant(ScopeAny self)
	{
		...
		{
			IntType block = builder_get_block(self, sInt(build_pos_x) + IntType(1), sInt(build_pos_y), sInt(build_pos_z));
			if (block != null_ && (block == sInt(block_current) || idVar(block, type) == /*"chorus_plant_connect"*/ STR(907)))
				east = /*"true"*/ STR(768);
		}
		if (!sBool(build_edge_xn))
		{
		...
		{
			IntType block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y), sInt(build_pos_z) - IntType(1));
			if (block != null_ && (block == sInt(block_current) || idVar(block, type) == /*"chorus_plant_connect"*/ STR(907) || idVar(block, name) == /*"end_stone"*/ STR(908)))
				down = /*"true"*/ STR(768);
		}
		sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"east"*/ STR(890), east, /*"west"*/ STR(891), west, /*"south"*/ STR(892), south, /*"north"*/ STR(893), north, /*"up"*/ STR(909), up, /*"down"*/ STR(910), down }));
		return IntType(0);
	}
	...
	RealType block_set_colored_bars(ScopeAny self)
	{
		...
		if (!sBool(builder_scenery) && sInt(build_size_x) == IntType(1) && sInt(build_size_y) == IntType(1))
			return IntType(0);
		VarType color = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"color"*/ STR(911));
		block_set_bars(self);
		sReal(block_state_id_current) = block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"color"*/ STR(911), color);
		return IntType(0);
	}
	
	VarType block_set_door(ScopeAny self)
	{
		if (block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"half"*/ STR(912)) == /*"upper"*/ STR(913))
			return null_;
		VarType hinge = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"hinge"*/ STR(914));
		if (!sBool(build_edge_zp))
		{
			...
			if (aboveblock == sInt(block_current))
			{
				...
				hinge = block_get_state_id_value(sInt(block_current), abovestateid, /*"hinge"*/ STR(914));
				sReal(block_state_id_current) = block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"hinge"*/ STR(914), hinge);
			}
		}
		VarType facing, open, dir;
		StringType location;
		facing = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"facing"*/ STR(897));
		open = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"open"*/ STR(915));
		if (facing == /*"east"*/ STR(890))
		{
			location = (hinge == /*"right"*/ STR(193) ? /*"south_west"*/ STR(916) : /*"north_west"*/ STR(917));
			if (open == /*"false"*/ STR(769))
				dir = (hinge == /*"right"*/ STR(193) ? /*"north"*/ STR(893) : /*"south"*/ STR(892));
		}
		else
			if (facing == /*"west"*/ STR(891))
			{
				location = (hinge == /*"right"*/ STR(193) ? /*"north_east"*/ STR(918) : /*"south_east"*/ STR(919));
				if (open == /*"false"*/ STR(769))
					dir = (hinge == /*"right"*/ STR(193) ? /*"south"*/ STR(892) : /*"north"*/ STR(893));
			}
			else
				if (facing == /*"south"*/ STR(892))
				{
					location = (hinge == /*"right"*/ STR(193) ? /*"north_west"*/ STR(917) : /*"north_east"*/ STR(918));
					if (open == /*"false"*/ STR(769))
						dir = (hinge == /*"right"*/ STR(193) ? /*"east"*/ STR(890) : /*"west"*/ STR(891));
				}
				else
					if (facing == /*"north"*/ STR(893))
					{
						location = (hinge == /*"right"*/ STR(193) ? /*"south_east"*/ STR(919) : /*"south_west"*/ STR(916));
						if (open == /*"false"*/ STR(769))
							dir = (hinge == /*"right"*/ STR(193) ? /*"west"*/ STR(891) : /*"east"*/ STR(890));
					}
			
		
		
		if (open == /*"true"*/ STR(768))
			dir = facing;
		VarType bottommodel = idVar(sInt(block_current), state_id_model_obj).Value(sReal(block_state_id_current));
		VarType topmodel = idVar(sInt(block_current), state_id_model_obj).Value(block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"half"*/ STR(912), /*"upper"*/ STR(913)));
		...
		sReal(block_state_id_current) = block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"location"*/ STR(920), location);
		sReal(block_state_id_current) = block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"direction"*/ STR(921), dir);
	...
	RealType block_set_dripstone(Scope<obj_builder_thread> self)
	{
		...
		thicknessprev = block_get_state_id_value(self->block_current, self->block_state_id_current, /*"thickness"*/ STR(922));
		if (thicknessprev == /*"base"*/ STR(923))
			return IntType(0);
		dir = block_get_state_id_value(self->block_current, self->block_state_id_current, /*"vertical_direction"*/ STR(924));
		size = (dir == /*"up"*/ STR(909) ? (self->build_size_z - IntType(1)) - self->build_pos_z : self->build_pos_z);
		sizeoffset = size;
		if (thicknessprev == /*"frustum"*/ STR(925))
			sizeoffset += IntType(1);
		else
			if (thicknessprev == /*"middle"*/ STR(926))
		...
		if (sizeoffset == IntType(0))
			...
			if (sizeoffset == IntType(1))
				thickness = /*"frustum"*/ STR(925);
			else
				if (size >= (self->build_size_z - IntType(1)))
					thickness = /*"base"*/ STR(923);
				else
					thickness = /*"middle"*/ STR(926);
			
		
		
		self->block_state_id_current = block_get_state_id(self->block_current, ArrType::From({ /*"vertical_direction"*/ STR(924), dir, /*"thickness"*/ STR(922), thickness }));
		return IntType(0);
	}
	...
	RealType block_set_fence(ScopeAny self)
	{
		...
		if (!sBool(build_edge_xp))
		{
			...
			if (block != null_)
			{
				if (idVar(block, type) == idVar(sInt(block_current), type) || (sInt(block_face_min_depth_xp) == e_block_depth_DEPTH0 && sBool(block_face_full_xp)))
					...
					{
						VarType facing = block_get_state_id_value(block, builder_get_state_id(self, sInt(build_pos_x) + IntType(1), sInt(build_pos_y), sInt(build_pos_z)), /*"facing"*/ STR(897));
		...
		if (!sBool(build_edge_yp))
		{
			...
			if (block != null_)
			{
				if (idVar(block, type) == idVar(sInt(block_current), type) || (sInt(block_face_min_depth_yp) == e_block_depth_DEPTH0 && sBool(block_face_full_yp)))
					...
					if (idVar(block, type) == /*"fence_gate"*/ STR(927))
					{
						VarType facing = block_get_state_id_value(block, builder_get_state_id(self, sInt(build_pos_x), sInt(build_pos_y) + IntType(1), sInt(build_pos_z)), /*"facing"*/ STR(897));
		...
		sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"variant"*/ STR(806), variant, /*"east"*/ STR(890), east, /*"west"*/ STR(891), west, /*"south"*/ STR(892), south, /*"north"*/ STR(893), north }));
		return IntType(0);
	}
	...
	RealType block_set_fence_gate(ScopeAny self)
	{
		...
		StringType inwall;
		facing = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"facing"*/ STR(897));
		inwall = /*"false"*/ STR(769);
		if (facing == /*"east"*/ STR(890) || facing == /*"west"*/ STR(891))
		{
			if (!sBool(build_edge_yp))
			{
				block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) + IntType(1), sInt(build_pos_z));
				if (block != null_ && idVar(block, type) == /*"wall"*/ STR(928))
					inwall = /*"true"*/ STR(768);
			}
			if (inwall == /*"false"*/ STR(769) && !sBool(build_edge_yn))
			{
				block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) - IntType(1), sInt(build_pos_z));
				if (block != null_ && idVar(block, type) == /*"wall"*/ STR(928))
					inwall = /*"true"*/ STR(768);
			...
			if (facing == /*"south"*/ STR(892) || facing == /*"north"*/ STR(893))
			{
				...
				if (inwall == /*"false"*/ STR(769) && !sBool(build_edge_xn))
				{
					block = builder_get_block(self, sInt(build_pos_x) - IntType(1), sInt(build_pos_y), sInt(build_pos_z));
					if (block != null_ && idVar(block, type) == /*"wall"*/ STR(928))
						inwall = /*"true"*/ STR(768);
		...
		sReal(block_state_id_current) = block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"in_wall"*/ STR(929), inwall);
		return IntType(0);
	}
	...
	RealType block_set_fire(ScopeAny self)
	{
		...
		sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"variant"*/ STR(806), variant, /*"east"*/ STR(890), east, /*"west"*/ STR(891), west, /*"south"*/ STR(892), south, /*"north"*/ STR(893), north, /*"up"*/ STR(909), up }));
		return IntType(0);
	}
	...
	RealType block_set_kelp(ScopeAny self)
	{
		...
		{
			IntType block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y), sInt(build_pos_z) - IntType(1));
			if (block == null_ || idVar(block, type) != /*"kelp"*/ STR(930))
				global::vertex_wave_zmin = sInt(block_pos_z);
		}
		else
			global::vertex_wave_zmin = sInt(block_pos_z);
		
		if ((sBool(builder_scenery) && !sBool(builder_scenery_legacy)) || block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"variant"*/ STR(806)) == /*"kelp_plant"*/ STR(931))
			return IntType(0);
		if (sInt(build_pos_z) != (sInt(build_size_z) - IntType(1)))
			sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"variant"*/ STR(806), /*"kelp_plant"*/ STR(931) }));
		return IntType(0);
	}
	...
	RealType block_set_redstone_repeater(ScopeAny self)
	{
		if (sBool(builder_scenery) && !sBool(builder_scenery_legacy))
			return IntType(0);
		if (block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"locked"*/ STR(932)) == /*"true"*/ STR(768))
			return IntType(0);
		VarType facing;
		StringType locked;
		facing = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"facing"*/ STR(897));
		locked = /*"false"*/ STR(769);
		if (!sBool(build_edge_xp) && (facing == /*"south"*/ STR(892) || facing == /*"north"*/ STR(893)))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x) + IntType(1), sInt(build_pos_y), sInt(build_pos_z));
			if (block != null_ && idVar(block, name) == /*"powered_repeater"*/ STR(933))
			{
				IntType stateid = builder_get_state_id(self, sInt(build_pos_x) + IntType(1), sInt(build_pos_y), sInt(build_pos_z));
				if (block_get_state_id_value(block, stateid, /*"facing"*/ STR(897)) == /*"east"*/ STR(890))
					locked = /*"true"*/ STR(768);
			}
		}
		if (locked == /*"false"*/ STR(769) && !sBool(build_edge_xn) && (facing == /*"south"*/ STR(892) || facing == /*"north"*/ STR(893)))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x) - IntType(1), sInt(build_pos_y), sInt(build_pos_z));
			if (block != null_ && idVar(block, name) == /*"powered_repeater"*/ STR(933))
			{
				IntType stateid = builder_get_state_id(self, sInt(build_pos_x) - IntType(1), sInt(build_pos_y), sInt(build_pos_z));
				if (block_get_state_id_value(block, stateid, /*"facing"*/ STR(897)) == /*"west"*/ STR(891))
					locked = /*"true"*/ STR(768);
			}
		}
		if (locked == /*"false"*/ STR(769) && !sBool(build_edge_yp) && (facing == /*"east"*/ STR(890) || facing == /*"west"*/ STR(891)))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) + IntType(1), sInt(build_pos_z));
			if (block != null_ && idVar(block, name) == /*"powered_repeater"*/ STR(933))
			{
				IntType stateid = builder_get_state_id(self, sInt(build_pos_x), sInt(build_pos_y) + IntType(1), sInt(build_pos_z));
				if (block_get_state_id_value(block, stateid, /*"facing"*/ STR(897)) == /*"south"*/ STR(892))
					locked = /*"true"*/ STR(768);
			}
		}
		if (locked == /*"false"*/ STR(769) && !sBool(build_edge_yn) && (facing == /*"east"*/ STR(890) || facing == /*"west"*/ STR(891)))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) - IntType(1), sInt(build_pos_z));
			if (block != null_ && idVar(block, name) == /*"powered_repeater"*/ STR(933))
			{
				IntType stateid = builder_get_state_id(self, sInt(build_pos_x), sInt(build_pos_y) - IntType(1), sInt(build_pos_z));
				if (block_get_state_id_value(block, stateid, /*"facing"*/ STR(897)) == /*"north"*/ STR(893))
					locked = /*"true"*/ STR(768);
			}
		}
		sReal(block_state_id_current) = block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"locked"*/ STR(932), locked);
		return IntType(0);
	}
	...
	RealType block_set_redstone_wire(ScopeAny self)
	{
		...
		pow = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"power"*/ STR(934));
		...
		if (!sBool(build_edge_xp))
		{
			...
			if (block != null_)
			{
				if (block == sInt(block_current) || idVar(block, type) == /*"redstone_connect"*/ STR(935))
					east = /*"side"*/ STR(936);
				else
					if (idVar(block, type) == /*"redstone_repeater"*/ STR(937) || idVar(block, type) == /*"redstone_comparator"*/ STR(938))
					{
						VarType facing = block_get_state_id_value(block, builder_get_state_id(self, sInt(build_pos_x) + IntType(1), sInt(build_pos_y), sInt(build_pos_z)), /*"facing"*/ STR(897));
						if (facing == /*"east"*/ STR(890) || facing == /*"west"*/ STR(891))
							east = /*"side"*/ STR(936);
			...
			if (east == /*"none"*/ STR(899) && !sBool(build_edge_zp) && !(sInt(block_face_min_depth_zp) == e_block_depth_DEPTH0 && sBool(block_face_full_zp)))
			{
			...
			if (east == /*"none"*/ STR(899) && !sBool(build_edge_zn) && !(sInt(block_face_min_depth_xp) == e_block_depth_DEPTH0 && sBool(block_face_full_xp)))
			{
				block = builder_get_block(self, sInt(build_pos_x) + IntType(1), sInt(build_pos_y), sInt(build_pos_z) - IntType(1));
				if (block == sInt(block_current))
					east = /*"side"*/ STR(936);
		...
		if (!sBool(build_edge_xn))
		{
			...
			if (west == /*"none"*/ STR(899) && !sBool(build_edge_zp) && !(sInt(block_face_min_depth_zp) == e_block_depth_DEPTH0 && sBool(block_face_full_zp)))
			{
				block = builder_get_block(self, sInt(build_pos_x) - IntType(1), sInt(build_pos_y), sInt(build_pos_z) + IntType(1));
				if (block == sInt(block_current))
					west = /*"up"*/ STR(909);
			}
			if (west == /*"none"*/ STR(899) && !sBool(build_edge_zn) && !(sInt(block_face_min_depth_xn) == e_block_depth_DEPTH0 && sBool(block_face_full_xn)))
			{
				block = builder_get_block(self, sInt(build_pos_x) - IntType(1), sInt(build_pos_y), sInt(build_pos_z) - IntType(1));
				if (block == sInt(block_current))
					west = /*"side"*/ STR(936);
		...
		if (!sBool(build_edge_yp))
		{
			...
			if (south == /*"none"*/ STR(899) && !sBool(build_edge_zp) && !(sInt(block_face_min_depth_zp) == e_block_depth_DEPTH0 && sBool(block_face_full_zp)))
			{
				block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) + IntType(1), sInt(build_pos_z) + IntType(1));
				if (block == sInt(block_current))
					south = /*"up"*/ STR(909);
			}
			if (south == /*"none"*/ STR(899) && !sBool(build_edge_zn) && !(sInt(block_face_min_depth_yp) == e_block_depth_DEPTH0 && sBool(block_face_full_yp)))
			{
				block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) + IntType(1), sInt(build_pos_z) - IntType(1));
				if (block == sInt(block_current))
					south = /*"side"*/ STR(936);
		...
		if (!sBool(build_edge_yn))
		{
			...
			if (north == /*"none"*/ STR(899) && !sBool(build_edge_zp) && !(sInt(block_face_min_depth_zp) == e_block_depth_DEPTH0 && sBool(block_face_full_zp)))
			{
				block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) - IntType(1), sInt(build_pos_z) + IntType(1));
				if (block == sInt(block_current))
					north = /*"up"*/ STR(909);
			}
			if (north == /*"none"*/ STR(899) && !sBool(build_edge_zn) && !(sInt(block_face_min_depth_yn) == e_block_depth_DEPTH0 && sBool(block_face_full_yn)))
			{
				block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) - IntType(1), sInt(build_pos_z) - IntType(1));
				if (block == sInt(block_current))
					north = /*"side"*/ STR(936);
		...
		if (east == /*"none"*/ STR(899) && west == /*"none"*/ STR(899) && south == /*"none"*/ STR(899) && north == /*"none"*/ STR(899))
		{
			east = /*"side"*/ STR(936);
			west = /*"side"*/ STR(936);
			south = /*"side"*/ STR(936);
		...
		sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"east"*/ STR(890), east, /*"west"*/ STR(891), west, /*"south"*/ STR(892), south, /*"north"*/ STR(893), north, /*"power"*/ STR(934), pow }));
		return IntType(0);
	}
