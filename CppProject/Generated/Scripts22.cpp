...
namespace CppProject
{
	...
	{
		self->timeline = true;
		if (is_string(DsMap(map).Value(/*"model"*/ STR(532))))
		{
			self->tl_model_name = DsMap(map).Value(/*"model"*/ STR(532));
			self->tl_model_state = ArrType();
			self->tl_model_state_amount = IntType(0);
			self->tl_has_model_state = false;
			if (DsMap(typemap).Value(/*"model_state"*/ STR(871)) == e_json_type_STRING)
			{
				self->tl_model_state = string_get_state_vars(DsMap(map).Value(/*"model_state"*/ STR(871)));
				self->tl_has_model_state = true;
			}
			else
				if (DsMap(typemap).Value(/*"model_state"*/ STR(871)) == e_json_type_OBJECT)
				{
					VarType key = ds_map_find_first((IntType)(DsMap(map).Value(/*"model_state"*/ STR(871))));
					while (!is_undefined(key))
					{
						withOne (obj_block_tl_state, (new obj_block_tl_state)->id, self->id)
						{
							self->vars = string_get_state_vars(key);
							self->value = string_get_state_vars(ds_map_find_value((IntType)(DsMap(map).Value(/*"model_state"*/ STR(871))), key));
						...
						key = ds_map_find_next((IntType)(DsMap(map).Value(/*"model_state"*/ STR(871))), key);
					}
		...
		if (is_bool(DsMap(map).Value(/*"model_double"*/ STR(872))))
			self->model_double = DsMap(map).Value(/*"model_double"*/ STR(872));
		self->tl_has_text = false;
		if (is_bool(DsMap(map).Value(/*"has_text"*/ STR(873))))
			self->tl_has_text = DsMap(map).Value(/*"has_text"*/ STR(873));
		if (self->tl_has_text > 0)
			self->tl_text_position = value_get_point3D(DsMap(map).Value(/*"text_position"*/ STR(874)), point3D(IntType(0), IntType(0), IntType(0)));
		self->tl_text_scale = DsMap(map).Value(/*"text_scale"*/ STR(875));
		self->tl_pattern_type = /*""*/ STR(0);
		if (is_string(DsMap(map).Value(/*"pattern_type"*/ STR(876))))
			self->tl_pattern_type = DsMap(map).Value(/*"pattern_type"*/ STR(876));
		self->tl_rot_point = point3D(IntType(0), IntType(0), IntType(0));
		self->tl_rot_point_state_amount = IntType(0);
		if (DsMap(typemap).Value(/*"rotation_point"*/ STR(877)) == e_json_type_ARRAY)
			self->tl_rot_point = value_get_point3D(DsMap(map).Value(/*"rotation_point"*/ STR(877)), point3D(IntType(0), IntType(0), IntType(0)));
		else
			if (DsMap(typemap).Value(/*"rotation_point"*/ STR(877)) == e_json_type_OBJECT)
			{
				VarType key = ds_map_find_first((IntType)(DsMap(map).Value(/*"rotation_point"*/ STR(877))));
				while (!is_undefined(key))
				{
					withOne (obj_block_tl_state, (new obj_block_tl_state)->id, self->id)
					{
						self->vars = string_get_state_vars(key);
						self->value = value_get_point3D(ds_map_find_value((IntType)(DsMap(map).Value(/*"rotation_point"*/ STR(877))), key), point3D(IntType(0), IntType(0), IntType(0)));
						self->state_id = ArrType();
						for (IntType i = IntType(0); i < ObjType(obj_block, self.otherId)->state_id_amount; i++)
							if (state_vars_match_state_id(self->vars, self.otherId, i))
								self->state_id = array_add(VarType::CreateRef(self->state_id), i);
					...
					key = ds_map_find_next((IntType)(DsMap(map).Value(/*"rotation_point"*/ STR(877))), key);
				}
		...
		if (DsMap(typemap).Value(/*"rotation"*/ STR(831)) == e_json_type_ARRAY)
			self->tl_rotation = value_get_point3D(DsMap(map).Value(/*"rotation"*/ STR(831)), point3D(IntType(0), IntType(0), IntType(0)));
		else
			if (DsMap(typemap).Value(/*"rotation"*/ STR(831)) == e_json_type_OBJECT)
			{
				VarType key = ds_map_find_first((IntType)(DsMap(map).Value(/*"rotation"*/ STR(831))));
				while (!is_undefined(key))
				{
					withOne (obj_block_tl_state, (new obj_block_tl_state)->id, self->id)
					{
						self->vars = string_get_state_vars(key);
						self->value = value_get_point3D(ds_map_find_value((IntType)(DsMap(map).Value(/*"rotation"*/ STR(831))), key), point3D(IntType(0), IntType(0), IntType(0)));
						self->state_id = ArrType();
						for (IntType i = IntType(0); i < ObjType(obj_block, self.otherId)->state_id_amount; i++)
							if (state_vars_match_state_id(self->vars, self.otherId, i))
								self->state_id = array_add(VarType::CreateRef(self->state_id), i);
					...
					key = ds_map_find_next((IntType)(DsMap(map).Value(/*"rotation"*/ STR(831))), key);
				}
	...
	{
		if (is_undefined(DsMap(map).Value(/*"model"*/ STR(532))))
		{
			log({ /*"Missing parameter \"model\""*/ STR(878) });
			return false;
		}
		StringType blockname;
		VarType blockmodel;
		blockname = string_replace(DsMap(map).Value(/*"model"*/ STR(532)), /*"minecraft:"*/ STR(823), /*""*/ STR(0));
		blockmodel = block_load_model_file(global::load_assets_dir + mc_models_directory + blockname + /*".json"*/ STR(714));
		if (!(blockmodel > 0))
			return false;
		VecType rot = vec3(IntType(0), IntType(0), IntType(0));
		if (!is_undefined(DsMap(map).Value(/*"x"*/ STR(835))))
			rot.Real(X_) = clamp(snap(DsMap(map).Value(/*"x"*/ STR(835)), IntType(90)), IntType(0), IntType(270));
		if (!is_undefined(DsMap(map).Value(/*"y"*/ STR(818))))
			rot.Real(Z_) = clamp(snap(DsMap(map).Value(/*"y"*/ STR(818)), IntType(90)), IntType(0), IntType(270));
		VarType uvlock = false;
		if (is_bool(DsMap(map).Value(/*"uvlock"*/ STR(879))))
			uvlock = DsMap(map).Value(/*"uvlock"*/ STR(879));
		else
			if (is_string(DsMap(map).Value(/*"uvlock"*/ STR(879))))
				uvlock = (DsMap(map).Value(/*"uvlock"*/ STR(879)) == /*"true"*/ STR(762));
		
		VarType weight = IntType(1);
		if (!is_undefined(DsMap(map).Value(/*"weight"*/ STR(880))))
			weight = DsMap(map).Value(/*"weight"*/ STR(880));
		...
		switch ((IntType)culldir)
		{
			case e_dir_EAST:
			{
				if (!idBool(el, face_edge_xp) || self->block_face_min_depth_xp == null_ || self->block_face_min_depth_xp > ObjType(obj_block_render_model, model)->face_min_depth_xp)
					return false;
				if (self->block_current != null_ && ObjType(obj_block, self->block_current)->type == /*"leaves"*/ STR(881) && self->block_face_min_depth_xp > e_block_depth_DEPTH0)
					return false;
			...
			case e_dir_WEST:
			{
				if (!idBool(el, face_edge_xn) || self->block_face_min_depth_xn == null_ || self->block_face_min_depth_xn > ObjType(obj_block_render_model, model)->face_min_depth_xn)
					return false;
				if (self->block_current != null_ && ObjType(obj_block, self->block_current)->type == /*"leaves"*/ STR(881) && self->block_face_min_depth_xn > e_block_depth_DEPTH0)
					return false;
			...
			case e_dir_SOUTH:
			{
				if (!idBool(el, face_edge_yp) || self->block_face_min_depth_yp == null_ || self->block_face_min_depth_yp > ObjType(obj_block_render_model, model)->face_min_depth_yp)
					return false;
				if (self->block_current != null_ && ObjType(obj_block, self->block_current)->type == /*"leaves"*/ STR(881) && self->block_face_min_depth_yp > e_block_depth_DEPTH0)
					return false;
			...
			case e_dir_NORTH:
			{
				if (!idBool(el, face_edge_yn) || self->block_face_min_depth_yn == null_ || self->block_face_min_depth_yn > ObjType(obj_block_render_model, model)->face_min_depth_yn)
					return false;
				if (self->block_current != null_ && ObjType(obj_block, self->block_current)->type == /*"leaves"*/ STR(881) && self->block_face_min_depth_yn > e_block_depth_DEPTH0)
					return false;
			...
			case e_dir_UP:
			{
				if (!idBool(el, face_edge_zp) || self->block_face_min_depth_zp == null_ || self->block_face_min_depth_zp > ObjType(obj_block_render_model, model)->face_min_depth_zp)
					return false;
				if (self->block_current != null_ && ObjType(obj_block, self->block_current)->type == /*"leaves"*/ STR(881) && self->block_face_min_depth_zp > e_block_depth_DEPTH0)
					return false;
			...
			case e_dir_DOWN:
			{
				if (!idBool(el, face_edge_zn) || self->block_face_min_depth_zn == null_ || self->block_face_min_depth_zn > ObjType(obj_block_render_model, model)->face_min_depth_zn)
					return false;
				if (self->block_current != null_ && ObjType(obj_block, self->block_current)->type == /*"leaves"*/ STR(881) && self->block_face_min_depth_zn > e_block_depth_DEPTH0)
					return false;
	...
	RealType block_set_bars(ScopeAny self)
	{
		...
		if (!sBool(build_edge_xp))
		{
			...
			if ((block != null_ && (idVar(block, type) == /*"bars"*/ STR(882) || idVar(block, type) == /*"colored_bars"*/ STR(883))) || (sInt(block_face_min_depth_xp) != e_block_depth_DEPTH1 && sBool(block_face_full_xp)))
				east = /*"true"*/ STR(762);
		}
		if (!sBool(build_edge_xn))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x) - IntType(1), sInt(build_pos_y), sInt(build_pos_z));
			if ((block != null_ && (idVar(block, type) == /*"bars"*/ STR(882) || idVar(block, type) == /*"colored_bars"*/ STR(883))) || (sInt(block_face_min_depth_xn) != e_block_depth_DEPTH1 && sBool(block_face_full_xn)))
				west = /*"true"*/ STR(762);
		}
		if (!sBool(build_edge_yp))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) + IntType(1), sInt(build_pos_z));
			if ((block != null_ && (idVar(block, type) == /*"bars"*/ STR(882) || idVar(block, type) == /*"colored_bars"*/ STR(883))) || (sInt(block_face_min_depth_yp) != e_block_depth_DEPTH1 && sBool(block_face_full_yp)))
				south = /*"true"*/ STR(762);
		}
		if (!sBool(build_edge_yn))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) - IntType(1), sInt(build_pos_z));
			if ((block != null_ && (idVar(block, type) == /*"bars"*/ STR(882) || idVar(block, type) == /*"colored_bars"*/ STR(883))) || (sInt(block_face_min_depth_yn) != e_block_depth_DEPTH1 && sBool(block_face_full_yn)))
				north = /*"true"*/ STR(762);
		}
		sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"east"*/ STR(884), east, /*"west"*/ STR(885), west, /*"south"*/ STR(886), south, /*"north"*/ STR(887), north }));
		return IntType(0);
	}
	
	VarType block_set_bed(Scope<obj_builder_thread> self)
	{
		if (block_get_state_id_value(self->block_current, self->block_state_id_current, /*"part"*/ STR(888)) == /*"head"*/ STR(889))
			return null_;
		return IntType(0);
	}
	...
	{
		if ((self->builder_scenery && !self->builder_scenery_legacy) || block_get_state_id_value(self->block_current, self->block_state_id_current, /*"type"*/ STR(790)) == /*"big_dripleaf_stem"*/ STR(890))
			return IntType(0);
		if (self->build_pos_z != (self->build_size_z - IntType(1)))
		{
			VarType facing = block_get_state_id_value(self->block_current, self->block_state_id_current, /*"facing"*/ STR(891));
			self->block_state_id_current = block_get_state_id(self->block_current, ArrType::From({ /*"type"*/ STR(790), /*"big_dripleaf_stem"*/ STR(890), /*"facing"*/ STR(891), facing, /*"tilt"*/ STR(892), /*"none"*/ STR(893) }));
		}
		return IntType(0);
	}
	...
	RealType block_set_cave_vines(ScopeAny self)
	{
		if (!sBool(build_edge_zp))
		{
			...
			if (block == null_ || idVar(block, type) != /*"cave_vines"*/ STR(894))
				global::vertex_wave_zmax = sInt(block_pos_z) + block_size_;
		}
		else
			global::vertex_wave_zmax = sInt(block_pos_z) + block_size_;
		
		if ((sBool(builder_scenery) && !sBool(builder_scenery_legacy)) || block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"type"*/ STR(790)) == /*"cave_vines_plant"*/ STR(895))
			return IntType(0);
		VarType berries = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"berries"*/ STR(896));
		if (sInt(build_pos_z) == IntType(0))
			sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"type"*/ STR(790), /*"cave_vines"*/ STR(894), /*"berries"*/ STR(896), berries }));
		else
			sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"type"*/ STR(790), /*"cave_vines_plant"*/ STR(895), /*"berries"*/ STR(896), berries }));
	...
	VarType block_set_chest(ScopeAny self)
	{
		VarType type;
		StringType double_;
		type = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"type"*/ STR(790));
		double_ = /*"false"*/ STR(763);
		switch (StringType(type).id)
		{
			...
			case 898: // legacy
			{
				if (idVar(sInt(block_current), name) == /*"ender_chest"*/ STR(899))
					break;
				IntType connectblock, discardblock;
				connectblock = null_;
				discardblock = null_;
				VarType facing = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"facing"*/ STR(891));
		...
		sReal(block_state_id_current) = block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"double"*/ STR(900), double_);
		return IntType(0);
	}
	...
	RealType block_set_chorus_plant(ScopeAny self)
	{
		...
		{
			IntType block = builder_get_block(self, sInt(build_pos_x) + IntType(1), sInt(build_pos_y), sInt(build_pos_z));
			if (block != null_ && (block == sInt(block_current) || idVar(block, type) == /*"chorus_plant_connect"*/ STR(901)))
				east = /*"true"*/ STR(762);
		}
		if (!sBool(build_edge_xn))
		{
		...
		{
			IntType block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y), sInt(build_pos_z) - IntType(1));
			if (block != null_ && (block == sInt(block_current) || idVar(block, type) == /*"chorus_plant_connect"*/ STR(901) || idVar(block, name) == /*"end_stone"*/ STR(902)))
				down = /*"true"*/ STR(762);
		}
		sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"east"*/ STR(884), east, /*"west"*/ STR(885), west, /*"south"*/ STR(886), south, /*"north"*/ STR(887), north, /*"up"*/ STR(903), up, /*"down"*/ STR(904), down }));
		return IntType(0);
	}
	...
	RealType block_set_colored_bars(ScopeAny self)
	{
		...
		if (!sBool(builder_scenery) && sInt(build_size_x) == IntType(1) && sInt(build_size_y) == IntType(1))
			return IntType(0);
		VarType color = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"color"*/ STR(905));
		block_set_bars(self);
		sReal(block_state_id_current) = block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"color"*/ STR(905), color);
		return IntType(0);
	}
	
	VarType block_set_door(ScopeAny self)
	{
		if (block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"half"*/ STR(906)) == /*"upper"*/ STR(907))
			return null_;
		VarType hinge = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"hinge"*/ STR(908));
		if (!sBool(build_edge_zp))
		{
			...
			if (aboveblock == sInt(block_current))
			{
				...
				hinge = block_get_state_id_value(sInt(block_current), abovestateid, /*"hinge"*/ STR(908));
				sReal(block_state_id_current) = block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"hinge"*/ STR(908), hinge);
			}
		}
		VarType facing, open, dir;
		StringType location;
		facing = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"facing"*/ STR(891));
		open = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"open"*/ STR(909));
		if (facing == /*"east"*/ STR(884))
		{
			location = (hinge == /*"right"*/ STR(192) ? /*"south_west"*/ STR(910) : /*"north_west"*/ STR(911));
			if (open == /*"false"*/ STR(763))
				dir = (hinge == /*"right"*/ STR(192) ? /*"north"*/ STR(887) : /*"south"*/ STR(886));
		}
		else
			if (facing == /*"west"*/ STR(885))
			{
				location = (hinge == /*"right"*/ STR(192) ? /*"north_east"*/ STR(912) : /*"south_east"*/ STR(913));
				if (open == /*"false"*/ STR(763))
					dir = (hinge == /*"right"*/ STR(192) ? /*"south"*/ STR(886) : /*"north"*/ STR(887));
			}
			else
				if (facing == /*"south"*/ STR(886))
				{
					location = (hinge == /*"right"*/ STR(192) ? /*"north_west"*/ STR(911) : /*"north_east"*/ STR(912));
					if (open == /*"false"*/ STR(763))
						dir = (hinge == /*"right"*/ STR(192) ? /*"east"*/ STR(884) : /*"west"*/ STR(885));
				}
				else
					if (facing == /*"north"*/ STR(887))
					{
						location = (hinge == /*"right"*/ STR(192) ? /*"south_east"*/ STR(913) : /*"south_west"*/ STR(910));
						if (open == /*"false"*/ STR(763))
							dir = (hinge == /*"right"*/ STR(192) ? /*"west"*/ STR(885) : /*"east"*/ STR(884));
					}
			
		
		
		if (open == /*"true"*/ STR(762))
			dir = facing;
		VarType bottommodel = idVar(sInt(block_current), state_id_model_obj).Value(sReal(block_state_id_current));
		VarType topmodel = idVar(sInt(block_current), state_id_model_obj).Value(block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"half"*/ STR(906), /*"upper"*/ STR(907)));
		...
		sReal(block_state_id_current) = block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"location"*/ STR(914), location);
		sReal(block_state_id_current) = block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"direction"*/ STR(915), dir);
	...
	RealType block_set_dripstone(Scope<obj_builder_thread> self)
	{
		...
		thicknessprev = block_get_state_id_value(self->block_current, self->block_state_id_current, /*"thickness"*/ STR(916));
		if (thicknessprev == /*"base"*/ STR(917))
			return IntType(0);
		dir = block_get_state_id_value(self->block_current, self->block_state_id_current, /*"vertical_direction"*/ STR(918));
		size = (dir == /*"up"*/ STR(903) ? (self->build_size_z - IntType(1)) - self->build_pos_z : self->build_pos_z);
		sizeoffset = size;
		if (thicknessprev == /*"frustum"*/ STR(919))
			sizeoffset += IntType(1);
		else
			if (thicknessprev == /*"middle"*/ STR(920))
		...
		if (sizeoffset == IntType(0))
			...
			if (sizeoffset == IntType(1))
				thickness = /*"frustum"*/ STR(919);
			else
				if (size >= (self->build_size_z - IntType(1)))
					thickness = /*"base"*/ STR(917);
				else
					thickness = /*"middle"*/ STR(920);
			
		
		
		self->block_state_id_current = block_get_state_id(self->block_current, ArrType::From({ /*"vertical_direction"*/ STR(918), dir, /*"thickness"*/ STR(916), thickness }));
		return IntType(0);
	}
	...
	RealType block_set_fence(ScopeAny self)
	{
		...
		south = /*"false"*/ STR(763);
		north = /*"false"*/ STR(763);
		variant = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"variant"*/ STR(800));
		if (!sBool(build_edge_xp))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x) + IntType(1), sInt(build_pos_y), sInt(build_pos_z));
			if (block != null_)
			{
				if (idVar(block, type) == idVar(sInt(block_current), type) || (sInt(block_face_min_depth_xp) == e_block_depth_DEPTH0 && sBool(block_face_full_xp)))
					...
					if (idVar(block, type) == /*"fence_gate"*/ STR(921))
					{
						VarType facing = block_get_state_id_value(block, builder_get_state_id(self, sInt(build_pos_x) + IntType(1), sInt(build_pos_y), sInt(build_pos_z)), /*"facing"*/ STR(891));
						if (facing != /*"east"*/ STR(884) && facing != /*"west"*/ STR(885))
							east = /*"true"*/ STR(762);
					}
		...
		if (!sBool(build_edge_yp))
		{
			...
			if (block != null_)
			{
				if (idVar(block, type) == idVar(sInt(block_current), type) || (sInt(block_face_min_depth_yp) == e_block_depth_DEPTH0 && sBool(block_face_full_yp)))
					...
					if (idVar(block, type) == /*"fence_gate"*/ STR(921))
					{
						VarType facing = block_get_state_id_value(block, builder_get_state_id(self, sInt(build_pos_x), sInt(build_pos_y) + IntType(1), sInt(build_pos_z)), /*"facing"*/ STR(891));
						if (facing != /*"south"*/ STR(886) && facing != /*"north"*/ STR(887))
							south = /*"true"*/ STR(762);
					}
		...
		sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"variant"*/ STR(800), variant, /*"east"*/ STR(884), east, /*"west"*/ STR(885), west, /*"south"*/ STR(886), south, /*"north"*/ STR(887), north }));
		return IntType(0);
	}
	...
	RealType block_set_fence_gate(ScopeAny self)
	{
		...
		StringType inwall;
		facing = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"facing"*/ STR(891));
		inwall = /*"false"*/ STR(763);
		if (facing == /*"east"*/ STR(884) || facing == /*"west"*/ STR(885))
		{
			if (!sBool(build_edge_yp))
			{
				block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) + IntType(1), sInt(build_pos_z));
				if (block != null_ && idVar(block, type) == /*"wall"*/ STR(922))
					inwall = /*"true"*/ STR(762);
			}
			if (inwall == /*"false"*/ STR(763) && !sBool(build_edge_yn))
			{
				block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) - IntType(1), sInt(build_pos_z));
				if (block != null_ && idVar(block, type) == /*"wall"*/ STR(922))
					inwall = /*"true"*/ STR(762);
			...
			if (facing == /*"south"*/ STR(886) || facing == /*"north"*/ STR(887))
			{
				...
				if (inwall == /*"false"*/ STR(763) && !sBool(build_edge_xn))
				{
					block = builder_get_block(self, sInt(build_pos_x) - IntType(1), sInt(build_pos_y), sInt(build_pos_z));
					if (block != null_ && idVar(block, type) == /*"wall"*/ STR(922))
						inwall = /*"true"*/ STR(762);
		...
		sReal(block_state_id_current) = block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"in_wall"*/ STR(923), inwall);
		return IntType(0);
	}
	...
	RealType block_set_fire(ScopeAny self)
	{
		...
		sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"variant"*/ STR(800), variant, /*"east"*/ STR(884), east, /*"west"*/ STR(885), west, /*"south"*/ STR(886), south, /*"north"*/ STR(887), north, /*"up"*/ STR(903), up }));
		return IntType(0);
	}
	...
	RealType block_set_kelp(ScopeAny self)
	{
		...
		{
			IntType block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y), sInt(build_pos_z) - IntType(1));
			if (block == null_ || idVar(block, type) != /*"kelp"*/ STR(924))
				global::vertex_wave_zmin = sInt(block_pos_z);
		}
		else
			global::vertex_wave_zmin = sInt(block_pos_z);
		
		if ((sBool(builder_scenery) && !sBool(builder_scenery_legacy)) || block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"variant"*/ STR(800)) == /*"kelp_plant"*/ STR(925))
			return IntType(0);
		if (sInt(build_pos_z) != (sInt(build_size_z) - IntType(1)))
			sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"variant"*/ STR(800), /*"kelp_plant"*/ STR(925) }));
		return IntType(0);
	}
	...
	RealType block_set_redstone_repeater(ScopeAny self)
	{
		if (sBool(builder_scenery) && !sBool(builder_scenery_legacy))
			return IntType(0);
		if (block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"locked"*/ STR(926)) == /*"true"*/ STR(762))
			return IntType(0);
		VarType facing;
		StringType locked;
		facing = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"facing"*/ STR(891));
		locked = /*"false"*/ STR(763);
		if (!sBool(build_edge_xp) && (facing == /*"south"*/ STR(886) || facing == /*"north"*/ STR(887)))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x) + IntType(1), sInt(build_pos_y), sInt(build_pos_z));
			if (block != null_ && idVar(block, name) == /*"powered_repeater"*/ STR(927))
			{
				IntType stateid = builder_get_state_id(self, sInt(build_pos_x) + IntType(1), sInt(build_pos_y), sInt(build_pos_z));
				if (block_get_state_id_value(block, stateid, /*"facing"*/ STR(891)) == /*"east"*/ STR(884))
					locked = /*"true"*/ STR(762);
			}
		}
		if (locked == /*"false"*/ STR(763) && !sBool(build_edge_xn) && (facing == /*"south"*/ STR(886) || facing == /*"north"*/ STR(887)))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x) - IntType(1), sInt(build_pos_y), sInt(build_pos_z));
			if (block != null_ && idVar(block, name) == /*"powered_repeater"*/ STR(927))
			{
				IntType stateid = builder_get_state_id(self, sInt(build_pos_x) - IntType(1), sInt(build_pos_y), sInt(build_pos_z));
				if (block_get_state_id_value(block, stateid, /*"facing"*/ STR(891)) == /*"west"*/ STR(885))
					locked = /*"true"*/ STR(762);
			}
		}
		if (locked == /*"false"*/ STR(763) && !sBool(build_edge_yp) && (facing == /*"east"*/ STR(884) || facing == /*"west"*/ STR(885)))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) + IntType(1), sInt(build_pos_z));
			if (block != null_ && idVar(block, name) == /*"powered_repeater"*/ STR(927))
			{
				IntType stateid = builder_get_state_id(self, sInt(build_pos_x), sInt(build_pos_y) + IntType(1), sInt(build_pos_z));
				if (block_get_state_id_value(block, stateid, /*"facing"*/ STR(891)) == /*"south"*/ STR(886))
					locked = /*"true"*/ STR(762);
			}
		}
		if (locked == /*"false"*/ STR(763) && !sBool(build_edge_yn) && (facing == /*"east"*/ STR(884) || facing == /*"west"*/ STR(885)))
		{
			IntType block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) - IntType(1), sInt(build_pos_z));
			if (block != null_ && idVar(block, name) == /*"powered_repeater"*/ STR(927))
			{
				IntType stateid = builder_get_state_id(self, sInt(build_pos_x), sInt(build_pos_y) - IntType(1), sInt(build_pos_z));
				if (block_get_state_id_value(block, stateid, /*"facing"*/ STR(891)) == /*"north"*/ STR(887))
					locked = /*"true"*/ STR(762);
			}
		}
		sReal(block_state_id_current) = block_set_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"locked"*/ STR(926), locked);
		return IntType(0);
	}
	...
	RealType block_set_redstone_wire(ScopeAny self)
	{
		...
		pow = block_get_state_id_value(sInt(block_current), sReal(block_state_id_current), /*"power"*/ STR(928));
		...
		if (!sBool(build_edge_xp))
		{
			...
			if (block != null_)
			{
				if (block == sInt(block_current) || idVar(block, type) == /*"redstone_connect"*/ STR(929))
					east = /*"side"*/ STR(930);
				else
					if (idVar(block, type) == /*"redstone_repeater"*/ STR(931) || idVar(block, type) == /*"redstone_comparator"*/ STR(932))
					{
						VarType facing = block_get_state_id_value(block, builder_get_state_id(self, sInt(build_pos_x) + IntType(1), sInt(build_pos_y), sInt(build_pos_z)), /*"facing"*/ STR(891));
						if (facing == /*"east"*/ STR(884) || facing == /*"west"*/ STR(885))
							east = /*"side"*/ STR(930);
			...
			if (east == /*"none"*/ STR(893) && !sBool(build_edge_zp) && !(sInt(block_face_min_depth_zp) == e_block_depth_DEPTH0 && sBool(block_face_full_zp)))
			{
			...
			if (east == /*"none"*/ STR(893) && !sBool(build_edge_zn) && !(sInt(block_face_min_depth_xp) == e_block_depth_DEPTH0 && sBool(block_face_full_xp)))
			{
				block = builder_get_block(self, sInt(build_pos_x) + IntType(1), sInt(build_pos_y), sInt(build_pos_z) - IntType(1));
				if (block == sInt(block_current))
					east = /*"side"*/ STR(930);
		...
		if (!sBool(build_edge_xn))
		{
			...
			if (west == /*"none"*/ STR(893) && !sBool(build_edge_zp) && !(sInt(block_face_min_depth_zp) == e_block_depth_DEPTH0 && sBool(block_face_full_zp)))
			{
				block = builder_get_block(self, sInt(build_pos_x) - IntType(1), sInt(build_pos_y), sInt(build_pos_z) + IntType(1));
				if (block == sInt(block_current))
					west = /*"up"*/ STR(903);
			}
			if (west == /*"none"*/ STR(893) && !sBool(build_edge_zn) && !(sInt(block_face_min_depth_xn) == e_block_depth_DEPTH0 && sBool(block_face_full_xn)))
			{
				block = builder_get_block(self, sInt(build_pos_x) - IntType(1), sInt(build_pos_y), sInt(build_pos_z) - IntType(1));
				if (block == sInt(block_current))
					west = /*"side"*/ STR(930);
		...
		if (!sBool(build_edge_yp))
		{
			...
			if (south == /*"none"*/ STR(893) && !sBool(build_edge_zp) && !(sInt(block_face_min_depth_zp) == e_block_depth_DEPTH0 && sBool(block_face_full_zp)))
			{
				block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) + IntType(1), sInt(build_pos_z) + IntType(1));
				if (block == sInt(block_current))
					south = /*"up"*/ STR(903);
			}
			if (south == /*"none"*/ STR(893) && !sBool(build_edge_zn) && !(sInt(block_face_min_depth_yp) == e_block_depth_DEPTH0 && sBool(block_face_full_yp)))
			{
				block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) + IntType(1), sInt(build_pos_z) - IntType(1));
				if (block == sInt(block_current))
					south = /*"side"*/ STR(930);
		...
		if (!sBool(build_edge_yn))
		{
			...
			if (north == /*"none"*/ STR(893) && !sBool(build_edge_zp) && !(sInt(block_face_min_depth_zp) == e_block_depth_DEPTH0 && sBool(block_face_full_zp)))
			{
				block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) - IntType(1), sInt(build_pos_z) + IntType(1));
				if (block == sInt(block_current))
					north = /*"up"*/ STR(903);
			}
			if (north == /*"none"*/ STR(893) && !sBool(build_edge_zn) && !(sInt(block_face_min_depth_yn) == e_block_depth_DEPTH0 && sBool(block_face_full_yn)))
			{
				block = builder_get_block(self, sInt(build_pos_x), sInt(build_pos_y) - IntType(1), sInt(build_pos_z) - IntType(1));
				if (block == sInt(block_current))
					north = /*"side"*/ STR(930);
		...
		if (east == /*"none"*/ STR(893) && west == /*"none"*/ STR(893) && south == /*"none"*/ STR(893) && north == /*"none"*/ STR(893))
		{
			east = /*"side"*/ STR(930);
			west = /*"side"*/ STR(930);
			south = /*"side"*/ STR(930);
		...
		sReal(block_state_id_current) = block_get_state_id(sInt(block_current), ArrType::From({ /*"east"*/ STR(884), east, /*"west"*/ STR(885), west, /*"south"*/ STR(886), south, /*"north"*/ STR(887), north, /*"power"*/ STR(928), pow }));
		return IntType(0);
	}
