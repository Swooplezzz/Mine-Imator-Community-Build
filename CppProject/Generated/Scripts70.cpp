/*
	...
	[ Generated on 2024.01.26 10:44:15 ]
*/
...
namespace CppProject
{
	...
	VarType tl_value_default(VarType valueid)
	{
		switch ((IntType)valueid)
		{
			...
			case e_value_BEND_IK_TARGET:
			case e_value_COPY_POS_OFFSET_X:
			case e_value_COPY_POS_OFFSET_Y:
			case e_value_COPY_POS_OFFSET_Z:
			case e_value_COPY_SCALE_MULT:
			case e_value_IK_TARGET_ANGLE:
			{
				return null_;
			}
			case e_value_COPY_POS_X:
			case e_value_COPY_POS_Y:
			case e_value_COPY_POS_Z:
			case e_value_COPY_ROT_X:
			case e_value_COPY_ROT_Y:
			case e_value_COPY_ROT_Z:
			case e_value_COPY_SCALE_X:
			case e_value_COPY_SCALE_Y:
			case e_value_COPY_SCALE_Z:
			{
				return true;
			}
	...
	VarType tl_value_find_save_id(VarType vid, VarType oldval, VarType newval)
	{
		...
		if (tl_value_is_texture(vid) && newval == /*"none"*/ STR(909))
			newval = IntType(0);
		else
			if (vid == e_value_PATH_OBJ || vid == e_value_ATTRACTOR || vid == e_value_ROT_TARGET || vid == e_value_POS_TARGET || vid == e_value_SCALE_TARGET || vid == e_value_BEND_IK_TARGET || vid == e_value_IK_TARGET || vid == e_value_IK_TARGET_ANGLE || tl_value_is_texture(vid) || vid == e_value_SOUND_OBJ || vid == e_value_TEXT_FONT)
