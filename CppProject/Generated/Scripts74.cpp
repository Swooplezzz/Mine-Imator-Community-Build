...
namespace CppProject
{
	...
	RealType view_draw(ScopeAny self, IntType view)
	{
		...
		if (sVar(window_busy) == /*"viewmove"*/ STR(3971) && view == sInt(view_second))
		{
		...
		if (view == sInt(view_main) && ObjType(obj_view, sInt(view_second))->show > 0 && !window_exists(e_window_VIEW_SECOND) && sVar(window_busy) != /*"viewmove"*/ STR(3971))
		{
			if (ObjType(obj_view, sInt(view_second))->location == /*"left_top"*/ STR(3970))
				captionx += ObjType(obj_view, sInt(view_second))->width;
			if (ObjType(obj_view, sInt(view_second))->location == /*"right_top"*/ STR(3968))
				dx -= ObjType(obj_view, sInt(view_second))->width;
			if (ObjType(obj_view, sInt(view_second))->location == /*"left_top"*/ STR(3970) || ObjType(obj_view, sInt(view_second))->location == /*"right_top"*/ STR(3968))
		...
		if (view == sInt(view_second))
		{
			if (window_get_current() != e_window_VIEW_SECOND)
			{
				if (draw_button_icon(self, { /*"viewclose"*/ STR(3972), dx, dy, sVar(dw), sVar(dh), false, icons_CLOSE, null_, false, /*"viewclose"*/ STR(3972) }))
				{
					ObjType(obj_view, view)->show = false;
					sBool(view_render) = false;
				}
				dx -= sVar(dw) + padding;
				if (draw_button_icon(self, { /*"viewpopout"*/ STR(3973), dx, dy, sVar(dw), sVar(dh), false, icons_EXTERNAL, null_, false, /*"viewpopout"*/ STR(3973) }))
					window_create(e_window_VIEW_SECOND, boxx, boxy, boxw, boxh);
			}
			else
			{
				if (draw_button_icon(self, { /*"viewpopout"*/ STR(3973), dx, dy, sVar(dw), sVar(dh), false, icons_INTERNAL, null_, false, /*"viewpopin"*/ STR(3974) }))
				{
		...
		else
		{
			...
			if (draw_button_icon(self, { /*"viewsecond"*/ STR(3975), dx, dy, sVar(dw), sVar(dh), ObjType(obj_view, sInt(view_second))->show, icons_VIEWPORT_SECONDARY, null_, false, (ObjType(obj_view, sInt(view_second))->show > 0) ? /*"viewseconddisable"*/ STR(3976) : /*"viewsecondenable"*/ STR(3977) }))
		...
		dx -= 16.0 + padding;
		if (draw_button_icon(self, { /*"viewqualitysettings"*/ STR(3978), dx, dy, IntType(16), IntType(24), sStr(settings_menu_name) == (string(view) + /*"viewqualitysettings"*/ STR(3978)), icons_CHEVRON_DOWN_TINY }))
		{
			menu_settings_set(self, dx, dy, (string(view) + /*"viewqualitysettings"*/ STR(3978)), IntType(24));
			sInt(settings_menu_view) = view;
			sInt(settings_menu_script) = ID_menu_quality_settings;
		}
		if (sStr(settings_menu_name) == (string(view) + /*"viewqualitysettings"*/ STR(3978)) && sStr(settings_menu_ani_type) != /*"hide"*/ STR(751))
		...
		if (draw_button_icon(self, { /*"viewmoderender"*/ STR(3979), dx, dy, sVar(dw), sVar(dh), ObjType(obj_view, view)->quality == e_view_mode_RENDER, ObjType(obj_theme, sInt(setting_theme))->dark ? icons_SPHERE_MATERIAL__DARK : icons_SPHERE_MATERIAL, null_, false, /*"viewmoderender"*/ STR(3979) }))
		{
		...
		dx -= sVar(dw) + padding;
		tip_set_keybind(self, e_keybind_RENDER_MODE);
		if (draw_button_icon(self, { /*"viewmodeshaded"*/ STR(3980), dx, dy, sVar(dw), sVar(dh), ObjType(obj_view, view)->quality == e_view_mode_SHADED, ObjType(obj_theme, sInt(setting_theme))->dark ? icons_SPHERE_SHADING__DARK : icons_SPHERE_SHADING, null_, false, /*"viewmodeshaded"*/ STR(3980) }))
			ObjType(obj_view, view)->quality = e_view_mode_SHADED;
		dx -= sVar(dw) + padding;
		if (draw_button_icon(self, { /*"viewmodeflat"*/ STR(3981), dx, dy, sVar(dw), sVar(dh), ObjType(obj_view, view)->quality == e_view_mode_FLAT, icons_SPHERE_FLAT, null_, false, /*"viewmodeflat"*/ STR(3981) }))
			ObjType(obj_view, view)->quality = e_view_mode_FLAT;
		dx -= sVar(dw) + padding;
		if (draw_button_icon(self, { /*"viewparticles"*/ STR(3982), dx, dy, sVar(dw), sVar(dh), ObjType(obj_view, view)->particles, icons_FIREWORKS, null_, false, (ObjType(obj_view, view)->particles > 0) ? /*"viewparticlesdisable"*/ STR(3983) : /*"viewparticlesenable"*/ STR(3984) }))
			ObjType(obj_view, view)->particles = !(ObjType(obj_view, view)->particles > 0);
		if (cam != null_)
		{
			dx -= sVar(dw) + padding;
			if (draw_button_icon(self, { /*"vieweffects"*/ STR(3985), dx, dy, sVar(dw), sVar(dh), ObjType(obj_view, view)->effects, icons_WAND, null_, false, (ObjType(obj_view, view)->effects > 0) ? /*"vieweffectsdisable"*/ STR(3986) : /*"vieweffectsenable"*/ STR(3987) }))
			{
		...
		draw_divide_vertical(dx, dy, sVar(dh));
		dx -= 16.0 + padding;
		if (draw_button_icon(self, { /*"viewgridsettings"*/ STR(3988), dx, dy, IntType(16), IntType(24), sStr(settings_menu_name) == (string(view) + /*"viewgridsettings"*/ STR(3988)), icons_CHEVRON_DOWN_TINY }))
		{
			menu_settings_set(self, dx, dy, (string(view) + /*"viewgridsettings"*/ STR(3988)), IntType(24));
			sInt(settings_menu_view) = view;
			sInt(settings_menu_script) = ID_menu_grid_settings;
		}
		if (sStr(settings_menu_name) == (string(view) + /*"viewgridsettings"*/ STR(3988)) && sStr(settings_menu_ani_type) != /*"hide"*/ STR(751))
			ObjType(value_animation, ObjType(micro_animation, global::current_microani)->active)->value = true;
		dx -= sVar(dw);
		if (draw_button_icon(self, { /*"viewgrid"*/ STR(3989), dx, dy, sVar(dw), sVar(dh), ObjType(obj_view, view)->grid, icons_GRID, null_, false, (ObjType(obj_view, view)->grid > 0) ? /*"viewgriddisable"*/ STR(3990) : /*"viewgridenable"*/ STR(3991) }))
			ObjType(obj_view, view)->grid = !(ObjType(obj_view, view)->grid > 0);
		dx -= sVar(dw) + padding;
		if (draw_button_icon(self, { /*"viewaspectratio"*/ STR(3992), dx, dy, sVar(dw), sVar(dh), ObjType(obj_view, view)->aspect_ratio, icons_LETTERBOX, null_, false, (ObjType(obj_view, view)->aspect_ratio > 0) ? /*"viewaspectratiodisable"*/ STR(3993) : /*"viewaspectratioenable"*/ STR(3994) }))
			ObjType(obj_view, view)->aspect_ratio = !(ObjType(obj_view, view)->aspect_ratio > 0);
		dx -= sVar(dw) + padding;
		if (draw_button_icon(self, { /*"viewoverlays"*/ STR(3995), dx, dy, sVar(dw), sVar(dh), ObjType(obj_view, view)->gizmos, icons_OVERLAYS, null_, false, (ObjType(obj_view, view)->gizmos > 0) ? /*"viewoverlaysdisable"*/ STR(3996) : /*"viewoverlaysenable"*/ STR(3997) }))
		...
		if (view == sInt(view_main))
		{
			...
			draw_divide_vertical(dx, dy, sVar(dh));
			dx -= 16.0 + padding;
			if (draw_button_icon(self, { /*"viewsnapsettings"*/ STR(3998), dx, dy, IntType(16), IntType(24), sStr(settings_menu_name) == (string(view) + /*"viewsnapsettings"*/ STR(3998)), icons_CHEVRON_DOWN_TINY }))
			{
				menu_settings_set(self, dx, dy, (string(view) + /*"viewsnapsettings"*/ STR(3998)), IntType(24));
				sInt(settings_menu_view) = view;
				sInt(settings_menu_script) = ID_menu_snap_settings;
			}
			if (sStr(settings_menu_name) == (string(view) + /*"viewsnapsettings"*/ STR(3998)) && sStr(settings_menu_ani_type) != /*"hide"*/ STR(751))
				ObjType(value_animation, ObjType(micro_animation, global::current_microani)->active)->value = true;
			dx -= sVar(dw);
			tip_set_keybind(self, e_keybind_SNAP);
			if (draw_button_icon(self, { /*"viewsnap"*/ STR(3999), dx, dy, sVar(dw), sVar(dh), sReal(setting_snap), icons_MAGNET, null_, false, (sReal(setting_snap) > 0) ? /*"viewsnapdisable"*/ STR(4000) : /*"viewsnapenable"*/ STR(4001) }))
		...
		if (ObjType(obj_view, view)->camera == -IntType(4) && cam == -IntType(4))
			camname = text_get({ /*"viewworkcamera"*/ STR(4002) });
		else
			if (ObjType(obj_view, view)->camera == -IntType(5))
				camname = text_get({ /*"viewactivecamera"*/ STR(4003), (cam == -IntType(4) ? text_get({ /*"viewworkcamera"*/ STR(4002) }) : string_remove_newline(idVar(cam, display_name))) });
			else
		...
		if (location != /*"full"*/ STR(2809) && location != /*"top"*/ STR(202) && location != /*"bottom"*/ STR(201))
		{
			...
			if (!string_contains(location, /*"right"*/ STR(204)))
				sVar(content_width) -= 3.0;
			if (location == /*"right_top"*/ STR(3968) || location == /*"left_top"*/ STR(3970))
		...
		if (sVar(content_width) > IntType(0) && sVar(content_height) > IntType(0))
		{
			...
			if (sBool(content_mouseon))
				sStr(shortcut_bar_state) = /*"viewport"*/ STR(124) + (cam == null_ ? /*""*/ STR(0) : /*"cam"*/ STR(4004));
		...
		if (view == sInt(view_main))
		{
			...
			if (ObjType(obj_view, sInt(view_main))->mouseon && app_mouse_box(self, benchx, benchy, IntType(86), IntType(86)) && !sBool(popup_mouseon) && !sBool(toast_mouseon) && !sBool(context_menu_mouseon) && !(ObjType(obj_view, sInt(view_second))->show > 0 && ObjType(obj_view, sInt(view_second))->mouseon))
			{
				...
				tip_set(self, text_get({ /*"viewworkbenchtip"*/ STR(4005) }), benchx, benchy, IntType(86), IntType(86), false);
		...
		if (view == sInt(view_second) && window_get_current() != e_window_VIEW_SECOND)
		{
			if (ObjType(obj_view, view)->mouseon && (sInt(mouse_cursor) == cr_default || sBool(content_mouseon)))
			{
				...
				{
					if (ObjType(obj_view, view)->location == /*"right_top"*/ STR(3968) || ObjType(obj_view, view)->location == /*"left_bottom"*/ STR(3969))
					...
					if (sBool(mouse_left_pressed))
					{
						sVar(window_busy) = /*"viewresizeboth"*/ STR(3964);
					...
					if (mouseonresizehor)
					{
						...
						if (sBool(mouse_left_pressed))
						{
							sVar(window_busy) = /*"viewresizehor"*/ STR(3963);
							sVar(view_resize_width) = ObjType(obj_view, view)->width;
						}
					}
					else
						if (mouseonresizever)
						{
							...
							if (sBool(mouse_left_pressed))
							{
								sVar(window_busy) = /*"viewresizever"*/ STR(3965);
								sVar(view_resize_height) = ObjType(obj_view, view)->height;
							}
						}
						else
							if (app_mouse_box(self, boxx, boxy, boxw, captionh) && !sBool(popup_mouseon) && sBool(mouse_left_pressed))
								sVar(window_busy) = /*"viewclickcaption"*/ STR(4006);
					
				
				
			}
			if (sVar(window_busy) == /*"viewclickcaption"*/ STR(4006))
			{
				if (sReal(mouse_move) > IntType(10))
				{
					ObjType(obj_view, sInt(view_main))->location = /*"full"*/ STR(2809);
					sVar(window_busy) = /*"viewmove"*/ STR(3971);
			...
			if (sVar(window_busy) == /*"viewmove"*/ STR(3971))
			{
		...
		if (mouseonresizesplit && (sInt(mouse_cursor) == cr_default || sBool(content_mouseon)))
		{
			...
			{
				sInt(mouse_cursor) = cr_size_we;
				mouselocation = /*"hor"*/ STR(4007);
			}
			else
			{
				sInt(mouse_cursor) = cr_size_ns;
				mouselocation = /*"ver"*/ STR(4008);
			}
			
			if (sBool(mouse_left_pressed))
				sVar(window_busy) = /*"viewresizesplit"*/ STR(4009) + mouselocation;
		}
		if (view == sInt(view_second))
		{
			...
			lineleft = false;
			lineright = false;
			if (location == /*"top"*/ STR(202) && (mouseonresizesplit || sVar(window_busy) == /*"viewresizesplitver"*/ STR(3967)))
				linetop = true;
			if (location == /*"bottom"*/ STR(201) && (mouseonresizesplit || sVar(window_busy) == /*"viewresizesplitver"*/ STR(3967)))
				linebottom = true;
			if (location == /*"left"*/ STR(203) && (mouseonresizesplit || sVar(window_busy) == /*"viewresizesplithor"*/ STR(3966)))
				lineright = true;
			if (location == /*"right"*/ STR(204) && (mouseonresizesplit || sVar(window_busy) == /*"viewresizesplithor"*/ STR(3966)))
				lineleft = true;
			if ((mouseonresizever || mouseonresizehor) || (sVar(window_busy) == /*"viewresizeboth"*/ STR(3964) || sVar(window_busy) == /*"viewresizever"*/ STR(3965) || sVar(window_busy) == /*"viewresizehor"*/ STR(3963)))
			{
				if (location == /*"left_top"*/ STR(3970))
				{
					lineright = (mouseonresizehor || sVar(window_busy) == /*"viewresizehor"*/ STR(3963) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3964));
					linetop = (mouseonresizever || sVar(window_busy) == /*"viewresizever"*/ STR(3965) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3964));
				}
				if (location == /*"right_top"*/ STR(3968))
				{
					lineleft = (mouseonresizehor || sVar(window_busy) == /*"viewresizehor"*/ STR(3963) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3964));
					linetop = (mouseonresizever || sVar(window_busy) == /*"viewresizever"*/ STR(3965) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3964));
				}
				if (location == /*"left_bottom"*/ STR(3969))
				{
					lineright = (mouseonresizehor || sVar(window_busy) == /*"viewresizehor"*/ STR(3963) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3964));
					linebottom = (mouseonresizever || sVar(window_busy) == /*"viewresizever"*/ STR(3965) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3964));
				}
				if (location == /*"right_bottom"*/ STR(2810))
				{
					lineleft = (mouseonresizehor || sVar(window_busy) == /*"viewresizehor"*/ STR(3963) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3964));
					linebottom = (mouseonresizever || sVar(window_busy) == /*"viewresizever"*/ STR(3965) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3964));
				}
		...
		if (ObjType(obj_view, view)->quality == e_view_mode_RENDER)
		{
			...
			if (sBool(view_render_real_time))
				infotext = text_get({ /*"viewrenderfps"*/ STR(4010), string(gmlGlobal::fps), max({ IntType(1), global::render_samples }), sVar(project_render_samples) });
			else
				infotext = /*""*/ STR(0);
			...
			{
				infotext = text_get({ /*"viewrenderpass"*/ STR(4011), text_get({ /*"viewmodepass"*/ STR(1510) + DsList(global::render_pass_list).Value(sInt(project_render_pass)) }) });
	...
	{
		self->show = true;
		self->location = /*"full"*/ STR(2809);
		self->location_last = /*"full"*/ STR(2809);
		self->surface = null_;
	...
	void view_shape_camera(IntType tl)
	{
		...
		view_shape_circle({ point3D(IntType(0), -IntType(3), 6.5), 2.5, ObjType(obj_timeline, tl)->matrix });
		if (ObjType(obj_timeline, tl)->selected > 0 && mod(ObjType(obj_timeline, tl)->value.Value(e_value_CAM_FOV), IntType(180)) != IntType(0))
			view_shape_camera_frustum(tl);
	}
	
	void view_shape_camera_frustum(IntType tl)
	{
		RealType distnear, ratio, sizemath;
		VarType distfar;
		distnear = global::cam_near;
		distfar = global::cam_far;
		ratio = ((RealType)ObjType(obj_timeline, tl)->value.Value(e_value_CAM_WIDTH) / ObjType(obj_timeline, tl)->value.Value(e_value_CAM_HEIGHT)) * ObjType(obj_timeline, tl)->value.Value(e_value_CAM_ASPECT);
		sizemath = tan(degtorad(ObjType(obj_timeline, tl)->value.Value(e_value_CAM_FOV) * 0.5));
		ArrType viewfrustumpoints = ArrType::From({ point3D(-((sizemath * distnear) * ratio), distnear, -sizemath * distnear), point3D(-((sizemath * distnear) * ratio), distnear, sizemath * distnear), point3D(((sizemath * distnear) * ratio), distnear, -sizemath * distnear), point3D(((sizemath * distnear) * ratio), distnear, sizemath * distnear), point3D(-((sizemath * distfar) * ratio), distfar, -sizemath * distfar), point3D(-((sizemath * distfar) * ratio), distfar, sizemath * distfar), point3D(((sizemath * distfar) * ratio), distfar, -sizemath * distfar), point3D(((sizemath * distfar) * ratio), distfar, sizemath * distfar) });
		if (ObjType(obj_timeline, tl)->value.Value(e_value_CAM_DOF) > 0)
		{
			VarType dofnear, doffar, dofblurnear, dofblurfar;
			dofnear = min({ distfar, max({ distnear, ObjType(obj_timeline, tl)->value.Value(e_value_CAM_DOF_DEPTH) - ObjType(obj_timeline, tl)->value.Value(e_value_CAM_DOF_RANGE) }) });
			doffar = min({ distfar, max({ distnear, ObjType(obj_timeline, tl)->value.Value(e_value_CAM_DOF_DEPTH) + ObjType(obj_timeline, tl)->value.Value(e_value_CAM_DOF_RANGE) }) });
			dofblurnear = min({ distfar, max({ distnear, (ObjType(obj_timeline, tl)->value.Value(e_value_CAM_DOF_DEPTH) - ObjType(obj_timeline, tl)->value.Value(e_value_CAM_DOF_RANGE)) - ObjType(obj_timeline, tl)->value.Value(e_value_CAM_DOF_FADE_SIZE) }) });
			dofblurfar = min({ distfar, max({ distnear, (ObjType(obj_timeline, tl)->value.Value(e_value_CAM_DOF_DEPTH) + ObjType(obj_timeline, tl)->value.Value(e_value_CAM_DOF_RANGE)) + ObjType(obj_timeline, tl)->value.Value(e_value_CAM_DOF_FADE_SIZE) }) });
			ArrType viewfrustumdofpoints = ArrType::From({ point3D(-((sizemath * dofnear) * ratio), dofnear, -sizemath * dofnear), point3D(-((sizemath * dofnear) * ratio), dofnear, sizemath * dofnear), point3D(((sizemath * dofnear) * ratio), dofnear, -sizemath * dofnear), point3D(((sizemath * dofnear) * ratio), dofnear, sizemath * dofnear), point3D(-((sizemath * doffar) * ratio), doffar, -sizemath * doffar), point3D(-((sizemath * doffar) * ratio), doffar, sizemath * doffar), point3D(((sizemath * doffar) * ratio), doffar, -sizemath * doffar), point3D(((sizemath * doffar) * ratio), doffar, sizemath * doffar) });
			ArrType viewfrustumdofblurpoints = ArrType::From({ point3D(-((sizemath * dofblurnear) * ratio), dofblurnear, -sizemath * dofblurnear), point3D(-((sizemath * dofblurnear) * ratio), dofblurnear, sizemath * dofblurnear), point3D(((sizemath * dofblurnear) * ratio), dofblurnear, -sizemath * dofblurnear), point3D(((sizemath * dofblurnear) * ratio), dofblurnear, sizemath * dofblurnear), point3D(-((sizemath * dofblurfar) * ratio), dofblurfar, -sizemath * dofblurfar), point3D(-((sizemath * dofblurfar) * ratio), dofblurfar, sizemath * dofblurfar), point3D(((sizemath * dofblurfar) * ratio), dofblurfar, -sizemath * dofblurfar), point3D(((sizemath * dofblurfar) * ratio), dofblurfar, sizemath * dofblurfar) });
			draw_set_alpha(.375);
			draw_set_color(global::c_control_blue);
			view_shape_draw({ viewfrustumdofpoints, ObjType(obj_timeline, tl)->matrix });
			draw_set_color(global::c_control_cyan);
			view_shape_draw({ viewfrustumdofblurpoints, ObjType(obj_timeline, tl)->matrix });
			draw_set_alpha(1.0);
		}
		draw_set_color(global::c_control_red);
		draw_set_alpha(.5);
		view_shape_draw({ viewfrustumpoints, ObjType(obj_timeline, tl)->matrix });
		draw_set_alpha(1.0);
	}
