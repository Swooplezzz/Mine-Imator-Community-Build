...
namespace CppProject
{
	...
	void view_shape_camera_frustum(IntType tl)
	{
		...
		VarType distfar, fov;
		distnear = IntType(1);
		distfar = global::_app->project_render_distance;
		fov = ObjType(obj_timeline, tl)->value.Value(e_value_CAM_FOV);
		...
		sizemath = tan(degtorad(fov * 0.5));
		if (ObjType(obj_timeline, tl)->selected > 0 && mod(fov, IntType(180)) != IntType(0))
		{
