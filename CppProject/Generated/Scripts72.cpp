...
namespace CppProject
{
	...
	{
		log({ /*"Create vertex format"*/ STR(3960) });
		vertex_format_begin();
	...
	void view_area_draw(ScopeAny self)
	{
		...
		if (sVar(window_busy) == /*"viewresizehor"*/ STR(3961) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3962))
		{
		...
		if (sVar(window_busy) == /*"viewresizever"*/ STR(3963) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3962))
		{
		...
		if (sVar(window_busy) == /*"viewresizeboth"*/ STR(3962))
		{
		...
		if (sVar(window_busy) == /*"viewresizesplithor"*/ STR(3964))
		{
			sInt(mouse_cursor) = cr_size_we;
		...
		if (sVar(window_busy) == /*"viewresizesplitver"*/ STR(3965))
		{
			sInt(mouse_cursor) = cr_size_ns;
