...
namespace CppProject
{
	...
	{
		log({ /*"Create vertex format"*/ STR(3945) });
		vertex_format_begin();
	...
	void view_area_draw(ScopeAny self)
	{
		...
		if (sVar(window_busy) == /*"viewresizehor"*/ STR(3946) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3947))
		{
		...
		if (sVar(window_busy) == /*"viewresizever"*/ STR(3948) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3947))
		{
		...
		if (sVar(window_busy) == /*"viewresizeboth"*/ STR(3947))
		{
		...
		if (sVar(window_busy) == /*"viewresizesplithor"*/ STR(3949))
		{
			sInt(mouse_cursor) = cr_size_we;
		...
		if (sVar(window_busy) == /*"viewresizesplitver"*/ STR(3950))
		{
			sInt(mouse_cursor) = cr_size_ns;
