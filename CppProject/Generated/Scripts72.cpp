...
namespace CppProject
{
	...
	{
		log({ /*"Create vertex format"*/ STR(3955) });
		vertex_format_begin();
	...
	void view_area_draw(ScopeAny self)
	{
		...
		if (sVar(window_busy) == /*"viewresizehor"*/ STR(3956) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3957))
		{
		...
		if (sVar(window_busy) == /*"viewresizever"*/ STR(3958) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3957))
		{
		...
		if (sVar(window_busy) == /*"viewresizeboth"*/ STR(3957))
		{
		...
		if (sVar(window_busy) == /*"viewresizesplithor"*/ STR(3959))
		{
			sInt(mouse_cursor) = cr_size_we;
		...
		if (sVar(window_busy) == /*"viewresizesplitver"*/ STR(3960))
		{
			sInt(mouse_cursor) = cr_size_ns;
