...
namespace CppProject
{
	...
	{
		log({ /*"Create vertex format"*/ STR(3963) });
		vertex_format_begin();
	...
	void view_area_draw(ScopeAny self)
	{
		...
		if (sVar(window_busy) == /*"viewresizehor"*/ STR(3964) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3965))
		{
		...
		if (sVar(window_busy) == /*"viewresizever"*/ STR(3966) || sVar(window_busy) == /*"viewresizeboth"*/ STR(3965))
		{
		...
		if (sVar(window_busy) == /*"viewresizeboth"*/ STR(3965))
		{
		...
		if (sVar(window_busy) == /*"viewresizesplithor"*/ STR(3967))
		{
			sInt(mouse_cursor) = cr_size_we;
		...
		if (sVar(window_busy) == /*"viewresizesplitver"*/ STR(3968))
		{
			sInt(mouse_cursor) = cr_size_ns;
