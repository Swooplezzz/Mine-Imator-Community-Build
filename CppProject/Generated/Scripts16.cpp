/*
	...
	[ Generated on 2023.08.28 02:20:49 ]
*/
...
namespace CppProject
{
	...
	void app_startup_fonts(ScopeAny self)
	{
		...
		sInt(font_splash_bold_big) = font_add(fonts_directory + /*"rubik_semibold.ttf"*/ STR(166), IntType(11), false, false, IntType(32), IntType(1024));
		sInt(font_splash_bold) = font_add(fonts_directory + /*"rubik_semibold.ttf"*/ STR(166), IntType(10), false, false, IntType(32), IntType(1024));
		sInt(font_splash_bold_secondary) = font_add(fonts_directory + /*"rubik_semibold.ttf"*/ STR(166), (IntType)(8.5), false, false, IntType(32), IntType(1024));
	}
	...
	void app_startup_interface(ScopeAny self)
	{
		...
		if (sStr(project_startup_fn) == /*""*/ STR(0))
		{
			if (dev_mode)
			{
				...
				{
					StringType projfile = sStr(setting_project_folder) + ObjType(obj_popup, sInt(popup_newproject))->folder + /*"/New Project.miproject"*/ STR(167);
	...
	void app_startup_interface_bench()
	{
		...
		list_item_add(/*"typechar"*/ STR(168), e_tl_type_CHARACTER, /*""*/ STR(0), null_, icons_CHARACTER, null_, ID_bench_click);
		list_item_add(/*"typebodypart"*/ STR(169), e_tl_type_BODYPART, /*""*/ STR(0), null_, icons_PART, null_, ID_bench_click);
		list_item_add(/*"typemodel"*/ STR(170), e_tl_type_MODEL, /*""*/ STR(0), null_, icons_MODEL, null_, ID_bench_click);
		list_item_add(/*"typeitem"*/ STR(171), e_tl_type_ITEM, /*""*/ STR(0), null_, icons_ITEM, null_, ID_bench_click);
		list_item_add(/*"typescenery"*/ STR(172), e_tl_type_SCENERY, /*""*/ STR(0), null_, icons_SCENERY, null_, ID_bench_click);
		list_item_add(/*"typeblock"*/ STR(173), e_tl_type_BLOCK, /*""*/ STR(0), null_, icons_BLOCK, null_, ID_bench_click);
		list_item_add(/*"typespblock"*/ STR(174), e_tl_type_SPECIAL_BLOCK, /*""*/ STR(0), null_, icons_BLOCK_SPECIAL, null_, ID_bench_click);
		list_item_add(/*"typeshape"*/ STR(175), e_tl_type_SHAPE, /*""*/ STR(0), null_, icons_SHAPES, null_, ID_bench_click);
		list_item_add(/*"typetext"*/ STR(176), e_tl_type_TEXT, /*""*/ STR(0), null_, icons_TEXT, null_, ID_bench_click);
		list_item_add(/*"typepath"*/ STR(177), e_tl_type_PATH, /*""*/ STR(0), null_, icons_PATH, null_, ID_bench_click);
		list_item_add(/*"typecamera"*/ STR(178), e_tl_type_CAMERA, /*""*/ STR(0), null_, icons_CAMERA, null_, ID_bench_click);
		list_item_add(/*"typeparticles"*/ STR(179), e_tl_type_PARTICLE_SPAWNER, /*""*/ STR(0), null_, icons_FIREWORKS, null_, ID_bench_click);
		list_item_add(/*"typelightsource"*/ STR(180), e_tl_type_LIGHT_SOURCE, /*""*/ STR(0), null_, icons_LIGHT_POINT, null_, ID_bench_click);
		list_item_add(/*"typeaudio"*/ STR(181), e_tl_type_AUDIO, /*""*/ STR(0), null_, icons_NOTE, null_, ID_bench_click);
		list_item_add(/*"typebackground"*/ STR(182), e_tl_type_BACKGROUND, /*""*/ STR(0), null_, icons_CLOUD, null_, ID_bench_click);
		...
		withOne (obj_bench_settings, global::_app->bench_settings, global::_app->id)
		{
			...
			sortlist_column_add(self->char_list, /*"charname"*/ STR(183), IntType(0));
			...
			sortlist_column_add(self->block_list, /*"blockname"*/ STR(184), IntType(0));
			...
			sortlist_column_add(self->special_block_list, /*"spblockname"*/ STR(185), IntType(0));
			...
			sortlist_column_add(self->bodypart_model_list, /*"bodypartmodelname"*/ STR(186), IntType(0));
			...
			sortlist_column_add(self->particles_list, /*"particlepresetname"*/ STR(187), IntType(0));
		}
	...
	void app_startup_interface_panels()
	{
		...
		DsMap(global::_app->panel_map)[/*"left_secondary"*/ STR(188)] = (new obj_panel)->id;
		ObjType(obj_panel, DsMap(global::_app->panel_map)[/*"left_secondary"*/ STR(188)])->size = global::_app->setting_panel_left_bottom_size;
		ObjType(obj_panel, DsMap(global::_app->panel_map)[/*"left_secondary"*/ STR(188)])->location = /*"left_secondary"*/ STR(188);
		DsMap(global::_app->panel_map)[/*"right_secondary"*/ STR(189)] = (new obj_panel)->id;
		ObjType(obj_panel, DsMap(global::_app->panel_map)[/*"right_secondary"*/ STR(189)])->size = global::_app->setting_panel_right_bottom_size;
		ObjType(obj_panel, DsMap(global::_app->panel_map)[/*"right_secondary"*/ STR(189)])->location = /*"right_secondary"*/ STR(189);
		DsMap(global::_app->panel_map)[/*"bottom"*/ STR(190)] = (new obj_panel)->id;
		ObjType(obj_panel, DsMap(global::_app->panel_map)[/*"bottom"*/ STR(190)])->size = global::_app->setting_panel_bottom_size;
		ObjType(obj_panel, DsMap(global::_app->panel_map)[/*"bottom"*/ STR(190)])->location = /*"bottom"*/ STR(190);
		DsMap(global::_app->panel_map)[/*"top"*/ STR(191)] = (new obj_panel)->id;
		ObjType(obj_panel, DsMap(global::_app->panel_map)[/*"top"*/ STR(191)])->size = global::_app->setting_panel_top_size;
		ObjType(obj_panel, DsMap(global::_app->panel_map)[/*"top"*/ STR(191)])->location = /*"top"*/ STR(191);
		DsMap(global::_app->panel_map)[/*"left"*/ STR(192)] = (new obj_panel)->id;
		ObjType(obj_panel, DsMap(global::_app->panel_map)[/*"left"*/ STR(192)])->size = global::_app->setting_panel_left_top_size;
		ObjType(obj_panel, DsMap(global::_app->panel_map)[/*"left"*/ STR(192)])->location = /*"left"*/ STR(192);
		DsMap(global::_app->panel_map)[/*"right"*/ STR(193)] = (new obj_panel)->id;
		ObjType(obj_panel, DsMap(global::_app->panel_map)[/*"right"*/ STR(193)])->size = global::_app->setting_panel_right_top_size;
		ObjType(obj_panel, DsMap(global::_app->panel_map)[/*"right"*/ STR(193)])->location = /*"right"*/ STR(193);
	...
	{
		global::_app->popup_welcome = new_popup({ /*"welcome"*/ STR(194), ID_popup_welcome_draw, IntType(420), IntType(159), true, false, false, false });
		global::_app->popup_about = new_popup({ /*"about"*/ STR(195), ID_popup_about_draw, IntType(542), IntType(480), true, true, false, true });
		global::_app->popup_newproject = new_popup({ /*"newproject"*/ STR(196), ID_popup_newproject_draw, IntType(380), null_, true });
		...
		global::_app->popup_saveas = new_popup({ /*"saveas"*/ STR(197), ID_popup_saveas_draw, IntType(380), null_, true });
		...
		global::_app->popup_loading = new_popup({ /*"loading"*/ STR(198), ID_popup_loading_draw, IntType(400), null_, true, true });
		...
		global::_app->popup_downloadskin = new_popup({ /*"downloadskin"*/ STR(199), ID_popup_downloadskin_draw, IntType(300), null_, true });
		...
		global::_app->popup_importimage = new_popup({ /*"importimage"*/ STR(200), ID_popup_importimage_draw, IntType(236), null_, true });
		...
		global::_app->popup_importitemsheet = new_popup({ /*"importitemsheet"*/ STR(201), ID_popup_importitemsheet_draw, IntType(288), null_, true });
		...
		global::_app->popup_exportmovie = new_popup({ /*"exportmovie"*/ STR(202), ID_popup_exportmovie_draw, IntType(350), null_, true });
		...
		global::_app->popup_exportimage = new_popup({ /*"exportimage"*/ STR(203), ID_popup_exportimage_draw, IntType(350), null_, true });
		...
		withOne (obj_popup, global::_app->popup_upgrade, global::_app->id)
		{
			...
			self->page_ani_type = /*"right"*/ STR(193);
			self->open_advanced = false;
			self->custom_rendering = /*"default"*/ STR(98);
		}
		
		global::_app->popup_advanced = new_popup({ /*"advanced"*/ STR(204), ID_popup_advanced_draw, IntType(420), null_, true });
		global::_app->popup_modelbench = new_popup({ /*"modelbench"*/ STR(205), ID_popup_modelbench_draw, IntType(420), null_, true });
		...
		global::_app->popup_pattern_editor = new_popup({ /*"patterneditor"*/ STR(206), ID_popup_pattern_editor_draw, IntType(550), null_, true, false, false, false });
	...
	void app_startup_interface_tabs()
	{
		...
		withOne (obj_tab, global::_app->properties, global::_app->id)
		{
			...
			withOne (obj_category, self->background, self->id)
			{
				...
				ObjType(obj_textbox, self->tbx_sky_sun_scale)->suffix = /*"%"*/ STR(208);
				...
				ObjType(obj_textbox, self->tbx_sky_moon_scale)->suffix = /*"%"*/ STR(208);
		...
		global::_app->timeline = new_tab(/*"bottom"*/ STR(190), true, null_, e_window_TIMELINE);
		...
		withOne (obj_tab, global::_app->frame_editor, global::_app->id)
		{
			...
			self->constraints_path = tab_add_category(self, /*"frameeditorconstraintspath"*/ STR(229), icons_JOINT_SMALL, ID_tab_frame_editor_constraints_path_point, false);
			self->constraints = tab_add_category(self, /*"frameeditorconstraints"*/ STR(230), icons_JOINT_SMALL, ID_tab_frame_editor_constraints, false);
			...
			self->material = tab_add_category(self, /*"frameeditormaterial"*/ STR(231), ArrType::From({ icons_SPHERE_MATERIAL_SMALL, icons_SPHERE_MATERIAL_SMALL__DARK }), ID_tab_frame_editor_material, false);
			...
			self->particles = tab_add_category(self, /*"frameeditorparticles"*/ STR(232), icons_PARTICLES_SMALL, ID_tab_frame_editor_particles, false);
			...
			self->light = tab_add_category(self, /*"frameeditorlight"*/ STR(233), icons_LIGHT_POINT_SMALL, ID_tab_frame_editor_light, false);
			...
			self->camera = tab_add_category(self, /*"frameeditorcamera"*/ STR(234), icons_CAMERA_SMALL, ID_tab_frame_editor_camera, false);
			...
			self->sound = tab_add_category(self, /*"frameeditorsound"*/ STR(235), icons_VOLUME_SMALL, ID_tab_frame_editor_sound, true);
			...
			self->text = tab_add_category(self, /*"frameeditortext"*/ STR(236), icons_TEXT_SMALL, ID_tab_frame_editor_text, false);
			withOne (Object, self->text, self->id)
				sInt(tbx_text) = new_textbox(false, IntType(0), /*""*/ STR(0));
			
			self->item = tab_add_category(self, /*"frameeditoritem"*/ STR(237), icons_ITEM_SMALL, ID_tab_frame_editor_item, false);
			...
			self->keyframe = tab_add_category(self, /*"frameeditorkeyframe"*/ STR(238), icons_KEYFRAME_SMALL, ID_tab_frame_editor_keyframe, false);
		...
		{
			self->program = tab_add_category(self, /*"settingsprogram"*/ STR(239), icons_SETTINGS_SMALL, ID_tab_settings_program, false);
			...
			self->interface_ = tab_add_category(self, /*"settingsinterface"*/ STR(240), icons_BRUSH_SMALL, ID_tab_settings_interface, false);
			self->controls = tab_add_category(self, /*"settingscontrols"*/ STR(241), icons_KEYBOARD_SMALL, ID_tab_settings_controls, false);
