/*
	...
	[ Generated on 2023.12.15 23:29:02 ]
*/
...
namespace CppProject
{
	...
	void app_startup_collapse()
	{
		...
		collapse_register(/*"followrot"*/ STR(148));
		collapse_register(/*"followpos"*/ STR(149));
		collapse_register(/*"followscale"*/ STR(150));
		collapse_register(/*"path_shape"*/ STR(151));
		collapse_register(/*"path_shape_tube"*/ STR(152));
		collapse_register(/*"light_management_cam"*/ STR(153));
		collapse_register(/*"aperture"*/ STR(154));
		collapse_register(/*"camshake"*/ STR(155));
		collapse_register(/*"dof"*/ STR(156));
		collapse_register(/*"dof_fringe"*/ STR(157));
		collapse_register(/*"bloom"*/ STR(158));
		collapse_register(/*"lensdirt"*/ STR(159));
		collapse_register(/*"clrcor"*/ STR(160));
		collapse_register(/*"grain"*/ STR(161));
		collapse_register(/*"vignette"*/ STR(162));
		collapse_register(/*"ca"*/ STR(163));
		collapse_register(/*"distort"*/ STR(164));
		collapse_register(/*"itemslot"*/ STR(165));
		collapse_register(/*"material_color"*/ STR(166));
		collapse_register(/*"material_surface"*/ STR(167));
		collapse_register(/*"material_subsurface"*/ STR(168));
		collapse_register(/*"textoutline"*/ STR(169));
		collapse_register(/*"tl_glint"*/ STR(170));
	}
	
	void app_startup_fonts(ScopeAny self)
	{
		sInt(font_subheading) = font_add(fonts_directory + /*"rubik_medium.ttf"*/ STR(171), (IntType)(8.5), false, false, IntType(32), IntType(1024));
		sInt(font_label) = font_add(fonts_directory + /*"noto_bold.ttf"*/ STR(172), IntType(9), false, false, IntType(32), IntType(1024));
		sInt(font_value) = font_add(fonts_directory + /*"noto_regular.ttf"*/ STR(173), IntType(9), false, false, IntType(32), IntType(1024));
		sInt(font_digits) = font_add(fonts_directory + /*"notomono_regular.ttf"*/ STR(174), IntType(9), false, false, IntType(32), IntType(1024));
		sInt(font_caption) = font_add(fonts_directory + /*"noto_regular.ttf"*/ STR(173), IntType(8), false, false, IntType(32), IntType(1024));
		sInt(font_button) = font_add(fonts_directory + /*"rubik_medium.ttf"*/ STR(171), (IntType)(9.5), false, false, IntType(32), IntType(1024));
		sVar(font_upgrade) = font_add(fonts_directory + /*"noto_regular.ttf"*/ STR(173), IntType(18), false, false, IntType(32), IntType(1024));
		sInt(font_heading) = font_add(fonts_directory + /*"rubik_medium.ttf"*/ STR(171), IntType(10), false, false, IntType(32), IntType(1024));
		sVar(font_body_big) = font_add(fonts_directory + /*"noto_regular.ttf"*/ STR(173), IntType(12), false, false, IntType(32), IntType(1024));
		sInt(font_heading_big) = font_add(fonts_directory + /*"rubik_medium.ttf"*/ STR(171), IntType(13), false, false, IntType(32), IntType(1024));
		sInt(font_splash_bold_big) = font_add(fonts_directory + /*"rubik_semibold.ttf"*/ STR(175), IntType(11), false, false, IntType(32), IntType(1024));
		sInt(font_splash_bold) = font_add(fonts_directory + /*"rubik_semibold.ttf"*/ STR(175), IntType(10), false, false, IntType(32), IntType(1024));
		sInt(font_splash_bold_secondary) = font_add(fonts_directory + /*"rubik_semibold.ttf"*/ STR(175), (IntType)(8.5), false, false, IntType(32), IntType(1024));
	}
	...
	void app_startup_interface(ScopeAny self)
	{
		...
		if (sStr(project_startup_fn) == /*""*/ STR(0))
		{
			if (dev_mode)
			{
				...
				{
					StringType projfile = sStr(setting_project_folder) + ObjType(obj_popup, sInt(popup_newproject))->folder + /*"/New Project.miproject"*/ STR(176);
	...
	void app_startup_interface_bench()
	{
		...
		list_item_add(/*"typechar"*/ STR(177), e_tl_type_CHARACTER, /*""*/ STR(0), null_, icons_CHARACTER, null_, ID_bench_click);
		list_item_add(/*"typebodypart"*/ STR(178), e_tl_type_BODYPART, /*""*/ STR(0), null_, icons_PART, null_, ID_bench_click);
		list_item_add(/*"typemodel"*/ STR(179), e_tl_type_MODEL, /*""*/ STR(0), null_, icons_MODEL, null_, ID_bench_click);
		list_item_add(/*"typeitem"*/ STR(180), e_tl_type_ITEM, /*""*/ STR(0), null_, icons_ITEM, null_, ID_bench_click);
		list_item_add(/*"typescenery"*/ STR(181), e_tl_type_SCENERY, /*""*/ STR(0), null_, icons_SCENERY, null_, ID_bench_click);
		list_item_add(/*"typeblock"*/ STR(182), e_tl_type_BLOCK, /*""*/ STR(0), null_, icons_BLOCK, null_, ID_bench_click);
		list_item_add(/*"typespblock"*/ STR(183), e_tl_type_SPECIAL_BLOCK, /*""*/ STR(0), null_, icons_BLOCK_SPECIAL, null_, ID_bench_click);
		list_item_add(/*"typeshape"*/ STR(184), e_tl_type_SHAPE, /*""*/ STR(0), null_, icons_SHAPES, null_, ID_bench_click);
		list_item_add(/*"typetext"*/ STR(185), e_tl_type_TEXT, /*""*/ STR(0), null_, icons_TEXT, null_, ID_bench_click);
		list_item_add(/*"typepath"*/ STR(186), e_tl_type_PATH, /*""*/ STR(0), null_, icons_PATH, null_, ID_bench_click);
		list_item_add(/*"typecamera"*/ STR(187), e_tl_type_CAMERA, /*""*/ STR(0), null_, icons_CAMERA, null_, ID_bench_click);
		list_item_add(/*"typeparticles"*/ STR(188), e_tl_type_PARTICLE_SPAWNER, /*""*/ STR(0), null_, icons_FIREWORKS, null_, ID_bench_click);
		list_item_add(/*"typelightsource"*/ STR(189), e_tl_type_LIGHT_SOURCE, /*""*/ STR(0), null_, icons_LIGHT_POINT, null_, ID_bench_click);
		list_item_add(/*"typeaudio"*/ STR(190), e_tl_type_AUDIO, /*""*/ STR(0), null_, icons_NOTE, null_, ID_bench_click);
		list_item_add(/*"typebackground"*/ STR(191), e_tl_type_BACKGROUND, /*""*/ STR(0), null_, icons_CLOUD, null_, ID_bench_click);
		...
		withOne (obj_bench_settings, global::_app->bench_settings, global::_app->id)
		{
			...
			sortlist_column_add(self->particles_list, /*"particlepresetname"*/ STR(196), IntType(0));
		}
