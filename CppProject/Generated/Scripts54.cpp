...
namespace CppProject
{
	...
	RealType res_load_pack(ScopeAny self)
	{
		...
		switch (StringType(sStr(load_stage)).id)
		{
			case 1320: // unzip
			{
				debug({ /*"res_load_pack"*/ STR(2618), /*"unzip"*/ STR(1320) });
				if (sVar(type) != e_res_type_PACK_UNZIPPED)
				{
					if (!unzip(fname))
					{
						log({ /*"Error unzipping pack"*/ STR(2619) });
						error(/*"errorunzippack"*/ STR(2620));
				...
				sStr(load_stage) = /*"modeltextures"*/ STR(1402);
				global::load_assets_dir = unzip_directory;
				res_load_pack_version(self);
				withOne (app, global::_app->id, self->id)
				{
					ObjType(obj_popup, global::_app->popup_loading)->text = text_get({ /*"loadpackmodeltextures"*/ STR(2621) });
			...
			{
				debug({ /*"res_load_pack"*/ STR(2618), /*"modeltextures"*/ STR(1402) });
				res_load_pack_model_textures(self);
				sStr(load_stage) = /*"blocktextures"*/ STR(2622);
				withOne (app, global::_app->id, self->id)
				{
					ObjType(obj_popup, global::_app->popup_loading)->text = text_get({ /*"loadpackblocktextures"*/ STR(2623) });
			...
			case 2622: // blocktextures
			{
				debug({ /*"res_load_pack"*/ STR(2618), /*"blocktextures"*/ STR(2622) });
				file_rename_lib(global::load_assets_dir + mc_textures_directory + /*"blocks"*/ STR(1025), global::load_assets_dir + mc_textures_directory + /*"block"*/ STR(4));
				res_load_pack_block_textures(self);
				sStr(load_stage) = /*"itemtextures"*/ STR(2624);
				withOne (app, global::_app->id, self->id)
				{
					ObjType(obj_popup, global::_app->popup_loading)->text = text_get({ /*"loadpackitemtextures"*/ STR(2625) });
			...
			case 2624: // itemtextures
			{
				debug({ /*"res_load_pack"*/ STR(2618), /*"itemtextures"*/ STR(2624) });
				file_rename_lib(global::load_assets_dir + mc_textures_directory + /*"items"*/ STR(2626), global::load_assets_dir + mc_textures_directory + /*"item"*/ STR(551));
				res_load_pack_item_textures(self, /*"diffuse"*/ STR(637), /*""*/ STR(0));
				res_load_pack_item_textures(self, /*"material"*/ STR(642), /*"_s"*/ STR(2627));
				res_load_pack_item_textures(self, /*"normal"*/ STR(631), /*"_n"*/ STR(2628));
	...
	void res_load_pack_block_sheet(ScopeAny self, StringType type, StringType suffix)
	{
		...
		{
			ArrType filesarr = file_find(global::load_assets_dir + mc_textures_directory + /*"block/"*/ STR(823), /*".png"*/ STR(10));
		...
		log({ /*"Block textures"*/ STR(2630), type, /*"load static"*/ STR(2631) });
		...
		for (IntType t = IntType(0); t < ds_list_size((IntType)(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_list)); t++)
		{
			...
			name = string_replace(DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_list).Value(t), /*" opaque"*/ STR(863), /*""*/ STR(0));
			name = string_replace(name, /*" noalpha"*/ STR(864), /*""*/ STR(0));
			...
			{
				if (dev_mode)
					log({ /*"Block texture not found"*/ STR(2632), DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_list).Value(t) + suffix });
				ds_list_add({ texlist, null_ });
			}
			
		}
		log({ /*"Block textures"*/ STR(2630), type, /*"load animated"*/ STR(2633) });
		...
		{
			StringType name, fname;
			name = string_replace(DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_ani_list).Value(t), /*" opaque"*/ STR(863), /*""*/ STR(0));
			fname = global::load_assets_dir + mc_textures_directory + name + suffix + /*".png"*/ STR(10);
			if (!file_exists_lib(fname) && !is_undefined(DsMap(global::legacy_block_texture_name_map).Value(name)))
				fname = global::load_assets_dir + mc_textures_directory + DsMap(global::legacy_block_texture_name_map).Value(name) + suffix + /*".png"*/ STR(10);
			if (file_exists_lib(fname))
			...
			{
				if (dev_mode)
					log({ /*"Animated block texture not found"*/ STR(2634), DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_ani_list).Value(t) + suffix });
		...
		if (fileslist != null_)
		{
			...
			if (ds_list_size(fileslist) > IntType(0))
			{
				...
				for (IntType i = IntType(0); i < ds_list_size(fileslist); i++)
					str += /*"  "*/ STR(1787) + filename_name(DsList(fileslist).Value(i)) + /*"\n"*/ STR(712);
				log({ str });
			}
		...
		log({ /*"Block textures, blocksize"*/ STR(2636), type, blocksize });
		draw_texture_start();
		surf = surface_create((IntType)(block_sheet_width * blocksize), (IntType)(block_sheet_height * blocksize));
		log({ /*"Block textures"*/ STR(2630), /*"static block surface"*/ STR(2637) });
		surface_set_target(surf);
	{
		...
		for (IntType t = IntType(0); t < ds_list_size(texlist); t++)
		{
			...
			if (tex != null_)
			{
				...
				if (string_contains(DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_list).Value(t), /*" opaque"*/ STR(863)))
				...
				if (type == /*"normal"*/ STR(631) || string_contains(DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_list).Value(t), /*" noalpha"*/ STR(864)))
				{
			...
			else
			{
				if (type == /*"diffuse"*/ STR(637))
				{
					...
					if (type == /*"material"*/ STR(642))
						draw_box(dx, dy, blocksize, blocksize, false, c_black, IntType(1));
					else
						if (type == /*"normal"*/ STR(631))
		...
		if (self->id == global::mc_res)
		{
			...
			log({ /*"Block textures"*/ STR(2630), /*"static block preview"*/ STR(2638) });
		...
		log({ /*"Block textures"*/ STR(2630), type, /*"animated block surfaces"*/ STR(2639) });
		...
		draw_texture_start();
		gpu_set_blendmode_ext(bm_one, bm_inv_src_alpha);
		log({ /*"Block textures"*/ STR(2630), type, /*"animated frames"*/ STR(2640) });
		for (IntType t = IntType(0); t < ds_list_size(texanilist); t++)
		{
			...
			frametime = IntType(1);
			framelist = null_;
			opaque = string_contains(DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_ani_list).Value(t), /*" opaque"*/ STR(863));
			fname = global::load_assets_dir + mc_textures_directory + DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_ani_list).Value(t) + suffix + /*".png.mcmeta"*/ STR(2641);
			if (file_exists_lib(fname))
			{
				IntType map = json_load({ fname });
				if (ds_map_valid(map))
				{
					VarType animation = DsMap(map).Value(/*"animation"*/ STR(2642));
					if (!is_undefined(animation))
					{
						if (!is_undefined(DsMap(animation).Value(/*"interpolate"*/ STR(2643))))
							framefade = DsMap(animation).Value(/*"interpolate"*/ STR(2643));
						if (!is_undefined(DsMap(animation).Value(/*"frametime"*/ STR(2644))))
							frametime = DsMap(animation).Value(/*"frametime"*/ STR(2644));
						if (!is_undefined(DsMap(animation).Value(/*"frames"*/ STR(1816))))
							framelist = DsMap(animation).Value(/*"frames"*/ STR(1816));
					}
				}
			}
			if (tex != null_)
		...
		if (self->id == global::mc_res)
		{
			log({ /*"Block textures"*/ STR(2630), /*"animated block preview"*/ STR(2645) });
		...
		if (type == /*"diffuse"*/ STR(637))
		{
			...
			log({ /*"Block textures"*/ STR(2630), /*"find static block depths"*/ STR(2646) });
			...
			for (IntType t = IntType(0); t < ds_list_size((IntType)(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_list)); t++)
			{
				...
				RealType opaque = string_contains(DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_list).Value(t), /*"leaves"*/ STR(898));
				if (opaque > 0)
				{
			...
			log({ /*"Block textures"*/ STR(2630), /*"find animated block depths"*/ STR(2647) });
		...
		log({ /*"Block textures"*/ STR(2630), type, /*"done"*/ STR(1773) });
		debug_timer_stop(/*"Block textures: "*/ STR(2648) + type);
	}
	...
	void res_load_pack_block_textures(ScopeAny self)
	{
		...
		res_load_pack_block_sheet(self, /*"diffuse"*/ STR(637), /*""*/ STR(0));
		if (self->id != global::mc_res)
		{
			res_load_pack_block_sheet(self, /*"material"*/ STR(642), /*"_s"*/ STR(2627));
			res_load_pack_block_sheet(self, /*"normal"*/ STR(631), /*"_n"*/ STR(2628));
		}
		else
		{
		...
		log({ /*"Block textures all"*/ STR(2649), /*"done"*/ STR(1773) });
	}
	
	void res_load_pack_item_textures(ScopeAny self, StringType type, StringType suffix)
	{
		if (type == /*"diffuse"*/ STR(637) && sInt(item_sheet_texture) != null_)
			texture_free(sInt(item_sheet_texture));
		if (type == /*"material"*/ STR(642) && sInt(item_sheet_texture_material) != null_)
			texture_free(sInt(item_sheet_texture_material));
		if (type == /*"normal"*/ STR(631) && sInt(item_sheet_tex_normal) != null_)
		...
		fileslist = null_;
		debug_timer_start();
		if (dev_mode_debug_unused && type == /*"diffuse"*/ STR(637))
		{
			ArrType filesarr = file_find(global::load_assets_dir + mc_textures_directory + /*"item/"*/ STR(2498), /*".png"*/ STR(10));
			fileslist = ds_list_create();
			for (IntType i = IntType(0); i < array_length(VarType::CreateRef(filesarr)); i++)
				ds_list_add({ fileslist, filesarr.Value(i) });
		}
		log({ /*"Item textures"*/ STR(2650), type, /*"load"*/ STR(2651) });
		texlist = ds_list_create();
		for (IntType t = IntType(0); t < ds_list_size((IntType)(ObjType(obj_minecraft_assets, global::mc_assets)->item_texture_list)); t++)
		{
			...
			{
				if (dev_mode)
					log({ /*"Item texture not found"*/ STR(2652), DsList(ObjType(obj_minecraft_assets, global::mc_assets)->item_texture_list).Value(t) + suffix });
				ds_list_add({ texlist, null_ });
			}
		...
		if (itemsize == null_)
			itemsize = item_size;
		log({ /*"Item textures"*/ STR(2650), /*"surface"*/ STR(557) });
		draw_texture_start();
		...
		surface_set_target(surf);
	{
		...
		for (IntType t = IntType(0); t < ds_list_size(texlist); t++)
		{
			...
			{
				if (type == /*"diffuse"*/ STR(637) && self->id != global::mc_res)
		...
		surface_free(surf);
		ds_list_destroy(texlist);
		log({ /*"Item textures"*/ STR(2650), type, /*"done"*/ STR(1773) });
		debug_timer_stop(/*"Item textures: "*/ STR(2654) + type);
	}
	...
	void res_load_pack_model_textures(ScopeAny self)
	{
		...
		debug_timer_start();
		log({ /*"Model textures"*/ STR(2655), /*"load"*/ STR(2651) });
		...
		for (IntType t = IntType(0); t < ds_list_size((IntType)(ObjType(obj_minecraft_assets, global::mc_assets)->model_texture_list)); t++)
		{
			...
			matfname = global::load_assets_dir + mc_textures_directory + name + /*"_s.png"*/ STR(2656);
			norfname = global::load_assets_dir + mc_textures_directory + name + /*"_n.png"*/ STR(2657);
			if (file_exists_lib(fname))
			{
				if (name == /*"entity/steve"*/ STR(2658))
				...
				{
					if (dev_mode)
						log({ /*"Model texture not found"*/ STR(2659), DsList(ObjType(obj_minecraft_assets, global::mc_assets)->model_texture_list).Value(t) });
			...
			{
				if (matfname == /*"entity/steve_s"*/ STR(2660))
			...
			{
				if (norfname == /*"entity/steve_n"*/ STR(2661))
		...
		log({ /*"Model textures"*/ STR(2655), /*"done"*/ STR(1773) });
		debug_timer_stop(/*"Model textures"*/ STR(2655));
	}
	...
	void res_load_pack_particle_textures(ScopeAny self)
	{
		...
		debug_timer_start();
		log({ /*"Particle textures"*/ STR(2662), /*"load"*/ STR(2651) });
		...
		for (IntType t = IntType(0); t < ds_list_size((IntType)(ObjType(obj_minecraft_assets, global::mc_assets)->particle_texture_list)); t++)
		{
			...
			if (file_exists_lib(fname))
			{
				...
				{
					if (dev_mode)
						log({ /*"Particle texture not found"*/ STR(2663), DsList(ObjType(obj_minecraft_assets, global::mc_assets)->particle_texture_list).Value(t) });
					tex = texture_create_missing();
				}
			...
			{
				if (string_contains(name, /*"explosion"*/ STR(2664)))
				{
		...
		log({ /*"Particle textures"*/ STR(2662), /*"legacy sheets"*/ STR(2665) });
		...
		log({ /*"Particle textures"*/ STR(2662), /*"done"*/ STR(1773) });
		debug_timer_stop(/*"Particle textures"*/ STR(2662));
	}
