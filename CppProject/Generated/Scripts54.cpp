...
namespace CppProject
{
	...
	RealType res_load_pack(ScopeAny self)
	{
		...
		switch (StringType(sStr(load_stage)).id)
		{
			case 1304: // unzip
			{
				debug({ /*"res_load_pack"*/ STR(2597), /*"unzip"*/ STR(1304) });
				if (sVar(type) != e_res_type_PACK_UNZIPPED)
				{
					if (!unzip(fname))
					{
						log({ /*"Error unzipping pack"*/ STR(2598) });
						error(/*"errorunzippack"*/ STR(2599));
				...
				sStr(load_stage) = /*"modeltextures"*/ STR(1386);
				global::load_assets_dir = unzip_directory;
				res_load_pack_version(self);
				withOne (app, global::_app->id, self->id)
				{
					ObjType(obj_popup, global::_app->popup_loading)->text = text_get({ /*"loadpackmodeltextures"*/ STR(2600) });
			...
			{
				debug({ /*"res_load_pack"*/ STR(2597), /*"modeltextures"*/ STR(1386) });
				res_load_pack_model_textures(self);
				sStr(load_stage) = /*"blocktextures"*/ STR(2601);
				withOne (app, global::_app->id, self->id)
				{
					ObjType(obj_popup, global::_app->popup_loading)->text = text_get({ /*"loadpackblocktextures"*/ STR(2602) });
			...
			case 2601: // blocktextures
			{
				debug({ /*"res_load_pack"*/ STR(2597), /*"blocktextures"*/ STR(2601) });
				file_rename_lib(global::load_assets_dir + mc_textures_directory + /*"blocks"*/ STR(1021), global::load_assets_dir + mc_textures_directory + /*"block"*/ STR(4));
				res_load_pack_block_textures(self);
				sStr(load_stage) = /*"itemtextures"*/ STR(2603);
				withOne (app, global::_app->id, self->id)
				{
					ObjType(obj_popup, global::_app->popup_loading)->text = text_get({ /*"loadpackitemtextures"*/ STR(2604) });
			...
			case 2603: // itemtextures
			{
				debug({ /*"res_load_pack"*/ STR(2597), /*"itemtextures"*/ STR(2603) });
				file_rename_lib(global::load_assets_dir + mc_textures_directory + /*"items"*/ STR(2605), global::load_assets_dir + mc_textures_directory + /*"item"*/ STR(547));
				res_load_pack_item_textures(self, /*"diffuse"*/ STR(633), /*""*/ STR(0));
				res_load_pack_item_textures(self, /*"material"*/ STR(638), /*"_s"*/ STR(2606));
				res_load_pack_item_textures(self, /*"normal"*/ STR(627), /*"_n"*/ STR(2607));
	...
	void res_load_pack_block_sheet(ScopeAny self, StringType type, StringType suffix)
	{
		...
		{
			ArrType filesarr = file_find(global::load_assets_dir + mc_textures_directory + /*"block/"*/ STR(819), /*".png"*/ STR(10));
		...
		log({ /*"Block textures"*/ STR(2609), type, /*"load static"*/ STR(2610) });
		...
		for (IntType t = IntType(0); t < ds_list_size((IntType)(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_list)); t++)
		{
			...
			name = string_replace(DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_list).Value(t), /*" opaque"*/ STR(859), /*""*/ STR(0));
			name = string_replace(name, /*" noalpha"*/ STR(860), /*""*/ STR(0));
			...
			{
				if (dev_mode)
					log({ /*"Block texture not found"*/ STR(2611), DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_list).Value(t) + suffix });
				ds_list_add({ texlist, null_ });
			}
			
		}
		log({ /*"Block textures"*/ STR(2609), type, /*"load animated"*/ STR(2612) });
		...
		{
			StringType name, fname;
			name = string_replace(DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_ani_list).Value(t), /*" opaque"*/ STR(859), /*""*/ STR(0));
			fname = global::load_assets_dir + mc_textures_directory + name + suffix + /*".png"*/ STR(10);
			if (!file_exists_lib(fname) && !is_undefined(DsMap(global::legacy_block_texture_name_map).Value(name)))
				fname = global::load_assets_dir + mc_textures_directory + DsMap(global::legacy_block_texture_name_map).Value(name) + suffix + /*".png"*/ STR(10);
			if (file_exists_lib(fname))
			...
			{
				if (dev_mode)
					log({ /*"Animated block texture not found"*/ STR(2613), DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_ani_list).Value(t) + suffix });
		...
		if (fileslist != null_)
		{
			...
			if (ds_list_size(fileslist) > IntType(0))
			{
				...
				for (IntType i = IntType(0); i < ds_list_size(fileslist); i++)
					str += /*"  "*/ STR(1771) + filename_name(DsList(fileslist).Value(i)) + /*"\n"*/ STR(708);
				log({ str });
			}
		...
		log({ /*"Block textures, blocksize"*/ STR(2615), type, blocksize });
		draw_texture_start();
		surf = surface_create((IntType)(block_sheet_width * blocksize), (IntType)(block_sheet_height * blocksize));
		log({ /*"Block textures"*/ STR(2609), /*"static block surface"*/ STR(2616) });
		surface_set_target(surf);
	{
		...
		for (IntType t = IntType(0); t < ds_list_size(texlist); t++)
		{
			...
			if (tex != null_)
			{
				...
				if (string_contains(DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_list).Value(t), /*" opaque"*/ STR(859)))
				...
				if (type == /*"normal"*/ STR(627) || string_contains(DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_list).Value(t), /*" noalpha"*/ STR(860)))
				{
		...
		if (self->id == global::mc_res)
		{
			...
			log({ /*"Block textures"*/ STR(2609), /*"static block preview"*/ STR(2617) });
		...
		log({ /*"Block textures"*/ STR(2609), type, /*"animated block surfaces"*/ STR(2618) });
		...
		draw_texture_start();
		gpu_set_blendmode_ext(bm_one, bm_inv_src_alpha);
		log({ /*"Block textures"*/ STR(2609), type, /*"animated frames"*/ STR(2619) });
		for (IntType t = IntType(0); t < ds_list_size(texanilist); t++)
		{
			...
			frametime = IntType(1);
			framelist = null_;
			opaque = string_contains(DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_ani_list).Value(t), /*" opaque"*/ STR(859));
			fname = global::load_assets_dir + mc_textures_directory + DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_ani_list).Value(t) + suffix + /*".png.mcmeta"*/ STR(2620);
			if (file_exists_lib(fname))
			{
				IntType map = json_load({ fname });
				if (ds_map_valid(map))
				{
					VarType animation = DsMap(map).Value(/*"animation"*/ STR(2621));
					if (!is_undefined(animation))
					{
						if (!is_undefined(DsMap(animation).Value(/*"interpolate"*/ STR(2622))))
							framefade = DsMap(animation).Value(/*"interpolate"*/ STR(2622));
						if (!is_undefined(DsMap(animation).Value(/*"frametime"*/ STR(2623))))
							frametime = DsMap(animation).Value(/*"frametime"*/ STR(2623));
						if (!is_undefined(DsMap(animation).Value(/*"frames"*/ STR(1800))))
							framelist = DsMap(animation).Value(/*"frames"*/ STR(1800));
					}
				}
			}
			if (tex != null_)
		...
		if (self->id == global::mc_res)
		{
			log({ /*"Block textures"*/ STR(2609), /*"animated block preview"*/ STR(2624) });
		...
		if (type == /*"diffuse"*/ STR(633))
		{
			...
			log({ /*"Block textures"*/ STR(2609), /*"find static block depths"*/ STR(2625) });
			...
			for (IntType t = IntType(0); t < ds_list_size((IntType)(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_list)); t++)
			{
				...
				RealType opaque = string_contains(DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_list).Value(t), /*"leaves"*/ STR(894));
				if (opaque > 0)
				{
			...
			log({ /*"Block textures"*/ STR(2609), /*"find animated block depths"*/ STR(2626) });
		...
		log({ /*"Block textures"*/ STR(2609), type, /*"done"*/ STR(1757) });
		debug_timer_stop(/*"Block textures: "*/ STR(2627) + type);
	}
	...
	void res_load_pack_block_textures(ScopeAny self)
	{
		...
		if (self->id != global::mc_res)
		{
			res_load_pack_block_sheet(self, /*"material"*/ STR(638), /*"_s"*/ STR(2606));
			res_load_pack_block_sheet(self, /*"normal"*/ STR(627), /*"_n"*/ STR(2607));
		}
		else
		{
		...
		log({ /*"Block textures all"*/ STR(2628), /*"done"*/ STR(1757) });
	}
	...
	void res_load_pack_item_textures(ScopeAny self, StringType type, StringType suffix)
	{
		...
		{
			ArrType filesarr = file_find(global::load_assets_dir + mc_textures_directory + /*"item/"*/ STR(2477), /*".png"*/ STR(10));
			fileslist = ds_list_create();
			for (IntType i = IntType(0); i < array_length(VarType::CreateRef(filesarr)); i++)
				ds_list_add({ fileslist, filesarr.Value(i) });
		}
		log({ /*"Item textures"*/ STR(2629), type, /*"load"*/ STR(2630) });
		texlist = ds_list_create();
		for (IntType t = IntType(0); t < ds_list_size((IntType)(ObjType(obj_minecraft_assets, global::mc_assets)->item_texture_list)); t++)
		{
			...
			{
				if (dev_mode)
					log({ /*"Item texture not found"*/ STR(2631), DsList(ObjType(obj_minecraft_assets, global::mc_assets)->item_texture_list).Value(t) + suffix });
				ds_list_add({ texlist, null_ });
			}
		...
		if (itemsize == null_)
			itemsize = item_size;
		log({ /*"Item textures"*/ STR(2629), /*"surface"*/ STR(553) });
		draw_texture_start();
		...
		surface_set_target(surf);
	{
		...
		surface_free(surf);
		ds_list_destroy(texlist);
		log({ /*"Item textures"*/ STR(2629), type, /*"done"*/ STR(1757) });
		debug_timer_stop(/*"Item textures: "*/ STR(2633) + type);
	}
	...
	void res_load_pack_model_textures(ScopeAny self)
	{
		...
		debug_timer_start();
		log({ /*"Model textures"*/ STR(2634), /*"load"*/ STR(2630) });
		...
		for (IntType t = IntType(0); t < ds_list_size((IntType)(ObjType(obj_minecraft_assets, global::mc_assets)->model_texture_list)); t++)
		{
			...
			matfname = global::load_assets_dir + mc_textures_directory + name + /*"_s.png"*/ STR(2635);
			norfname = global::load_assets_dir + mc_textures_directory + name + /*"_n.png"*/ STR(2636);
			if (file_exists_lib(fname))
			{
				if (name == /*"entity/steve"*/ STR(2637))
				...
				{
					if (dev_mode)
						log({ /*"Model texture not found"*/ STR(2638), DsList(ObjType(obj_minecraft_assets, global::mc_assets)->model_texture_list).Value(t) });
			...
			{
				if (matfname == /*"entity/steve_s"*/ STR(2639))
			...
			{
				if (norfname == /*"entity/steve_n"*/ STR(2640))
		...
		log({ /*"Model textures"*/ STR(2634), /*"done"*/ STR(1757) });
		debug_timer_stop(/*"Model textures"*/ STR(2634));
	}
	...
	void res_load_pack_particle_textures(ScopeAny self)
	{
		...
		debug_timer_start();
		log({ /*"Particle textures"*/ STR(2641), /*"load"*/ STR(2630) });
		...
		for (IntType t = IntType(0); t < ds_list_size((IntType)(ObjType(obj_minecraft_assets, global::mc_assets)->particle_texture_list)); t++)
		{
			...
			if (file_exists_lib(fname))
			{
				...
				{
					if (dev_mode)
						log({ /*"Particle texture not found"*/ STR(2642), DsList(ObjType(obj_minecraft_assets, global::mc_assets)->particle_texture_list).Value(t) });
					tex = texture_create_missing();
				}
			...
			{
				if (string_contains(name, /*"explosion"*/ STR(2643)))
				{
		...
		log({ /*"Particle textures"*/ STR(2641), /*"legacy sheets"*/ STR(2644) });
		...
		log({ /*"Particle textures"*/ STR(2641), /*"done"*/ STR(1757) });
		debug_timer_stop(/*"Particle textures"*/ STR(2641));
	}
