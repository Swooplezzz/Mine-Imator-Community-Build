...
namespace CppProject
{
	...
	RealType res_load_pack(ScopeAny self)
	{
		...
		switch (StringType(sStr(load_stage)).id)
		{
			case 1302: // unzip
			{
				debug({ /*"res_load_pack"*/ STR(2595), /*"unzip"*/ STR(1302) });
				if (sVar(type) != e_res_type_PACK_UNZIPPED)
				{
					if (!unzip(fname))
					{
						log({ /*"Error unzipping pack"*/ STR(2596) });
						error(/*"errorunzippack"*/ STR(2597));
				...
				sStr(load_stage) = /*"modeltextures"*/ STR(1384);
				global::load_assets_dir = unzip_directory;
				res_load_pack_version(self);
				withOne (app, global::_app->id, self->id)
				{
					ObjType(obj_popup, global::_app->popup_loading)->text = text_get({ /*"loadpackmodeltextures"*/ STR(2598) });
			...
			{
				debug({ /*"res_load_pack"*/ STR(2595), /*"modeltextures"*/ STR(1384) });
				res_load_pack_model_textures(self);
				sStr(load_stage) = /*"blocktextures"*/ STR(2599);
				withOne (app, global::_app->id, self->id)
				{
					ObjType(obj_popup, global::_app->popup_loading)->text = text_get({ /*"loadpackblocktextures"*/ STR(2600) });
			...
			case 2599: // blocktextures
			{
				debug({ /*"res_load_pack"*/ STR(2595), /*"blocktextures"*/ STR(2599) });
				file_rename_lib(global::load_assets_dir + mc_textures_directory + /*"blocks"*/ STR(1019), global::load_assets_dir + mc_textures_directory + /*"block"*/ STR(4));
				res_load_pack_block_textures(self);
				sStr(load_stage) = /*"itemtextures"*/ STR(2601);
				withOne (app, global::_app->id, self->id)
				{
					ObjType(obj_popup, global::_app->popup_loading)->text = text_get({ /*"loadpackitemtextures"*/ STR(2602) });
			...
			case 2601: // itemtextures
			{
				debug({ /*"res_load_pack"*/ STR(2595), /*"itemtextures"*/ STR(2601) });
				file_rename_lib(global::load_assets_dir + mc_textures_directory + /*"items"*/ STR(2603), global::load_assets_dir + mc_textures_directory + /*"item"*/ STR(547));
				res_load_pack_item_textures(self, /*"diffuse"*/ STR(633), /*""*/ STR(0));
				res_load_pack_item_textures(self, /*"material"*/ STR(638), /*"_s"*/ STR(2604));
				res_load_pack_item_textures(self, /*"normal"*/ STR(627), /*"_n"*/ STR(2605));
	...
	void res_load_pack_block_sheet(ScopeAny self, StringType type, StringType suffix)
	{
		...
		{
			ArrType filesarr = file_find(global::load_assets_dir + mc_textures_directory + /*"block/"*/ STR(817), /*".png"*/ STR(10));
		...
		log({ /*"Block textures"*/ STR(2607), type, /*"load static"*/ STR(2608) });
		...
		for (IntType t = IntType(0); t < ds_list_size((IntType)(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_list)); t++)
		{
			...
			name = string_replace(DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_list).Value(t), /*" opaque"*/ STR(857), /*""*/ STR(0));
			name = string_replace(name, /*" noalpha"*/ STR(858), /*""*/ STR(0));
			...
			{
				if (dev_mode)
					log({ /*"Block texture not found"*/ STR(2609), DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_list).Value(t) + suffix });
				ds_list_add({ texlist, null_ });
			}
			
		}
		log({ /*"Block textures"*/ STR(2607), type, /*"load animated"*/ STR(2610) });
		...
		{
			StringType name, fname;
			name = string_replace(DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_ani_list).Value(t), /*" opaque"*/ STR(857), /*""*/ STR(0));
			fname = global::load_assets_dir + mc_textures_directory + name + suffix + /*".png"*/ STR(10);
			if (!file_exists_lib(fname) && !is_undefined(DsMap(global::legacy_block_texture_name_map).Value(name)))
				fname = global::load_assets_dir + mc_textures_directory + DsMap(global::legacy_block_texture_name_map).Value(name) + suffix + /*".png"*/ STR(10);
			if (file_exists_lib(fname))
			...
			{
				if (dev_mode)
					log({ /*"Animated block texture not found"*/ STR(2611), DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_ani_list).Value(t) + suffix });
		...
		if (fileslist != null_)
		{
			...
			if (ds_list_size(fileslist) > IntType(0))
			{
				...
				for (IntType i = IntType(0); i < ds_list_size(fileslist); i++)
					str += /*"  "*/ STR(1769) + filename_name(DsList(fileslist).Value(i)) + /*"\n"*/ STR(76);
				log({ str });
			}
		...
		log({ /*"Block textures, blocksize"*/ STR(2613), type, blocksize });
		draw_texture_start();
		surf = surface_create((IntType)(block_sheet_width * blocksize), (IntType)(block_sheet_height * blocksize));
		log({ /*"Block textures"*/ STR(2607), /*"static block surface"*/ STR(2614) });
		surface_set_target(surf);
	{
		...
		for (IntType t = IntType(0); t < ds_list_size(texlist); t++)
		{
			...
			if (tex != null_)
			{
				...
				if (string_contains(DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_list).Value(t), /*" opaque"*/ STR(857)))
				...
				if (type == /*"normal"*/ STR(627) || string_contains(DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_list).Value(t), /*" noalpha"*/ STR(858)))
				{
			...
			else
			{
				if (type == /*"diffuse"*/ STR(633))
				{
					...
					if (type == /*"material"*/ STR(638))
						draw_box(dx, dy, blocksize, blocksize, false, c_black, IntType(1));
					else
						if (type == /*"normal"*/ STR(627))
		...
		if (self->id == global::mc_res)
		{
			...
			log({ /*"Block textures"*/ STR(2607), /*"static block preview"*/ STR(2615) });
		...
		log({ /*"Block textures"*/ STR(2607), type, /*"animated block surfaces"*/ STR(2616) });
		...
		draw_texture_start();
		gpu_set_blendmode_ext(bm_one, bm_inv_src_alpha);
		log({ /*"Block textures"*/ STR(2607), type, /*"animated frames"*/ STR(2617) });
		for (IntType t = IntType(0); t < ds_list_size(texanilist); t++)
		{
			...
			frametime = IntType(1);
			framelist = null_;
			opaque = string_contains(DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_ani_list).Value(t), /*" opaque"*/ STR(857));
			fname = global::load_assets_dir + mc_textures_directory + DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_ani_list).Value(t) + suffix + /*".png.mcmeta"*/ STR(2618);
			if (file_exists_lib(fname))
			{
				IntType map = json_load({ fname });
				if (ds_map_valid(map))
				{
					VarType animation = DsMap(map).Value(/*"animation"*/ STR(2619));
					if (!is_undefined(animation))
					{
						if (!is_undefined(DsMap(animation).Value(/*"interpolate"*/ STR(2620))))
							framefade = DsMap(animation).Value(/*"interpolate"*/ STR(2620));
						if (!is_undefined(DsMap(animation).Value(/*"frametime"*/ STR(2621))))
							frametime = DsMap(animation).Value(/*"frametime"*/ STR(2621));
						if (!is_undefined(DsMap(animation).Value(/*"frames"*/ STR(1798))))
							framelist = DsMap(animation).Value(/*"frames"*/ STR(1798));
					}
				}
			}
			if (tex != null_)
		...
		if (self->id == global::mc_res)
		{
			log({ /*"Block textures"*/ STR(2607), /*"animated block preview"*/ STR(2622) });
		...
		if (type == /*"diffuse"*/ STR(633))
		{
			...
			log({ /*"Block textures"*/ STR(2607), /*"find static block depths"*/ STR(2623) });
			...
			for (IntType t = IntType(0); t < ds_list_size((IntType)(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_list)); t++)
			{
				...
				RealType opaque = string_contains(DsList(ObjType(obj_minecraft_assets, global::mc_assets)->block_texture_list).Value(t), /*"leaves"*/ STR(892));
				if (opaque > 0)
				{
			...
			log({ /*"Block textures"*/ STR(2607), /*"find animated block depths"*/ STR(2624) });
		...
		log({ /*"Block textures"*/ STR(2607), type, /*"done"*/ STR(1755) });
		debug_timer_stop(/*"Block textures: "*/ STR(2625) + type);
	}
	...
	void res_load_pack_block_textures(ScopeAny self)
	{
		...
		res_load_pack_block_sheet(self, /*"diffuse"*/ STR(633), /*""*/ STR(0));
		if (self->id != global::mc_res)
		{
			res_load_pack_block_sheet(self, /*"material"*/ STR(638), /*"_s"*/ STR(2604));
			res_load_pack_block_sheet(self, /*"normal"*/ STR(627), /*"_n"*/ STR(2605));
		}
		else
		{
		...
		log({ /*"Block textures all"*/ STR(2626), /*"done"*/ STR(1755) });
	}
	
	void res_load_pack_item_textures(ScopeAny self, StringType type, StringType suffix)
	{
		if (type == /*"diffuse"*/ STR(633) && sInt(item_sheet_texture) != null_)
			texture_free(sInt(item_sheet_texture));
		if (type == /*"material"*/ STR(638) && sInt(item_sheet_texture_material) != null_)
			texture_free(sInt(item_sheet_texture_material));
		if (type == /*"normal"*/ STR(627) && sInt(item_sheet_tex_normal) != null_)
		...
		fileslist = null_;
		debug_timer_start();
		if (dev_mode_debug_unused && type == /*"diffuse"*/ STR(633))
		{
			ArrType filesarr = file_find(global::load_assets_dir + mc_textures_directory + /*"item/"*/ STR(2475), /*".png"*/ STR(10));
			fileslist = ds_list_create();
			for (IntType i = IntType(0); i < array_length(VarType::CreateRef(filesarr)); i++)
				ds_list_add({ fileslist, filesarr.Value(i) });
		}
		log({ /*"Item textures"*/ STR(2627), type, /*"load"*/ STR(2628) });
		texlist = ds_list_create();
		for (IntType t = IntType(0); t < ds_list_size((IntType)(ObjType(obj_minecraft_assets, global::mc_assets)->item_texture_list)); t++)
		{
			...
			{
				if (dev_mode)
					log({ /*"Item texture not found"*/ STR(2629), DsList(ObjType(obj_minecraft_assets, global::mc_assets)->item_texture_list).Value(t) + suffix });
				ds_list_add({ texlist, null_ });
			}
		...
		if (itemsize == null_)
			itemsize = item_size;
		log({ /*"Item textures"*/ STR(2627), /*"surface"*/ STR(553) });
		draw_texture_start();
		...
		surface_set_target(surf);
	{
		...
		for (IntType t = IntType(0); t < ds_list_size(texlist); t++)
		{
			...
			{
				if (type == /*"diffuse"*/ STR(633) && self->id != global::mc_res)
		...
		surface_free(surf);
		ds_list_destroy(texlist);
		log({ /*"Item textures"*/ STR(2627), type, /*"done"*/ STR(1755) });
		debug_timer_stop(/*"Item textures: "*/ STR(2631) + type);
	}
	...
	void res_load_pack_model_textures(ScopeAny self)
	{
		...
		debug_timer_start();
		log({ /*"Model textures"*/ STR(2632), /*"load"*/ STR(2628) });
		...
		for (IntType t = IntType(0); t < ds_list_size((IntType)(ObjType(obj_minecraft_assets, global::mc_assets)->model_texture_list)); t++)
		{
			...
			matfname = global::load_assets_dir + mc_textures_directory + name + /*"_s.png"*/ STR(2633);
			norfname = global::load_assets_dir + mc_textures_directory + name + /*"_n.png"*/ STR(2634);
			if (file_exists_lib(fname))
			{
				if (name == /*"entity/steve"*/ STR(2635))
				...
				{
					if (dev_mode)
						log({ /*"Model texture not found"*/ STR(2636), DsList(ObjType(obj_minecraft_assets, global::mc_assets)->model_texture_list).Value(t) });
			...
			{
				if (matfname == /*"entity/steve_s"*/ STR(2637))
			...
			{
				if (norfname == /*"entity/steve_n"*/ STR(2638))
		...
		log({ /*"Model textures"*/ STR(2632), /*"done"*/ STR(1755) });
		debug_timer_stop(/*"Model textures"*/ STR(2632));
	}
	...
	void res_load_pack_particle_textures(ScopeAny self)
	{
		...
		debug_timer_start();
		log({ /*"Particle textures"*/ STR(2639), /*"load"*/ STR(2628) });
		...
		for (IntType t = IntType(0); t < ds_list_size((IntType)(ObjType(obj_minecraft_assets, global::mc_assets)->particle_texture_list)); t++)
		{
			...
			if (file_exists_lib(fname))
			{
				...
				{
					if (dev_mode)
						log({ /*"Particle texture not found"*/ STR(2640), DsList(ObjType(obj_minecraft_assets, global::mc_assets)->particle_texture_list).Value(t) });
					tex = texture_create_missing();
				}
			...
			{
				if (string_contains(name, /*"explosion"*/ STR(2641)))
				{
		...
		log({ /*"Particle textures"*/ STR(2639), /*"legacy sheets"*/ STR(2642) });
		...
		log({ /*"Particle textures"*/ STR(2639), /*"done"*/ STR(1755) });
		debug_timer_stop(/*"Particle textures"*/ STR(2639));
	}
