...
namespace CppProject
{
	...
	VarType filename_get_valid(VarType fn)
	{
		...
		fn = string_replace_all(fn, /*":"*/ STR(782), /*"_"*/ STR(1127));
		...
		fn = string_replace_all(fn, /*"|"*/ STR(879), /*"_"*/ STR(1127));
	...
	{
		return file_dialog_open(text_get({ /*"filedialogopenasset"*/ STR(1135) }) + /*"|"*/ STR(879) + asset_exts, /*""*/ STR(0), /*""*/ STR(0), text_get({ /*"filedialogopenassetcaption"*/ STR(1136) }));
	}
	...
	{
		return file_dialog_save(/*" * "*/ STR(700) + exts + /*"|*"*/ STR(1196) + exts, filename_get_valid(fn), /*""*/ STR(0), text_get({ /*"filedialogsaveresourcecaption"*/ STR(1197) }));
	}
	...
	{
		StringType str, hex;
		str = string_replace(oldstr, /*"#"*/ STR(854), /*""*/ STR(0));
